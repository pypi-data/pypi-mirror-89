...
def make_openapi_response_model(http_200: Union[bool, int, float, tuple, list, dict, str, Type[BaseModel]] = None, http_409: str = None, http_400: str = None, http_404: str = None,
    ...
    if http_200:
        # if isinstance(http_200, (bool, int, float, tuple, list, dict, str)):
        #     responses[200] = {
