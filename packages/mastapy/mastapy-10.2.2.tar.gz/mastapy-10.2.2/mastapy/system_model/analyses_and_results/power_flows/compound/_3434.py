...
class ExternalCADModelCompoundPowerFlow(_3411.ComponentCompoundPowerFlow):
    '''ExternalCADModelCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3310.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3310.ExternalCADModelPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3310.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3310.ExternalCADModelPowerFlow))
        return value
