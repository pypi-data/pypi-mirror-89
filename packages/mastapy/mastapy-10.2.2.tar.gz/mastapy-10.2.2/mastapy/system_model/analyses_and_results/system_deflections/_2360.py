...
class SpringDamperConnectionSystemDeflection(_2289.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3360.SpringDamperConnectionPowerFlow':
        ...
        return constructor.new(_3360.SpringDamperConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
