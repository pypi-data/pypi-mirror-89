...
class Four:
	"""Four commands group definition. 1 total commands, 0 Sub-groups, 1 group commands
	Repeated Capability: MatrixFourLine, default value after init: MatrixFourLine.Nr1"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("four", core, parent)
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_matrixFourLine_get', 'repcap_matrixFourLine_set', repcap.MatrixFourLine.Nr1)

	def repcap_matrixFourLine_set(self, enum_value: repcap.MatrixFourLine) -> None:
	...
	def set(self, structure: SetStruct, secondaryCompCarrier=repcap.SecondaryCompCarrier.Default, matrixFourLine=repcap.MatrixFourLine.Default) -> None:
		...
		Snippet: driver.configure.connection.scc.tm.cmatrix.four.set(value = [PROPERTY_STRUCT_NAME](), secondaryCompCarrier = repcap.SecondaryCompCarrier.Default, matrixFourLine = repcap.MatrixFourLine.Default) \n
		...
		matrixFourLine_cmd_val = self._base.get_repcap_cmd_value(matrixFourLine, repcap.MatrixFourLine)
	...
	def clone(self) -> 'Four':
		...
		new_group = Four(self._core, self._base.parent)
