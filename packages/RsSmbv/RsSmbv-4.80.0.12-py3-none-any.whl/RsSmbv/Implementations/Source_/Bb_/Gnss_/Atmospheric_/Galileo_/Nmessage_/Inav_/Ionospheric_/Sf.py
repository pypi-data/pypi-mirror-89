...
class Sf:
	...
	def set(self, sf: int, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.gnss.atmospheric.galileo.nmessage.inav.ionospheric.sf.set(sf = 1, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ATMospheric:GALileo:[NMESsage]:[INAV]:IONospheric:SF<CH> \n
		Snippet: value: int = driver.source.bb.gnss.atmospheric.galileo.nmessage.inav.ionospheric.sf.get(channel = repcap.Channel.Default) \n
		Sets the parameters ionospheric disturbance flag for region 1 to 5 of the satellite's navigation message. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Galileo')
