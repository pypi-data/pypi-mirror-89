...
class Wnumber:
	...
	def set(self, week_number: int, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:GALileo<ST>:TOAData:WNUMber \n
		Snippet: driver.source.bb.gnss.adGeneration.galileo.toaData.wnumber.set(week_number = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:GALileo<ST>:TOAData:WNUMber \n
		Snippet: value: int = driver.source.bb.gnss.adGeneration.galileo.toaData.wnumber.get(stream = repcap.Stream.Default) \n
		Enabled for GPS timebase (method RsSmbv.Source.Bb.Gnss.AdGeneration.Qzss.ToaData.Tbasis.set) . Sets the week number (WN)
		the assistance data is generated for. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Galileo')
