...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2286.ConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3325.KlingelnbergCycloPalloidConicalGearPowerFlow':
