...
class Eviction(K8sResource):
    ...
    deleteOptions: Union[None, OmitEnum, kdsl.core.v1.DeleteOptions] = attr.ib(metadata={'yaml_name': 'deleteOptions'}, converter=kdsl.core.v1_converters.optional_converter_DeleteOptions, default=OMIT)
...
class PodDisruptionBudget(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.policy.v1beta1.PodDisruptionBudgetSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.policy.v1beta1_converters.optional_converter_PodDisruptionBudgetSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.policy.v1beta1.PodDisruptionBudgetStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.policy.v1beta1_converters.optional_converter_PodDisruptionBudgetStatus, default=OMIT)


@attr.s(kw_only=True)
class PodSecurityPolicySpec(K8sObject):
    fsGroup: kdsl.policy.v1beta1.FSGroupStrategyOptions = attr.ib(metadata={'yaml_name': 'fsGroup'}, converter=kdsl.policy.v1beta1_converters.required_converter_FSGroupStrategyOptions)
    runAsUser: kdsl.policy.v1beta1.RunAsUserStrategyOptions = attr.ib(metadata={'yaml_name': 'runAsUser'}, converter=kdsl.policy.v1beta1_converters.required_converter_RunAsUserStrategyOptions)
    seLinux: kdsl.policy.v1beta1.SELinuxStrategyOptions = attr.ib(metadata={'yaml_name': 'seLinux'}, converter=kdsl.policy.v1beta1_converters.required_converter_SELinuxStrategyOptions)
    supplementalGroups: kdsl.policy.v1beta1.SupplementalGroupsStrategyOptions = attr.ib(metadata={'yaml_name': 'supplementalGroups'}, converter=kdsl.policy.v1beta1_converters.required_converter_SupplementalGroupsStrategyOptions)
    allowPrivilegeEscalation: Union[None, OmitEnum, bool] = attr.ib(metadata={'yaml_name': 'allowPrivilegeEscalation'}, default=OMIT)
    allowedCSIDrivers: Union[None, OmitEnum, Sequence[kdsl.policy.v1beta1.AllowedCSIDriver]] = attr.ib(metadata={'yaml_name': 'allowedCSIDrivers'}, converter=kdsl.policy.v1beta1_converters.optional_list_converter_AllowedCSIDriver, default=OMIT)
    allowedCapabilities: Union[None, OmitEnum, Sequence[str]] = attr.ib(metadata={'yaml_name': 'allowedCapabilities'}, default=OMIT)
    allowedFlexVolumes: Union[None, OmitEnum, Sequence[kdsl.policy.v1beta1.AllowedFlexVolume]] = attr.ib(metadata={'yaml_name': 'allowedFlexVolumes'}, converter=kdsl.policy.v1beta1_converters.optional_list_converter_AllowedFlexVolume, default=OMIT)
    allowedHostPaths: Union[None, OmitEnum, Sequence[kdsl.policy.v1beta1.AllowedHostPath]] = attr.ib(metadata={'yaml_name': 'allowedHostPaths'}, converter=kdsl.policy.v1beta1_converters.optional_list_converter_AllowedHostPath, default=OMIT)
    ...
    hostPorts: Union[None, OmitEnum, Sequence[kdsl.policy.v1beta1.HostPortRange]] = attr.ib(metadata={'yaml_name': 'hostPorts'}, converter=kdsl.policy.v1beta1_converters.optional_list_converter_HostPortRange, default=OMIT)
    ...
    runAsGroup: Union[None, OmitEnum, kdsl.policy.v1beta1.RunAsGroupStrategyOptions] = attr.ib(metadata={'yaml_name': 'runAsGroup'}, converter=kdsl.policy.v1beta1_converters.optional_converter_RunAsGroupStrategyOptions, default=OMIT)
    runtimeClass: Union[None, OmitEnum, kdsl.policy.v1beta1.RuntimeClassStrategyOptions] = attr.ib(metadata={'yaml_name': 'runtimeClass'}, converter=kdsl.policy.v1beta1_converters.optional_converter_RuntimeClassStrategyOptions, default=OMIT)
...
class RunAsGroupStrategyOptions(K8sObject):
    rule: str = attr.ib(metadata={'yaml_name': 'rule'})
    ranges: Union[None, OmitEnum, Sequence[kdsl.policy.v1beta1.IDRange]] = attr.ib(metadata={'yaml_name': 'ranges'}, converter=kdsl.policy.v1beta1_converters.optional_list_converter_IDRange, default=OMIT)
...
class PodSecurityPolicy(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.policy.v1beta1.PodSecurityPolicySpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.policy.v1beta1_converters.optional_converter_PodSecurityPolicySpec, default=OMIT)
