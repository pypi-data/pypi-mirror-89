...
class ExternalMetricStatus(K8sObject):
    ...
    metricSelector: Union[None, OmitEnum, kdsl.core.v1.LabelSelector] = attr.ib(metadata={'yaml_name': 'metricSelector'}, converter=kdsl.core.v1_converters.optional_converter_LabelSelector, default=OMIT)
...
class MetricStatus(K8sObject):
    ...
    external: Union[None, OmitEnum, kdsl.autoscaling.v2beta1.ExternalMetricStatus] = attr.ib(metadata={'yaml_name': 'external'}, converter=kdsl.autoscaling.v2beta1_converters.optional_converter_ExternalMetricStatus, default=OMIT)
    object: Union[None, OmitEnum, kdsl.autoscaling.v2beta1.ObjectMetricStatus] = attr.ib(metadata={'yaml_name': 'object'}, converter=kdsl.autoscaling.v2beta1_converters.optional_converter_ObjectMetricStatus, default=OMIT)
    pods: Union[None, OmitEnum, kdsl.autoscaling.v2beta1.PodsMetricStatus] = attr.ib(metadata={'yaml_name': 'pods'}, converter=kdsl.autoscaling.v2beta1_converters.optional_converter_PodsMetricStatus, default=OMIT)
    resource: Union[None, OmitEnum, kdsl.autoscaling.v2beta1.ResourceMetricStatus] = attr.ib(metadata={'yaml_name': 'resource'}, converter=kdsl.autoscaling.v2beta1_converters.optional_converter_ResourceMetricStatus, default=OMIT)
...
class HorizontalPodAutoscalerSpec(K8sObject):
    ...
    scaleTargetRef: kdsl.autoscaling.v2beta1.CrossVersionObjectReference = attr.ib(metadata={'yaml_name': 'scaleTargetRef'}, converter=kdsl.autoscaling.v2beta1_converters.required_converter_CrossVersionObjectReference)
    metrics: Union[None, OmitEnum, Sequence[kdsl.autoscaling.v2beta1.MetricSpec]] = attr.ib(metadata={'yaml_name': 'metrics'}, converter=kdsl.autoscaling.v2beta1_converters.optional_list_converter_MetricSpec, default=OMIT)
...
class HorizontalPodAutoscalerStatus(K8sObject):
    conditions: Sequence[kdsl.autoscaling.v2beta1.HorizontalPodAutoscalerCondition] = attr.ib(metadata={'yaml_name': 'conditions'}, converter=kdsl.autoscaling.v2beta1_converters.required_list_converter_HorizontalPodAutoscalerCondition)
    ...
    currentMetrics: Union[None, OmitEnum, Sequence[kdsl.autoscaling.v2beta1.MetricStatus]] = attr.ib(metadata={'yaml_name': 'currentMetrics'}, converter=kdsl.autoscaling.v2beta1_converters.optional_list_converter_MetricStatus, default=OMIT)
...
class ObjectMetricStatus(K8sObject):
    currentValue: str = attr.ib(metadata={'yaml_name': 'currentValue'})
    metricName: str = attr.ib(metadata={'yaml_name': 'metricName'})
    target: kdsl.autoscaling.v2beta1.CrossVersionObjectReference = attr.ib(metadata={'yaml_name': 'target'}, converter=kdsl.autoscaling.v2beta1_converters.required_converter_CrossVersionObjectReference)
...
class HorizontalPodAutoscaler(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.autoscaling.v2beta1.HorizontalPodAutoscalerSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.autoscaling.v2beta1_converters.optional_converter_HorizontalPodAutoscalerSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.autoscaling.v2beta1.HorizontalPodAutoscalerStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.autoscaling.v2beta1_converters.optional_converter_HorizontalPodAutoscalerStatus, default=OMIT)


@attr.s(kw_only=True)
class MetricSpec(K8sObject):
    type: str = attr.ib(metadata={'yaml_name': 'type'})
    external: Union[None, OmitEnum, kdsl.autoscaling.v2beta1.ExternalMetricSource] = attr.ib(metadata={'yaml_name': 'external'}, converter=kdsl.autoscaling.v2beta1_converters.optional_converter_ExternalMetricSource, default=OMIT)
    object: Union[None, OmitEnum, kdsl.autoscaling.v2beta1.ObjectMetricSource] = attr.ib(metadata={'yaml_name': 'object'}, converter=kdsl.autoscaling.v2beta1_converters.optional_converter_ObjectMetricSource, default=OMIT)
    pods: Union[None, OmitEnum, kdsl.autoscaling.v2beta1.PodsMetricSource] = attr.ib(metadata={'yaml_name': 'pods'}, converter=kdsl.autoscaling.v2beta1_converters.optional_converter_PodsMetricSource, default=OMIT)
    resource: Union[None, OmitEnum, kdsl.autoscaling.v2beta1.ResourceMetricSource] = attr.ib(metadata={'yaml_name': 'resource'}, converter=kdsl.autoscaling.v2beta1_converters.optional_converter_ResourceMetricSource, default=OMIT)
