...
class HypoidGearSystemDeflection(_2256.AGMAGleasonConicalGearSystemDeflection):
    '''HypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3320.HypoidGearPowerFlow':
        ...
        return constructor.new(_3320.HypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
