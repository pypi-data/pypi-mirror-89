...
class Wnumber:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:STARt:GALileo<ST>:WNUMber \n
		Snippet: value: int = driver.source.bb.gnss.time.start.galileo.wnumber.get(stream = repcap.Stream.Default) \n
