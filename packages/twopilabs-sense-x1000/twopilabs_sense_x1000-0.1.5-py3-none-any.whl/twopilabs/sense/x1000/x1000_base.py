...
class SenseX1000Base(object):
    ...
    class AcqHeader(NamedTuple):
        ...
        @classmethod
        def from_stream(cls, stream: io.RawIOBase) -> 'SenseX1000Base.AcqHeader':
    ...
    class AcqData(object):
        ...
        @classmethod
        def from_stream(cls, stream: io.RawIOBase, header: 'SenseX1000Base.AcqHeader', seq_num: int, n_sweeps: int):
    ...
    class Acquisition(object):
        ...
        @classmethod
        def from_stream(cls, stream: io.RawIOBase) -> 'SenseX1000Base.Acquisition':
