...
class Min:
	...
	def set(self, minimum_sv_s: int, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:SELection:GPS<ST>:MIN \n
		Snippet: driver.source.bb.gnss.sv.selection.gps.min.set(minimum_sv_s = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:SELection:GPS<ST>:MIN \n
		Snippet: value: int = driver.source.bb.gnss.sv.selection.gps.min.get(stream = repcap.Stream.Default) \n
		Sets the minimum and maximum number of satellites per GNSS system that can be included in the satellite constellation. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Gps')
