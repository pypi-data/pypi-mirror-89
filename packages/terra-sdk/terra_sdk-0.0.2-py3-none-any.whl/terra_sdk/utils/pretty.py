...
__IPYTHON__ = False  # TODO: Need fixes
try:
...
def pretty_repr(obj, path=""):
    ...
    if isinstance(obj, dict) and not isinstance(obj, jigu.util.serdes.JiguBox):
        return jigu.util.serdes.JiguBox(obj)._pretty_repr_(path)
