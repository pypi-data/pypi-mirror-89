...
class Ivelocity:
	...
	def set(self, initial_velocity: float, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:SBAS<ST>:SDYNamics:IVELocity \n
		Snippet: driver.source.bb.gnss.svid.sbas.sdynamics.ivelocity.set(initial_velocity = 1.0, channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:SBAS<ST>:SDYNamics:IVELocity \n
		Snippet: value: float = driver.source.bb.gnss.svid.sbas.sdynamics.ivelocity.get(channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
		Indicates the initial velocity, used at the beginning of the profile. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Svid')
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Sbas')
