...
class Scell:
	...
	def get_flexible(self) -> FlexibleStruct:
		...
		"""
		return self._core.io.query_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:SCELl:FLEXible?', self.__class__.FlexibleStruct())
	...
	def set_flexible(self, value: FlexibleStruct) -> None:
		...
		"""
		self._core.io.write_struct('ROUTe:LTE:SIGNaling<Instance>:SCENario:SCELl:FLEXible', value)
