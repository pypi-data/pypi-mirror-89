...
[boto3.KinesisVideoSignalingChannels 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/kinesis-video-signaling.html#KinesisVideoSignalingChannels) service
compatible with
