...
class Npow:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("npow", core, parent)

	@property
	def current(self):
		"""current commands group. 0 Sub-classes, 2 commands."""
		if not hasattr(self, '_current'):
			from .Npow_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Npow_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Npow_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Npow_.Minimum import Minimum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .Npow_.StandardDev import StandardDev
	...
	def clone(self) -> 'Npow':
		...
		new_group = Npow(self._core, self._base.parent)
