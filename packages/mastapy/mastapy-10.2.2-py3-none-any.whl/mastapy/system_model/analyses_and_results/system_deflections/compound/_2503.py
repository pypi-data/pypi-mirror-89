...
class StraightBevelGearCompoundSystemDeflection(_2415.BevelGearCompoundSystemDeflection):
    '''StraightBevelGearCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2368.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2368.StraightBevelGearSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2368.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2368.StraightBevelGearSystemDeflection))
        return value
