...
class Diagnostic:
	"""Diagnostic commands group definition. 15 total commands, 1 Sub-groups, 0 group commands"""
	...
	@property
	def signaling(self):
		"""signaling commands group. 7 Sub-classes, 1 commands."""
		if not hasattr(self, '_signaling'):
			from .Diagnostic_.Signaling import Signaling
