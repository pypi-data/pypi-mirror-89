...
class PlanetCarrierSystemDeflection(_2335.MountableComponentSystemDeflection):
    '''PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3343.PlanetCarrierPowerFlow':
        ...
        return constructor.new(_3343.PlanetCarrierPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def windup(self) -> 'List[_2396.PlanetCarrierWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Windup, constructor.new(_2396.PlanetCarrierWindup))
        return value
