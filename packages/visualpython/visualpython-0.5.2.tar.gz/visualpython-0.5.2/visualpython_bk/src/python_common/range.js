define([
    ...
    PythonCommon.prototype.initHtml = function() {
        ...
        tblLayoutRequire.addRow("Start", sbTagString.toString());

        sbTagString.clear();
        sbTagString.appendFormat('<input type="number" id="{0}" class="{1}" />', 'vp_pyStop', 'vp-input');
        tblLayoutRequire.addRow("Stop", sbTagString.toString()); // TODO: required

        sbTagString.clear();
        sbTagString.appendFormat('<input type="number" id="{0}" class="{1}"/>', 'vp_pyStep', 'vp-input');
        tblLayoutRequire.addRow("Step", sbTagString.toString());
