...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2323.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3328.KlingelnbergCycloPalloidHypoidGearPowerFlow':
        ...
        return constructor.new(_3328.KlingelnbergCycloPalloidHypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
