...
class Catalog:
	...
	def get(self, ims=repcap.Ims.Default) -> str:
		...
		Snippet: value: str = driver.sense.data.control.ims.virtualSubscriber.catalog.get(ims = repcap.Ims.Default) \n
		...
		response = self._core.io.query_str(f'SENSe:DATA:CONTrol:IMS{ims_cmd_val}:VIRTualsub:CATalog?')
