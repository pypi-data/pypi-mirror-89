...
class Ioffset:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:GPS<ST>:UTC:IOFFset \n
		Snippet: value: int = driver.source.bb.gnss.time.conversion.gps.utc.ioffset.get(stream = repcap.Stream.Default) \n
