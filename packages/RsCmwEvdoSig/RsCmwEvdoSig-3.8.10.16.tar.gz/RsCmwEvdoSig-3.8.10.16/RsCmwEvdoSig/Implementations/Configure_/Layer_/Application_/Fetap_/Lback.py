...
class Lback:
	...
	def get_enable(self) -> bool:
		...
		Snippet: value: bool = driver.configure.layer.application.fetap.lback.get_enable() \n
		Indicates whether the AT under test can transmit FETAP loopback packets to provide packet error rate (PER) information. \n
			:return: lback: OFF | ON
		"""
		response = self._core.io.query_str('CONFigure:EVDO:SIGNaling<Instance>:LAYer:APPLication:FETap:LBACk:ENABle?')
