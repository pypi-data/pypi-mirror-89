...
class Am:
	"""Am commands group definition. 13 total commands, 5 Sub-groups, 3 group commands
	...
	@property
	def internal(self):
		"""internal commands group. 1 Sub-classes, 1 commands."""
		if not hasattr(self, '_internal'):
			from .Am_.Internal import Internal
