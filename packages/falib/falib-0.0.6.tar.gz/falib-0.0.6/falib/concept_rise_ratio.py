...
________________________________________________________
    ...
    df_ref1_pct = ts_day_data_today[['code', 'pre_pct_chg']].set_index('code')
    #  计算板块当日的平均涨幅
    for i, icode_list in enumerate(code_in_con.code):
        ref1_pct_list = [df_ref1_pct.loc[icode, 'pre_pct_chg'] if icode in df_ref1_pct.index else 0 for icode in icode_list]
