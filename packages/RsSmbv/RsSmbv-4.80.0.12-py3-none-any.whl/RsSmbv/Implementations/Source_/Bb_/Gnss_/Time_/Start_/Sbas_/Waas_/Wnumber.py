...
class Wnumber:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:STARt:SBAS<ST>:WAAS:WNUMber \n
		Snippet: value: int = driver.source.bb.gnss.time.start.sbas.waas.wnumber.get(stream = repcap.Stream.Default) \n
