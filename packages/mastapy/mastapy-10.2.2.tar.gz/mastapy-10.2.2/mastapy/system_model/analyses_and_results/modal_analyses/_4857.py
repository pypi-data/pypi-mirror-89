...
class StraightBevelGearSetModalAnalysis(_4763.BevelGearSetModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2367.StraightBevelGearSetSystemDeflection':
        ...
        return constructor.new(_2367.StraightBevelGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
