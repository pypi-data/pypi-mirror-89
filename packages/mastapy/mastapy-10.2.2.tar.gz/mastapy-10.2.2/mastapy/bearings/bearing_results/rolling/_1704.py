...
from mastapy.bearings.bearing_results.rolling import _1703, _1651
...
class LoadedThrustBallBearingRow(_1651.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1703.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1703.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
