...
from mastapy.bearings.bearing_results.rolling import _1691, _1678
...
class LoadedSphericalRollerThrustBearingRow(_1678.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1691.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1691.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
