...
class Current:
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.obw.current.read() \n
		...
		return self._core.io.query_struct(f'READ:CDMA:MEASurement<Instance>:MEValuation:OBW:CURRent?', self.__class__.ResultData())

	def fetch(self) -> ResultData:
		"""SCPI: FETCh:CDMA:MEASurement<Instance>:MEValuation:OBW:CURRent \n
		Snippet: value: ResultData = driver.multiEval.obw.current.fetch() \n
		Return the current, average and maximum occupied bandwidth value results. The values described below are returned by
		FETCh and READ commands. CALCulate commands return limit check results instead, one value for each result listed below. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:CDMA:MEASurement<Instance>:MEValuation:OBW:CURRent?', self.__class__.ResultData())
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.multiEval.obw.current.calculate() \n
		Return the current, average and maximum occupied bandwidth value results. The values described below are returned by
		FETCh and READ commands. CALCulate commands return limit check results instead, one value for each result listed below. \n
			:return: structure: for return value, see the help for CalculateStruct structure arguments."""
		return self._core.io.query_struct(f'CALCulate:CDMA:MEASurement<Instance>:MEValuation:OBW:CURRent?', self.__class__.CalculateStruct())
