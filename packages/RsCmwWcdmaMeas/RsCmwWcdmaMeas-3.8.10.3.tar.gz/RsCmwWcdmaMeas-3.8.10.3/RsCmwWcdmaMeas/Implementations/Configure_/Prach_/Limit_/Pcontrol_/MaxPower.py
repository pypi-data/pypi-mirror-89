...
class MaxPower:
	...
	def get_urp_class(self) -> bool:
		...
		Enables or disables the usage of the UE power class value reported by the UE in the capability report. This setting is
		only relevant if the combined signal path scenario is active and not relevant if user-defined limits are used instead of
		the predefined limit sets. \n
	...
	def get_user_defined(self) -> UserDefinedStruct:
		...
		Sets the user-defined maximum output power limits. To activate the usage of this limit set, see method RsCmwWcdmaMeas.
		Configure.Prach.Limit.Pcontrol.MaxPower.value. \n
			:return: structure: for return value, see the help for UserDefinedStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:WCDMa:MEASurement<Instance>:PRACh:LIMit:PCONtrol:MAXPower:UDEFined?', self.__class__.UserDefinedStruct())
	...
	def set_user_defined(self, value: UserDefinedStruct) -> None:
		...
		"""
		self._core.io.write_struct('CONFigure:WCDMa:MEASurement<Instance>:PRACh:LIMit:PCONtrol:MAXPower:UDEFined', value)
	...
	def get_value(self) -> ValueStruct:
		...
		"""
		return self._core.io.query_struct('CONFigure:WCDMa:MEASurement<Instance>:PRACh:LIMit:PCONtrol:MAXPower?', self.__class__.ValueStruct())
	...
	def set_value(self, value: ValueStruct) -> None:
		...
		"""
		self._core.io.write_struct('CONFigure:WCDMa:MEASurement<Instance>:PRACh:LIMit:PCONtrol:MAXPower', value)
