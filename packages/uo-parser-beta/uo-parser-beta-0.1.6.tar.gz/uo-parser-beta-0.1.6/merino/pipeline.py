...
class Pipeline:
    ...
    def ssplit(self, in_doc):  # assuming input is a document
        ...
        eval_batch_size = tbname2tokbatchsize.get(lang2treebank[self.active_lang], 6)
        # load input text
        config = self._config
    ...
    def _posdep_sent(self, in_sent):  # assuming input is a sentence
        ...
        for batch in DataLoader(test_set, batch_size=tbname2tagbatchsize.get(self._config.treebank_name, 32),
                                shuffle=False, collate_fn=test_set.collate_fn):
