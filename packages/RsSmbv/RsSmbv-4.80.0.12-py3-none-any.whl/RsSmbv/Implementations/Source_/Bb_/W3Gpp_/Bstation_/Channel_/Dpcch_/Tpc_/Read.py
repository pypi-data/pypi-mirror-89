...
class Read:
	...
	def set(self, read: enums.TpcReadMode, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:BSTation<ST>:CHANnel<CH>:DPCCh:TPC:READ \n
		Snippet: driver.source.bb.w3Gpp.bstation.channel.dpcch.tpc.read.set(read = enums.TpcReadMode.CONTinuous, stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
	...
	def get(self, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> enums.TpcReadMode:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:BSTation<ST>:CHANnel<CH>:DPCCh:TPC:READ \n
		Snippet: value: enums.TpcReadMode = driver.source.bb.w3Gpp.bstation.channel.dpcch.tpc.read.get(stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
		The command sets the read out mode for the bit pattern of the TPC field. The bit pattern is defined with the commands
		BB:W3GPp:BST<i>:CHANnel<n>:DPCCh:TPC.... \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Bstation')
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Channel')
