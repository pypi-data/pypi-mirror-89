...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns.compound import _4221
...
class CVTPulleyCompoundModalAnalysesAtSpeeds(_4221.PulleyCompoundModalAnalysesAtSpeeds):
    '''CVTPulleyCompoundModalAnalysesAtSpeeds
