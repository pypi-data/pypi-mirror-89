...
[boto3.PersonalizeEvents 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/personalize-events.html#PersonalizeEvents) service
compatible with
