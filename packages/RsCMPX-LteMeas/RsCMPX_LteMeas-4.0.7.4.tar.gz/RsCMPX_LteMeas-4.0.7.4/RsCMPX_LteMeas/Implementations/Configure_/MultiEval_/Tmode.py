...
class Tmode:
	...
	def get_scount(self) -> List[int]:
		...
		power values, see method RsCMPX_LteMeas.Configure.MultiEval.Tmode.envelopePower. \n
			:return: subframe_count: Comma-separated list of 16 values, for list entry number 0 to 15
		"""
	...
	def set_scount(self, subframe_count: List[int]) -> None:
		...
		Defines the subframe counts for all entries of the TPC Mode list. For definition of the corresponding expected nominal
		power values, see method RsCMPX_LteMeas.Configure.MultiEval.Tmode.envelopePower. \n
			:param subframe_count: Comma-separated list of 16 values, for list entry number 0 to 15
		"""
