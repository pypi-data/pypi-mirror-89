...
class ConceptCouplingParametricStudyTool(_3546.CouplingParametricStudyTool):
    '''ConceptCouplingParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2279.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2279.ConceptCouplingSystemDeflection))
        return value
