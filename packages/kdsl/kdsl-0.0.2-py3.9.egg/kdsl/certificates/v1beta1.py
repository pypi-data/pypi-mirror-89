...
class CertificateSigningRequest(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.certificates.v1beta1.CertificateSigningRequestSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.certificates.v1beta1_converters.optional_converter_CertificateSigningRequestSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.certificates.v1beta1.CertificateSigningRequestStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.certificates.v1beta1_converters.optional_converter_CertificateSigningRequestStatus, default=OMIT)
...
class CertificateSigningRequestStatus(K8sObject):
    ...
    conditions: Union[None, OmitEnum, Sequence[kdsl.certificates.v1beta1.CertificateSigningRequestCondition]] = attr.ib(metadata={'yaml_name': 'conditions'}, converter=kdsl.certificates.v1beta1_converters.optional_list_converter_CertificateSigningRequestCondition, default=OMIT)
