...
class KlingelnbergCycloPalloidHypoidGearSetGearWhineAnalysis(_5385.KlingelnbergCycloPalloidConicalGearSetGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2325.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection':
        ...
        return constructor.new(_2325.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
