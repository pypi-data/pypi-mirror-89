...
class PointLoadCompoundPowerFlow(_3502.VirtualComponentCompoundPowerFlow):
    '''PointLoadCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3344.PointLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3344.PointLoadPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3344.PointLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3344.PointLoadPowerFlow))
        return value
