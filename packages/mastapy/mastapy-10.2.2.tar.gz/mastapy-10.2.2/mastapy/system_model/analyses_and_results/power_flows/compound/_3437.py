...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3435, _3436, _3441
...
class FaceGearSetCompoundPowerFlow(_3441.GearSetCompoundPowerFlow):
    '''FaceGearSetCompoundPowerFlow
    ...
    @property
    def face_gears_compound_power_flow(self) -> 'List[_3435.FaceGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundPowerFlow, constructor.new(_3435.FaceGearCompoundPowerFlow))
        return value

    @property
    def face_meshes_compound_power_flow(self) -> 'List[_3436.FaceGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundPowerFlow, constructor.new(_3436.FaceGearMeshCompoundPowerFlow))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3313.FaceGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3313.FaceGearSetPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3313.FaceGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3313.FaceGearSetPowerFlow))
        return value
