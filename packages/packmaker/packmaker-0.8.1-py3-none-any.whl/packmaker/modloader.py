...
class ModLoader (object):
    ...
    def _install_libraries(self, cache_location, lib_location, libraries):
        for library in libraries:
            ...
            local_library = os.path.join(lib_location, library.get_path_local())
            if not os.path.exists(os.path.dirname(local_library)):
                os.makedirs(os.path.dirname(local_library))

            shutil.copy2(downloaded_file, local_library)
