...
class RollingRingConnectionParametricStudyTool(_3575.InterMountableComponentConnectionParametricStudyTool):
    '''RollingRingConnectionParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2348.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2348.RollingRingConnectionSystemDeflection))
        return value
