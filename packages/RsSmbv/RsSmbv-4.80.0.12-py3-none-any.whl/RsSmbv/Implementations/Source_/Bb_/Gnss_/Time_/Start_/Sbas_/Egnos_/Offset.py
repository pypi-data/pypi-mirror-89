...
class Offset:
	...
	def get(self, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:STARt:SBAS<ST>:EGNOS:OFFSet \n
		Snippet: value: float = driver.source.bb.gnss.time.start.sbas.egnos.offset.get(stream = repcap.Stream.Default) \n
