...
class KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis(_5383.KlingelnbergCycloPalloidConicalGearGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2329.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2329.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
