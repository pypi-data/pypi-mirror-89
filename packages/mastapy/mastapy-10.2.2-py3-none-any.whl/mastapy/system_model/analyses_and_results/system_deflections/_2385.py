...
class VirtualComponentSystemDeflection(_2335.MountableComponentSystemDeflection):
    '''VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3381.VirtualComponentPowerFlow':
