...
def make_openapi_response_model(http_409:str = None, http_400: str = None, http_404: str = None, http_403: str = "Unauthorized - Denied by eHelply", other: dict = None):
    """
    ...
    if http_409:
        responses[409] = "{item} already exists.".format(item=http_409)

    if http_400:
        responses[400] = http_400

    if http_404:
        responses[404] = "{item} does not exist.".format(item=http_404)

    if http_403:
        responses[403] = http_403
