...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.ber.pswitched.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:GSM:SIGNaling<Instance>:BER:PSWitched:STATe:ALL?', self.__class__.FetchStruct())
