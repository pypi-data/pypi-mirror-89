...
class EvMagnitude:
	...
	def get_evm_symbol(self) -> EvmSymbolStruct:
		...
		Snippet: value: EvmSymbolStruct = driver.configure.nrMmwMeas.multiEval.result.evMagnitude.get_evm_symbol() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:NRMMw:MEASurement<Instance>:MEValuation:RESult:EVMagnitude:EVMSymbol?', self.__class__.EvmSymbolStruct())

	def set_evm_symbol(self, value: EvmSymbolStruct) -> None:
		"""SCPI: CONFigure:NRMMw:MEASurement<Instance>:MEValuation:RESult:EVMagnitude:EVMSymbol \n
		Snippet: driver.configure.nrMmwMeas.multiEval.result.evMagnitude.set_evm_symbol(value = EvmSymbolStruct()) \n
		Enables or disables the measurement of EVM vs. modulation symbol results and configures the scope of the measurement. \n
			:param value: see the help for EvmSymbolStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:NRMMw:MEASurement<Instance>:MEValuation:RESult:EVMagnitude:EVMSymbol', value)
