...
class CVTPulleyGearWhineAnalysis(_5406.PulleyGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2293.CVTPulleySystemDeflection':
        ...
        return constructor.new(_2293.CVTPulleySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
