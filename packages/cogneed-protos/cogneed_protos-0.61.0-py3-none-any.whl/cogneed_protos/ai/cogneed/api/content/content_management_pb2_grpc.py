...
from cogneed_protos.ai.cogneed.api.content import content_management_pb2 as cogneed__protos_dot_ai_dot_cogneed_dot_api_dot_content_dot_content__management__pb2
...
class ContentManagementServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateUseCase = channel.unary_unary(
        '/ai.cogneed.api.content.ContentManagementService/CreateUseCase',
        request_serializer=cogneed__protos_dot_ai_dot_cogneed_dot_api_dot_content_dot_content__management__pb2.CreateUseCaseRequest.SerializeToString,
...
def add_ContentManagementServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'CreateUseCase': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=cogneed__protos_dot_ai_dot_cogneed_dot_api_dot_content_dot_content__management__pb2.CreateUseCaseRequest.FromString,
          response_serializer=cogneed__protos_dot_ai_dot_cogneed_dot_api_dot_common__pb2.AckResponse.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'ai.cogneed.api.content.ContentManagementService', rpc_method_handlers)
