...
class WormGearParametricStudyTool(_3568.GearParametricStudyTool):
    '''WormGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2388.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2388.WormGearSystemDeflection))
        return value
