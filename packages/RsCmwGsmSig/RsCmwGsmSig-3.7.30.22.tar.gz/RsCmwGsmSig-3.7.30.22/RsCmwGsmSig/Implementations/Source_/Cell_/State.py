...
class State:
	...
	def get_all(self) -> AllStruct:
		...
		"""
		return self._core.io.query_struct('SOURce:GSM:SIGNaling<Instance>:CELL:STATe:ALL?', self.__class__.AllStruct())
	...
	def get_value(self) -> bool:
		...
		"""
		response = self._core.io.query_str_with_opc('SOURce:GSM:SIGNaling<Instance>:CELL:STATe?')
	...
	def set_value(self, main_state: bool) -> None:
		...
		self._core.io.write_with_opc(f'SOURce:GSM:SIGNaling<Instance>:CELL:STATe {param}')
