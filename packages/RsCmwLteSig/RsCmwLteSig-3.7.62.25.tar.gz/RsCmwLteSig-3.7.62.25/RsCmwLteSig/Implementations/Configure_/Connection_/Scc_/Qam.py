...
class Qam:
	"""Qam commands group definition. 1 total commands, 1 Sub-groups, 0 group commands
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_qAMmodulationOrderB_get', 'repcap_qAMmodulationOrderB_set', repcap.QAMmodulationOrderB.QAM256)

	def repcap_qAMmodulationOrderB_set(self, enum_value: repcap.QAMmodulationOrderB) -> None:
	...
	def downlink(self):
		...
		if not hasattr(self, '_downlink'):
			from .Qam_.Downlink import Downlink
