...
[boto3.CodeStarNotifications 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/codestar-notifications.html#CodeStarNotifications) service
compatible with
