...
class RuIndicator:
	...
	def set(self, ruin: str, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.gbas.vdb.mconfig.fdb.ruIndicator.set(ruin = '1', channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> str:
		"""SCPI: [SOURce<HW>]:BB:GBAS:VDB<CH>:MCONfig:FDB<ST>:RUINdicator \n
		Snippet: value: str = driver.source.bb.gbas.vdb.mconfig.fdb.ruIndicator.get(channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
		Sets the route indicator. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Vdb')
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Fdb')
