...
#выполнить_команду('pip uninstall -y -q tensorflow')
#выполнить_команду('pip install -q tensorflow==2.3')
...
def тест_модели_симптомы(нейронка, симптомы, классы):
    обработка_текста.тест_модели(нейронка, симптомы, классы)
