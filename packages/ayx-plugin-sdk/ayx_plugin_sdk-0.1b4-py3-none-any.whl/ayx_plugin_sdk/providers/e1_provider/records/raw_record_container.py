...
from ayx_plugin_sdk.providers.e1_provider.proxies import FieldProxy, RecordCopierProxy
from ayx_plugin_sdk.providers.e1_provider.records.base_record_container import (
    BaseRecordContainer,
)
