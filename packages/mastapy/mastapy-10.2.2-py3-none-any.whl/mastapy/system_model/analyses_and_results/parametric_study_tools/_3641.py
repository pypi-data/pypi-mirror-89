...
class WormGearMeshParametricStudyTool(_3567.GearMeshParametricStudyTool):
    '''WormGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2386.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2386.WormGearMeshSystemDeflection))
        return value
