...
class Slength:
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Nr1) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:AS:DL:CELL<ST>:SLENgth \n
		Snippet: value: int = driver.source.bb.eutra.dl.user.asPy.dl.cell.slength.get(channel = repcap.Channel.Default, stream = repcap.Stream.Nr1) \n
