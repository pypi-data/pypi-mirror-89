...
class BoltedJointSystemDeflection(_2356.SpecialisedAssemblySystemDeflection):
    '''BoltedJointSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3280.BoltedJointPowerFlow':
        ...
        return constructor.new(_3280.BoltedJointPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
