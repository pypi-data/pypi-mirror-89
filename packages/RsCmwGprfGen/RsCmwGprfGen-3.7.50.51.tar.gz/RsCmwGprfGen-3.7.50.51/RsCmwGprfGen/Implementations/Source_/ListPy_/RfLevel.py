...
class RfLevel:
	...
	def set(self, index: int, level: float or bool) -> None:
		...
		Defines or queries the level of the frequency/level step number <Index>. \n
			...
			:param level: Level of the frequency/level step Range: Depends on the instrument model, the connector and other settings; please notice the ranges quoted in the data sheet , Unit: dBm Additional parameters: OFF | ON (disables | enables the frequency/level step)
		"""
	...
	def get(self, index: int) -> float or bool:
		...
		Defines or queries the level of the frequency/level step number <Index>. \n
			:param index: Number of the frequency/level step in the table. Range: 0 to 1999
			:return: level: Level of the frequency/level step Range: Depends on the instrument model, the connector and other settings; please notice the ranges quoted in the data sheet , Unit: dBm Additional parameters: OFF | ON (disables | enables the frequency/level step)"""
	...
	def get_all(self) -> List[float or bool]:
		...
		Defines the levels of all frequency/level steps. \n
			:return: all_levels: Comma-separated list of n values, one per frequency/level step, where n 2001. The query returns 2000 results. Range: Depends on the instrument model, the connector and other settings; please notice the ranges quoted in the data sheet , Unit: dBm Additional parameters: OFF | ON (disables | enables the frequency/level step)
		"""
	...
	def set_all(self, all_levels: List[float or bool]) -> None:
		...
		Defines the levels of all frequency/level steps. \n
			:param all_levels: Comma-separated list of n values, one per frequency/level step, where n 2001. The query returns 2000 results. Range: Depends on the instrument model, the connector and other settings; please notice the ranges quoted in the data sheet , Unit: dBm Additional parameters: OFF | ON (disables | enables the frequency/level step)
		"""
