...
class WorkspaceFetcher(object):
    def __init__(self, sdk_key=None, update_interval=None, blocking_timeout=None, logger=None, ssl_verify=True):
        self.sdk_key = sdk_key
        self.workspace_url = (ssl_verify and enums.Default.WORKSPACE_URL) or enums.Default.HTTP_WORKSPACE_URL
    ...
    def fetch(self):
        ...
        try:
            response = requests.get(
                ...
                timeout=enums.Default.REQUEST_TIMEOUT
            )
