...
from mastapy.system_model.analyses_and_results.system_deflections import _2339, _2291
...
class PartToPartShearCouplingSystemDeflection(_2291.CouplingSystemDeflection):
    '''PartToPartShearCouplingSystemDeflection
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2339.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2339.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
    ...
    @property
    def power_flow_results(self) -> '_3340.PartToPartShearCouplingPowerFlow':
        ...
        return constructor.new(_3340.PartToPartShearCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
