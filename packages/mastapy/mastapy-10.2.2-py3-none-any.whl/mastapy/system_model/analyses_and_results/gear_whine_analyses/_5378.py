...
class HypoidGearGearWhineAnalysis(_5303.AGMAGleasonConicalGearGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2318.HypoidGearSystemDeflection':
        ...
        return constructor.new(_2318.HypoidGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
