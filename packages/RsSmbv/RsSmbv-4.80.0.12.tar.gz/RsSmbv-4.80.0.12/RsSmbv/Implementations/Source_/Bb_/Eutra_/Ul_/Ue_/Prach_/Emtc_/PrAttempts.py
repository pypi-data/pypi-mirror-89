...
class PrAttempts:
	...
	def set(self, preamble_attempt: int, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.prach.emtc.prAttempts.set(preamble_attempt = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:PRACh:EMTC:PRATtempts \n
		Snippet: value: int = driver.source.bb.eutra.ul.ue.prach.emtc.prAttempts.get(stream = repcap.Stream.Default) \n
		Sets the number of preamble attempts. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
