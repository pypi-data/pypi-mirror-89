...
class StraightBevelDiffGearMeshModalAnalysis(_4761.BevelGearMeshModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2363.StraightBevelDiffGearMeshSystemDeflection':
        ...
        return constructor.new(_2363.StraightBevelDiffGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
