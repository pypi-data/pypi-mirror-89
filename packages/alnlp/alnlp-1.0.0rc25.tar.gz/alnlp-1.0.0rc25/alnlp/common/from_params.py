...
from alnlp.common.lazy import Lazy
from alnlp.common.params import Params
...
def is_base_registrable(cls) -> bool:
    ...
    a class.
    """
    from alnlp.common.registrable import Registrable  # import here to avoid circular imports
