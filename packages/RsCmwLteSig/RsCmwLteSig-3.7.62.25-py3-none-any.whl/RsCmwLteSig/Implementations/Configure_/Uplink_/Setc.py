...
class Setc:
	"""Setc commands group definition. 17 total commands, 3 Sub-groups, 1 group commands"""
	...
	def get_power_max(self) -> float or bool:
		...
		Snippet: value: float or bool = driver.configure.uplink.setc.get_power_max() \n
	...
	def set_power_max(self, power: float or bool) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:UL:SETC:PMAX \n
		Snippet: driver.configure.uplink.setc.set_power_max(power = 1.0) \n
		Specifies the maximum allowed UE power. \n
