...
class ToWeek:
	...
	def get(self, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:STARt:SBAS<ST>:GAGAN:TOWeek \n
		Snippet: value: float = driver.source.bb.gnss.time.start.sbas.gagan.toWeek.get(stream = repcap.Stream.Default) \n
