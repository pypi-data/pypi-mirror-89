...
class SubjectRulesReviewStatus(K8sObject):
    ...
    nonResourceRules: Sequence[kdsl.authorization.v1.NonResourceRule] = attr.ib(metadata={'yaml_name': 'nonResourceRules'}, converter=kdsl.authorization.v1_converters.required_list_converter_NonResourceRule)
    resourceRules: Sequence[kdsl.authorization.v1.ResourceRule] = attr.ib(metadata={'yaml_name': 'resourceRules'}, converter=kdsl.authorization.v1_converters.required_list_converter_ResourceRule)
...
class SelfSubjectRulesReview(K8sResource):
    ...
    spec: kdsl.authorization.v1.SelfSubjectRulesReviewSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.authorization.v1_converters.required_converter_SelfSubjectRulesReviewSpec)
    ...
    status: Union[None, OmitEnum, kdsl.authorization.v1.SubjectRulesReviewStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.authorization.v1_converters.optional_converter_SubjectRulesReviewStatus, default=OMIT)
...
class SubjectAccessReview(K8sResource):
    ...
    spec: kdsl.authorization.v1.SubjectAccessReviewSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.authorization.v1_converters.required_converter_SubjectAccessReviewSpec)
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    status: Union[None, OmitEnum, kdsl.authorization.v1.SubjectAccessReviewStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.authorization.v1_converters.optional_converter_SubjectAccessReviewStatus, default=OMIT)
...
class SelfSubjectAccessReview(K8sResource):
    ...
    spec: kdsl.authorization.v1.SelfSubjectAccessReviewSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.authorization.v1_converters.required_converter_SelfSubjectAccessReviewSpec)
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    status: Union[None, OmitEnum, kdsl.authorization.v1.SubjectAccessReviewStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.authorization.v1_converters.optional_converter_SubjectAccessReviewStatus, default=OMIT)
...
class SubjectAccessReviewSpec(K8sObject):
    ...
    nonResourceAttributes: Union[None, OmitEnum, kdsl.authorization.v1.NonResourceAttributes] = attr.ib(metadata={'yaml_name': 'nonResourceAttributes'}, converter=kdsl.authorization.v1_converters.optional_converter_NonResourceAttributes, default=OMIT)
    resourceAttributes: Union[None, OmitEnum, kdsl.authorization.v1.ResourceAttributes] = attr.ib(metadata={'yaml_name': 'resourceAttributes'}, converter=kdsl.authorization.v1_converters.optional_converter_ResourceAttributes, default=OMIT)
