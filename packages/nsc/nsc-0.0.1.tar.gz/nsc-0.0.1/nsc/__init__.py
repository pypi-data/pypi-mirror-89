# -*- coding: utf-8 -*-
# ============================================================================
#     Deep Time-Series Very Early Alpha v0.0.1
#     Python v3.6+
#     Created by [TBD]
...
if __name__ == "__main__":
    ...
    print(f"Running NSC v{version_number}. Execute package by "
          "calling dnntime.run(config) with your provided config YAML file.")
else:
    version_number = __version__
    print(f"Importing NSC v{version_number}. Execute package by "
          "calling dnntime.run(config) with your provided config YAML file.")
