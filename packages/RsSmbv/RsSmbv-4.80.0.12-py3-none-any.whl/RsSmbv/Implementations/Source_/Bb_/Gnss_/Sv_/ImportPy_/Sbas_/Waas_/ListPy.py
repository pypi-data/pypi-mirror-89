...
class ListPy:
	...
	def get(self, stream=repcap.Stream.Default) -> List[str]:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:IMPort:SBAS:WAAS<ST>:LIST \n
		Snippet: value: List[str] = driver.source.bb.gnss.sv.importPy.sbas.waas.listPy.get(stream = repcap.Stream.Default) \n
