...
class Globale:
	...
	def get_seed(self) -> int:
		...
		"""
		response = self._core.io.query_str('CONFigure:GSM:SIGNaling<Instance>:FADing:FSIMulator:GLOBal:SEED?')
	...
	def set_seed(self, seed: int) -> None:
		...
		self._core.io.write(f'CONFigure:GSM:SIGNaling<Instance>:FADing:FSIMulator:GLOBal:SEED {param}')
