...
class Frequency:
	...
	def get_all(self) -> List[float]:
		...
		base unit manual. \n
			:return: frequency: Comma-separated list of up to 200 frequencies, with one value per frequency/level step A query returns 200 results (maximum number of steps) . Range: 70 MHz to 6 GHz, Unit: Hz
		"""
	...
	def set_all(self, frequency: List[float]) -> None:
		...
		the available options. The supported range can be smaller than stated here. Refer to the preface of your model-specific
		base unit manual. \n
			:param frequency: Comma-separated list of up to 200 frequencies, with one value per frequency/level step A query returns 200 results (maximum number of steps) . Range: 70 MHz to 6 GHz, Unit: Hz
		"""
