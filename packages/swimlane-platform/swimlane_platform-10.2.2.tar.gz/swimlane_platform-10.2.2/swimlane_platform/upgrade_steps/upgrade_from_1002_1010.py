...
class UpgradeFrom1002To1010(UpgradeStep):
    FROM = semver.parse_version_info('10.0.2')  # type: semver.VersionInfo
    TO = semver.parse_version_info('10.1.0')  # type: semver.VersionInfo

    @info_function_start_finish('Upgrade From 10.0.2 To 10.1.0.')
    def process(self):
        # type: () -> None
