...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.data.measurement.ipReplay.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:DATA:MEASurement<MeasInstance>:IPReplay:STATe:ALL?', self.__class__.FetchStruct())
