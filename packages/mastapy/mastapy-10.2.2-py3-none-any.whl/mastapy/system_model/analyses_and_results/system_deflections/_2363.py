...
class StraightBevelDiffGearMeshSystemDeflection(_2266.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3363.StraightBevelDiffGearMeshPowerFlow':
        ...
        return constructor.new(_3363.StraightBevelDiffGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
