...
class Downlink:
	...
	def get_value(self) -> ValueStruct:
		...
		Snippet: value: ValueStruct = driver.configure.connection.pcc.fpmi.downlink.get_value() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:FPMI:DL?', self.__class__.ValueStruct())

	def set_value(self, value: ValueStruct) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:CONNection[:PCC]:FPMI:DL \n
		Snippet: driver.configure.connection.pcc.fpmi.downlink.set_value(value = ValueStruct()) \n
		Configures the downlink for the scheduling type 'Follow WB PMI', with contiguous allocation. The allowed input ranges
		have dependencies and are described in the background information, see 'CQI Channels'. \n
			:param value: see the help for ValueStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:FPMI:DL', value)
