...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3485
...
class StraightBevelPlanetGearCompoundPowerFlow(_3485.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
