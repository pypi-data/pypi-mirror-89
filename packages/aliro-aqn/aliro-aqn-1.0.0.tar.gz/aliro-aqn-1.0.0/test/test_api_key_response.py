...
from aliro_quantum_networking.models.api_key_response import ApiKeyResponse  # noqa: E501
...
class TestApiKeyResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = aliro_quantum_networking.models.api_key_response.ApiKeyResponse()  # noqa: E501
        if include_optional :
            return ApiKeyResponse(
                data = aliro_quantum_networking.models.api_key.ApiKey(
                    api_key = '0', )
            )
        else :
            return ApiKeyResponse(
