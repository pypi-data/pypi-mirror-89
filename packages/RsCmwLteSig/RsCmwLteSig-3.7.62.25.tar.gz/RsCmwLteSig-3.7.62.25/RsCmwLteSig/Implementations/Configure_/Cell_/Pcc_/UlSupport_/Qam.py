...
class Qam:
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_qAMmodulationOrder_get', 'repcap_qAMmodulationOrder_set', repcap.QAMmodulationOrder.QAM64)

	def repcap_qAMmodulationOrder_set(self, enum_value: repcap.QAMmodulationOrder) -> None:
	...
	def enable(self):
		...
		if not hasattr(self, '_enable'):
			from .Qam_.Enable import Enable
