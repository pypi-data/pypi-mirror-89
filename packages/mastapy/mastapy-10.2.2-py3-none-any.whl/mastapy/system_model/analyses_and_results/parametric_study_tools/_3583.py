...
class KlingelnbergCycloPalloidSpiralBevelGearParametricStudyTool(_3577.KlingelnbergCycloPalloidConicalGearParametricStudyTool):
    '''KlingelnbergCycloPalloidSpiralBevelGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2329.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2329.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection))
        return value
