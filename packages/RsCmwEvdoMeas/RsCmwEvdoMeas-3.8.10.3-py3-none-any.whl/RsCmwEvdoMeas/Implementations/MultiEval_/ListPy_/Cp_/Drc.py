...
class Drc:
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Drc_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Drc_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Drc_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Drc_.Minimum import Minimum
	...
	def clone(self) -> 'Drc':
		...
		new_group = Drc(self._core, self._base.parent)
