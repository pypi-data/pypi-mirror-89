...
from mastapy.bearings.bearing_results.rolling import _1660, _1651
...
class LoadedDeepGrooveBallBearingRow(_1651.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1660.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1660.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
