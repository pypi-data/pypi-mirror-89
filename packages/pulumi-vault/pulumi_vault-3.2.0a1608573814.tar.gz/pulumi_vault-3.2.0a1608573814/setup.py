...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '3.2.0-alpha.1608573814+5b69910e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 3.2.0-alpha.1608573814+5b69910e`
                """)
            else:
                raise
