...
class Alpha:
	...
	def set(self, alpha: int, channel=repcap.Channel.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ATMospheric:BEIDou:[NMESsage]:[DNAV]:IONospheric:ALPHa<CH> \n
		Snippet: driver.source.bb.gnss.atmospheric.beidou.nmessage.dnav.ionospheric.alpha.set(alpha = 1, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ATMospheric:BEIDou:[NMESsage]:[DNAV]:IONospheric:ALPHa<CH> \n
		Snippet: value: int = driver.source.bb.gnss.atmospheric.beidou.nmessage.dnav.ionospheric.alpha.get(channel = repcap.Channel.Default) \n
		Sets the parameters alpha_0 to alpha_3 of the satellite's navigation message. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Alpha')
