...
class Frequency:
	...
	def set(self, connector: enums.CmwsConnector, path_index: enums.PathIndex, num_entries: int, frequency: List[float]) -> None:
		...
		Configures the frequency list for a selected path of a selected RF connector. Use this command if you have an external RF
		switch with several signal paths at the RF connector. For possible connector values, see 'Values for RF Path Selection'.
		...
		smaller than stated here. Refer to the preface of your model-specific base unit manual. \n
			...
			:param path_index: P1 | P2 | P3 | P4 | P5 | P6 | P7 | P8
