...
def jenkins_validate(clustername, web_type, localpath_to_artifact_dir, jenkins_server, timeout='2', pull_method="STATIC", total_request="1000",
    ...
    #summoryfile = localpath_to_artifact_dir + "test_results_" + "AMS" + "_" + "DWEB" + "_summary.json"
    print(summoryfile)
    results_judge(summoryfile)
...
if __name__ == '__main__':
    jenkins_validate(clustername='AMS', web_type='DWEB', localpath_to_artifact_dir='/Users/xuenwang/validator_test/20201203/', total_request="50", jenkins_server="http://10.148.183.183:8080")
