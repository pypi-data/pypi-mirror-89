...
class BoltModalAnalysis(_4770.ComponentModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2270.BoltSystemDeflection':
        ...
        return constructor.new(_2270.BoltSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
