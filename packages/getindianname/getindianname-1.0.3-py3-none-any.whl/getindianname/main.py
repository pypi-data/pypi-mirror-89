...
"Vedang", "Varun", "Vinay", "Vivek", "Yogesh","Saritha","Vijay","Shila","Arjun","Gauri","Rohit","Senthil","Bavya","Abhijeet","Udaya","Ankit","Krishna","Hayat","Murat","Ravindra","Nagaraju","Ranjit","Rupesh","Sarthak","Gagan", "Hari", "Bala", "Maan", "Naveen", "Sukhan", "Guru", "Karam", "Karan", "Diljeet", "Dharam", "Param", "Devesh", "Jaspreet","Ankit","Devansh","Pranjal","Gagan", "Har", "Bal", "Man", "Nav", "Sukh", "Kush", "Gur", "Karam", "Karan", "Dil", "Dharam", "Param", "Dal", "Jas", "Par", "Dul","Raju","Rohan","Rohit","Mohit","Himanshu","Shivam","Shubham","Rounak","Rahul","Raghav","Raghvendra","Ram","Shyam","Kishan","Krishan","Ritik","Anupam","Abhishek","Ashok","Abhimanyu","Gopal","Harsh","Virat","Samraat","Ashish","Ayush","Anurag","Suryansh"]

fsufix = ["Gayatri","Roshni","Priyanka","Priyanshee","Priyanshi","Priya","Pragya","Paridhi","Pallawi","Shivani","Siwangi","Sweta","Silam","Nilam","Annu","Anushka","Riya","Radha","Shyama","Nikita","Janhavi","Rakhi","Kamini","Anshika","Nitya","Ridhima","Namita","Namrata","Yashi","Kirti","Ambika","Anamika","Manisha","Damini","Ananya","Shradha","Aishwarya","Anjali","Jooli","Deepa","Savita","Sita","Sherya","Pinky","Monika","Khushi","Jyoti","Anupriya","Kajal","Tripti","Priti","Pradhi","Komal","Vandana","Khushi","Gouri","Nivedita","Parul","Sanjana","Shruti","Simran","Puspha","Nitya","Ruhi","Aaroohi","Pragati","Rahul","Ronak","Shila","Gita","Seeta","Radha","Mony","Reena", "Joohi","Neha","Divya","Ruhi","Shalani","Shivani","Siwangi"]

mprefix=["Singh","Yadav","Rajput","Pandey","Mishra","Seth","Srivastav","Vishwakarma","Maurrya","Pratap","Thakur","Tiwari","Divedi","Sonkar","Rai","Rao","Gupta","Kumar","Pandit","Phatak","Triphati"]

fprefix=["Devi","Singh","Yadav","Rajput","Pandey","Mishra","Seth","Srivastav","Vishwakarma","Maurya","Thakur","Tiwari","Divedi","Sonkar","Rai","Rao","Gupta","Kumari","Phatak","Triphati"]
