...
class DaemonSet(res.NamespacedResourceG, m_extensions_v1beta1.DaemonSetList):
    """* **Extends**: ``models.extensions_v1beta1.DaemonSetList``
       * **Type**: Namespaced Resource
...
class Deployment(res.NamespacedResourceG, m_extensions_v1beta1.DeploymentList):
    """* **Extends**: ``models.extensions_v1beta1.DeploymentList``
       * **Type**: Namespaced Resource
       * **Accepted client methods**: `delete`, `deletecollection`, `get`, `list` all, `watch` all, `list`, `patch`, `create`, `replace`, `watch`
...
class Ingress(res.NamespacedResourceG, m_extensions_v1beta1.IngressList):
    """* **Extends**: ``models.extensions_v1beta1.IngressList``
       * **Type**: Namespaced Resource
       * **Accepted client methods**: `delete`, `deletecollection`, `get`, `list` all, `watch` all, `list`, `patch`, `create`, `replace`, `watch`
