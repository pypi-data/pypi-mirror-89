...
class Flexible:
	...
	class ExternalStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			...
			- Scc_3_Iq_1_Conn: enums.TxConnector: No parameter help available
			...
			- Scc_3_Iq_2_Conn: enums.TxConnector: No parameter help available"""
		__meta_args_list = [
			...
			ArgStruct.scalar_enum('Scc_3_Iq_1_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_3_Tx_2_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_3_Tx_2_Conv', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_3_Iq_2_Conn', enums.TxConnector)]
		...
		def __init__(self):
			...
			self.Scc_3_Iq_1_Conn: enums.TxConnector = None
			self.Scc_3_Tx_2_Conn: enums.TxConnector = None
			self.Scc_3_Tx_2_Conv: enums.TxConverter = None
			self.Scc_3_Iq_2_Conn: enums.TxConnector = None
