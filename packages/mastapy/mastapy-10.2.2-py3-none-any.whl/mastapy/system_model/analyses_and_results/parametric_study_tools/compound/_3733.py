...
class RootAssemblyCompoundParametricStudyTool(_3652.AssemblyCompoundParametricStudyTool):
    '''RootAssemblyCompoundParametricStudyTool
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> '_2447.DutyCycleEfficiencyResults':
        ...
        return constructor.new(_2447.DutyCycleEfficiencyResults)(self.wrapped.RootAssemblyDutyCycleResults) if self.wrapped.RootAssemblyDutyCycleResults else None
