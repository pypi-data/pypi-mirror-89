...
class RuAllocation:
	...
	def set(self, ch_20_index: enums.Ch20Index, ru_index: enums.RuIndex, alloc_state: enums.RuAlloc) -> None:
		"""SCPI: CONFigure:WLAN:SIGNaling<instance>:CONNection:DFRame:HEMU:RUALlocation \n
		Snippet: driver.configure.connection.dframe.hemu.ruAllocation.set(ch_20_index = enums.Ch20Index.CHA1, ru_index = enums.RuIndex.RU1, alloc_state = enums.RuAlloc.DMY1) \n
		...
		self._core.io.write(f'CONFigure:WLAN:SIGNaling<Instance>:CONNection:DFRame:HEMU:RUALlocation {param}'.rstrip())
	...
	def get(self, ch_20_index: enums.Ch20Index, ru_index: enums.RuIndex) -> GetStruct:
		"""SCPI: CONFigure:WLAN:SIGNaling<instance>:CONNection:DFRame:HEMU:RUALlocation \n
		Snippet: value: GetStruct = driver.configure.connection.dframe.hemu.ruAllocation.get(ch_20_index = enums.Ch20Index.CHA1, ru_index = enums.RuIndex.RU1) \n
		Configures allocations for specified channel and resource unit (RU) . Maps a user to the RU, sets the size of allocation. \n
			:param ch_20_index: CHA1 | CHA2 | CHA3 | CHA4
			:param ru_index: RU1 | RU2 | RU3 | RU4 | RU5 | RU6 | RU7 | RU8 | RU9 Resource unit selection
		...
		return self._core.io.query_struct(f'CONFigure:WLAN:SIGNaling<Instance>:CONNection:DFRame:HEMU:RUALlocation? {param}'.rstrip(), self.__class__.GetStruct())
