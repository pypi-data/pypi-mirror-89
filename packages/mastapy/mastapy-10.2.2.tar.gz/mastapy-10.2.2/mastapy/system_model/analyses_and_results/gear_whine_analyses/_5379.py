...
class HypoidGearMeshGearWhineAnalysis(_5304.AGMAGleasonConicalGearMeshGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2316.HypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2316.HypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
