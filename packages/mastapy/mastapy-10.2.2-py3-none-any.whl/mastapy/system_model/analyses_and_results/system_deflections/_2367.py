...
from mastapy.system_model.analyses_and_results.system_deflections import _2368, _2366, _2267
...
class StraightBevelGearSetSystemDeflection(_2267.BevelGearSetSystemDeflection):
    '''StraightBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3368.StraightBevelGearSetPowerFlow':
        ...
        return constructor.new(_3368.StraightBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def straight_bevel_gears_system_deflection(self) -> 'List[_2368.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSystemDeflection, constructor.new(_2368.StraightBevelGearSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_system_deflection(self) -> 'List[_2366.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSystemDeflection, constructor.new(_2366.StraightBevelGearMeshSystemDeflection))
        return value
