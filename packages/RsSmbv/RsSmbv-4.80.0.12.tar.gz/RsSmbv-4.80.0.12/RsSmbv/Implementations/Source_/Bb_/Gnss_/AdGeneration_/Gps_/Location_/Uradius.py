...
class Uradius:
	...
	def set(self, radius: int, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:GPS<ST>:LOCation:URADius \n
		Snippet: driver.source.bb.gnss.adGeneration.gps.location.uradius.set(radius = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:GPS<ST>:LOCation:URADius \n
		Snippet: value: int = driver.source.bb.gnss.adGeneration.gps.location.uradius.get(stream = repcap.Stream.Default) \n
		Sets the Uncertainty Radius, i.e. sets the maximum radius of the area within which the two-dimensional location of the UE
		is bounded. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Gps')
