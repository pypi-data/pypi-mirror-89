...
from mastapy.system_model.analyses_and_results.system_deflections import _2371, _2356
...
class SynchroniserSystemDeflection(_2356.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3373.SynchroniserPowerFlow':
        ...
        return constructor.new(_3373.SynchroniserPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def cones(self) -> 'List[_2371.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2371.SynchroniserHalfSystemDeflection))
        return value
