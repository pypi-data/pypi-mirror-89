...
class Inhibit:
	...
	def set(self, inhibit: int, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.vor.trigger.external.inhibit.set(inhibit = 1, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:VOR:TRIGger:[EXTernal<CH>]:INHibit \n
		Snippet: value: int = driver.source.vor.trigger.external.inhibit.get(channel = repcap.Channel.Default) \n
		No command help available \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'External')
