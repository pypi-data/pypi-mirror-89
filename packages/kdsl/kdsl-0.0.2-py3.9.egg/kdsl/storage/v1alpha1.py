...
class VolumeAttachment(K8sResource):
    ...
    spec: kdsl.storage.v1alpha1.VolumeAttachmentSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.storage.v1alpha1_converters.required_converter_VolumeAttachmentSpec)
    ...
    status: Union[None, OmitEnum, kdsl.storage.v1alpha1.VolumeAttachmentStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.storage.v1alpha1_converters.optional_converter_VolumeAttachmentStatus, default=OMIT)
...
class VolumeAttachmentSpec(K8sObject):
    ...
    source: kdsl.storage.v1alpha1.VolumeAttachmentSource = attr.ib(metadata={'yaml_name': 'source'}, converter=kdsl.storage.v1alpha1_converters.required_converter_VolumeAttachmentSource)
...
class VolumeAttachmentStatus(K8sObject):
    ...
    attachError: Union[None, OmitEnum, kdsl.storage.v1alpha1.VolumeError] = attr.ib(metadata={'yaml_name': 'attachError'}, converter=kdsl.storage.v1alpha1_converters.optional_converter_VolumeError, default=OMIT)
    attachmentMetadata: Union[None, OmitEnum, Mapping[str, str]] = attr.ib(metadata={'yaml_name': 'attachmentMetadata'}, default=OMIT)
    detachError: Union[None, OmitEnum, kdsl.storage.v1alpha1.VolumeError] = attr.ib(metadata={'yaml_name': 'detachError'}, converter=kdsl.storage.v1alpha1_converters.optional_converter_VolumeError, default=OMIT)
