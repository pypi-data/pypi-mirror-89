...
class Step:
	...
	def set(self, resolution: enums.LogRes, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:LOGGing:CATegory:SATellite:STEP<ST> \n
		Snippet: driver.source.bb.gnss.logging.category.satellite.step.set(resolution = enums.LogRes.R02S, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> enums.LogRes:
		"""SCPI: [SOURce<HW>]:BB:GNSS:LOGGing:CATegory:SATellite:STEP<ST> \n
		Snippet: value: enums.LogRes = driver.source.bb.gnss.logging.category.satellite.step.get(stream = repcap.Stream.Default) \n
		Sets the logging step. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Step')
