...
from kdsl.bases import K8sResource, OMIT, K8sObject, OmitEnum
from typing import Mapping, Union, ClassVar, Optional, TypedDict, Any, Sequence


@attr.s(kw_only=True)
class ValidatingWebhookItem(K8sObject):
    clientConfig: kdsl.admissionregistration.v1beta1.WebhookClientConfig = attr.ib(metadata={'yaml_name': 'clientConfig'}, converter=kdsl.admissionregistration.v1beta1_converters.required_converter_WebhookClientConfig)
    admissionReviewVersions: Union[None, OmitEnum, Sequence[str]] = attr.ib(metadata={'yaml_name': 'admissionReviewVersions'}, default=OMIT)
    ...
    objectSelector: Union[None, OmitEnum, kdsl.core.v1.LabelSelector] = attr.ib(metadata={'yaml_name': 'objectSelector'}, converter=kdsl.core.v1_converters.optional_converter_LabelSelector, default=OMIT)
    rules: Union[None, OmitEnum, Sequence[kdsl.admissionregistration.v1beta1.RuleWithOperations]] = attr.ib(metadata={'yaml_name': 'rules'}, converter=kdsl.admissionregistration.v1beta1_converters.optional_list_converter_RuleWithOperations, default=OMIT)
    sideEffects: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'sideEffects'}, default=OMIT)
...
class WebhookClientConfig(K8sObject):
    ...
    service: Union[None, OmitEnum, kdsl.admissionregistration.v1beta1.ServiceReference] = attr.ib(metadata={'yaml_name': 'service'}, converter=kdsl.admissionregistration.v1beta1_converters.optional_converter_ServiceReference, default=OMIT)
...
class MutatingWebhookConfiguration(K8sResource):
    ...
    webhooks: Union[None, OmitEnum, Mapping[str, kdsl.admissionregistration.v1beta1.MutatingWebhookItem]] = attr.ib(metadata={'yaml_name': 'webhooks', 'mlist_key': 'name'}, converter=kdsl.admissionregistration.v1beta1_converters.optional_mlist_converter_MutatingWebhookItem, default=OMIT)
...
class ValidatingWebhookConfiguration(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    webhooks: Union[None, OmitEnum, Mapping[str, kdsl.admissionregistration.v1beta1.ValidatingWebhookItem]] = attr.ib(metadata={'yaml_name': 'webhooks', 'mlist_key': 'name'}, converter=kdsl.admissionregistration.v1beta1_converters.optional_mlist_converter_ValidatingWebhookItem, default=OMIT)
