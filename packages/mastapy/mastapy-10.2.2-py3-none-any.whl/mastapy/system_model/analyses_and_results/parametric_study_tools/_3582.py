...
class KlingelnbergCycloPalloidSpiralBevelGearMeshParametricStudyTool(_3576.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2327.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2327.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection))
        return value
