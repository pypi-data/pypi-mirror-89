...
class PolicyRulesWithSubjects(K8sObject):
    subjects: Sequence[kdsl.flowcontrol.v1alpha1.Subject] = attr.ib(metadata={'yaml_name': 'subjects'}, converter=kdsl.flowcontrol.v1alpha1_converters.required_list_converter_Subject)
    nonResourceRules: Union[None, OmitEnum, Sequence[kdsl.flowcontrol.v1alpha1.NonResourcePolicyRule]] = attr.ib(metadata={'yaml_name': 'nonResourceRules'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_list_converter_NonResourcePolicyRule, default=OMIT)
    resourceRules: Union[None, OmitEnum, Sequence[kdsl.flowcontrol.v1alpha1.ResourcePolicyRule]] = attr.ib(metadata={'yaml_name': 'resourceRules'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_list_converter_ResourcePolicyRule, default=OMIT)
...
class FlowSchema(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.FlowSchemaSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_FlowSchemaSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.FlowSchemaStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_FlowSchemaStatus, default=OMIT)
...
class PriorityLevelConfiguration(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.PriorityLevelConfigurationSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_PriorityLevelConfigurationSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.PriorityLevelConfigurationStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_PriorityLevelConfigurationStatus, default=OMIT)
...
class LimitedPriorityLevelConfiguration(K8sObject):
    ...
    limitResponse: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.LimitResponse] = attr.ib(metadata={'yaml_name': 'limitResponse'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_LimitResponse, default=OMIT)
...
class FlowSchemaStatus(K8sObject):
    conditions: Union[None, OmitEnum, Sequence[kdsl.flowcontrol.v1alpha1.FlowSchemaCondition]] = attr.ib(metadata={'yaml_name': 'conditions'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_list_converter_FlowSchemaCondition, default=OMIT)
...
class PriorityLevelConfigurationSpec(K8sObject):
    ...
    limited: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.LimitedPriorityLevelConfiguration] = attr.ib(metadata={'yaml_name': 'limited'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_LimitedPriorityLevelConfiguration, default=OMIT)
...
class PriorityLevelConfigurationStatus(K8sObject):
    conditions: Union[None, OmitEnum, Sequence[kdsl.flowcontrol.v1alpha1.PriorityLevelConfigurationCondition]] = attr.ib(metadata={'yaml_name': 'conditions'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_list_converter_PriorityLevelConfigurationCondition, default=OMIT)
...
class LimitResponse(K8sObject):
    type: str = attr.ib(metadata={'yaml_name': 'type'})
    queuing: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.QueuingConfiguration] = attr.ib(metadata={'yaml_name': 'queuing'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_QueuingConfiguration, default=OMIT)
...
class FlowSchemaSpec(K8sObject):
    priorityLevelConfiguration: kdsl.flowcontrol.v1alpha1.PriorityLevelConfigurationReference = attr.ib(metadata={'yaml_name': 'priorityLevelConfiguration'}, converter=kdsl.flowcontrol.v1alpha1_converters.required_converter_PriorityLevelConfigurationReference)
    distinguisherMethod: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.FlowDistinguisherMethod] = attr.ib(metadata={'yaml_name': 'distinguisherMethod'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_FlowDistinguisherMethod, default=OMIT)
    matchingPrecedence: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'matchingPrecedence'}, default=OMIT)
    rules: Union[None, OmitEnum, Sequence[kdsl.flowcontrol.v1alpha1.PolicyRulesWithSubjects]] = attr.ib(metadata={'yaml_name': 'rules'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_list_converter_PolicyRulesWithSubjects, default=OMIT)
...
class Subject(K8sObject):
    ...
    group: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.GroupSubject] = attr.ib(metadata={'yaml_name': 'group'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_GroupSubject, default=OMIT)
    serviceAccount: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.ServiceAccountSubject] = attr.ib(metadata={'yaml_name': 'serviceAccount'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_ServiceAccountSubject, default=OMIT)
    user: Union[None, OmitEnum, kdsl.flowcontrol.v1alpha1.UserSubject] = attr.ib(metadata={'yaml_name': 'user'}, converter=kdsl.flowcontrol.v1alpha1_converters.optional_converter_UserSubject, default=OMIT)
