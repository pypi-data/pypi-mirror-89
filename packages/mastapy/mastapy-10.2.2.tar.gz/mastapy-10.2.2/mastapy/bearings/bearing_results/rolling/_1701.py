...
from mastapy.bearings.bearing_results.rolling import _1700, _1651
...
class LoadedThreePointContactBallBearingRow(_1651.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1700.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1700.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
