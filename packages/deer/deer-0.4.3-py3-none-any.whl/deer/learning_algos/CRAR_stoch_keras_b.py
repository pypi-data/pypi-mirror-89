...
class CRAR(LearningAlgo):
    ...
    def __init__(self, environment, rho=0.9, rms_epsilon=0.0001, momentum=0, clip_norm=0, freeze_interval=1000, batch_size=32, update_rule="rmsprop", random_state=np.random.RandomState(), double_Q=False, neural_network=NN, **kwargs):
        ...
        self.encoder_g_full_lrdiv = kwargs.get('transition_g_full_lrdiv',100)
        ...
        self.full_Q_lrdiv = kwargs.get('full_Q_lrdiv',100)
        self.transition_d_lrdiv = kwargs.get('transition_d_lrdiv',2)
    ...
    def train(self, states_val, actions_val, rewards_val, next_states_val, terminals_val):
        ...
        noise_Es = np.random.normal(0,noise_level,Es.shape)
        noise_Es2 = np.random.normal(0,noise_level,Es.shape) #noise_Es #good
...
##            print (self.transition.layers[7].get_weights())
##            print (self.transition_d.layers[7].get_weights())
#            loss_D2=self.encoder_d_full.train_on_batch(states_val+[onehot_actions]+next_states_val+[rewards_val_noise,terminals_val_noise,np.random.normal(0,noise_level,Es_[:self._batch_size].shape)], np.ones((self._batch_size,1)) )
##            print ("after D2")
##            print (self.encoder.layers[2].get_weights())
##            print (self.transition.layers[7].get_weights())
##            print (self.transition_d.layers[7].get_weights())
...
#            optimizer7=Adam(lr=self._lr)#RMSprop(lr=self._lr, rho=self._rho, epsilon=self._rms_epsilon, clipvalue=self._clip_norm)
        ...
        self.full_Q2.compile(optimizer=optimizer, loss='mse')
    ...
    def setLearningRate(self, lr):
        ...
        K.set_value(self.transition_d.optimizer.lr, self._lr/self.transition_d_lrdiv)
