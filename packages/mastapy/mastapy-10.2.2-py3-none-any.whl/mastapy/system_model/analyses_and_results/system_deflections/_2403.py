...
from mastapy.system_model.analyses_and_results.system_deflections import _2404, _2402, _2400
...
class KlingelnbergCycloPalloidHypoidGearSetSystemDeflection(_2400.KlingelnbergCycloPalloidConicalGearSetSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3733.KlingelnbergCycloPalloidHypoidGearSetPowerFlow':
        ...
        return constructor.new(_3733.KlingelnbergCycloPalloidHypoidGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_system_deflection(self) -> 'List[_2404.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsSystemDeflection, constructor.new(_2404.KlingelnbergCycloPalloidHypoidGearSystemDeflection))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_system_deflection(self) -> 'List[_2402.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesSystemDeflection, constructor.new(_2402.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection))
        return value
