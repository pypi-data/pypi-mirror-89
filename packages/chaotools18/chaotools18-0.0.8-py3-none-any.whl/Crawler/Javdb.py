...
import sqlite3
import os
from Util.Mysqlite import create_database
...
class Javdb_Sqlite:
    ...
    def createdb(self):
        create_database(self.savepath,self.SQLITE_TABLE_BRIEF)
        create_database(self.savepath,self.SQLITE_TABLE_DETAIL)
    ...
    def save(self, detailinfo):
        ...
        cursor = conn.cursor()
        sqltext = f"INSERT INTO detail (id,date,runtime,javdblink,director,directorlink,studio,studiolink,tag,taglink,genres,genreslink,actors,actorslink,rating,ratingnum,smallimage,bigimage,previewimages,magnets) " \
