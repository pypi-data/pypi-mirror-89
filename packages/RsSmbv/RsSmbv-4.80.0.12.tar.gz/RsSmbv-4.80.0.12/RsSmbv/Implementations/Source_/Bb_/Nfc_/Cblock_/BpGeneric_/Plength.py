...
class Plength:
	...
	def set(self, payload_length: int, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.nfc.cblock.bpGeneric.plength.set(payload_length = 1, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:BPGeneric:PLENgth \n
		Snippet: value: int = driver.source.bb.nfc.cblock.bpGeneric.plength.get(channel = repcap.Channel.Default) \n
		Sets the length of a standard frame. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cblock')
