...
class State:
	...
	def fetch(self) -> str:
		...
		Snippet: value: str = driver.rxQuality.flPerformance.state.fetch() \n
		...
		response = self._core.io.query_str_suppressed(f'FETCh:EVDO:SIGNaling<Instance>:RXQuality:FLPFormance:STATe?', suppressed)
