...
class ListPy:
	"""ListPy commands group definition. 13 total commands, 2 Sub-groups, 3 group commands"""
	...
	@property
	def segment(self):
		"""segment commands group. 9 Sub-classes, 0 commands."""
	...
	def get_lrange(self) -> LrangeStruct:
		...
		Snippet: value: LrangeStruct = driver.configure.nrSubMeas.multiEval.listPy.get_lrange() \n
		Select a range of measured segments. \n
			:return: structure: for return value, see the help for LrangeStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIST:LRANge?', self.__class__.LrangeStruct())

	def set_lrange(self, value: LrangeStruct) -> None:
		"""SCPI: CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIST:LRANge \n
		Snippet: driver.configure.nrSubMeas.multiEval.listPy.set_lrange(value = LrangeStruct()) \n
		Select a range of measured segments. \n
			:param value: see the help for LrangeStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIST:LRANge', value)
