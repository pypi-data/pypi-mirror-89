...
from mastapy.bearings.bearing_results.rolling import _1720, _1677
...
class LoadedNonBarrelRollerBearingResults(_1677.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1720.SMTRibStressResults':
        ...
        return constructor.new(_1720.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
