...
class DATA_REQUEST_FLAG():
    ...
    def name(self) -> str:
        ...
        :type: str
        """
    CHANGED: simcon._native.DATA_REQUEST_FLAG # value = <DATA_REQUEST_FLAG.CHANGED: 1>
    DEFAULT: simcon._native.DATA_REQUEST_FLAG # value = <DATA_REQUEST_FLAG.DEFAULT: 0>
    TAGGED: simcon._native.DATA_REQUEST_FLAG # value = <DATA_REQUEST_FLAG.TAGGED: 2>
    __members__: dict # value = {'DEFAULT': <DATA_REQUEST_FLAG.DEFAULT: 0>, 'CHANGED': <DATA_REQUEST_FLAG.CHANGED: 1>, 'TAGGED': <DATA_REQUEST_FLAG.TAGGED: 2>}
    pass
class EXCEPTION():
    """
...
class Sim():
    ...
    def request_data_on_sim_object(self, arg0: int, arg1: int, arg2: int, arg3: PERIOD, arg4: int, arg5: int, arg6: int, arg7: int) -> None: ...
