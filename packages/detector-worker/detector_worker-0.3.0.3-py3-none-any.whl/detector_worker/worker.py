...
class Worker:
    def __init__(self, queue_name, metadata_table_name, worker_name, segment_limit=200):
        ...
        self.queue = QueueClient.from_connection_string(conn_str=self.connection_string, queue_name=queue_name)
