...
class Pep:
	...
	def get(self, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:IQ:DOHerty<ST>:OUTPut:PEP \n
		Snippet: value: float = driver.source.iq.doherty.output.pep.get(stream = repcap.Stream.Default) \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:IQ:DOHerty{stream_cmd_val}:OUTPut:PEP?')
