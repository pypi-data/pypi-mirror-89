...
class Dlink:
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.data.measurement.throughput.overall.dlink.fetch() \n
		Query the statistical results of the throughput measurement in downlink direction. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:DATA:MEASurement<MeasInstance>:THRoughput:OVERall:DLINk?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:DATA:MEASurement<Instance>:THRoughput:OVERall:DLINk \n
		Snippet: value: ResultData = driver.data.measurement.throughput.overall.dlink.read() \n
		Query the statistical results of the throughput measurement in downlink direction. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:DATA:MEASurement<MeasInstance>:THRoughput:OVERall:DLINk?', self.__class__.ResultData())
