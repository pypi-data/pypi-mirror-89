...
def cleanup_dag_factory(
    ...
    DAG_OWNER_NAME = dag_owner       # Who is listed as the owner of this DAG in the Airflow Web Server
    ALERT_EMAIL_ADDRESSES = alert_emails          # List of email address to send email alerts to if this job fails
