...
class TtInterval:
	...
	def get(self, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> enums.TdscdmaEnhTchTti:
		...
		Snippet: value: enums.TdscdmaEnhTchTti = driver.source.bb.tdscdma.down.cell.enh.bch.dtch.ttInterval.get(stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
