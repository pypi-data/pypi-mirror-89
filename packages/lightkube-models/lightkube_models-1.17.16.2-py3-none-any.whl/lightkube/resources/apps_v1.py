...
class ControllerRevision(res.NamespacedResourceG, m_apps_v1.ControllerRevisionList):
    """* **Extends**: ``models.apps_v1.ControllerRevisionList``
...
class DaemonSet(res.NamespacedResourceG, m_apps_v1.DaemonSetList):
    """* **Extends**: ``models.apps_v1.DaemonSetList``
       * **Type**: Namespaced Resource
       * **Accepted client methods**: `delete`, `deletecollection`, `get`, `list` all, `watch` all, `list`, `patch`, `create`, `replace`, `watch`
...
class Deployment(res.NamespacedResourceG, m_apps_v1.DeploymentList):
    """* **Extends**: ``models.apps_v1.DeploymentList``
       * **Type**: Namespaced Resource
       * **Accepted client methods**: `delete`, `deletecollection`, `get`, `list` all, `watch` all, `list`, `patch`, `create`, `replace`, `watch`
