...
def main():
    ...
    Examples:
    For volume:
        python terminal_prints.py launch chk_std print_ascii_levels_01_70
    For online spectral projector outliers:
        python terminal_prints.py launch compute_outlier print_ascii_levels_2_70
