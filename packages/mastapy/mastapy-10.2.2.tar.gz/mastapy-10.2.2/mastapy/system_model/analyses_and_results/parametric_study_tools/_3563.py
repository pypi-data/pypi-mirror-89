...
class FaceGearMeshParametricStudyTool(_3567.GearMeshParametricStudyTool):
    '''FaceGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2308.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2308.FaceGearMeshSystemDeflection))
        return value
