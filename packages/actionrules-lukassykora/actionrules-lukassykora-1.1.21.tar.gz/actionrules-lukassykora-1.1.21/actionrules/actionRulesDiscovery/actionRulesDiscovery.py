...
class ActionRulesDiscovery:
    ...
    def fit(self,
        ...
        self.stable_attributes = stable_attributes.intersection(self.decisions.decision_table.columns)
        self.flexible_attributes = flexible_attributes.intersection(self.decisions.decision_table.columns)
        # Data
