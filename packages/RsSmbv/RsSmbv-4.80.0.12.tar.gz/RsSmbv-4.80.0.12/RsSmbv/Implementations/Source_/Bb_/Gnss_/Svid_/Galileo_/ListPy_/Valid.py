...
class Valid:
	...
	def get(self, stream=repcap.Stream.Default) -> List[int]:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID:GALileo<ST>:LIST:[VALid] \n
		Snippet: value: List[int] = driver.source.bb.gnss.svid.galileo.listPy.valid.get(stream = repcap.Stream.Default) \n
