...
class DftPrecoding:
	...
	def set(self, bwp: enums.BandwidthPart, dft_precodingcoding: bool, carrierComponent=repcap.CarrierComponent.Default) -> None:
		"""SCPI: CONFigure:NRSub:MEASurement<Instance>[:CC<no>]:BWPart:PUSCh:DFTPrecoding \n
		Snippet: driver.configure.nrSubMeas.cc.bwPart.pusch.dftPrecoding.set(bwp = enums.BandwidthPart.BWP0, dft_precodingcoding = False, carrierComponent = repcap.CarrierComponent.Default) \n
