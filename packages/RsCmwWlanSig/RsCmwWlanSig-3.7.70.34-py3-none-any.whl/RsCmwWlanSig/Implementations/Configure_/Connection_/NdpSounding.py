...
class NdpSounding:
	"""NdpSounding commands group definition. 10 total commands, 1 Sub-groups, 9 group commands"""
	...
	def get_method(self) -> enums.NdpSoundingMethod:
		...
		Sets the feedback method for NDP sounding procedure. \n
			:return: method: NONTrigger 'NONTrigger': non-trigger-based
		"""
	...
	def set_method(self, method: enums.NdpSoundingMethod) -> None:
		...
		Sets the feedback method for NDP sounding procedure. \n
			:param method: NONTrigger 'NONTrigger': non-trigger-based
		"""
