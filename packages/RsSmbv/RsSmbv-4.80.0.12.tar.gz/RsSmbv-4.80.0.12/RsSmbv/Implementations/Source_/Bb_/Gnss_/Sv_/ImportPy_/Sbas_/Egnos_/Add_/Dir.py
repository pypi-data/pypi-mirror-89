...
class Dir:
	...
	def set(self, directory: str, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:IMPort:SBAS:EGNOS<ST>:ADD:DIR \n
		Snippet: driver.source.bb.gnss.sv.importPy.sbas.egnos.add.dir.set(directory = '1', stream = repcap.Stream.Default) \n
