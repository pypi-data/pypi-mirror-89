...
class State:
	...
	def fetch(self) -> enums.ResourceState:
		...
		Snippet: value: enums.ResourceState = driver.data.measurement.ipReplay.state.fetch() \n
		...
		response = self._core.io.query_str(f'FETCh:DATA:MEASurement<MeasInstance>:IPReplay:STATe?')
