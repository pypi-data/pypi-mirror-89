...
class Qsignal:
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Qsignal_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Qsignal_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Qsignal_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Qsignal_.Minimum import Minimum
	...
	def state(self):
		...
		if not hasattr(self, '_state'):
			from .Qsignal_.State import State
	...
	def limit(self):
		...
		if not hasattr(self, '_limit'):
			from .Qsignal_.Limit import Limit
