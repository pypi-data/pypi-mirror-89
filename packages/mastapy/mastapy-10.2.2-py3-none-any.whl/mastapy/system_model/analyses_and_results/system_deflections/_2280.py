...
class ConceptGearMeshSystemDeflection(_2312.GearMeshSystemDeflection):
    '''ConceptGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3290.ConceptGearMeshPowerFlow':
        ...
        return constructor.new(_3290.ConceptGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
