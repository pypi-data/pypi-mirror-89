...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5982, _5983, _5894
...
class StraightBevelDiffGearSetDynamicAnalysis(_5894.BevelGearSetDynamicAnalysis):
    '''StraightBevelDiffGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_diff_gears_dynamic_analysis(self) -> 'List[_5982.StraightBevelDiffGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsDynamicAnalysis, constructor.new(_5982.StraightBevelDiffGearDynamicAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_dynamic_analysis(self) -> 'List[_5983.StraightBevelDiffGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesDynamicAnalysis, constructor.new(_5983.StraightBevelDiffGearMeshDynamicAnalysis))
        return value
