...
class SynchroniserHalfParametricStudyTool(_3633.SynchroniserPartParametricStudyTool):
    '''SynchroniserHalfParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2371.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2371.SynchroniserHalfSystemDeflection))
        return value
