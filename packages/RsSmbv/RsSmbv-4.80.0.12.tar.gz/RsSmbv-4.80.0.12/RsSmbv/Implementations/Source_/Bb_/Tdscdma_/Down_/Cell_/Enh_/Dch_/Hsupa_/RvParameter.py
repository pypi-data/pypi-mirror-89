...
class RvParameter:
	...
	def set(self, rv_parameter: int, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.down.cell.enh.dch.hsupa.rvParameter.set(rv_parameter = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:TDSCdma:DOWN:CELL<ST>:ENH:DCH:HSUPA:RVParameter \n
		Snippet: value: int = driver.source.bb.tdscdma.down.cell.enh.dch.hsupa.rvParameter.get(stream = repcap.Stream.Default) \n
		(for HARQ Mode set to constant ACK) Sets the redundancy version parameter, i.e. indicates which redundancy version of the
		data is sent. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cell')
