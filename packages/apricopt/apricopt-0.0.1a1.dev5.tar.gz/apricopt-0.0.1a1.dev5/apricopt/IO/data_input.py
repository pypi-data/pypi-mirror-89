...
from apricopt.solving.NOMAD.NOMADSolver import NOMADSolver
...
def parse_synthesis_config_file(config_filename: str):
    ...
    model, vp_params, reference_treatments = initialise_model_with_PEtab_files_synthesis(data['files'], sim_engine,
    ...
    return model, sim_engine, solver, horizon, vp_params, exclude_init, reference_treatments, solver_parameters, random_seed, db_configuration_info, reference_treatments_ids  
