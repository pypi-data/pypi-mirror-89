...
setup(
    ...
    url='https://github.com/claudioperez/emma',
    ...
    project_urls={
        'Changelog': 'https://github.com/claudioperez/emma/blob/master/CHANGELOG.rst',
        'Issue Tracker': 'https://github.com/claudioperez/emma/issues',
    },
    keywords=[
