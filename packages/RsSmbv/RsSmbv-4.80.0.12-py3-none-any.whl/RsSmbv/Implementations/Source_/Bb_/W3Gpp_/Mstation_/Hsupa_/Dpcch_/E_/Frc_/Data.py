...
class Data:
	...
	def set(self, data: enums.DataSour, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.mstation.hsupa.dpcch.e.frc.data.set(data = enums.DataSour.DLISt, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> enums.DataSour:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:MSTation<ST>:[HSUPa]:DPCCh:E:FRC:DATA \n
		Snippet: value: enums.DataSour = driver.source.bb.w3Gpp.mstation.hsupa.dpcch.e.frc.data.get(stream = repcap.Stream.Default) \n
		Selects the data source for the E-DCH channels, i.e. this parameter affects the corresponding parameter of the E-DPDCH. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Mstation')
