...
class ValidatingWebhookConfiguration(K8sResource):
    ...
    webhooks: Union[None, OmitEnum, Mapping[str, kdsl.admissionregistration.v1.ValidatingWebhookItem]] = attr.ib(metadata={'yaml_name': 'webhooks', 'mlist_key': 'name'}, converter=kdsl.admissionregistration.v1_converters.optional_mlist_converter_ValidatingWebhookItem, default=OMIT)


@attr.s(kw_only=True)
class WebhookClientConfig(K8sObject):
    caBundle: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'caBundle'}, default=OMIT)
    service: Union[None, OmitEnum, kdsl.admissionregistration.v1.ServiceReference] = attr.ib(metadata={'yaml_name': 'service'}, converter=kdsl.admissionregistration.v1_converters.optional_converter_ServiceReference, default=OMIT)
...
class MutatingWebhookConfiguration(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    webhooks: Union[None, OmitEnum, Mapping[str, kdsl.admissionregistration.v1.MutatingWebhookItem]] = attr.ib(metadata={'yaml_name': 'webhooks', 'mlist_key': 'name'}, converter=kdsl.admissionregistration.v1_converters.optional_mlist_converter_MutatingWebhookItem, default=OMIT)
...
class MutatingWebhookItem(K8sObject):
    ...
    clientConfig: kdsl.admissionregistration.v1.WebhookClientConfig = attr.ib(metadata={'yaml_name': 'clientConfig'}, converter=kdsl.admissionregistration.v1_converters.required_converter_WebhookClientConfig)
    ...
    rules: Union[None, OmitEnum, Sequence[kdsl.admissionregistration.v1.RuleWithOperations]] = attr.ib(metadata={'yaml_name': 'rules'}, converter=kdsl.admissionregistration.v1_converters.optional_list_converter_RuleWithOperations, default=OMIT)
