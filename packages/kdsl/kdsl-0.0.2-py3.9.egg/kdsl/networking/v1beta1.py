...
class IngressSpec(K8sObject):
    backend: Union[None, OmitEnum, kdsl.networking.v1beta1.IngressBackend] = attr.ib(metadata={'yaml_name': 'backend'}, converter=kdsl.networking.v1beta1_converters.optional_converter_IngressBackend, default=OMIT)
    rules: Union[None, OmitEnum, Sequence[kdsl.networking.v1beta1.IngressRule]] = attr.ib(metadata={'yaml_name': 'rules'}, converter=kdsl.networking.v1beta1_converters.optional_list_converter_IngressRule, default=OMIT)
    tls: Union[None, OmitEnum, Sequence[kdsl.networking.v1beta1.IngressTLS]] = attr.ib(metadata={'yaml_name': 'tls'}, converter=kdsl.networking.v1beta1_converters.optional_list_converter_IngressTLS, default=OMIT)
...
class HTTPIngressPath(K8sObject):
    backend: kdsl.networking.v1beta1.IngressBackend = attr.ib(metadata={'yaml_name': 'backend'}, converter=kdsl.networking.v1beta1_converters.required_converter_IngressBackend)
...
class Ingress(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.networking.v1beta1.IngressSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.networking.v1beta1_converters.optional_converter_IngressSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.networking.v1beta1.IngressStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.networking.v1beta1_converters.optional_converter_IngressStatus, default=OMIT)
...
class IngressRule(K8sObject):
    ...
    http: Union[None, OmitEnum, kdsl.networking.v1beta1.HTTPIngressRuleValue] = attr.ib(metadata={'yaml_name': 'http'}, converter=kdsl.networking.v1beta1_converters.optional_converter_HTTPIngressRuleValue, default=OMIT)
...
class HTTPIngressRuleValue(K8sObject):
    paths: Sequence[kdsl.networking.v1beta1.HTTPIngressPath] = attr.ib(metadata={'yaml_name': 'paths'}, converter=kdsl.networking.v1beta1_converters.required_list_converter_HTTPIngressPath)
