...
class CylindricalGearMeshFEModel(_935.GearMeshFEModel):
    ...
    def stiffness_wrt_contacts_for_with_progress(self, gear: '_934.GearFEModel', flank: '_126.GearFlanks', progress: '_6553.TaskProgress') -> 'List[_612.GearContactStiffness]':
        ''' 'StiffnessWrtContactsFor' is the original name of this method.
