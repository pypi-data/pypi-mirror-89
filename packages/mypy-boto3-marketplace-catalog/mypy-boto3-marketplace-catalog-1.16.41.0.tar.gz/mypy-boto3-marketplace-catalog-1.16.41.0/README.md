...
[boto3.MarketplaceCatalog 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/marketplace-catalog.html#MarketplaceCatalog) service
compatible with
