...
class AddContactDialog(QDialog):
    '''Класс диалога выбора контакта для добавления в список контактов'''
    ...
    def possible_contacts_update(self):
        '''Метод заполнения возможных контактов без текущего контакта'''
        self.selector.clear()
    ...
    def update_possible_contacts(self):
        '''Метод - обновление известных контактов'''
        try:
