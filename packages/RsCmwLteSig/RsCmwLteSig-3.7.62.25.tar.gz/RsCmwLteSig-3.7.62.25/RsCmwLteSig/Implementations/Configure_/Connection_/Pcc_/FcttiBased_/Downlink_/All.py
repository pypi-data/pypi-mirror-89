...
class All:
	...
	def set(self, structure: AllStruct, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.configure.connection.pcc.fcttiBased.downlink.all.set(value = [PROPERTY_STRUCT_NAME](), stream = repcap.Stream.Default) \n
		...
		self._core.io.write_struct(f'CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:FCTTibased:DL{stream_cmd_val}:ALL', structure)
