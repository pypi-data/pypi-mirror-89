...
class MeRms:
	"""MeRms commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("meRms", core, parent)

	def set(self, cell_name: str, power: int) -> None:
		"""SCPI: [CONFigure]:SIGNaling:NRADio:CELL:POWer:UL:MERMs \n
		Snippet: driver.configure.signaling.nradio.cell.power.uplink.meRms.set(cell_name = '1', power = 1) \n
	...
	def get(self, cell_name: str) -> int:
		"""SCPI: [CONFigure]:SIGNaling:NRADio:CELL:POWer:UL:MERMs \n
		Snippet: value: int = driver.configure.signaling.nradio.cell.power.uplink.meRms.get(cell_name = '1') \n
		Defines the maximum expected RMS UL power, for user-defined configuration. \n
			:param cell_name: No help available
