...
class Signaling:
	"""Signaling commands group definition. 14 total commands, 3 Sub-groups, 1 group commands"""
	...
	@property
	def lte(self):
		"""lte commands group. 2 Sub-classes, 2 commands."""
	...
	@property
	def nradio(self):
		"""nradio commands group. 1 Sub-classes, 2 commands."""
