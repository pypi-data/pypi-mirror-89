...
class Sss:
	"""Sss commands group definition. 1 total commands, 1 Sub-groups, 0 group commands"""
	...
	def poffset(self):
		...
		if not hasattr(self, '_poffset'):
			from .Sss_.Poffset import Poffset
	...
	def clone(self) -> 'Sss':
		...
		new_group = Sss(self._core, self._base.parent)
