class TableTemplete():
    ...
    def crosswiseTableTemplete(dc,jsonObject):
        ...
        if(len(dc)> 0):
            ...
            for key,value in dc.items():
                string_list.append("<tr><td>"+str(value)+": </td><td>"+str(jsonObject[key])+"</td></tr>")
    ...
    def columnTableTemplete(dc,jsonObject):
        ...
        if (len(dc) > 0):
            ...
            for value in value_list:
                table_list.append("<td>" + str(jsonObject[value]) + "</td>")
            table_list.append("</tr>");
    ...
    def crosswiseTableTempleteByDictionary(dc):
        ...
        if (len(dc) > 0):
            ...
            for key, value in dc.items():
                string_list.append("<tr><td>" + str(key) + ": </td><td>" + str(value) + "</td></tr>")
            string_list.append("</table>")
