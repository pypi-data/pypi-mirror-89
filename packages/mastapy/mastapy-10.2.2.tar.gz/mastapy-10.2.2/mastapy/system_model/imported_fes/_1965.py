...
class ElectricMachineDataSet(_0.APIBase):
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_6184.HarmonicLoadDataType') -> '_1094.MultipleFourierSeriesInterpolator':
    ...
    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_6184.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6554.MeasurementType'):
    ...
    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_6184.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6554.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def multiple_fourier_series_interpolator_for_with_stiffness_node(self, harmonic_load_data_type: '_6184.HarmonicLoadDataType', node: '_1988.ImportedFEStiffnessNode') -> '_1094.MultipleFourierSeriesInterpolator':
        ''' 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_stiffness_node(self, harmonic_load_data_type: '_6184.HarmonicLoadDataType', node: '_1988.ImportedFEStiffnessNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_6554.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_stiffness_node(self, harmonic_load_data_type: '_6184.HarmonicLoadDataType', node: '_1988.ImportedFEStiffnessNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_6554.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
