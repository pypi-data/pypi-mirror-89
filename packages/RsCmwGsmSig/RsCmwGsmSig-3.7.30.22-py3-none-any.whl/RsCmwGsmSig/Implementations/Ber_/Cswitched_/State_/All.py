...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.ber.cswitched.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:GSM:SIGNaling<Instance>:BER:CSWitched:STATe:ALL?', self.__class__.FetchStruct())
