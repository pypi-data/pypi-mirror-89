...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, repository=None, base_path=None, repository_version=None, name=None, pulp_created=None, pulp_href=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
