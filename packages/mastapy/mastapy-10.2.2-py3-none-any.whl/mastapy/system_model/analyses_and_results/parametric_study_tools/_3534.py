...
class ConceptCouplingHalfParametricStudyTool(_3545.CouplingHalfParametricStudyTool):
    '''ConceptCouplingHalfParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2278.ConceptCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2278.ConceptCouplingHalfSystemDeflection))
        return value
