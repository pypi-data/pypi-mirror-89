...
class StandardDev:
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- On_Power_Rms_1: float: No parameter help available
			- On_Power_Peak_1: float: No parameter help available
			- On_Power_Rms_2: float: No parameter help available
			- On_Power_Peak_2: float: No parameter help available
	...
	def calculate(self) -> CalculateStruct:
		...
		Snippet: value: CalculateStruct = driver.srs.pdynamics.standardDev.calculate() \n
