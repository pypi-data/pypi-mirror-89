...
class ClutchConnectionSystemDeflection(_2289.CouplingConnectionSystemDeflection):
    '''ClutchConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3282.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3282.ClutchConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
