...
class FaceGearMeshGearWhineAnalysis(_5368.GearMeshGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2308.FaceGearMeshSystemDeflection':
        ...
        return constructor.new(_2308.FaceGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
