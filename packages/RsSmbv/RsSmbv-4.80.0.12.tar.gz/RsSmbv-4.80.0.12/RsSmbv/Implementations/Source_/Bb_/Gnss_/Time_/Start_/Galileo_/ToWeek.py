...
class ToWeek:
	...
	def get(self, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:STARt:GALileo<ST>:TOWeek \n
		Snippet: value: float = driver.source.bb.gnss.time.start.galileo.toWeek.get(stream = repcap.Stream.Default) \n
