...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.olpControl.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:WCDMa:MEASurement<Instance>:OLPControl:STATe:ALL?', self.__class__.FetchStruct())
