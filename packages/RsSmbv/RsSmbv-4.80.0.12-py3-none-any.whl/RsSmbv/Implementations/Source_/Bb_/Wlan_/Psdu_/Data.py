...
class Data:
	...
	def get_dselect(self) -> str:
		"""SCPI: [SOURce<HW>]:BB:WLAN:PSDU:DATA:DSELect \n
		Snippet: value: str = driver.source.bb.wlan.psdu.data.get_dselect() \n
	...
	def set_dselect(self, dselect: str) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:PSDU:DATA:DSELect \n
		Snippet: driver.source.bb.wlan.psdu.data.set_dselect(dselect = '1') \n
		No command help available \n
	...
	def get_pattern(self) -> PatternStruct:
		"""SCPI: [SOURce<HW>]:BB:WLAN:PSDU:DATA:PATTern \n
		Snippet: value: PatternStruct = driver.source.bb.wlan.psdu.data.get_pattern() \n
		No command help available \n
	...
	def set_pattern(self, value: PatternStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:PSDU:DATA:PATTern \n
		Snippet: driver.source.bb.wlan.psdu.data.set_pattern(value = PatternStruct()) \n
		No command help available \n
	...
	def get_value(self) -> enums.DataSour:
		"""SCPI: [SOURce<HW>]:BB:WLAN:PSDU:DATA \n
		Snippet: value: enums.DataSour = driver.source.bb.wlan.psdu.data.get_value() \n
		No command help available \n
	...
	def set_value(self, data: enums.DataSour) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:PSDU:DATA \n
		Snippet: driver.source.bb.wlan.psdu.data.set_value(data = enums.DataSour.DLISt) \n
		No command help available \n
