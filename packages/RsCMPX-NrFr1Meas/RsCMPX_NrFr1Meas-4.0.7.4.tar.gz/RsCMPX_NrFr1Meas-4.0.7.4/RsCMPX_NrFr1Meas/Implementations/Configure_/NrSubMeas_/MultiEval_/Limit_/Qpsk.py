...
class Qpsk:
	...
	def get_ev_magnitude(self) -> EvMagnitudeStruct:
		...
		Snippet: value: EvMagnitudeStruct = driver.configure.nrSubMeas.multiEval.limit.qpsk.get_ev_magnitude() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:EVMagnitude?', self.__class__.EvMagnitudeStruct())

	def set_ev_magnitude(self, value: EvMagnitudeStruct) -> None:
		"""SCPI: CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:EVMagnitude \n
		Snippet: driver.configure.nrSubMeas.multiEval.limit.qpsk.set_ev_magnitude(value = EvMagnitudeStruct()) \n
		Defines upper limits for the RMS and peak values of the error vector magnitude (EVM) for QPSK. \n
			:param value: see the help for EvMagnitudeStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:EVMagnitude', value)
	...
	def get_merror(self) -> MerrorStruct:
		...
		Snippet: value: MerrorStruct = driver.configure.nrSubMeas.multiEval.limit.qpsk.get_merror() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:MERRor?', self.__class__.MerrorStruct())

	def set_merror(self, value: MerrorStruct) -> None:
		"""SCPI: CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:MERRor \n
		Snippet: driver.configure.nrSubMeas.multiEval.limit.qpsk.set_merror(value = MerrorStruct()) \n
		Defines upper limits for the RMS and peak values of the magnitude error for QPSK. \n
			:param value: see the help for MerrorStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:MERRor', value)
	...
	def get_perror(self) -> PerrorStruct:
		...
		Snippet: value: PerrorStruct = driver.configure.nrSubMeas.multiEval.limit.qpsk.get_perror() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:PERRor?', self.__class__.PerrorStruct())

	def set_perror(self, value: PerrorStruct) -> None:
		"""SCPI: CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:PERRor \n
		Snippet: driver.configure.nrSubMeas.multiEval.limit.qpsk.set_perror(value = PerrorStruct()) \n
		Defines symmetric limits for the RMS and peak values of the phase error for QPSK. The limit check fails if the absolute
		value of the measured phase error exceeds the specified values. \n
			:param value: see the help for PerrorStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:PERRor', value)
	...
	def get_iq_offset(self) -> IqOffsetStruct:
		...
		Snippet: value: IqOffsetStruct = driver.configure.nrSubMeas.multiEval.limit.qpsk.get_iq_offset() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:IQOFfset?', self.__class__.IqOffsetStruct())

	def set_iq_offset(self, value: IqOffsetStruct) -> None:
		"""SCPI: CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:IQOFfset \n
		Snippet: driver.configure.nrSubMeas.multiEval.limit.qpsk.set_iq_offset(value = IqOffsetStruct()) \n
		Defines upper limits for the I/Q origin offset (QPSK modulation) . Four different I/Q origin offset limits can be set for
		four TX power ranges. \n
			:param value: see the help for IqOffsetStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:IQOFfset', value)
	...
	def set_es_flatness(self, value: EsFlatnessStruct) -> None:
		"""SCPI: CONFigure:NRSub:MEASurement<Instance>:MEValuation:LIMit:QPSK:ESFLatness \n
		Snippet: driver.configure.nrSubMeas.multiEval.limit.qpsk.set_es_flatness(value = EsFlatnessStruct()) \n
		Defines limits for the equalizer spectrum flatness (QPSK modulation) . \n
