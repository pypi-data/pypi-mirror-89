...
class CriticalSpeedAnalysis(_6548.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def modal_analyses_at_stiffnesses_options(self) -> '_3840.ModalAnalysesAtStiffnessesOptions':
        ...
        return constructor.new(_3840.ModalAnalysesAtStiffnessesOptions)(self.wrapped.ModalAnalysesAtStiffnessesOptions) if self.wrapped.ModalAnalysesAtStiffnessesOptions else None
