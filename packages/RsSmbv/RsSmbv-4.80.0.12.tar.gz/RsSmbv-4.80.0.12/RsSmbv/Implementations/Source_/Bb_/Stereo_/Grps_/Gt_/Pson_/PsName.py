...
class PsName:
	...
	def set(self, ps_name: str, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:STEReo:GRPS:GT<ST>:PSON:PSName \n
		Snippet: driver.source.bb.stereo.grps.gt.pson.psName.set(ps_name = '1', stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> str:
		"""SCPI: [SOURce<HW>]:BB:STEReo:GRPS:GT<ST>:PSON:PSName \n
		Snippet: value: str = driver.source.bb.stereo.grps.gt.pson.psName.get(stream = repcap.Stream.Default) \n
		No command help available \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Gt')
