...
from ..constraints import (AffineConstraint, ConvexQuadraticConstraint,
                           LMIConstraint, RSOCConstraint, SOCConstraint)
...
class MOSEKSolver(Solver):
    ...
    def _import_affine_objective(self, picosObjective):
        ...
        for picosVar, picosCoef in picosObjective._coefs.items():
        ...
        if picosObjective._const:
            self.int.putcfix(picosObjective._const[0])
