...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2490, _2402
...
class ShaftCompoundSystemDeflection(_2402.AbstractShaftOrHousingCompoundSystemDeflection):
    '''ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2490.ShaftDutyCycleSystemDeflection':
        ...
        return constructor.new(_2490.ShaftDutyCycleSystemDeflection)(self.wrapped.ShaftDutyCycleDamageResults) if self.wrapped.ShaftDutyCycleDamageResults else None

    @property
    def load_case_analyses_ready(self) -> 'List[_2354.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2354.ShaftSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2354.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2354.ShaftSystemDeflection))
        return value
