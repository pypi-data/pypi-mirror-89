...
class TokenRequestSpec(K8sObject):
    ...
    boundObjectRef: Union[None, OmitEnum, kdsl.authentication.v1.BoundObjectReference] = attr.ib(metadata={'yaml_name': 'boundObjectRef'}, converter=kdsl.authentication.v1_converters.optional_converter_BoundObjectReference, default=OMIT)
...
class TokenRequest(K8sResource):
    ...
    spec: kdsl.authentication.v1.TokenRequestSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.authentication.v1_converters.required_converter_TokenRequestSpec)
    ...
    status: Union[None, OmitEnum, kdsl.authentication.v1.TokenRequestStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.authentication.v1_converters.optional_converter_TokenRequestStatus, default=OMIT)
...
class TokenReview(K8sResource):
    ...
    spec: kdsl.authentication.v1.TokenReviewSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.authentication.v1_converters.required_converter_TokenReviewSpec)
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    status: Union[None, OmitEnum, kdsl.authentication.v1.TokenReviewStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.authentication.v1_converters.optional_converter_TokenReviewStatus, default=OMIT)
...
class TokenReviewStatus(K8sObject):
    ...
    user: Union[None, OmitEnum, kdsl.authentication.v1.UserInfo] = attr.ib(metadata={'yaml_name': 'user'}, converter=kdsl.authentication.v1_converters.optional_converter_UserInfo, default=OMIT)
