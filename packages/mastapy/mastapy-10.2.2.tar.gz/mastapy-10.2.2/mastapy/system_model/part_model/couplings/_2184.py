...
from mastapy.system_model.part_model.couplings import _2185, _2187, _2161
...
class TorqueConverter(_2161.Coupling):
    ...
    @property
    def pump(self) -> '_2185.TorqueConverterPump':
        ...
        return constructor.new(_2185.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2187.TorqueConverterTurbine':
        ...
        return constructor.new(_2187.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
