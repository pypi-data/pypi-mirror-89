...
class Roffset:
	...
	def set(self, mark_rise_offs: int, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.nr5G.trigger.output.roffset.set(mark_rise_offs = 1, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:NR5G:TRIGger:OUTPut<CH>:ROFFset \n
		Snippet: value: int = driver.source.bb.nr5G.trigger.output.roffset.get(channel = repcap.Channel.Default) \n
		Sets the rise/fall offset. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Output')
