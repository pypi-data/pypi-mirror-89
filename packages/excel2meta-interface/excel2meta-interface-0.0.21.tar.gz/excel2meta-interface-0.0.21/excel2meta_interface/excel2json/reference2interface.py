    ...
    def process_map_data_source_file(self, data_source_file):
        ...
        with open(data_source_file, "r") as input:
            ...
            for src_tgt_data_source in src_tgt_data_sources:
                ...
                src_path = path.join(src + "://", "FileSystem", found_pattern["source_folder"], src_tgt_data_source["source_dataset"])
                tgt_path = path.join(self.edc_target_resource + "://", "FileSystem"
                ...
                tgt_path = path.join(tgt + "://", "FileSystem"
