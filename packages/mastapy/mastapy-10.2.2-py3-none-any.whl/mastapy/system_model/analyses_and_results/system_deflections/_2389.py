...
class ZerolBevelGearMeshSystemDeflection(_2266.BevelGearMeshSystemDeflection):
    '''ZerolBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3385.ZerolBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3385.ZerolBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
