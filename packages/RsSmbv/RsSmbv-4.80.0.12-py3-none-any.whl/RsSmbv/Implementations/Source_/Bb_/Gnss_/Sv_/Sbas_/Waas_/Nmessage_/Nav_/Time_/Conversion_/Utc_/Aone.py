...
class Aone:
	...
	def set(self, a_1: int, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:SBAS<ST>:WAAS:NMESsage:NAV:TIME:CONVersion:UTC<CH>:AONE \n
		Snippet: driver.source.bb.gnss.sv.sbas.waas.nmessage.nav.time.conversion.utc.aone.set(a_1 = 1, stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
	...
	def get(self, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:SBAS<ST>:WAAS:NMESsage:NAV:TIME:CONVersion:UTC<CH>:AONE \n
		Snippet: value: int = driver.source.bb.gnss.sv.sbas.waas.nmessage.nav.time.conversion.utc.aone.get(stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
		Sets the parameter A1. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Sbas')
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Utc')
