...
class ConceptGearSetGearWhineAnalysis(_5371.GearSetGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2281.ConceptGearSetSystemDeflection':
        ...
        return constructor.new(_2281.ConceptGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
