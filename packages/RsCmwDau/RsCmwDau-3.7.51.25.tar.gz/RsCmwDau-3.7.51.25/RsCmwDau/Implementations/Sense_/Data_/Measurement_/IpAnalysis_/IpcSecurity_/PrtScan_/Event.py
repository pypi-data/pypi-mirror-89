...
class Event:
	...
	def get_log(self) -> LogStruct:
		...
		Snippet: value: LogStruct = driver.sense.data.measurement.ipAnalysis.ipcSecurity.prtScan.event.get_log() \n
		...
		"""
		return self._core.io.query_struct('SENSe:DATA:MEASurement<MeasInstance>:IPANalysis:IPCSecurity:PRTScan:EVENt:LOG?', self.__class__.LogStruct())
