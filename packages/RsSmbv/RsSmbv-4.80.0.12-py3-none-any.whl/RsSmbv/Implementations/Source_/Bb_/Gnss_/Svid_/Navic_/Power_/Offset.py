...
class Offset:
	...
	def set(self, power_offset: float, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:NAVic<ST>:POWer:OFFSet \n
		Snippet: driver.source.bb.gnss.svid.navic.power.offset.set(power_offset = 1.0, channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:NAVic<ST>:POWer:OFFSet \n
		Snippet: value: float = driver.source.bb.gnss.svid.navic.power.offset.get(channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
		Reduces the signal of the selected SV ID by the defined value. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Svid')
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Navic')
