...
class Max:
	...
	def set(self, max_acceleration: float, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:GPS<ST>:SDYNamics:ACCel:MAX \n
		Snippet: driver.source.bb.gnss.svid.gps.sdynamics.accel.max.set(max_acceleration = 1.0, channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:GPS<ST>:SDYNamics:ACCel:MAX \n
		Snippet: value: float = driver.source.bb.gnss.svid.gps.sdynamics.accel.max.get(channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
		Sets the maximum acceleration. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Svid')
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Gps')
