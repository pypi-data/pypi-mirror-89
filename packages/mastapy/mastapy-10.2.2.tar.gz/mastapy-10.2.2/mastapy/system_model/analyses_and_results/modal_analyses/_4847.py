...
class SpiralBevelGearModalAnalysis(_4762.BevelGearModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2359.SpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2359.SpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
