...
from mastapy.system_model.analyses_and_results.system_deflections import _2318, _2316, _2255
...
class HypoidGearSetSystemDeflection(_2255.AGMAGleasonConicalGearSetSystemDeflection):
    '''HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3321.HypoidGearSetPowerFlow':
        ...
        return constructor.new(_3321.HypoidGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2318.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSystemDeflection, constructor.new(_2318.HypoidGearSystemDeflection))
        return value

    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2316.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSystemDeflection, constructor.new(_2316.HypoidGearMeshSystemDeflection))
        return value
