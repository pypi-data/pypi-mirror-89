...
class StatefulSetSpec(K8sObject):
    ...
    updateStrategy: Union[None, OmitEnum, kdsl.apps.v1.StatefulSetUpdateStrategy] = attr.ib(metadata={'yaml_name': 'updateStrategy'}, converter=kdsl.apps.v1_converters.optional_converter_StatefulSetUpdateStrategy, default=OMIT)
...
class DaemonSetStatus(K8sObject):
    ...
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apps.v1.DaemonSetConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apps.v1_converters.optional_mlist_converter_DaemonSetConditionItem, default=OMIT)
...
class StatefulSet(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.apps.v1.StatefulSetSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apps.v1_converters.optional_converter_StatefulSetSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apps.v1.StatefulSetStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apps.v1_converters.optional_converter_StatefulSetStatus, default=OMIT)
...
class DaemonSet(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.apps.v1.DaemonSetSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apps.v1_converters.optional_converter_DaemonSetSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apps.v1.DaemonSetStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apps.v1_converters.optional_converter_DaemonSetStatus, default=OMIT)
...
class DaemonSetSpec(K8sObject):
    ...
    revisionHistoryLimit: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'revisionHistoryLimit'}, default=OMIT)
    updateStrategy: Union[None, OmitEnum, kdsl.apps.v1.DaemonSetUpdateStrategy] = attr.ib(metadata={'yaml_name': 'updateStrategy'}, converter=kdsl.apps.v1_converters.optional_converter_DaemonSetUpdateStrategy, default=OMIT)
...
class DaemonSetUpdateStrategy(K8sObject):
    rollingUpdate: Union[None, OmitEnum, kdsl.apps.v1.RollingUpdateDaemonSet] = attr.ib(metadata={'yaml_name': 'rollingUpdate'}, converter=kdsl.apps.v1_converters.optional_converter_RollingUpdateDaemonSet, default=OMIT)
...
class Deployment(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.apps.v1.DeploymentSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apps.v1_converters.optional_converter_DeploymentSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apps.v1.DeploymentStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apps.v1_converters.optional_converter_DeploymentStatus, default=OMIT)
...
class StatefulSetStatus(K8sObject):
    ...
    collisionCount: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'collisionCount'}, default=OMIT)
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apps.v1.StatefulSetConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apps.v1_converters.optional_mlist_converter_StatefulSetConditionItem, default=OMIT)
...
class DeploymentStrategy(K8sObject):
    rollingUpdate: Union[None, OmitEnum, kdsl.apps.v1.RollingUpdateDeployment] = attr.ib(metadata={'yaml_name': 'rollingUpdate'}, converter=kdsl.apps.v1_converters.optional_converter_RollingUpdateDeployment, default=OMIT)
    type: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'type'}, default=OMIT)
...
class DeploymentStatus(K8sObject):
    ...
    collisionCount: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'collisionCount'}, default=OMIT)
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apps.v1.DeploymentConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apps.v1_converters.optional_mlist_converter_DeploymentConditionItem, default=OMIT)
    observedGeneration: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'observedGeneration'}, default=OMIT)
    readyReplicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'readyReplicas'}, default=OMIT)
    replicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'replicas'}, default=OMIT)
...
class ReplicaSet(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.apps.v1.ReplicaSetSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apps.v1_converters.optional_converter_ReplicaSetSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apps.v1.ReplicaSetStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apps.v1_converters.optional_converter_ReplicaSetStatus, default=OMIT)
...
class DeploymentSpec(K8sObject):
    ...
    replicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'replicas'}, default=OMIT)
    revisionHistoryLimit: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'revisionHistoryLimit'}, default=OMIT)
    strategy: Union[None, OmitEnum, kdsl.apps.v1.DeploymentStrategy] = attr.ib(metadata={'yaml_name': 'strategy'}, converter=kdsl.apps.v1_converters.optional_converter_DeploymentStrategy, default=OMIT)
...
class StatefulSetUpdateStrategy(K8sObject):
    rollingUpdate: Union[None, OmitEnum, kdsl.apps.v1.RollingUpdateStatefulSetStrategy] = attr.ib(metadata={'yaml_name': 'rollingUpdate'}, converter=kdsl.apps.v1_converters.optional_converter_RollingUpdateStatefulSetStrategy, default=OMIT)
    type: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'type'}, default=OMIT)
...
class ReplicaSetStatus(K8sObject):
    replicas: int = attr.ib(metadata={'yaml_name': 'replicas'})
    availableReplicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'availableReplicas'}, default=OMIT)
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apps.v1.ReplicaSetConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apps.v1_converters.optional_mlist_converter_ReplicaSetConditionItem, default=OMIT)
