...
class EvmPilot:
	...
	def get_tb_high(self) -> float or bool:
		...
		Sets EVM limits for a pilot subcarrier in IEEE 802.11ax signals, when transmit power is larger than the maximum power of
		MCS 7. \n
	...
	def get_tb_low(self) -> float or bool:
		...
		Sets EVM limits for a pilot subcarrier in IEEE 802.11ax signals, when transmit power is less than or equal to the maximum
		power of MCS 7. \n
