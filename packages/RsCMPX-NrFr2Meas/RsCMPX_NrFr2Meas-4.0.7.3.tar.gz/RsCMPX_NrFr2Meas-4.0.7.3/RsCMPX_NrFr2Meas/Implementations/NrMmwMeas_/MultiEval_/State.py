...
class State:
	...
	def fetch(self) -> enums.ResourceState:
		...
		Snippet: value: enums.ResourceState = driver.nrMmwMeas.multiEval.state.fetch() \n
		...
		response = self._core.io.query_str(f'FETCh:NRMMw:MEASurement<Instance>:MEValuation:STATe?')
