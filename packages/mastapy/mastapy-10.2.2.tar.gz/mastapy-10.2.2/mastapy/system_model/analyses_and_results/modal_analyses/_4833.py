...
class PlanetCarrierModalAnalysis(_4824.MountableComponentModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2343.PlanetCarrierSystemDeflection':
        ...
        return constructor.new(_2343.PlanetCarrierSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
