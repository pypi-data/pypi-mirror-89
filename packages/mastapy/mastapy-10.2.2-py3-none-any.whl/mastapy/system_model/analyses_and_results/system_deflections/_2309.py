...
from mastapy.system_model.analyses_and_results.system_deflections import _2310, _2308, _2313
...
class FaceGearSetSystemDeflection(_2313.GearSetSystemDeflection):
    '''FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3313.FaceGearSetPowerFlow':
        ...
        return constructor.new(_3313.FaceGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2310.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSystemDeflection, constructor.new(_2310.FaceGearSystemDeflection))
        return value

    @property
    def face_meshes_system_deflection(self) -> 'List[_2308.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSystemDeflection, constructor.new(_2308.FaceGearMeshSystemDeflection))
        return value
