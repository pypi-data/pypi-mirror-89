...
class Pbch:
	"""Pbch commands group definition. 1 total commands, 1 Sub-groups, 0 group commands"""
	...
	def poffset(self):
		...
		if not hasattr(self, '_poffset'):
			from .Pbch_.Poffset import Poffset
	...
	def clone(self) -> 'Pbch':
		...
		new_group = Pbch(self._core, self._base.parent)
