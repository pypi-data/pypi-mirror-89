...
class TorqueConverterPumpSystemDeflection(_2290.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3378.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3378.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
