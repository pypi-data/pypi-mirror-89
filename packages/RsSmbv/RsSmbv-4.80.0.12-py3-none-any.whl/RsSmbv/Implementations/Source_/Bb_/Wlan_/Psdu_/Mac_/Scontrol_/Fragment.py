...
class Fragment:
	...
	def get_increment(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:WLAN:PSDU:MAC:SCONtrol:FRAGment:INCRement \n
		Snippet: value: float = driver.source.bb.wlan.psdu.mac.scontrol.fragment.get_increment() \n
	...
	def set_increment(self, increment: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:PSDU:MAC:SCONtrol:FRAGment:INCRement \n
		Snippet: driver.source.bb.wlan.psdu.mac.scontrol.fragment.set_increment(increment = 1.0) \n
		No command help available \n
	...
	def get_start(self) -> List[str]:
		"""SCPI: [SOURce<HW>]:BB:WLAN:PSDU:MAC:SCONtrol:FRAGment:STARt \n
		Snippet: value: List[str] = driver.source.bb.wlan.psdu.mac.scontrol.fragment.get_start() \n
		No command help available \n
	...
	def set_start(self, start: List[str]) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:PSDU:MAC:SCONtrol:FRAGment:STARt \n
		Snippet: driver.source.bb.wlan.psdu.mac.scontrol.fragment.set_start(start = ['raw1', 'raw2', 'raw3']) \n
		No command help available \n
