...
class ImportedFE(_1390.FEStiffness):
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6553.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_1473.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_6553.TaskProgress'] = None):
