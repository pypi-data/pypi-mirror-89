...
class DynamicCustomReportItem(_1312.CustomReportNameableItem):
    ...
    @property
    def inner_item_of_type_shaft_system_deflection_sections_report(self) -> '_2399.ShaftSystemDeflectionSectionsReport':
        ...
        if _2399.ShaftSystemDeflectionSectionsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_parametric_study_histogram(self) -> '_3593.ParametricStudyHistogram':
        ...
        if _3593.ParametricStudyHistogram.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
