...
class TorqueConverterConnectionAdvancedSystemDeflection(_6324.CouplingConnectionAdvancedSystemDeflection):
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2378.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2378.TorqueConverterConnectionSystemDeflection))
        return value
