...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow(_3448.KlingelnbergCycloPalloidConicalGearCompoundPowerFlow):
    '''KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3331.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3331.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3331.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3331.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow))
        return value
