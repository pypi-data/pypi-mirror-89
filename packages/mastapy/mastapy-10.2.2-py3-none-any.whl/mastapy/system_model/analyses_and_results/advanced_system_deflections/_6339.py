...
from mastapy.system_model.analyses_and_results.system_deflections import _2351, _2331, _2311
...
class FlexiblePinAssemblyAdvancedSystemDeflection(_6380.SpecialisedAssemblyAdvancedSystemDeflection):
    ...
    @property
    def pin_spindle_fit_advanced_analyses(self) -> 'List[_2351.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinSpindleFitAdvancedAnalyses, constructor.new(_2351.ShaftHubConnectionSystemDeflection))
        return value
