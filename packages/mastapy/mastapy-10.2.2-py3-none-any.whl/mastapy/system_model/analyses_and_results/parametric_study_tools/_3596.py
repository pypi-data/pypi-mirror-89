...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3597, _3598
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def step_results(self) -> 'List[_3597.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3597.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3598.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3598.ParametricStudyVariable))
        return value
