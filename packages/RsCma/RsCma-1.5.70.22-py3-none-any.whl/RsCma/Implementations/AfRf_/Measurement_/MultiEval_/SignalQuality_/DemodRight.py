...
class DemodRight:
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .DemodRight_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .DemodRight_.Average import Average
	...
	def deviation(self):
		...
		if not hasattr(self, '_deviation'):
			from .DemodRight_.Deviation import Deviation
	...
	def extreme(self):
		...
		if not hasattr(self, '_extreme'):
			from .DemodRight_.Extreme import Extreme
