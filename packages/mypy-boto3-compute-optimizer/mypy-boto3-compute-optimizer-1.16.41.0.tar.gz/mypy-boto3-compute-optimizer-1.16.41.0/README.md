...
[boto3.ComputeOptimizer 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/compute-optimizer.html#ComputeOptimizer) service
compatible with
