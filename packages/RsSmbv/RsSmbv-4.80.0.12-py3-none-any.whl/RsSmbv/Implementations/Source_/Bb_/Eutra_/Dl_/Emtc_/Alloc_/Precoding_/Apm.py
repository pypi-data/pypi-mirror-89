...
class Apm:
	...
	def get(self, channel=repcap.Channel.Default) -> enums.EutraBfapMapMode:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH>:PRECoding:APM \n
		Snippet: value: enums.EutraBfapMapMode = driver.source.bb.eutra.dl.emtc.alloc.precoding.apm.get(channel = repcap.Channel.Default) \n
