...
class FaceGearMeshSystemDeflection(_2312.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3311.FaceGearMeshPowerFlow':
        ...
        return constructor.new(_3311.FaceGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
