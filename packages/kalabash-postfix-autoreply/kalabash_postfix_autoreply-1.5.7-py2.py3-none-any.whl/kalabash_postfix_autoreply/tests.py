...
class EventsTestCase(KaldeeTestCase):
...
class FormTestCase(KaldeeTestCase):
...
class RepairTestCase(KaldeeTestCase):
    ...
    def test_management_command(self):
        ...
        management.call_command("kaldee", "repair", "--quiet")
        self.assertFalse(
            admin_models.AliasRecipient.objects.filter(
...
class ManagementCommandTestCase(KaldeeTestCase):
...
class ARMessageViewSetTestCase(KaldeeAPITestCase):
    """API test case."""
