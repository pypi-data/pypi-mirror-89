...
class Poffset:
	...
	def set(self, cell_name: str, mode: enums.Mode, value: float = None) -> None:
		...
		Snippet: driver.configure.signaling.nradio.cell.power.downlink.ocng.pdsch.poffset.set(cell_name = '1', mode = enums.Mode.MAX, value = 1.0) \n
		Defines the power level of the PDSCH for OCNG. \n
			:param cell_name: No help available
			:param mode: No help available
			:param value: Power level relative to the SSB EPRE, for Mode = UDEFined.
		"""
	...
	class GetStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Value: float: Power level relative to the SSB EPRE, for Mode = UDEFined."""
		__meta_args_list = [
