...
class Microservice(core.Construct):
    ...
    Args:
        ...
        existing_efs_security_group (str): In case you want to enble access to an existing EFS, provide its already-existing security group
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        if existing_efs_security_group:
            existing_efs_security_group_resource = _ec2.SecurityGroup.from_security_group_id(
                self,
