...
class CylindricalPlanetGearSystemDeflection(_2301.CylindricalGearSystemDeflection):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3308.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3308.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
