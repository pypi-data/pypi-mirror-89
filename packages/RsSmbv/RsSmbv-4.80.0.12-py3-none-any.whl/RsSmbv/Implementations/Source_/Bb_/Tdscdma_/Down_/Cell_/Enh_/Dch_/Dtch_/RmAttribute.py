...
class RmAttribute:
	...
	def set(self, rm_attribute: int, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.down.cell.enh.dch.dtch.rmAttribute.set(rm_attribute = 1, stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
	...
	def get(self, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:TDSCdma:DOWN:CELL<ST>:ENH:DCH:DTCH<CH>:RMATtribute \n
		Snippet: value: int = driver.source.bb.tdscdma.down.cell.enh.dch.dtch.rmAttribute.get(stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
		Sets the rate matching. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cell')
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Dtch')
