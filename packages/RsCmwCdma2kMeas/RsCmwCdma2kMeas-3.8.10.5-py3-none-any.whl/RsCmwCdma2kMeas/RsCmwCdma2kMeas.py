...
class RsCmwCdma2kMeas:
	...
	driver_options = "SupportedInstrModels = CMW500/CMW270/CMW280/CMP, SupportedIdnPatterns = CMW, SimulationIdnString = 'Rohde&Schwarz,CMW500,100001,3.8.10.0005'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core = Core(resource_name, id_query, reset, RsCmwCdma2kMeas.driver_options, options, direct_session)
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsCmwCdma2kMeas version failed. Current version: '3.8.10.0005', minimum required version: '{min_version}'")
