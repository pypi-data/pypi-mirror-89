...
class State:
	...
	def fetch(self) -> enums.ResourceState:
		...
		Snippet: value: enums.ResourceState = driver.ploss.state.fetch() \n
		...
		INITiate..., STOP..., ABORt...to change the measurement state. \n
			:return: meas_state: OFF | RUN | RDY OFF: measurement off, no resources allocated RUN: measurement running, synchronization pending or adjusted, resources active or queued RDY: measurement finished"""
