...
class FlexiblePinAssemblyModalAnalysis(_4845.SpecialisedAssemblyModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2311.FlexiblePinAssemblySystemDeflection':
        ...
        return constructor.new(_2311.FlexiblePinAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
