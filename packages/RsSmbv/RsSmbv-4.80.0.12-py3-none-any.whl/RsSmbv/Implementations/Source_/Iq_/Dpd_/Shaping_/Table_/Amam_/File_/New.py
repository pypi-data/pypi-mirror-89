...
class New:
	...
	def set(self, ipartd_pi_db_dpd_am_table_data_new_file: List[float], stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:IQ:DPD<ST>:SHAPing:TABLe:AMAM:FILE:NEW \n
		Snippet: driver.source.iq.dpd.shaping.table.amam.file.new.set(ipartd_pi_db_dpd_am_table_data_new_file = [1.1, 2.2, 3.3], stream = repcap.Stream.Default) \n
