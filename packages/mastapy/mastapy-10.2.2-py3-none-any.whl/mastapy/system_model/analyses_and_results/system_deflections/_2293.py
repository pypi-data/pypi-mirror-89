...
class CVTPulleySystemDeflection(_2346.PulleySystemDeflection):
    '''CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3303.CVTPulleyPowerFlow':
        ...
        return constructor.new(_3303.CVTPulleyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
