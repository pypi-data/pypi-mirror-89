...
class TransportBlock:
	"""TransportBlock commands group definition. 4 total commands, 2 Sub-groups, 0 group commands"""
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .TransportBlock_.Minimum import Minimum
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .TransportBlock_.Maximum import Maximum
