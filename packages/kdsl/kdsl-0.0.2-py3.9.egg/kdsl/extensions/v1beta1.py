...
class PodSecurityPolicySpec(K8sObject):
    fsGroup: kdsl.extensions.v1beta1.FSGroupStrategyOptions = attr.ib(metadata={'yaml_name': 'fsGroup'}, converter=kdsl.extensions.v1beta1_converters.required_converter_FSGroupStrategyOptions)
    runAsUser: kdsl.extensions.v1beta1.RunAsUserStrategyOptions = attr.ib(metadata={'yaml_name': 'runAsUser'}, converter=kdsl.extensions.v1beta1_converters.required_converter_RunAsUserStrategyOptions)
    seLinux: kdsl.extensions.v1beta1.SELinuxStrategyOptions = attr.ib(metadata={'yaml_name': 'seLinux'}, converter=kdsl.extensions.v1beta1_converters.required_converter_SELinuxStrategyOptions)
    supplementalGroups: kdsl.extensions.v1beta1.SupplementalGroupsStrategyOptions = attr.ib(metadata={'yaml_name': 'supplementalGroups'}, converter=kdsl.extensions.v1beta1_converters.required_converter_SupplementalGroupsStrategyOptions)
    allowPrivilegeEscalation: Union[None, OmitEnum, bool] = attr.ib(metadata={'yaml_name': 'allowPrivilegeEscalation'}, default=OMIT)
    allowedCSIDrivers: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.AllowedCSIDriver]] = attr.ib(metadata={'yaml_name': 'allowedCSIDrivers'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_AllowedCSIDriver, default=OMIT)
    allowedCapabilities: Union[None, OmitEnum, Sequence[str]] = attr.ib(metadata={'yaml_name': 'allowedCapabilities'}, default=OMIT)
    allowedFlexVolumes: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.AllowedFlexVolume]] = attr.ib(metadata={'yaml_name': 'allowedFlexVolumes'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_AllowedFlexVolume, default=OMIT)
    allowedHostPaths: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.AllowedHostPath]] = attr.ib(metadata={'yaml_name': 'allowedHostPaths'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_AllowedHostPath, default=OMIT)
    ...
    hostPorts: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.HostPortRange]] = attr.ib(metadata={'yaml_name': 'hostPorts'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_HostPortRange, default=OMIT)
    ...
    runAsGroup: Union[None, OmitEnum, kdsl.extensions.v1beta1.RunAsGroupStrategyOptions] = attr.ib(metadata={'yaml_name': 'runAsGroup'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_RunAsGroupStrategyOptions, default=OMIT)
    runtimeClass: Union[None, OmitEnum, kdsl.extensions.v1beta1.RuntimeClassStrategyOptions] = attr.ib(metadata={'yaml_name': 'runtimeClass'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_RuntimeClassStrategyOptions, default=OMIT)
...
class Deployment(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.extensions.v1beta1.DeploymentSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_DeploymentSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.extensions.v1beta1.DeploymentStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_DeploymentStatus, default=OMIT)
...
class Ingress(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.extensions.v1beta1.IngressSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_IngressSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.extensions.v1beta1.IngressStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_IngressStatus, default=OMIT)


@attr.s(kw_only=True)
class RunAsUserStrategyOptions(K8sObject):
    rule: str = attr.ib(metadata={'yaml_name': 'rule'})
    ranges: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.IDRange]] = attr.ib(metadata={'yaml_name': 'ranges'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_IDRange, default=OMIT)
...
class DaemonSetUpdateStrategy(K8sObject):
    rollingUpdate: Union[None, OmitEnum, kdsl.extensions.v1beta1.RollingUpdateDaemonSet] = attr.ib(metadata={'yaml_name': 'rollingUpdate'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_RollingUpdateDaemonSet, default=OMIT)
...
class DaemonSet(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.extensions.v1beta1.DaemonSetSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_DaemonSetSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.extensions.v1beta1.DaemonSetStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_DaemonSetStatus, default=OMIT)


@attr.s(kw_only=True)
class DaemonSetSpec(K8sObject):
    template: kdsl.core.v1.PodTemplateSpec = attr.ib(metadata={'yaml_name': 'template'}, converter=kdsl.core.v1_converters.required_converter_PodTemplateSpec)
    ...
    templateGeneration: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'templateGeneration'}, default=OMIT)
    updateStrategy: Union[None, OmitEnum, kdsl.extensions.v1beta1.DaemonSetUpdateStrategy] = attr.ib(metadata={'yaml_name': 'updateStrategy'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_DaemonSetUpdateStrategy, default=OMIT)
...
class NetworkPolicyEgressRule(K8sObject):
    ports: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.NetworkPolicyPort]] = attr.ib(metadata={'yaml_name': 'ports'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_NetworkPolicyPort, default=OMIT)
    to: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.NetworkPolicyPeer]] = attr.ib(metadata={'yaml_name': 'to'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_NetworkPolicyPeer, default=OMIT)
...
class ReplicaSet(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.extensions.v1beta1.ReplicaSetSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_ReplicaSetSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.extensions.v1beta1.ReplicaSetStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_ReplicaSetStatus, default=OMIT)
...
class DeploymentSpec(K8sObject):
    ...
    revisionHistoryLimit: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'revisionHistoryLimit'}, default=OMIT)
    rollbackTo: Union[None, OmitEnum, kdsl.extensions.v1beta1.RollbackConfig] = attr.ib(metadata={'yaml_name': 'rollbackTo'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_RollbackConfig, default=OMIT)
    selector: Union[None, OmitEnum, kdsl.core.v1.LabelSelector] = attr.ib(metadata={'yaml_name': 'selector'}, converter=kdsl.core.v1_converters.optional_converter_LabelSelector, default=OMIT)
    strategy: Union[None, OmitEnum, kdsl.extensions.v1beta1.DeploymentStrategy] = attr.ib(metadata={'yaml_name': 'strategy'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_DeploymentStrategy, default=OMIT)
...
class ReplicaSetStatus(K8sObject):
    ...
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.extensions.v1beta1.ReplicaSetConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.extensions.v1beta1_converters.optional_mlist_converter_ReplicaSetConditionItem, default=OMIT)
...
class NetworkPolicyIngressRule(K8sObject):
    from_: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.NetworkPolicyPeer]] = attr.ib(metadata={'yaml_name': 'from'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_NetworkPolicyPeer, default=OMIT)
    ports: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.NetworkPolicyPort]] = attr.ib(metadata={'yaml_name': 'ports'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_NetworkPolicyPort, default=OMIT)
...
class HTTPIngressPath(K8sObject):
    backend: kdsl.extensions.v1beta1.IngressBackend = attr.ib(metadata={'yaml_name': 'backend'}, converter=kdsl.extensions.v1beta1_converters.required_converter_IngressBackend)
...
class RollbackConfig(K8sObject):
    revision: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'revision'}, default=OMIT)
...
class DeploymentStrategy(K8sObject):
    rollingUpdate: Union[None, OmitEnum, kdsl.extensions.v1beta1.RollingUpdateDeployment] = attr.ib(metadata={'yaml_name': 'rollingUpdate'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_RollingUpdateDeployment, default=OMIT)
    type: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'type'}, default=OMIT)
...
class NetworkPolicyPeer(K8sObject):
    ipBlock: Union[None, OmitEnum, kdsl.extensions.v1beta1.IPBlock] = attr.ib(metadata={'yaml_name': 'ipBlock'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_IPBlock, default=OMIT)
    namespaceSelector: Union[None, OmitEnum, kdsl.core.v1.LabelSelector] = attr.ib(metadata={'yaml_name': 'namespaceSelector'}, converter=kdsl.core.v1_converters.optional_converter_LabelSelector, default=OMIT)
    podSelector: Union[None, OmitEnum, kdsl.core.v1.LabelSelector] = attr.ib(metadata={'yaml_name': 'podSelector'}, converter=kdsl.core.v1_converters.optional_converter_LabelSelector, default=OMIT)
...
class DaemonSetStatus(K8sObject):
    ...
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.extensions.v1beta1.DaemonSetConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.extensions.v1beta1_converters.optional_mlist_converter_DaemonSetConditionItem, default=OMIT)
...
class NetworkPolicy(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.extensions.v1beta1.NetworkPolicySpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_NetworkPolicySpec, default=OMIT)
...
class DeploymentStatus(K8sObject):
    availableReplicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'availableReplicas'}, default=OMIT)
    collisionCount: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'collisionCount'}, default=OMIT)
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.extensions.v1beta1.DeploymentConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.extensions.v1beta1_converters.optional_mlist_converter_DeploymentConditionItem, default=OMIT)
    observedGeneration: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'observedGeneration'}, default=OMIT)
    readyReplicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'readyReplicas'}, default=OMIT)
    replicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'replicas'}, default=OMIT)
...
class NetworkPolicySpec(K8sObject):
    podSelector: kdsl.core.v1.LabelSelector = attr.ib(metadata={'yaml_name': 'podSelector'}, converter=kdsl.core.v1_converters.required_converter_LabelSelector)
    egress: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.NetworkPolicyEgressRule]] = attr.ib(metadata={'yaml_name': 'egress'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_NetworkPolicyEgressRule, default=OMIT)
    ingress: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.NetworkPolicyIngressRule]] = attr.ib(metadata={'yaml_name': 'ingress'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_NetworkPolicyIngressRule, default=OMIT)
...
class IngressSpec(K8sObject):
    backend: Union[None, OmitEnum, kdsl.extensions.v1beta1.IngressBackend] = attr.ib(metadata={'yaml_name': 'backend'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_IngressBackend, default=OMIT)
    rules: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.IngressRule]] = attr.ib(metadata={'yaml_name': 'rules'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_IngressRule, default=OMIT)
    tls: Union[None, OmitEnum, Sequence[kdsl.extensions.v1beta1.IngressTLS]] = attr.ib(metadata={'yaml_name': 'tls'}, converter=kdsl.extensions.v1beta1_converters.optional_list_converter_IngressTLS, default=OMIT)
...
class IngressRule(K8sObject):
    ...
    http: Union[None, OmitEnum, kdsl.extensions.v1beta1.HTTPIngressRuleValue] = attr.ib(metadata={'yaml_name': 'http'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_HTTPIngressRuleValue, default=OMIT)
...
class PodSecurityPolicy(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.extensions.v1beta1.PodSecurityPolicySpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.extensions.v1beta1_converters.optional_converter_PodSecurityPolicySpec, default=OMIT)
...
class HTTPIngressRuleValue(K8sObject):
    paths: Sequence[kdsl.extensions.v1beta1.HTTPIngressPath] = attr.ib(metadata={'yaml_name': 'paths'}, converter=kdsl.extensions.v1beta1_converters.required_list_converter_HTTPIngressPath)
