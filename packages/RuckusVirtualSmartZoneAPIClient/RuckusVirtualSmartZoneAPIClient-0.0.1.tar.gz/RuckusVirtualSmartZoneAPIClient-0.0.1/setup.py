...
setup(
    ...
    packages=['RuckusVirtualSmartZoneAPIClient'],
    version='0.0.1',
    license='MIT',
    description='An API Client to use the Virtual SmartZone - High Scale Public API.',
    long_description=long_description,
    long_description_content_type='text/markdown',
    author='Victor M Santiago',
    author_email='vsantiago113sec@gmail.com',
    url='https://github.com/vsantiago113/RuckusVirtualSmartZoneAPIClient',
