...
import websockets
import threading
import Utils.eventThread as eventthread
...
def _initAxControl(conf):#初始化
    ...
    loop.run_until_complete(socketApiServe.SocketApiServe_init(conf))
    eventthread.eventprocess_init(conf)
    global _global_dict
    _global_dict = {}
