...
from mastapy.bearings.bearing_results.rolling import _1706, _1678
...
class LoadedToroidalRollerBearingRow(_1678.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1706.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1706.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
