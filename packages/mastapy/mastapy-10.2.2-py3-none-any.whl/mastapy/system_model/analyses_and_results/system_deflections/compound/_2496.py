...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2494, _2495, _2417
...
class SpiralBevelGearSetCompoundSystemDeflection(_2417.BevelGearSetCompoundSystemDeflection):
    '''SpiralBevelGearSetCompoundSystemDeflection
    ...
    @property
    def spiral_bevel_gears_compound_system_deflection(self) -> 'List[_2494.SpiralBevelGearCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCompoundSystemDeflection, constructor.new(_2494.SpiralBevelGearCompoundSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_compound_system_deflection(self) -> 'List[_2495.SpiralBevelGearMeshCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCompoundSystemDeflection, constructor.new(_2495.SpiralBevelGearMeshCompoundSystemDeflection))
        return value
