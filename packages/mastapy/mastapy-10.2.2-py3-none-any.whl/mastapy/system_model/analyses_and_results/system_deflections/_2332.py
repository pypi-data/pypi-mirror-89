...
class MassDiscSystemDeflection(_2385.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3333.MassDiscPowerFlow':
        ...
        return constructor.new(_3333.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
