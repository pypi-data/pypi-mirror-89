...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.data.measurement.ipLogging.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:DATA:MEASurement<MeasInstance>:IPLogging:STATe:ALL?', self.__class__.FetchStruct())
