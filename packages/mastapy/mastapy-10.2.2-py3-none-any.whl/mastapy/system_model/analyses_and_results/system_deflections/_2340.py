...
class PartToPartShearCouplingHalfSystemDeflection(_2290.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3339.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3339.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
