...
class Connect:
    ...
    def __init__(self, token: str):
        self.token = token
        self.base = 'http://nospamplus.cf'
        tokencheckurl = 'http://nospamplus.cf' + f'/tokencheck/?token={token}'
    ...
    def ban(self, user_id: int, reason: str):
        ...
        userid = user_id
        reason_is = reason
        banuserlink = 'http://nospamplus.cf' + f'/ban/?userid={userid}&ban_code={reason_is}&token={token}'
    ...
    def unban(self, user_id: int):
        ...
        token = self.token
        userid = user_id
        unbanurl = 'http://nospamplus.cf' + f'/unban/?userid={userid}&token={token}'
    ...
    def new_token(self, nospamplustoken: str):
        ...
        newtokenurl = 'http://nospamplus.cf' + f'/newtoken/?token={tokenz}&secrets={secret_token}'
    ...
    def is_banned(self, user_id: int):
        ...
        getbanurl = 'http://nospamplus.cf' + '/info/'
