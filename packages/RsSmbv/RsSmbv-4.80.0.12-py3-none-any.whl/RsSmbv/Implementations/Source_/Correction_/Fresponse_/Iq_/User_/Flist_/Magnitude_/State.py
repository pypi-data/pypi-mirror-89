...
class State:
	...
	def set(self, freq_corr_mag_stat: bool, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.correction.fresponse.iq.user.flist.magnitude.state.set(freq_corr_mag_stat = False, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> bool:
		"""SCPI: [SOURce<HW>]:CORRection:FRESponse:IQ:USER:FLISt<CH>:MAGNitude:[STATe] \n
		Snippet: value: bool = driver.source.correction.fresponse.iq.user.flist.magnitude.state.get(channel = repcap.Channel.Default) \n
		No command help available \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
