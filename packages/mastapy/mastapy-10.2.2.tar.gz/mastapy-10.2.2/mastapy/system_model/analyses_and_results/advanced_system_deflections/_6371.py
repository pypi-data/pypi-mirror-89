...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6403, _6405
...
class PowerLoadAdvancedSystemDeflection(_6405.VirtualComponentAdvancedSystemDeflection):
    '''PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2345.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2345.PowerLoadSystemDeflection))
        return value
