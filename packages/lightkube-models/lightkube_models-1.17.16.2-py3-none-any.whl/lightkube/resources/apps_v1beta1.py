...
class ControllerRevision(res.NamespacedResourceG, m_apps_v1beta1.ControllerRevisionList):
    """* **Extends**: ``models.apps_v1beta1.ControllerRevisionList``
...
class Deployment(res.NamespacedResourceG, m_apps_v1beta1.DeploymentList):
    """* **Extends**: ``models.apps_v1beta1.DeploymentList``
       * **Type**: Namespaced Resource
       * **Accepted client methods**: `delete`, `deletecollection`, `get`, `list` all, `watch` all, `list`, `patch`, `create`, `replace`, `watch`
