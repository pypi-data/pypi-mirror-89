...
#####################################################################
  ...
  ################################################################
  ## PassFilter (low-pass, band-pass, high-pass)
  ################################################################
class BandPassFilter(object):
  ...
  ################################################################
  ## Octave band filter (geometric filter)
  ################################################################
...
class MelSpectrogram(object):
    ...
    def show(self, savepath=None, H=2, dpi=72, ticks=False):
        if self.S is None:
            return
