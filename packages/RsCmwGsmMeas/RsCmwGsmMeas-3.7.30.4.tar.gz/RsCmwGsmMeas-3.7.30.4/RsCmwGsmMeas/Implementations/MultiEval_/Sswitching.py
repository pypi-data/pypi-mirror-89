...
class Sswitching:
	...
	def frequency(self):
		...
		if not hasattr(self, '_frequency'):
			from .Sswitching_.Frequency import Frequency
	...
	def fetch(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.multiEval.sswitching.fetch() \n
		Returns general spectrum switching results. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:GSM:MEASurement<Instance>:MEValuation:SSWitching?', self.__class__.ResultData())

	def read(self) -> ResultData:
		"""SCPI: READ:GSM:MEASurement<Instance>:MEValuation:SSWitching \n
		Snippet: value: ResultData = driver.multiEval.sswitching.read() \n
		Returns general spectrum switching results. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:GSM:MEASurement<Instance>:MEValuation:SSWitching?', self.__class__.ResultData())
