from rest_framework_simplejwt.views import TokenObtainPairView, TokenRefreshView as HolgerRefreshView
from rest_framework_simplejwt.serializers import TokenObtainPairSerializer


class HolgerTokenSerializer(TokenObtainPairSerializer):
...
class HolgerTokenObtainPairView(TokenObtainPairView):
    serializer_class = HolgerTokenSerializer
