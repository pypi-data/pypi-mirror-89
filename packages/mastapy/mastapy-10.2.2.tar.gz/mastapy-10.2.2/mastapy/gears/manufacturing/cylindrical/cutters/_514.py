...
class CylindricalGearRealCutterDesign(_507.CylindricalGearAbstractCutterDesign):
    ...
    @property
    def nominal_cutter_drawing(self) -> '_6556.SMTBitmap':
        ...
        return constructor.new(_6556.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
