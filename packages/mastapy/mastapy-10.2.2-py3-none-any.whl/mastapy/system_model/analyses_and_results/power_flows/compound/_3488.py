...
class StraightBevelGearCompoundPowerFlow(_3402.BevelGearCompoundPowerFlow):
    '''StraightBevelGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3367.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3367.StraightBevelGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3367.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3367.StraightBevelGearPowerFlow))
        return value
