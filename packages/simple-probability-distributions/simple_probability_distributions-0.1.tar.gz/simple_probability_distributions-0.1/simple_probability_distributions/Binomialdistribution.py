...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self, p = 0.5):
    ...
    def plot_bar(self):
        ...
        data = self.data
        x_axis = [0,1]
        y_axis = [data.count(0),data.count(1)]
        plt.bar(a_axis, y_axis)
    ...
    def plot_bar_pdf(self):
        ...
        x_axis = [i for i in range(self.n + 1)]
        y_axis = [self.pdf(i) for i in x_axis]
