...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6556.SMTBitmap':
        ...
        return constructor.new(_6556.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
