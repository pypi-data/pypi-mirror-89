...
[boto3.PersonalizeEvents 1.16.40](https://boto3.amazonaws.com/v1/documentation/api/1.16.40/reference/services/personalize-events.html#PersonalizeEvents) service
compatible with
