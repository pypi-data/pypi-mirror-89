...
class RcdError:
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .RcdError_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .RcdError_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .RcdError_.Maximum import Maximum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .RcdError_.StandardDev import StandardDev
	...
	def ocInfo(self):
		...
		if not hasattr(self, '_ocInfo'):
			from .RcdError_.OcInfo import OcInfo
			self._ocInfo = OcInfo(self._core, self._base)
		return self._ocInfo
