...
class FaceGearSystemDeflection(_2314.GearSystemDeflection):
    '''FaceGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3312.FaceGearPowerFlow':
        ...
        return constructor.new(_3312.FaceGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
