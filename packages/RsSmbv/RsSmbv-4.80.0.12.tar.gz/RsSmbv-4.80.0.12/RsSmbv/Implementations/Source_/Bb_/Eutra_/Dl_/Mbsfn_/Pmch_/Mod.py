...
class Mod:
	...
	def get(self, channel=repcap.Channel.Default) -> enums.ModulationD:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:MBSFn:PMCH<CH>:MOD \n
		Snippet: value: enums.ModulationD = driver.source.bb.eutra.dl.mbsfn.pmch.mod.get(channel = repcap.Channel.Default) \n
