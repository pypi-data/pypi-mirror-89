...
[boto3.SageMakerRuntime 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/sagemaker-runtime.html#SageMakerRuntime) service
compatible with
