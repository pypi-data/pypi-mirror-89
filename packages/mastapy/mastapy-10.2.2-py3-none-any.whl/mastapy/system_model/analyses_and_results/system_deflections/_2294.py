...
class CVTSystemDeflection(_2260.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3302.CVTPowerFlow':
        ...
        return constructor.new(_3302.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
