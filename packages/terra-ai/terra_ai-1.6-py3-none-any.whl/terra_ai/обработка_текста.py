...
def создать_выборки(maxWordsCount, xLen):
...
def тест_модели(нейронка, симптомы, классы):
  gastro_10_predict(нейронка, симптомы, классы)
  
def gastro_10_predict(нейронка, text_input = None, классы = None):
