...
class PostProcessing(Component):
    ...
    def train(self, training_data: TrainingData, config: Optional[RasaNLUModelConfig] = None, **kwargs: Any,):
        ...
        elif self.component_config["project"] == "display_diet_attribute":
            count = 5
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        elif self.component_config["project"] == "custom":
            self.post_process_custom(message)

    def post_process_custom(self, message):
