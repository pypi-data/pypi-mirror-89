...
import roccclient
from roccclient.models.challenge_filter import ChallengeFilter  # noqa: E501
from roccclient.rest import ApiException

class TestChallengeFilter(unittest.TestCase):
    """ChallengeFilter unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ChallengeFilter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = roccclient.models.challenge_filter.ChallengeFilter()  # noqa: E501
        if include_optional :
