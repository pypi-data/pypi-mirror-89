...
class Valid:
	...
	def get(self, stream=repcap.Stream.Default) -> List[int]:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID:GLONass<ST>:LIST:[VALid] \n
		Snippet: value: List[int] = driver.source.bb.gnss.svid.glonass.listPy.valid.get(stream = repcap.Stream.Default) \n
