...
def get_v(direcs={'ch4':'/home/gfeng/siesta/train/ch4'}):
    rn = ReaxFF(libfile='ffield',direcs=direcs, 
                dft='siesta',
                rc_scale='none',
                optword='all',
...
def get_spv(direcs={'ch4':'/home/gfeng/siesta/train/ch4'},batch=50):
    ...
    # ebond = rn.get_value(rn.ebond[mol])
    diffa  = rn.get_value(rn.bo)
    diffb  = rn.get_value(rn.bo0)
    diffe  = rn.get_value(rn.bop)
