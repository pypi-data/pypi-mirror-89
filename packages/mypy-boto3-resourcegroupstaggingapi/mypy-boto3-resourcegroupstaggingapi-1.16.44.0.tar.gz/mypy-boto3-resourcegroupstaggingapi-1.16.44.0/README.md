...
[boto3.ResourceGroupsTaggingAPI 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/resourcegroupstaggingapi.html#ResourceGroupsTaggingAPI) service
compatible with
