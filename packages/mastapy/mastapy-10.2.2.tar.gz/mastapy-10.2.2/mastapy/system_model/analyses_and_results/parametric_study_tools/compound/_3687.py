...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3729
...
class CVTPulleyCompoundParametricStudyTool(_3729.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
