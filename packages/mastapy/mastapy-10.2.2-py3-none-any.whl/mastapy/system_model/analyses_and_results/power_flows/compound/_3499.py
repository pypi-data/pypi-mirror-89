...
class TorqueConverterPumpCompoundPowerFlow(_3425.CouplingHalfCompoundPowerFlow):
    '''TorqueConverterPumpCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3378.TorqueConverterPumpPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3378.TorqueConverterPumpPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3378.TorqueConverterPumpPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3378.TorqueConverterPumpPowerFlow))
        return value
