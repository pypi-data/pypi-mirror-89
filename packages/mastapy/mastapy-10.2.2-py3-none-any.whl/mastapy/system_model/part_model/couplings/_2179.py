...
from mastapy.system_model.part_model.couplings import _2183, _2181
...
class Synchroniser(_2060.SpecialisedAssembly):
    ...
    @property
    def hub_and_sleeve(self) -> '_2183.SynchroniserSleeve':
        ...
        return constructor.new(_2183.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2181.SynchroniserHalf':
        ...
        return constructor.new(_2181.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2181.SynchroniserHalf':
        ...
        return constructor.new(_2181.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None
