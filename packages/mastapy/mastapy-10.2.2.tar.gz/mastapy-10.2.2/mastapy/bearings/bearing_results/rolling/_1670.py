...
from mastapy.bearings.bearing_results.rolling import _1669, _1658
...
class LoadedNeedleRollerBearingRow(_1658.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1669.LoadedNeedleRollerBearingResults':
        ...
        return constructor.new(_1669.LoadedNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
