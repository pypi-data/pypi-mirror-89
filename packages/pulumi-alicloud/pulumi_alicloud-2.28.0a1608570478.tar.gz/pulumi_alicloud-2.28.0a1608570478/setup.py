...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.28.0-alpha.1608570478+b68d5bac'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.28.0-alpha.1608570478+b68d5bac`
                """)
            else:
                raise
