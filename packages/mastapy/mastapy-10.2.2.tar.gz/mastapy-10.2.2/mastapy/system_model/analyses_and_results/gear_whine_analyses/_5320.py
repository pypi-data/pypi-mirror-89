...
class ClutchConnectionGearWhineAnalysis(_5337.CouplingConnectionGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2271.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2271.ClutchConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
