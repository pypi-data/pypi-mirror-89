...
class FreqOffset:
	"""FreqOffset commands group definition. 12 total commands, 4 Sub-groups, 0 group commands"""
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .FreqOffset_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .FreqOffset_.Average import Average
	...
	def extreme(self):
		...
		if not hasattr(self, '_extreme'):
			from .FreqOffset_.Extreme import Extreme
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .FreqOffset_.StandardDev import StandardDev
