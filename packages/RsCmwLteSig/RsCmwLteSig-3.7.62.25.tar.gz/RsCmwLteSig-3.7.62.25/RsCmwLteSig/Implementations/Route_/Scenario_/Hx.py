...
class Hx:
	...
	class FlexibleStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			...
			- Pcc_Tx_3_Conn: enums.TxConnector: No parameter help available
			- Pcc_Tx_3_Conv: enums.TxConverter: No parameter help available
			- Pcc_Tx_4_Conn: enums.TxConnector: No parameter help available
			- Pcc_Tx_4_Conv: enums.TxConverter: No parameter help available
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_enum('Pcc_Tx_3_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Pcc_Tx_3_Conv', enums.TxConverter),
			ArgStruct.scalar_enum('Pcc_Tx_4_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Pcc_Tx_4_Conv', enums.TxConverter),
		...
		def __init__(self):
			...
			self.Pcc_Tx_3_Conn: enums.TxConnector = None
			self.Pcc_Tx_3_Conv: enums.TxConverter = None
			self.Pcc_Tx_4_Conn: enums.TxConnector = None
			self.Pcc_Tx_4_Conv: enums.TxConverter = None
