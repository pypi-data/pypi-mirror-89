...
class All:
	...
	def fetch(self) -> List[enums.ResourceState]:
		"""SCPI: FETCh:UWB:MEASurement<Instance>:MEValuation:STATe:ALL \n
		Snippet: value: List[enums.ResourceState] = driver.uwbMeas.multiEval.state.all.fetch() \n
		...
		response = self._core.io.query_str(f'FETCh:UWB:MEASurement<Instance>:MEValuation:STATe:ALL?')
