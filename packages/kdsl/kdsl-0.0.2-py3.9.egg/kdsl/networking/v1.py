...
class NetworkPolicySpec(K8sObject):
    ...
    egress: Union[None, OmitEnum, Sequence[kdsl.networking.v1.NetworkPolicyEgressRule]] = attr.ib(metadata={'yaml_name': 'egress'}, converter=kdsl.networking.v1_converters.optional_list_converter_NetworkPolicyEgressRule, default=OMIT)
    ingress: Union[None, OmitEnum, Sequence[kdsl.networking.v1.NetworkPolicyIngressRule]] = attr.ib(metadata={'yaml_name': 'ingress'}, converter=kdsl.networking.v1_converters.optional_list_converter_NetworkPolicyIngressRule, default=OMIT)
...
class NetworkPolicy(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.networking.v1.NetworkPolicySpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.networking.v1_converters.optional_converter_NetworkPolicySpec, default=OMIT)


@attr.s(kw_only=True)
class NetworkPolicyIngressRule(K8sObject):
    from_: Union[None, OmitEnum, Sequence[kdsl.networking.v1.NetworkPolicyPeer]] = attr.ib(metadata={'yaml_name': 'from'}, converter=kdsl.networking.v1_converters.optional_list_converter_NetworkPolicyPeer, default=OMIT)
    ports: Union[None, OmitEnum, Sequence[kdsl.networking.v1.NetworkPolicyPort]] = attr.ib(metadata={'yaml_name': 'ports'}, converter=kdsl.networking.v1_converters.optional_list_converter_NetworkPolicyPort, default=OMIT)
...
class NetworkPolicyPeer(K8sObject):
    ipBlock: Union[None, OmitEnum, kdsl.networking.v1.IPBlock] = attr.ib(metadata={'yaml_name': 'ipBlock'}, converter=kdsl.networking.v1_converters.optional_converter_IPBlock, default=OMIT)
...
class NetworkPolicyEgressRule(K8sObject):
    ports: Union[None, OmitEnum, Sequence[kdsl.networking.v1.NetworkPolicyPort]] = attr.ib(metadata={'yaml_name': 'ports'}, converter=kdsl.networking.v1_converters.optional_list_converter_NetworkPolicyPort, default=OMIT)
    to: Union[None, OmitEnum, Sequence[kdsl.networking.v1.NetworkPolicyPeer]] = attr.ib(metadata={'yaml_name': 'to'}, converter=kdsl.networking.v1_converters.optional_list_converter_NetworkPolicyPeer, default=OMIT)
