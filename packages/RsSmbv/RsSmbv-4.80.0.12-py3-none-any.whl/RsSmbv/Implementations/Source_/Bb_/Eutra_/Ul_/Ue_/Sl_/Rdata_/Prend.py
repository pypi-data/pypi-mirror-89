...
class Prend:
	...
	def set(self, prb_end: int, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.rdata.prend.set(prb_end = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:RDATa:PRENd \n
		Snippet: value: int = driver.source.bb.eutra.ul.ue.sl.rdata.prend.get(stream = repcap.Stream.Default) \n
		Sets the parameters prb-Start and prb-End and define allocation of the two SL bands. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
