...
class Extreme:
	...
	def read(self) -> ResultData:
		"""SCPI: READ:NRSub:MEASurement<Instance>:MEValuation:ESFLatness:EXTReme \n
		Snippet: value: ResultData = driver.nrSubMeas.multiEval.esFlatness.extreme.read() \n
		...
		return self._core.io.query_struct(f'READ:NRSub:MEASurement<Instance>:MEValuation:ESFLatness:EXTReme?', self.__class__.ResultData())

	def fetch(self) -> ResultData:
		"""SCPI: FETCh:NRSub:MEASurement<Instance>:MEValuation:ESFLatness:EXTReme \n
		Snippet: value: ResultData = driver.nrSubMeas.multiEval.esFlatness.extreme.fetch() \n
		Return current, average, extreme and standard deviation single value results of the equalizer spectrum flatness
		measurement. See also 'Equalizer Spectrum Flatness Limits'. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:NRSub:MEASurement<Instance>:MEValuation:ESFLatness:EXTReme?', self.__class__.ResultData())
	...
	def calculate(self) -> CalculateStruct:
		"""SCPI: CALCulate:NRSub:MEASurement<Instance>:MEValuation:ESFLatness:EXTReme \n
		Snippet: value: CalculateStruct = driver.nrSubMeas.multiEval.esFlatness.extreme.calculate() \n
		...
		return self._core.io.query_struct(f'CALCulate:NRSub:MEASurement<Instance>:MEValuation:ESFLatness:EXTReme?', self.__class__.CalculateStruct())
