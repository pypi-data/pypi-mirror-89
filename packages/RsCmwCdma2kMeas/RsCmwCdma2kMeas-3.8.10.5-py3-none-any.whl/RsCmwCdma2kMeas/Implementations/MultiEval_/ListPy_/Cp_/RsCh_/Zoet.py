...
class Zoet:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("zoet", core, parent)

	@property
	def state(self):
		"""state commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_state'):
			from .Zoet_.State import State
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Zoet_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Zoet_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Zoet_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Zoet_.Minimum import Minimum
	...
	def clone(self) -> 'Zoet':
		...
		new_group = Zoet(self._core, self._base.parent)
