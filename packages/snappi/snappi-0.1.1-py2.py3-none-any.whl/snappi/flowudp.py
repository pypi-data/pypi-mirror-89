...
class FlowUdp(SnappiObject):
    ...
    def src_port(self):
        ...
        A container for packet header field patterns.Udp source port  
    ...
    def length(self):
        ...
        A container for packet header field patterns.Length in bytes of the udp header and yudp data  
        Max length is 2 bytes  
    ...
    def checksum(self):
        ...
        A container for packet header field patterns.Checksum field used for error checking of header and data  
        Max length is 2 bytes  
