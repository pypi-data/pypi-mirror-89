...
class Mbytes:
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GBAS:VDB<CH>:SCH:M2T<ST>:MBYTes \n
		Snippet: value: int = driver.source.bb.gbas.vdb.sch.m2T.mbytes.get(channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
