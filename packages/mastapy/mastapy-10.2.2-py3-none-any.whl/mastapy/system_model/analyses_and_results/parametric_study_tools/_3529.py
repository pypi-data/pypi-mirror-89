...
class ClutchHalfParametricStudyTool(_3545.CouplingHalfParametricStudyTool):
    '''ClutchHalfParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2272.ClutchHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2272.ClutchHalfSystemDeflection))
        return value
