...
class ConnectorSystemDeflection(_2335.MountableComponentSystemDeflection):
    '''ConnectorSystemDeflection
    ...
    @property
    def outer_imported_fe(self) -> '_2319.ImportedFEComponentSystemDeflection':
        ...
        return constructor.new(_2319.ImportedFEComponentSystemDeflection)(self.wrapped.OuterImportedFE) if self.wrapped.OuterImportedFE else None
    ...
    @property
    def power_flow_results(self) -> '_3297.ConnectorPowerFlow':
