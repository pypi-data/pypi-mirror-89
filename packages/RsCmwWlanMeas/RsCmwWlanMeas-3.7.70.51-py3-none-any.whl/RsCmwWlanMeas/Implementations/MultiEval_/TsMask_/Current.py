...
class Current:
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			...
			- Margin: List[float]: float Comma-separated list of margin values, one value per spectrum mask area The number of margin values depends on the selected standard, see Table 'Spectrum mask areas'. Range: -100 dB to 100 dB"""
		__meta_args_list = [
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Margin: List[enums.ResultStatus2]: float Comma-separated list of margin values, one value per spectrum mask area The number of margin values depends on the selected standard, see Table 'Spectrum mask areas'. Range: -100 dB to 100 dB"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
