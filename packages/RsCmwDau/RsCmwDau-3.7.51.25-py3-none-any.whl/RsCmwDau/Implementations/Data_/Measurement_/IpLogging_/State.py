...
class State:
	...
	def fetch(self) -> enums.ResourceState:
		...
		Snippet: value: enums.ResourceState = driver.data.measurement.ipLogging.state.fetch() \n
		...
		response = self._core.io.query_str(f'FETCh:DATA:MEASurement<MeasInstance>:IPLogging:STATe?')
