...
class Ioffset:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:QZSS<ST>:UTC:IOFFset \n
		Snippet: value: int = driver.source.bb.gnss.time.conversion.qzss.utc.ioffset.get(stream = repcap.Stream.Default) \n
