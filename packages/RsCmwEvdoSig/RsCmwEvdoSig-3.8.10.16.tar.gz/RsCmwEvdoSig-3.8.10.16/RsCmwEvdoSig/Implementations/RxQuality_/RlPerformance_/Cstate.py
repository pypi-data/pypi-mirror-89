...
class Cstate:
	...
	def fetch(self) -> List[enums.CarrierStatus]:
		...
		Snippet: value: List[enums.CarrierStatus] = driver.rxQuality.rlPerformance.cstate.fetch() \n
		...
		response = self._core.io.query_str_suppressed(f'FETCh:EVDO:SIGNaling<Instance>:RXQuality:RLPFormance:CSTate?', suppressed)
