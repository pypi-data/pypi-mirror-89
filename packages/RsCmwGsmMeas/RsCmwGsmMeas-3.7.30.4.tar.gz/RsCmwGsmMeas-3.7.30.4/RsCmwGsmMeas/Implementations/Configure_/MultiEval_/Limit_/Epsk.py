...
class Epsk:
	...
	def powerVsTime(self):
		...
		if not hasattr(self, '_powerVsTime'):
			from .Epsk_.PowerVsTime import PowerVsTime
	...
	def smodulation(self):
		...
		if not hasattr(self, '_smodulation'):
			from .Epsk_.Smodulation import Smodulation
	...
	def sswitching(self):
		...
		if not hasattr(self, '_sswitching'):
			from .Epsk_.Sswitching import Sswitching
	...
	def get_ev_magnitude(self) -> EvMagnitudeStruct:
		...
		Snippet: value: EvMagnitudeStruct = driver.configure.multiEval.limit.epsk.get_ev_magnitude() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:EVMagnitude?', self.__class__.EvMagnitudeStruct())

	def set_ev_magnitude(self, value: EvMagnitudeStruct) -> None:
		"""SCPI: CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:EVMagnitude \n
		Snippet: driver.configure.multiEval.limit.epsk.set_ev_magnitude(value = EvMagnitudeStruct()) \n
		Defines and activates upper limits for the RMS, peak and 95th percentile values of the error vector magnitude (EVM) . \n
			:param value: see the help for EvMagnitudeStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:EVMagnitude', value)
	...
	def get_merror(self) -> MerrorStruct:
		...
		Snippet: value: MerrorStruct = driver.configure.multiEval.limit.epsk.get_merror() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:MERRor?', self.__class__.MerrorStruct())

	def set_merror(self, value: MerrorStruct) -> None:
		"""SCPI: CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:MERRor \n
		Snippet: driver.configure.multiEval.limit.epsk.set_merror(value = MerrorStruct()) \n
		Defines and activates upper limits for the RMS, peak and 95th percentile values of the magnitude error. \n
			:param value: see the help for MerrorStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:MERRor', value)
	...
	def get_perror(self) -> PerrorStruct:
		...
		Snippet: value: PerrorStruct = driver.configure.multiEval.limit.epsk.get_perror() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:PERRor?', self.__class__.PerrorStruct())

	def set_perror(self, value: PerrorStruct) -> None:
		"""SCPI: CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:PERRor \n
		Snippet: driver.configure.multiEval.limit.epsk.set_perror(value = PerrorStruct()) \n
		Defines and activates upper limits for the RMS, peak and 95th percentile values of the phase error. \n
			:param value: see the help for PerrorStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:PERRor', value)
	...
	def get_iq_offset(self) -> IqOffsetStruct:
		...
		Snippet: value: IqOffsetStruct = driver.configure.multiEval.limit.epsk.get_iq_offset() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:IQOFfset?', self.__class__.IqOffsetStruct())

	def set_iq_offset(self, value: IqOffsetStruct) -> None:
		"""SCPI: CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:IQOFfset \n
		Snippet: driver.configure.multiEval.limit.epsk.set_iq_offset(value = IqOffsetStruct()) \n
		Defines and activates upper limits for the I/Q origin offset values. \n
			:param value: see the help for IqOffsetStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:IQOFfset', value)
	...
	def get_iq_imbalance(self) -> IqImbalanceStruct:
		...
		Snippet: value: IqImbalanceStruct = driver.configure.multiEval.limit.epsk.get_iq_imbalance() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:IQIMbalance?', self.__class__.IqImbalanceStruct())

	def set_iq_imbalance(self, value: IqImbalanceStruct) -> None:
		"""SCPI: CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:IQIMbalance \n
		Snippet: driver.configure.multiEval.limit.epsk.set_iq_imbalance(value = IqImbalanceStruct()) \n
		Defines and activates upper limits for the I/Q imbalance values. \n
			:param value: see the help for IqImbalanceStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:IQIMbalance', value)
	...
	def get_terror(self) -> TerrorStruct:
		...
		Snippet: value: TerrorStruct = driver.configure.multiEval.limit.epsk.get_terror() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:TERRor?', self.__class__.TerrorStruct())

	def set_terror(self, value: TerrorStruct) -> None:
		"""SCPI: CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:TERRor \n
		Snippet: driver.configure.multiEval.limit.epsk.set_terror(value = TerrorStruct()) \n
		Defines and activates upper limits for the timing error. \n
			:param value: see the help for TerrorStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:TERRor', value)
	...
	def get_freq_error(self) -> FreqErrorStruct:
		...
		Snippet: value: FreqErrorStruct = driver.configure.multiEval.limit.epsk.get_freq_error() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:FERRor?', self.__class__.FreqErrorStruct())

	def set_freq_error(self, value: FreqErrorStruct) -> None:
		"""SCPI: CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:FERRor \n
		Snippet: driver.configure.multiEval.limit.epsk.set_freq_error(value = FreqErrorStruct()) \n
		Defines and activates upper limits for the frequency error. \n
			:param value: see the help for FreqErrorStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:GSM:MEASurement<Instance>:MEValuation:LIMit:EPSK:FERRor', value)

	def clone(self) -> 'Epsk':
		"""Clones the group by creating new object from it and its whole existing sub-groups
		Also copies all the existing default Repeated Capabilities setting,
		which you can change independently without affecting the original group"""
		new_group = Epsk(self._core, self._base.parent)
