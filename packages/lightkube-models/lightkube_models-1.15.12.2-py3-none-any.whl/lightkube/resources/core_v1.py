...
class ComponentStatus(res.GlobalResource, m_core_v1.ComponentStatusList):
    """* **Extends**: ``models.core_v1.ComponentStatusList``
...
class ConfigMap(res.NamespacedResourceG, m_core_v1.ConfigMapList):
    """* **Extends**: ``models.core_v1.ConfigMapList``
...
class Endpoints(res.NamespacedResourceG, m_core_v1.EndpointsList):
    """* **Extends**: ``models.core_v1.EndpointsList``
       * **Type**: Namespaced Resource
       * **Accepted client methods**: `delete`, `deletecollection`, `get`, `list` all, `watch` all, `list`, `patch`, `create`, `replace`, `watch`
    """
    _api_info = res.ApiInfo(
...
class Event(res.NamespacedResourceG, m_core_v1.EventList):
    """* **Extends**: ``models.core_v1.EventList``
       * **Type**: Namespaced Resource
       * **Accepted client methods**: `delete`, `deletecollection`, `get`, `list` all, `watch` all, `list`, `patch`, `create`, `replace`, `watch`
    """
    _api_info = res.ApiInfo(
...
class LimitRange(res.NamespacedResourceG, m_core_v1.LimitRangeList):
    """* **Extends**: ``models.core_v1.LimitRangeList``
       * **Type**: Namespaced Resource
       * **Accepted client methods**: `delete`, `deletecollection`, `get`, `list` all, `watch` all, `list`, `patch`, `create`, `replace`, `watch`
    """
    _api_info = res.ApiInfo(
