...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3887, _3886, _3822
...
class WormGearSetModalAnalysesAtStiffnesses(_3822.GearSetModalAnalysesAtStiffnesses):
    '''WormGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def worm_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3887.WormGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysesAtStiffnesses, constructor.new(_3887.WormGearModalAnalysesAtStiffnesses))
        return value

    @property
    def worm_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3886.WormGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysesAtStiffnesses, constructor.new(_3886.WormGearMeshModalAnalysesAtStiffnesses))
        return value
