...
class PartToPartShearCouplingParametricStudyTool(_3546.CouplingParametricStudyTool):
    '''PartToPartShearCouplingParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2341.PartToPartShearCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2341.PartToPartShearCouplingSystemDeflection))
        return value
