...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3132, _3130, _3064
...
class WormGearSetSteadyStateSynchronousResponse(_3064.GearSetSteadyStateSynchronousResponse):
    '''WormGearSetSteadyStateSynchronousResponse
    ...
    @property
    def worm_gears_steady_state_synchronous_response(self) -> 'List[_3132.WormGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSteadyStateSynchronousResponse, constructor.new(_3132.WormGearSteadyStateSynchronousResponse))
        return value

    @property
    def worm_meshes_steady_state_synchronous_response(self) -> 'List[_3130.WormGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSteadyStateSynchronousResponse, constructor.new(_3130.WormGearMeshSteadyStateSynchronousResponse))
        return value
