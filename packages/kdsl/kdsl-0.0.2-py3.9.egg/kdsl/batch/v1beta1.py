...
class CronJob(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.batch.v1beta1.CronJobSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.batch.v1beta1_converters.optional_converter_CronJobSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.batch.v1beta1.CronJobStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.batch.v1beta1_converters.optional_converter_CronJobStatus, default=OMIT)


@attr.s(kw_only=True)
class CronJobSpec(K8sObject):
    jobTemplate: kdsl.batch.v1beta1.JobTemplateSpec = attr.ib(metadata={'yaml_name': 'jobTemplate'}, converter=kdsl.batch.v1beta1_converters.required_converter_JobTemplateSpec)
