...
from mastapy.system_model.analyses_and_results.power_flows import _3307, _3342
from mastapy.gears.rating.cylindrical import _262
from mastapy.gears.manufacturing.cylindrical import _404
from mastapy.system_model.analyses_and_results.system_deflections import _2301, _2295, _2313
...
class CylindricalGearSetSystemDeflection(_2313.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3307.CylindricalGearSetPowerFlow':
    ...
    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2301.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2301.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2295.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2295.CylindricalGearMeshSystemDeflection))
        return value
