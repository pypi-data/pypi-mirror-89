...
class Modulation:
	...
	def set(self, modulation: enums.ModulationC, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.up.cell.enh.dch.hsupa.modulation.set(modulation = enums.ModulationC.QAM16, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> enums.ModulationC:
		"""SCPI: [SOURce<HW>]:BB:TDSCdma:UP:CELL<ST>:ENH:DCH:HSUPA:MODulation \n
		Snippet: value: enums.ModulationC = driver.source.bb.tdscdma.up.cell.enh.dch.hsupa.modulation.get(stream = repcap.Stream.Default) \n
		Sets the modulation scheme for each HSDPA RMC or HSUPA FRC. The HSUPA FRCs do not support modulation scheme 64QAM. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cell')
