...
class Parameter:
	...
	def get_apco_25(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:APCO25 \n
		Snippet: value: float = driver.source.bb.wlan.filterPy.parameter.get_apco_25() \n
	...
	def set_apco_25(self, apco_25: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:APCO25 \n
		Snippet: driver.source.bb.wlan.filterPy.parameter.set_apco_25(apco_25 = 1.0) \n
		No command help available \n
	...
	def get_cosine(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:COSine \n
		Snippet: value: float = driver.source.bb.wlan.filterPy.parameter.get_cosine() \n
		No command help available \n
	...
	def set_cosine(self, cosine: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:COSine \n
		Snippet: driver.source.bb.wlan.filterPy.parameter.set_cosine(cosine = 1.0) \n
		No command help available \n
	...
	def get_gauss(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:GAUSs \n
		Snippet: value: float = driver.source.bb.wlan.filterPy.parameter.get_gauss() \n
		No command help available \n
	...
	def set_gauss(self, gauss: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:GAUSs \n
		Snippet: driver.source.bb.wlan.filterPy.parameter.set_gauss(gauss = 1.0) \n
		No command help available \n
	...
	def get_lpass_evm(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:LPASSEVM \n
		Snippet: value: float = driver.source.bb.wlan.filterPy.parameter.get_lpass_evm() \n
		No command help available \n
	...
	def set_lpass_evm(self, lpassevm: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:LPASSEVM \n
		Snippet: driver.source.bb.wlan.filterPy.parameter.set_lpass_evm(lpassevm = 1.0) \n
		No command help available \n
	...
	def get_lpass(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:LPASs \n
		Snippet: value: float = driver.source.bb.wlan.filterPy.parameter.get_lpass() \n
		No command help available \n
	...
	def set_lpass(self, lpass: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:LPASs \n
		Snippet: driver.source.bb.wlan.filterPy.parameter.set_lpass(lpass = 1.0) \n
		No command help available \n
	...
	def get_pgauss(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:PGAuss \n
		Snippet: value: float = driver.source.bb.wlan.filterPy.parameter.get_pgauss() \n
		No command help available \n
	...
	def set_pgauss(self, pgauss: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:PGAuss \n
		Snippet: driver.source.bb.wlan.filterPy.parameter.set_pgauss(pgauss = 1.0) \n
		No command help available \n
	...
	def get_rcosine(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:RCOSine \n
		Snippet: value: float = driver.source.bb.wlan.filterPy.parameter.get_rcosine() \n
		No command help available \n
	...
	def set_rcosine(self, rcosine: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:RCOSine \n
		Snippet: driver.source.bb.wlan.filterPy.parameter.set_rcosine(rcosine = 1.0) \n
		No command help available \n
	...
	def get_sphase(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:SPHase \n
		Snippet: value: float = driver.source.bb.wlan.filterPy.parameter.get_sphase() \n
		No command help available \n
	...
	def set_sphase(self, sphase: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLAN:FILTer:PARameter:SPHase \n
		Snippet: driver.source.bb.wlan.filterPy.parameter.set_sphase(sphase = 1.0) \n
		No command help available \n
