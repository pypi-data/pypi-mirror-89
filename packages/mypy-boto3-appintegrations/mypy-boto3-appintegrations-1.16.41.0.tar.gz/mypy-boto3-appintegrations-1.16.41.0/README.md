...
[boto3.AppIntegrationsService 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/appintegrations.html#AppIntegrationsService) service
compatible with
