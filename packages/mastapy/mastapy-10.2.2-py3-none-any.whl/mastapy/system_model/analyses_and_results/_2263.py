...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_7150.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2293.DesignEntityAnalysis') -> '_2293.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
