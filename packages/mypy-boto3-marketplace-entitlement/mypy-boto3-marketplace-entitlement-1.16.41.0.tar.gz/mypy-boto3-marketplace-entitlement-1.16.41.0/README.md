...
[boto3.MarketplaceEntitlementService 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
compatible with
