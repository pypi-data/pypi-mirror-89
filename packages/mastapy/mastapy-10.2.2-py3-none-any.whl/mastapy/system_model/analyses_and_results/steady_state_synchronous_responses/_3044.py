...
class ConnectionSteadyStateSynchronousResponse(_6539.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3109.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3109.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse else None
