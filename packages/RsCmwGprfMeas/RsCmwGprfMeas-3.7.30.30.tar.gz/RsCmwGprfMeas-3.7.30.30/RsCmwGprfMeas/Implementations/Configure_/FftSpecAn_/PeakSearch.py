...
class PeakSearch:
	...
	def get_noa_markers(self) -> int:
		...
		Defines the number of active markers for the peak search (see method RsCmwGprfMeas.Configure.FftSpecAn.PeakSearch.value) . \n
	...
	class ValueStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			- Full_Span_Enable_0: bool: No parameter help available
			- Peak_Range_From_0: float: No parameter help available
			- Peak_Range_To_0: float: No parameter help available
			- Full_Span_Enable_1: bool: No parameter help available
			- Peak_Range_From_1: float: No parameter help available
			- Peak_Range_To_1: float: No parameter help available
			- Full_Span_Enable_2: bool: No parameter help available
			- Peak_Range_From_2: float: No parameter help available
			- Peak_Range_To_2: float: No parameter help available
			- Full_Span_Enable_3: bool: No parameter help available
			- Peak_Range_From_3: float: No parameter help available
			- Peak_Range_To_3: float: No parameter help available
			- Full_Span_Enable_4: bool: No parameter help available
	...
	def get_value(self) -> ValueStruct:
		...
		Defines the peak search ranges. The search ranges are automatically adjusted if the frequency span fs is reduced (see
		method RsCmwGprfMeas.Configure.FftSpecAn.fspan) . Range settings beyond the number of active markers (see method
		RsCmwGprfMeas.Configure.FftSpecAn.PeakSearch.noaMarkers) are ignored. \n
	...
	def set_value(self, value: ValueStruct) -> None:
		"""SCPI: CONFigure:GPRF:MEASurement<Instance>:FFTSanalyzer:PSEarch \n
		Snippet: driver.configure.fftSpecAn.peakSearch.set_value(value = ValueStruct()) \n
		Defines the peak search ranges. The search ranges are automatically adjusted if the frequency span fs is reduced (see
		method RsCmwGprfMeas.Configure.FftSpecAn.fspan) . Range settings beyond the number of active markers (see method
		RsCmwGprfMeas.Configure.FftSpecAn.PeakSearch.noaMarkers) are ignored. \n
