...
INSERT IGNORE INTO `fs_tns_files` (`TNSId`,`dateObs`,`filename`,`spec1phot2`,`url`, dateCreated) VALUES ("2016fbz" ,"2016-08-27 14:24:00" ,"tns_2016fbz_2016-08-27.60_BAO-2.16m_Phot-spec.txt" ,"1" ,"https://wis-tns.weizmann.ac.il/system/files/uploaded/general/tns_2016fbz_2016-08-27.60_BAO-2.16m_Phot-spec.txt", NOW())  ON DUPLICATE KEY UPDATE  `TNSId`="2016fbz", `dateObs`="2016-08-27 14:24:00", `filename`="tns_2016fbz_2016-08-27.60_BAO-2.16m_Phot-spec.txt", `spec1phot2`="1", `url`="https://wis-tns.weizmann.ac.il/system/files/uploaded/general/tns_2016fbz_2016-08-27.60_BAO-2.16m_Phot-spec.txt" ;