...
[boto3.CodeStarconnections 1.16.40](https://boto3.amazonaws.com/v1/documentation/api/1.16.40/reference/services/codestar-connections.html#CodeStarconnections) service
compatible with
