...
class Current:
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			...
			- Eutraneg: float: Power in the first E-UTRA channel with lower frequency Unit: dBm
			- Eutra: float: Power in the allocated E-UTRA channel Unit: dBm
			- Eutrapos: float: Power in the first E-UTRA channel with higher frequency Unit: dBm
