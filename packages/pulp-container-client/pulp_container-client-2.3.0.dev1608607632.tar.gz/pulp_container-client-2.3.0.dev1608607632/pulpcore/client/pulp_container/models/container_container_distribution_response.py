...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, base_path=None, repository=None, content_guard=None, name=None, pulp_href=None, pulp_created=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
