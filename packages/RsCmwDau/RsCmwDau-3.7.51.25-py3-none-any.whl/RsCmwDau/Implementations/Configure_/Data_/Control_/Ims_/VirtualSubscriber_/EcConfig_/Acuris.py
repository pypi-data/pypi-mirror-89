...
class Acuris:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("acuris", core, parent)
	...
	class SetStruct(StructBase):
		...
		def __init__(self):
			...
			self.Uri_Value_1: str = None
			self.Uri_Value_2: str = None
			self.Uri_Value_3: str = None
			self.Uri_Value_4: str = None
			self.Uri_Value_5: str = None
			self.Uri_Value_6: str = None
			self.Uri_Value_7: str = None
			self.Uri_Value_8: str = None
			self.Uri_Value_9: str = None
			self.Uri_Value_10: str = None
			self.Uri_Value_11: str = None
			self.Uri_Value_12: str = None
			self.Uri_Value_13: str = None
			self.Uri_Value_14: str = None
			self.Uri_Value_15: str = None
			self.Uri_Value_16: str = None
	...
	def set(self, structure: SetStruct, ims=repcap.Ims.Default, virtualSubscriber=repcap.VirtualSubscriber.Default) -> None:
		...
		Snippet: driver.configure.data.control.ims.virtualSubscriber.ecConfig.acuris.set(value = [PROPERTY_STRUCT_NAME](), ims = repcap.Ims.Default, virtualSubscriber = repcap.VirtualSubscriber.Default) \n
		...
		self._core.io.write_struct(f'CONFigure:DATA:CONTrol:IMS{ims_cmd_val}:VIRTualsub{virtualSubscriber_cmd_val}:ECConfig:ACURis', structure)
