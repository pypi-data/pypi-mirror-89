...
class ExternalCADModelParametricStudyTool(_3532.ComponentParametricStudyTool):
    '''ExternalCADModelParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2306.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2306.ExternalCADModelSystemDeflection))
        return value
