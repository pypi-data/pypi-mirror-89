...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.whine_analyses_results import _5452
from mastapy.system_model.analyses_and_results.modal_analyses import _4823
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5416, _5365
...
class GearWhineAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5452.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5452.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4823.ModalAnalysisOptions':
        ...
        return constructor.new(_4823.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
