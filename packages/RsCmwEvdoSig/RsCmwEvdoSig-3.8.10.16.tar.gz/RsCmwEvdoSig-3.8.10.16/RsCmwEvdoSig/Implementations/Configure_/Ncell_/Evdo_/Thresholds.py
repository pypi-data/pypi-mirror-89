...
class Thresholds:
	...
	def get_low(self) -> int:
		...
		"""
		response = self._core.io.query_str('CONFigure:EVDO:SIGNaling<Instance>:NCELl:EVDO:THResholds:LOW?')
	...
	def set_low(self, low: int) -> None:
		...
		self._core.io.write(f'CONFigure:EVDO:SIGNaling<Instance>:NCELl:EVDO:THResholds:LOW {param}')
	...
	def get_value(self) -> ValueStruct:
		...
		"""
		return self._core.io.query_struct('CONFigure:EVDO:SIGNaling<Instance>:NCELl:EVDO:THResholds?', self.__class__.ValueStruct())
	...
	def set_value(self, value: ValueStruct) -> None:
		...
		"""
		self._core.io.write_struct('CONFigure:EVDO:SIGNaling<Instance>:NCELl:EVDO:THResholds', value)
