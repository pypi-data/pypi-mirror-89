...
class Wpow:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("wpow", core, parent)

	@property
	def current(self):
		"""current commands group. 0 Sub-classes, 2 commands."""
		if not hasattr(self, '_current'):
			from .Wpow_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Wpow_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Wpow_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Wpow_.Minimum import Minimum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .Wpow_.StandardDev import StandardDev
	...
	def clone(self) -> 'Wpow':
		...
		new_group = Wpow(self._core, self._base.parent)
