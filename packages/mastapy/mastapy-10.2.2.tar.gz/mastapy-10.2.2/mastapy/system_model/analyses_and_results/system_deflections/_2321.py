...
class KlingelnbergCycloPalloidConicalGearMeshSystemDeflection(_2284.ConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3324.KlingelnbergCycloPalloidConicalGearMeshPowerFlow':
