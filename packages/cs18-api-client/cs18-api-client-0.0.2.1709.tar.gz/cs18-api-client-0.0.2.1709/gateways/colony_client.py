...
class Colony:
    ...
    def add_account_blueprint_repository_to_space(
            self,
            deployment_type: str,
            space_name: str,
        ...
        if deployment_type.lower() == "sandbox":
            method_url = self._api_root.spaces.sandbox_repository_space(space_name)
        else:
            method_url = self._api_root.spaces.production_repository_space(space_name)
    ...
    def get_blueprint_repository_space(
            self,
            deployment_type: str,
            space_name: str):
    ...
    def delete_blueprint_repository_from_space(
            self,
            deployment_type: str,
            space_name: str):
