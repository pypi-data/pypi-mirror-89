...
class FlowGtpv2(SnappiObject):
    ...
    def version(self):
        ...
        A container for packet header field patterns.It is a 3-bit field  
    ...
    def teid_flag(self):
        ...
        A container for packet header field patterns.If this bit is set to 1 then the TEID field will be present between the message length and the sequence number  
    ...
    def message_type(self):
        ...
        A container for packet header field patterns.An 8-bit field that indicates the type of GTP message  
    ...
    def message_length(self):
        ...
        A container for packet header field patterns.A 16-bit field that indicates the length of the payload in bytes (excluding the mandatory GTP-c header (first 4 bytes)  
    ...
    def teid(self):
        ...
        A container for packet header field patterns.Tunnel endpoint identifier  
