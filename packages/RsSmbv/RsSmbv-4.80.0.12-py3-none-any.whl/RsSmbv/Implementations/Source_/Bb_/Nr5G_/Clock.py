...
class Clock:
	...
	def get_mode(self) -> enums.Nr5GclocMode:
		...
		Snippet: value: enums.Nr5GclocMode = driver.source.bb.nr5G.clock.get_mode() \n
	...
	def set_mode(self, clock_mode: enums.Nr5GclocMode) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:CLOCk:MODE \n
		Snippet: driver.source.bb.nr5G.clock.set_mode(clock_mode = enums.Nr5GclocMode.SAMPle) \n
		No command help available \n
	...
	def set_source(self, clock_sour: enums.ClockSourceC) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:CLOCk:SOURce \n
		Snippet: driver.source.bb.nr5G.clock.set_source(clock_sour = enums.ClockSourceC.ELCLock) \n
			INTRO_CMD_HELP: Selects the clock source: \n
			- INTernal: Internal clock reference \n
