...
class PulleyParametricStudyTool(_3545.CouplingHalfParametricStudyTool):
    '''PulleyParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2346.PulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2346.PulleySystemDeflection))
        return value
