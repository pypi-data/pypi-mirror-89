...
[boto3.MarketplaceEntitlementService 1.16.40](https://boto3.amazonaws.com/v1/documentation/api/1.16.40/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
compatible with
