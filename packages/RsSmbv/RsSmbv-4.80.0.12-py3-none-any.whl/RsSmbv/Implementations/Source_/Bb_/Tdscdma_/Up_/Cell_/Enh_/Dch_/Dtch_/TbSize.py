...
class TbSize:
	...
	def set(self, tb_size: int, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.up.cell.enh.dch.dtch.tbSize.set(tb_size = 1, stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
	...
	def get(self, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:TDSCdma:UP:CELL<ST>:ENH:DCH:DTCH<CH>:TBSize \n
		Snippet: value: int = driver.source.bb.tdscdma.up.cell.enh.dch.dtch.tbSize.get(stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
		Sets the size of the transport block at the channel coding input. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cell')
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Dtch')
