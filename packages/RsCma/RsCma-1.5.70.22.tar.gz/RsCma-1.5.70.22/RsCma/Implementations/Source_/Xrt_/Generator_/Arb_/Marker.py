...
class Marker:
	...
	def get_delays(self) -> DelaysStruct:
		"""SCPI: SOURce:XRT:GENerator<Instance>:ARB:MARKer:DELays \n
		Snippet: value: DelaysStruct = driver.source.xrt.generator.arb.marker.get_delays() \n
		No command help available \n
			:return: structure: for return value, see the help for DelaysStruct structure arguments.
		"""
		return self._core.io.query_struct('SOURce:XRT:GENerator<Instance>:ARB:MARKer:DELays?', self.__class__.DelaysStruct())

	def set_delays(self, value: DelaysStruct) -> None:
		"""SCPI: SOURce:XRT:GENerator<Instance>:ARB:MARKer:DELays \n
		Snippet: driver.source.xrt.generator.arb.marker.set_delays(value = DelaysStruct()) \n
		No command help available \n
			:param value: see the help for DelaysStruct structure arguments.
		"""
		self._core.io.write_struct('SOURce:XRT:GENerator<Instance>:ARB:MARKer:DELays', value)
