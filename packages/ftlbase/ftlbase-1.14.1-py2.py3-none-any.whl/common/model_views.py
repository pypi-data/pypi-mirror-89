...
from django.urls import re_path, reverse_lazy, reverse
...
class URLGenerator(object):
    ...
    def __init__(self, model, form_class=None, form_table=None, view_prefix=None, cancel_url=None,
                 ...
                 createview_cls=CreateView, updateview_cls=UpdateView, deleteview_cls=DeleteView,
                 detailview_cls=DetailView, listview_cls=ListView):
        """
        ...
        self.createview_cls = createview_cls
        self.updateview_cls = updateview_cls
        self.deleteview_cls = deleteview_cls
