...
class Offset:
	...
	def get(self, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:STARt:GALileo<ST>:OFFSet \n
		Snippet: value: float = driver.source.bb.gnss.time.start.galileo.offset.get(stream = repcap.Stream.Default) \n
