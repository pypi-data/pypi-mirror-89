...
class ConnectionModalAnalysesAtStiffnesses(_6539.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtStiffnesses
    ...
    @property
    def modal_analyses_at_stiffnesses(self) -> '_3806.CriticalSpeedAnalysis':
        ...
        return constructor.new(_3806.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnesses) if self.wrapped.ModalAnalysesAtStiffnesses else None
