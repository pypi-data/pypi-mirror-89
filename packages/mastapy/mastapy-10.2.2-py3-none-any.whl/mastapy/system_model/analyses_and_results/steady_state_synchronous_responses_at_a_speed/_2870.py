...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _2871, _2869, _2783
...
class StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed(_2783.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    '''StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_2871.StraightBevelGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSteadyStateSynchronousResponseAtASpeed, constructor.new(_2871.StraightBevelGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def straight_bevel_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_2869.StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSteadyStateSynchronousResponseAtASpeed, constructor.new(_2869.StraightBevelGearMeshSteadyStateSynchronousResponseAtASpeed))
        return value
