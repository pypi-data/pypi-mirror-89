...
class GuideDxfModelSystemDeflection(_2275.ComponentSystemDeflection):
    '''GuideDxfModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3318.GuideDxfModelPowerFlow':
        ...
        return constructor.new(_3318.GuideDxfModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
