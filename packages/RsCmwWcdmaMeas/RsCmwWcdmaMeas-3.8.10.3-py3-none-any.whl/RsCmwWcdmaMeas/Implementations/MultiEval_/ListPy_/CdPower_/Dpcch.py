...
class Dpcch:
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Dpcch_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Dpcch_.Average import Average
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Dpcch_.Minimum import Minimum
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Dpcch_.Maximum import Maximum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .Dpcch_.StandardDev import StandardDev
