...
class PlanetaryConnectionModalAnalysis(_4844.ShaftToMountableComponentConnectionModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2342.PlanetaryConnectionSystemDeflection':
        ...
        return constructor.new(_2342.PlanetaryConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
