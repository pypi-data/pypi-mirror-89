...
class Rmessage:
	...
	def get_all(self) -> List[str]:
		...
		Snippet: value: List[str] = driver.source.sequencer.apool.rmessage.get_all() \n
	...
	def get(self, index: int) -> str:
		...
		Snippet: value: str = driver.source.sequencer.apool.rmessage.get(index = 1) \n
		Queries the reliability message for the ARB file with the specified <Index>. For possible values, see 'Reliability
		Indicator'. \n
			:param index: String with the reliability message
			:return: reliability_msg: String with the reliability message"""
