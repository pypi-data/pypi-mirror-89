...
class StraightBevelGearParametricStudyTool(_3524.BevelGearParametricStudyTool):
    '''StraightBevelGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2368.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2368.StraightBevelGearSystemDeflection))
        return value
