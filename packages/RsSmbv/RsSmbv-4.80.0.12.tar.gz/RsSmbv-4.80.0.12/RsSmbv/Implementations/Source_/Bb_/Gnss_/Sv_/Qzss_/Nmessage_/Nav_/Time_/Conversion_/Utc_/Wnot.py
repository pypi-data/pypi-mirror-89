...
class Wnot:
	...
	def set(self, wnot: int, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:QZSS<ST>:NMESsage:NAV:TIME:CONVersion:UTC<CH>:WNOT \n
		Snippet: driver.source.bb.gnss.sv.qzss.nmessage.nav.time.conversion.utc.wnot.set(wnot = 1, stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
	...
	def get(self, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:QZSS<ST>:NMESsage:NAV:TIME:CONVersion:UTC<CH>:WNOT \n
		Snippet: value: int = driver.source.bb.gnss.sv.qzss.nmessage.nav.time.conversion.utc.wnot.get(stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
		Sets the parameter WNot. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Qzss')
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Utc')
