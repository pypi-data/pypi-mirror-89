...
try:
    ...
    window_icon = pygame.image.load('pgwidget//icon.png')
...
class RadioButton(DraggableRect):
    def __init__(self,pos,text,radio_group,selected=False):
        ...
        try:
            ...
            self.img_empty = pygame.image.load('pgwidget//radio_empty.png')
            
        try:
            self.img_full = pygame.image.load('radio_full.png')
        except:
            self.img_full = pygame.image.load('pgwidget//radio_full.png')
...
class Checkbox(DraggableRect):
    def __init__(self,pos,text,selected=False):
        ...
        try:
            ...
            self.img_empty = pygame.image.load('pgwidget//checkbox_empty.png')
            
        try:
            self.img_full = pygame.image.load('checkbox_full.png')
        except:
            self.img_full = pygame.image.load('pgwidget//checkbox_full.png')
