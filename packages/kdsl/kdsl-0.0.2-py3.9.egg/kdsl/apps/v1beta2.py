...
class DaemonSetStatus(K8sObject):
    ...
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apps.v1beta2.DaemonSetConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apps.v1beta2_converters.optional_mlist_converter_DaemonSetConditionItem, default=OMIT)
...
class Deployment(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.apps.v1beta2.DeploymentSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apps.v1beta2_converters.optional_converter_DeploymentSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apps.v1beta2.DeploymentStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apps.v1beta2_converters.optional_converter_DeploymentStatus, default=OMIT)


@attr.s(kw_only=True)
class ReplicaSetSpec(K8sObject):
    selector: kdsl.core.v1.LabelSelector = attr.ib(metadata={'yaml_name': 'selector'}, converter=kdsl.core.v1_converters.required_converter_LabelSelector)
...
class ReplicaSetStatus(K8sObject):
    ...
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apps.v1beta2.ReplicaSetConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apps.v1beta2_converters.optional_mlist_converter_ReplicaSetConditionItem, default=OMIT)
...
class DeploymentStatus(K8sObject):
    availableReplicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'availableReplicas'}, default=OMIT)
    collisionCount: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'collisionCount'}, default=OMIT)
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apps.v1beta2.DeploymentConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apps.v1beta2_converters.optional_mlist_converter_DeploymentConditionItem, default=OMIT)
    observedGeneration: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'observedGeneration'}, default=OMIT)
    readyReplicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'readyReplicas'}, default=OMIT)
    replicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'replicas'}, default=OMIT)
...
class StatefulSetStatus(K8sObject):
    replicas: int = attr.ib(metadata={'yaml_name': 'replicas'})
    collisionCount: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'collisionCount'}, default=OMIT)
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apps.v1beta2.StatefulSetConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apps.v1beta2_converters.optional_mlist_converter_StatefulSetConditionItem, default=OMIT)
...
class StatefulSet(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.apps.v1beta2.StatefulSetSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apps.v1beta2_converters.optional_converter_StatefulSetSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apps.v1beta2.StatefulSetStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apps.v1beta2_converters.optional_converter_StatefulSetStatus, default=OMIT)
...
class StatefulSetSpec(K8sObject):
    ...
    updateStrategy: Union[None, OmitEnum, kdsl.apps.v1beta2.StatefulSetUpdateStrategy] = attr.ib(metadata={'yaml_name': 'updateStrategy'}, converter=kdsl.apps.v1beta2_converters.optional_converter_StatefulSetUpdateStrategy, default=OMIT)
    volumeClaimTemplates: Union[None, OmitEnum, Sequence[kdsl.core.v1.EmbeddedPersistentVolumeClaim]] = attr.ib(metadata={'yaml_name': 'volumeClaimTemplates'}, converter=kdsl.core.v1_converters.optional_list_converter_EmbeddedPersistentVolumeClaim, default=OMIT)
...
class DeploymentSpec(K8sObject):
    ...
    replicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'replicas'}, default=OMIT)
    revisionHistoryLimit: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'revisionHistoryLimit'}, default=OMIT)
    strategy: Union[None, OmitEnum, kdsl.apps.v1beta2.DeploymentStrategy] = attr.ib(metadata={'yaml_name': 'strategy'}, converter=kdsl.apps.v1beta2_converters.optional_converter_DeploymentStrategy, default=OMIT)
...
class DaemonSetSpec(K8sObject):
    ...
    minReadySeconds: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'minReadySeconds'}, default=OMIT)
    revisionHistoryLimit: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'revisionHistoryLimit'}, default=OMIT)
    updateStrategy: Union[None, OmitEnum, kdsl.apps.v1beta2.DaemonSetUpdateStrategy] = attr.ib(metadata={'yaml_name': 'updateStrategy'}, converter=kdsl.apps.v1beta2_converters.optional_converter_DaemonSetUpdateStrategy, default=OMIT)
...
class DeploymentStrategy(K8sObject):
    rollingUpdate: Union[None, OmitEnum, kdsl.apps.v1beta2.RollingUpdateDeployment] = attr.ib(metadata={'yaml_name': 'rollingUpdate'}, converter=kdsl.apps.v1beta2_converters.optional_converter_RollingUpdateDeployment, default=OMIT)
...
class DaemonSet(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.apps.v1beta2.DaemonSetSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apps.v1beta2_converters.optional_converter_DaemonSetSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apps.v1beta2.DaemonSetStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apps.v1beta2_converters.optional_converter_DaemonSetStatus, default=OMIT)
...
class StatefulSetUpdateStrategy(K8sObject):
    rollingUpdate: Union[None, OmitEnum, kdsl.apps.v1beta2.RollingUpdateStatefulSetStrategy] = attr.ib(metadata={'yaml_name': 'rollingUpdate'}, converter=kdsl.apps.v1beta2_converters.optional_converter_RollingUpdateStatefulSetStrategy, default=OMIT)
    type: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'type'}, default=OMIT)
...
class ReplicaSet(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.apps.v1beta2.ReplicaSetSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apps.v1beta2_converters.optional_converter_ReplicaSetSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apps.v1beta2.ReplicaSetStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apps.v1beta2_converters.optional_converter_ReplicaSetStatus, default=OMIT)


@attr.s(kw_only=True)
class DaemonSetUpdateStrategy(K8sObject):
    rollingUpdate: Union[None, OmitEnum, kdsl.apps.v1beta2.RollingUpdateDaemonSet] = attr.ib(metadata={'yaml_name': 'rollingUpdate'}, converter=kdsl.apps.v1beta2_converters.optional_converter_RollingUpdateDaemonSet, default=OMIT)
    type: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'type'}, default=OMIT)
