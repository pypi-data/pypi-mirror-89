...
def report_action_result(njinn_api, action_output, action_context):
    """
...
class TaskLogging:
    def __init__(self, action_config):
        ...
        self.logfile = os.path.join(
            task_log_dir,
            f"{action_config.njinn_execution_id}-{action_config.task_name}-{action_config.action_execution_id}.log",
        )
