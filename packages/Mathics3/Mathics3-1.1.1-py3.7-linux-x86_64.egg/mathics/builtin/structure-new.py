...
#         l = structure('List', expr, evaluation)

#         heads = self.get_option(options, "Heads", evaluation).is_true()
#         result, depth = walk_levels(expr, n_int, n_int, heads=heads, callback=callback)
