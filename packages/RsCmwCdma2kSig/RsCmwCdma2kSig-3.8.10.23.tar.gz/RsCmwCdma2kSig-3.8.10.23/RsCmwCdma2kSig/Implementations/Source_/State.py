...
class State:
	...
	def get_all(self) -> AllStruct:
		...
		"""
		return self._core.io.query_struct('SOURce:CDMA:SIGNaling<Instance>:STATe:ALL?', self.__class__.AllStruct())
	...
	def get_value(self) -> bool:
		...
		"""
		response = self._core.io.query_str_with_opc('SOURce:CDMA:SIGNaling<Instance>:STATe?')
	...
	def set_value(self, main_state: bool) -> None:
		...
		self._core.io.write_with_opc(f'SOURce:CDMA:SIGNaling<Instance>:STATe {param}')
