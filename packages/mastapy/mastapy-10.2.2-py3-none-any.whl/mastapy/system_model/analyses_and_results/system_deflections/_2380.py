...
class TorqueConverterSystemDeflection(_2291.CouplingSystemDeflection):
    '''TorqueConverterSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3377.TorqueConverterPowerFlow':
        ...
        return constructor.new(_3377.TorqueConverterPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
