...
from typing import Mapping, Union, ClassVar, Sequence, Optional, TypedDict, Any
...
class HorizontalPodAutoscaler(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.autoscaling.v2beta2.HorizontalPodAutoscalerSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.autoscaling.v2beta2_converters.optional_converter_HorizontalPodAutoscalerSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.autoscaling.v2beta2.HorizontalPodAutoscalerStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.autoscaling.v2beta2_converters.optional_converter_HorizontalPodAutoscalerStatus, default=OMIT)


@attr.s(kw_only=True)
class ObjectMetricSource(K8sObject):
    describedObject: kdsl.autoscaling.v2beta2.CrossVersionObjectReference = attr.ib(metadata={'yaml_name': 'describedObject'}, converter=kdsl.autoscaling.v2beta2_converters.required_converter_CrossVersionObjectReference)
    metric: kdsl.autoscaling.v2beta2.MetricIdentifier = attr.ib(metadata={'yaml_name': 'metric'}, converter=kdsl.autoscaling.v2beta2_converters.required_converter_MetricIdentifier)
    target: kdsl.autoscaling.v2beta2.MetricTarget = attr.ib(metadata={'yaml_name': 'target'}, converter=kdsl.autoscaling.v2beta2_converters.required_converter_MetricTarget)
...
class HorizontalPodAutoscalerStatus(K8sObject):
    conditions: Sequence[kdsl.autoscaling.v2beta2.HorizontalPodAutoscalerCondition] = attr.ib(metadata={'yaml_name': 'conditions'}, converter=kdsl.autoscaling.v2beta2_converters.required_list_converter_HorizontalPodAutoscalerCondition)
    ...
    currentMetrics: Union[None, OmitEnum, Sequence[kdsl.autoscaling.v2beta2.MetricStatus]] = attr.ib(metadata={'yaml_name': 'currentMetrics'}, converter=kdsl.autoscaling.v2beta2_converters.optional_list_converter_MetricStatus, default=OMIT)
...
class HorizontalPodAutoscalerSpec(K8sObject):
    ...
    scaleTargetRef: kdsl.autoscaling.v2beta2.CrossVersionObjectReference = attr.ib(metadata={'yaml_name': 'scaleTargetRef'}, converter=kdsl.autoscaling.v2beta2_converters.required_converter_CrossVersionObjectReference)
    metrics: Union[None, OmitEnum, Sequence[kdsl.autoscaling.v2beta2.MetricSpec]] = attr.ib(metadata={'yaml_name': 'metrics'}, converter=kdsl.autoscaling.v2beta2_converters.optional_list_converter_MetricSpec, default=OMIT)
...
class PodsMetricStatus(K8sObject):
    current: kdsl.autoscaling.v2beta2.MetricValueStatus = attr.ib(metadata={'yaml_name': 'current'}, converter=kdsl.autoscaling.v2beta2_converters.required_converter_MetricValueStatus)
    metric: kdsl.autoscaling.v2beta2.MetricIdentifier = attr.ib(metadata={'yaml_name': 'metric'}, converter=kdsl.autoscaling.v2beta2_converters.required_converter_MetricIdentifier)
...
class MetricSpec(K8sObject):
    type: str = attr.ib(metadata={'yaml_name': 'type'})
    external: Union[None, OmitEnum, kdsl.autoscaling.v2beta2.ExternalMetricSource] = attr.ib(metadata={'yaml_name': 'external'}, converter=kdsl.autoscaling.v2beta2_converters.optional_converter_ExternalMetricSource, default=OMIT)
    object: Union[None, OmitEnum, kdsl.autoscaling.v2beta2.ObjectMetricSource] = attr.ib(metadata={'yaml_name': 'object'}, converter=kdsl.autoscaling.v2beta2_converters.optional_converter_ObjectMetricSource, default=OMIT)
    pods: Union[None, OmitEnum, kdsl.autoscaling.v2beta2.PodsMetricSource] = attr.ib(metadata={'yaml_name': 'pods'}, converter=kdsl.autoscaling.v2beta2_converters.optional_converter_PodsMetricSource, default=OMIT)
    resource: Union[None, OmitEnum, kdsl.autoscaling.v2beta2.ResourceMetricSource] = attr.ib(metadata={'yaml_name': 'resource'}, converter=kdsl.autoscaling.v2beta2_converters.optional_converter_ResourceMetricSource, default=OMIT)
...
class MetricStatus(K8sObject):
    type: str = attr.ib(metadata={'yaml_name': 'type'})
    external: Union[None, OmitEnum, kdsl.autoscaling.v2beta2.ExternalMetricStatus] = attr.ib(metadata={'yaml_name': 'external'}, converter=kdsl.autoscaling.v2beta2_converters.optional_converter_ExternalMetricStatus, default=OMIT)
    object: Union[None, OmitEnum, kdsl.autoscaling.v2beta2.ObjectMetricStatus] = attr.ib(metadata={'yaml_name': 'object'}, converter=kdsl.autoscaling.v2beta2_converters.optional_converter_ObjectMetricStatus, default=OMIT)
    pods: Union[None, OmitEnum, kdsl.autoscaling.v2beta2.PodsMetricStatus] = attr.ib(metadata={'yaml_name': 'pods'}, converter=kdsl.autoscaling.v2beta2_converters.optional_converter_PodsMetricStatus, default=OMIT)
    resource: Union[None, OmitEnum, kdsl.autoscaling.v2beta2.ResourceMetricStatus] = attr.ib(metadata={'yaml_name': 'resource'}, converter=kdsl.autoscaling.v2beta2_converters.optional_converter_ResourceMetricStatus, default=OMIT)
