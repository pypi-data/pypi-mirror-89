...
[boto3.ApiGatewayManagementApi 1.16.40](https://boto3.amazonaws.com/v1/documentation/api/1.16.40/reference/services/apigatewaymanagementapi.html#ApiGatewayManagementApi) service
compatible with
