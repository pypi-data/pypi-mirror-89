...
class Determined:
	...
	def get(self, tablename: enums.Table = None, secondaryCompCarrier=repcap.SecondaryCompCarrier.Default) -> List[int]:
		...
		Snippet: value: List[int] = driver.sense.connection.scc.fcpri.downlink.mcsTable.csirs.determined.get(tablename = enums.Table.ANY, secondaryCompCarrier = repcap.SecondaryCompCarrier.Default) \n
