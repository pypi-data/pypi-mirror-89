...
class SpiralBevelGearParametricStudyTool(_3524.BevelGearParametricStudyTool):
    '''SpiralBevelGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2359.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2359.SpiralBevelGearSystemDeflection))
        return value
