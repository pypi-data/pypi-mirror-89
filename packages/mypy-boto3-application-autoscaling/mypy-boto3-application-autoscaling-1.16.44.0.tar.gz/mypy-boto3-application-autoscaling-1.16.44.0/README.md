...
[boto3.ApplicationAutoScaling 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/application-autoscaling.html#ApplicationAutoScaling) service
compatible with
