...
class Half:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("half", core, parent)
	...
	def get_percent(self) -> PercentStruct:
		...
		Snippet: value: PercentStruct = driver.sense.rxQuality.speech.half.get_percent() \n
		...
		"""
		return self._core.io.query_struct('SENSe:CDMA:SIGNaling<Instance>:RXQuality:SPEech:HALF:PERCent?', self.__class__.PercentStruct())
	...
	def get_value(self) -> ValueStruct:
		...
		Snippet: value: ValueStruct = driver.sense.rxQuality.speech.half.get_value() \n
		Displays the speech activity counters since the last reset statistics. Commands are provided for the frames at the eight,
		full, half and quarter frame rate. \n
			:return: structure: for return value, see the help for ValueStruct structure arguments.
		"""
		return self._core.io.query_struct('SENSe:CDMA:SIGNaling<Instance>:RXQuality:SPEech:HALF?', self.__class__.ValueStruct())
