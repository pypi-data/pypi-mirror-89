...
from client_python_tool.packages.platon_keys.utils.module_loading import (
    import_string,
)
...
def get_default_backend_class() -> str:
    if is_coincurve_available():
        return 'client_python_tool.packages.platon_keys.backends.CoinCurveECCBackend'
    else:
        return 'client_python_tool.packages.platon_keys.backends.NativeECCBackend'
