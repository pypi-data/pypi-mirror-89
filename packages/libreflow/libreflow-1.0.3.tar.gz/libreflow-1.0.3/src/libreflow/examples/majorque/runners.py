...
class AfterEffect(baseflow.runners.EditFileRunner):
    ...
    def executable(self):
        return 'C:/Program Files/Adobe/Adobe After Effects 2020/Support Files/AfterFX.exe'
...
class Photoshop(baseflow.runners.EditFileRunner):
    ...
    def executable(self):
        return 'C:/Program Files/Adobe/Adobe Photoshop CC 2020/Support Files/Photoshop.exe'
