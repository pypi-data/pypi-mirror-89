...
from mastapy.system_model.analyses_and_results.power_flows import _3306, _3308
...
class CylindricalGearSystemDeflection(_2314.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3306.CylindricalGearPowerFlow':
