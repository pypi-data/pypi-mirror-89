...
class Thresholds:
	...
	def get_value(self) -> ValueStruct:
		...
		"""
		return self._core.io.query_struct('CONFigure:LTE:SIGNaling<Instance>:NCELl:EVDO:THResholds?', self.__class__.ValueStruct())
	...
	def set_value(self, value: ValueStruct) -> None:
		...
		"""
		self._core.io.write_struct('CONFigure:LTE:SIGNaling<Instance>:NCELl:EVDO:THResholds', value)
