...
class Nstb:
	...
	def set(self, filename: str, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ATMospheric:IONospheric:MOPS:IMPort<ST>:ADD:FILE:NSTB<CH> \n
		Snippet: driver.source.bb.gnss.atmospheric.ionospheric.mops.importPy.add.file.nstb.set(filename = '1', stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
