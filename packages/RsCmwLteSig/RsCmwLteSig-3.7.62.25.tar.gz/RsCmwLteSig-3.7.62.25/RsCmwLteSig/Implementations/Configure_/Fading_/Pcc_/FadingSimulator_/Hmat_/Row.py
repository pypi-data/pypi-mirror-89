...
class Row:
	...
	def __init__(self, core: Core, parent):
		...
		self._base.rep_cap = RepeatedCapability(self._base.group_name, 'repcap_hMatrixRow_get', 'repcap_hMatrixRow_set', repcap.HMatrixRow.Row1)

	def repcap_hMatrixRow_set(self, enum_value: repcap.HMatrixRow) -> None:
