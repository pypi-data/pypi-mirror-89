...
class Prefixes:
	...
	def get_catalog(self) -> List[str]:
		...
		Snippet: value: List[str] = driver.sense.data.control.ipvSix.automatic.prefixes.get_catalog() \n
		...
		"""
		response = self._core.io.query_str('SENSe:DATA:CONTrol:IPVSix:AUTomatic:PREFixes:CATalog?')
