...
class StraightBevelPlanetGearSystemDeflection(_2365.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3369.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3369.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
