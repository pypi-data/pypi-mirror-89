...
class ElectricMachineHarmonicLoadData(_6229.SpeedDependentHarmonicLoadData):
    ...
    @property
    def force_distribution(self) -> '_6556.SMTBitmap':
        ...
        return constructor.new(_6556.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
