...
class KlingelnbergCycloPalloidHypoidGearMeshGearWhineAnalysis(_5384.KlingelnbergCycloPalloidConicalGearMeshGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2324.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2324.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
