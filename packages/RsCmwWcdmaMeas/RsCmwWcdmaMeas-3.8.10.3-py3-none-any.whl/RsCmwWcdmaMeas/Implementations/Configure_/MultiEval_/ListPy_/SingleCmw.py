...
class SingleCmw:
	...
	def get_cmode(self) -> enums.ParameterSetMode:
		...
		"""
		response = self._core.io.query_str('CONFigure:WCDMa:MEASurement<Instance>:MEValuation:LIST:CMWS:CMODe?')
	...
	def set_cmode(self, connector_mode: enums.ParameterSetMode) -> None:
		...
		self._core.io.write(f'CONFigure:WCDMa:MEASurement<Instance>:MEValuation:LIST:CMWS:CMODe {param}')
