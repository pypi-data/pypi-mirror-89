...
from kalabash.lib.tests import KaldeeTestCase, KaldeeAPITestCase
...
class ViewsTestCase(TestDataMixin, KaldeeTestCase):
    """Check views."""
...
class AccessRuleTestCase(KaldeeTestCase):
...
class UserCalendarViewSetTestCase(TestDataMixin, KaldeeAPITestCase):
...
class SharedCalendarViewSetTestCase(TestDataMixin, KaldeeAPITestCase):
...
class AccessRuleViewSetTestCase(TestDataMixin, KaldeeAPITestCase):
...
class EventViewSetTestCase(TestDataMixin, KaldeeAPITestCase):
    """Event viewset tests."""
...
class AttendeeViewSetTestCase(KaldeeAPITestCase):
...
class MailboxViewSetTestCase(KaldeeAPITestCase):
