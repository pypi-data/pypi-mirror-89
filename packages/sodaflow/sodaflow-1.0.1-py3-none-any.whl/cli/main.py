...
def run(port,config):
    try:
        ...
        url_items = "http://192.168.100.221:32447/nni/run/{}".format(port)
...
@click.command()
def experiment():
    url_items = "http://192.168.100.221:32447/nni/experiment/list"
...
@click.argument('id')
def trial(id):
    url_items = "http://192.168.100.221:32447/nni/trial/ls/{}".format(id)
    response = requests.get(url_items)
    print(response.text)
...
def trial_kill(eid, tid):
    url_items = "http://192.168.100.221:32447/nni/trial/kill/{}/{}".format(eid,tid)
    response = requests.get(url_items)
    if "app.nni.ApiError" in response.text:
...
@click.argument('id')
def stop(id):
    url_items = "http://192.168.100.221:32447/nni/stop/{}".format(id)
    response = requests.get(url_items)
    print(response.text)
...
@click.command()
def stop_all():
    url_items = "http://192.168.100.221:32447/nni/stop/all"
    response = requests.get(url_items)
    print(response.text)
...
@click.argument('id')
def log_stdout(id):
    url_items = "http://192.168.100.221:32447/nni/log/stdout/{}".format(id)
    response = requests.get(url_items)
    print(response.text)
...
@click.argument('id')
def log_stderr(id):
    url_items = "http://192.168.100.221:32447/nni/log/stderr/{}".format(id)
    response = requests.get(url_items)
    print(response.text)
