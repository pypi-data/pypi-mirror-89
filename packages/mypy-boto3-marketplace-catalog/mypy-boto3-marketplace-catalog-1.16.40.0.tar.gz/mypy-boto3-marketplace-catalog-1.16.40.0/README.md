...
[boto3.MarketplaceCatalog 1.16.40](https://boto3.amazonaws.com/v1/documentation/api/1.16.40/reference/services/marketplace-catalog.html#MarketplaceCatalog) service
compatible with
