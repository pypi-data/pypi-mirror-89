...
class Rframe:
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GBAS:VDB<CH>:SCH:M1T<ST>:RFRame \n
		Snippet: value: int = driver.source.bb.gbas.vdb.sch.m1T.rframe.get(channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
