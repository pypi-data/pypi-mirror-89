...
class MassDiscGearWhineAnalysis(_5441.VirtualComponentGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2332.MassDiscSystemDeflection':
        ...
        return constructor.new(_2332.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
