...
class CVTModalAnalysis(_4755.BeltDriveModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2294.CVTSystemDeflection':
        ...
        return constructor.new(_2294.CVTSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
