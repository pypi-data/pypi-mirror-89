...
class State:
	...
	def fetch(self) -> str:
		...
		Snippet: value: str = driver.rxQuality.flPer.state.fetch() \n
		...
		response = self._core.io.query_str_suppressed(f'FETCh:EVDO:SIGNaling<Instance>:RXQuality:FLPer:STATe?', suppressed)
