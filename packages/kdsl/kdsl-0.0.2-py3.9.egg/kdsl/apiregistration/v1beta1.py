...
class APIService(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.apiregistration.v1beta1.APIServiceSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apiregistration.v1beta1_converters.optional_converter_APIServiceSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apiregistration.v1beta1.APIServiceStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apiregistration.v1beta1_converters.optional_converter_APIServiceStatus, default=OMIT)


@attr.s(kw_only=True)
class APIServiceSpec(K8sObject):
    groupPriorityMinimum: int = attr.ib(metadata={'yaml_name': 'groupPriorityMinimum'})
    service: kdsl.apiregistration.v1beta1.ServiceReference = attr.ib(metadata={'yaml_name': 'service'}, converter=kdsl.apiregistration.v1beta1_converters.required_converter_ServiceReference)
...
class APIServiceStatus(K8sObject):
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apiregistration.v1beta1.APIServiceConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apiregistration.v1beta1_converters.optional_mlist_converter_APIServiceConditionItem, default=OMIT)
