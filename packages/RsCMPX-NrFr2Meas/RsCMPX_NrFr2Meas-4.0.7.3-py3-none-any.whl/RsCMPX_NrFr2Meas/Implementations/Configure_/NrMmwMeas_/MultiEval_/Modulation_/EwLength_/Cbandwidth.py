...
class Cbandwidth:
	...
	def set(self, structure: CbandwidthStruct, channelBw=repcap.ChannelBw.Default) -> None:
		...
		Snippet: driver.configure.nrMmwMeas.multiEval.modulation.ewLength.cbandwidth.set(value = [PROPERTY_STRUCT_NAME](), channelBw = repcap.ChannelBw.Default) \n
		...
		self._core.io.write_struct(f'CONFigure:NRMMw:MEASurement<Instance>:MEValuation:MODulation:EWLength:CBANdwidth{channelBw_cmd_val}', structure)
