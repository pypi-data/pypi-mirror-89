...
from mastapy.system_model.analyses_and_results.system_deflections import _2391, _2389, _2267
...
class ZerolBevelGearSetSystemDeflection(_2267.BevelGearSetSystemDeflection):
    '''ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3387.ZerolBevelGearSetPowerFlow':
        ...
        return constructor.new(_3387.ZerolBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2391.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSystemDeflection, constructor.new(_2391.ZerolBevelGearSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2389.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSystemDeflection, constructor.new(_2389.ZerolBevelGearMeshSystemDeflection))
        return value
