...
class Spectrum:
	...
	def initiate_with_opc(self) -> None:
		"""SCPI: INITiate:GPRF:MEASurement<Instance>:SPECtrum \n
		Snippet: driver.gprf.measurement.spectrum.initiate_with_opc() \n
		No command help available \n
	...
	def stop_with_opc(self) -> None:
		"""SCPI: STOP:GPRF:MEASurement<Instance>:SPECtrum \n
		Snippet: driver.gprf.measurement.spectrum.stop_with_opc() \n
		No command help available \n
	...
	def abort_with_opc(self) -> None:
		"""SCPI: ABORt:GPRF:MEASurement<Instance>:SPECtrum \n
		Snippet: driver.gprf.measurement.spectrum.abort_with_opc() \n
		No command help available \n
