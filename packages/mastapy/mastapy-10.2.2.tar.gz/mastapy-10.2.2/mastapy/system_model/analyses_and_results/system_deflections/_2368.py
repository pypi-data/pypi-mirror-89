...
class StraightBevelGearSystemDeflection(_2268.BevelGearSystemDeflection):
    '''StraightBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3367.StraightBevelGearPowerFlow':
        ...
        return constructor.new(_3367.StraightBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
