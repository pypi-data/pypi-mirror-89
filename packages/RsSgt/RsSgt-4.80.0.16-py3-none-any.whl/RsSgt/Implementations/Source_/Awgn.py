...
class Awgn:
	...
	def get_state(self) -> bool:
		...
		Activates or deactivates the white noise (AWGN = Averaged White Gaussian Noise) . Use the command method RsSgt.Source.
		Awgn.mode to define the mode the AWGN generator is working in. \n
