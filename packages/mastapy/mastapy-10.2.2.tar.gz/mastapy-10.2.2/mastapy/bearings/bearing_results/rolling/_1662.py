...
from mastapy.bearings.bearing_results.rolling import _1625, _1721
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1625.InternalClearance':
        ...
        return constructor.new(_1625.InternalClearance)(self.wrapped.OperatingInternalClearance) if self.wrapped.OperatingInternalClearance else None

    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_1721.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionInner, constructor.new(_1721.StressAtPosition))
        return value

    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_1721.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionOuter, constructor.new(_1721.StressAtPosition))
        return value
