...
class Secondary:
	...
	def get_address(self) -> str:
		...
		Snippet: value: str = driver.sense.data.control.dns.current.ipvSix.secondary.get_address() \n
		Queries the IPv6 address sent to the DUT as secondary DNS server address. \n
			:return: cdns_sec_ip_6: IPv6 address as string
		"""
		response = self._core.io.query_str('SENSe:DATA:CONTrol:DNS:CURRent:IPVSix:SECondary:ADDRess?')
