...
class Lte:
	...
	def get(self, band: enums.CompressedModeBand) -> List[enums.CompressedMode]:
		...
		Snippet: value: List[enums.CompressedMode] = driver.sense.ueCapability.measurement.cmode.lte.get(band = enums.CompressedModeBand.OB1) \n
		...
		response = self._core.io.query_str(f'SENSe:WCDMa:SIGNaling<Instance>:UECapability:MEASurement:CMODe:LTE? {param}')
