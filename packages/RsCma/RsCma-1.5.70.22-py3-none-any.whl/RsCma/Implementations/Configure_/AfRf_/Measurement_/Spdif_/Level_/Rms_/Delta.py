...
class Delta:
	...
	def get_user(self) -> UserStruct:
		...
		Snippet: value: UserStruct = driver.configure.afRf.measurement.spdif.level.rms.delta.get_user() \n
		No command help available \n
			:return: structure: for return value, see the help for UserStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:AFRF:MEASurement<Instance>:SIN:LEVel:RMS:DELTa:USER?', self.__class__.UserStruct())

	def set_user(self, value: UserStruct) -> None:
		"""SCPI: CONFigure:AFRF:MEASurement<Instance>:SIN:LEVel:RMS:DELTa:USER \n
		Snippet: driver.configure.afRf.measurement.spdif.level.rms.delta.set_user(value = UserStruct()) \n
		No command help available \n
			:param value: see the help for UserStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:AFRF:MEASurement<Instance>:SIN:LEVel:RMS:DELTa:USER', value)
