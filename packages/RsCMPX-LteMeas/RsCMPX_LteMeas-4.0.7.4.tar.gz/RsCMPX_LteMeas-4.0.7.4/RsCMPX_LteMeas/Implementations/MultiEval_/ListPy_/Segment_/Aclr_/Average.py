...
class Average:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Eutraneg: float: ACLR for the first E-UTRA channel below the carrier frequency
			- Eutra: float: Power in the allocated E-UTRA channel
			- Eutrapos: float: ACLR for the first E-UTRA channel above the carrier frequency
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Eutraneg: enums.ResultStatus2: ACLR for the first E-UTRA channel below the carrier frequency
			- Eutra: enums.ResultStatus2: Power in the allocated E-UTRA channel
			- Eutrapos: enums.ResultStatus2: ACLR for the first E-UTRA channel above the carrier frequency
