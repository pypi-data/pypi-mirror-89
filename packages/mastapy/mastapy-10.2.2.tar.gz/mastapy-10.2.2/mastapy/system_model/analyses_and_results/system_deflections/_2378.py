...
class TorqueConverterConnectionSystemDeflection(_2289.CouplingConnectionSystemDeflection):
    '''TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3376.TorqueConverterConnectionPowerFlow':
        ...
        return constructor.new(_3376.TorqueConverterConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
