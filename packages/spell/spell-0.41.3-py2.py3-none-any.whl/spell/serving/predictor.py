...
from spell.serving.endpoint import Endpoint, BatchEndpointPair
...
class BasePredictor:
    ...
    @classmethod
    def get_batched_predict_endpoint(cls) -> BatchEndpointPair:
        ...
        prepare = cls._create_endpoint("prepare", 1) if hasattr(cls, "prepare") else None
