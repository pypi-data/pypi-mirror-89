...
class DatumCompoundPowerFlow(_3411.ComponentCompoundPowerFlow):
    '''DatumCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3309.DatumPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3309.DatumPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3309.DatumPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3309.DatumPowerFlow))
        return value
