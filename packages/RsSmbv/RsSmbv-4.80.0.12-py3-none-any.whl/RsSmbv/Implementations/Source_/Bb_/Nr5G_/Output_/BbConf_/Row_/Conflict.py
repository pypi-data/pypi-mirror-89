...
class Conflict:
	...
	def get(self, channel=repcap.Channel.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:NR5G:OUTPut:BBConf:ROW<CH>:CONFlict \n
		Snippet: value: bool = driver.source.bb.nr5G.output.bbConf.row.conflict.get(channel = repcap.Channel.Default) \n
