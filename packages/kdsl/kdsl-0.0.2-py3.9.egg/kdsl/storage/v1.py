...
class VolumeAttachmentSpec(K8sObject):
    ...
    source: kdsl.storage.v1.VolumeAttachmentSource = attr.ib(metadata={'yaml_name': 'source'}, converter=kdsl.storage.v1_converters.required_converter_VolumeAttachmentSource)
...
class VolumeAttachmentStatus(K8sObject):
    ...
    attachError: Union[None, OmitEnum, kdsl.storage.v1.VolumeError] = attr.ib(metadata={'yaml_name': 'attachError'}, converter=kdsl.storage.v1_converters.optional_converter_VolumeError, default=OMIT)
    attachmentMetadata: Union[None, OmitEnum, Mapping[str, str]] = attr.ib(metadata={'yaml_name': 'attachmentMetadata'}, default=OMIT)
    detachError: Union[None, OmitEnum, kdsl.storage.v1.VolumeError] = attr.ib(metadata={'yaml_name': 'detachError'}, converter=kdsl.storage.v1_converters.optional_converter_VolumeError, default=OMIT)
...
class CSINodeDriverItem(K8sObject):
    ...
    allocatable: Union[None, OmitEnum, kdsl.storage.v1.VolumeNodeResources] = attr.ib(metadata={'yaml_name': 'allocatable'}, converter=kdsl.storage.v1_converters.optional_converter_VolumeNodeResources, default=OMIT)
...
class VolumeAttachment(K8sResource):
    ...
    spec: kdsl.storage.v1.VolumeAttachmentSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.storage.v1_converters.required_converter_VolumeAttachmentSpec)
    ...
    status: Union[None, OmitEnum, kdsl.storage.v1.VolumeAttachmentStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.storage.v1_converters.optional_converter_VolumeAttachmentStatus, default=OMIT)
...
class CSINodeSpec(K8sObject):
    drivers: Mapping[str, kdsl.storage.v1.CSINodeDriverItem] = attr.ib(metadata={'yaml_name': 'drivers', 'mlist_key': 'name'}, converter=kdsl.storage.v1_converters.required_mlist_converter_CSINodeDriverItem)
...
class CSINode(K8sResource):
    ...
    spec: kdsl.storage.v1.CSINodeSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.storage.v1_converters.required_converter_CSINodeSpec)
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
