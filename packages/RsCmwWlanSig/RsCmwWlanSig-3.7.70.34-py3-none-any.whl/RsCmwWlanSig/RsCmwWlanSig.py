...
class RsCmwWlanSig:
	"""220 total commands, 10 Sub-groups, 0 group commands"""
	driver_options = "SupportedInstrModels = CMW500/CMW100/CMW270/CMW280/CMP, SupportedIdnPatterns = CMW, SimulationIdnString = 'Rohde&Schwarz,CMW500,100001,3.7.70.0034'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '3.7.70.0034'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '3.7.70.0034'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsCmwWlanSig version failed. Current version: '3.7.70.0034', minimum required version: '{min_version}'")
	...
	@property
	def configure(self):
		"""configure commands group. 12 Sub-classes, 0 commands."""
