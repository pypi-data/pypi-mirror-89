...
from mastapy.system_model.analyses_and_results.power_flows import _3345, _3268
...
class RootAssemblyPowerFlow(_3268.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3345.PowerFlow':
        ...
        return constructor.new(_3345.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs else None
