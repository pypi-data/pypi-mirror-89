...
class PartToPartShearCouplingHalfParametricStudyTool(_3545.CouplingHalfParametricStudyTool):
    '''PartToPartShearCouplingHalfParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2340.PartToPartShearCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2340.PartToPartShearCouplingHalfSystemDeflection))
        return value
