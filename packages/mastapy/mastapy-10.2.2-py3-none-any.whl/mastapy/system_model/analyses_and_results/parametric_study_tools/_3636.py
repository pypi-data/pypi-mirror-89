...
class TorqueConverterParametricStudyTool(_3546.CouplingParametricStudyTool):
    '''TorqueConverterParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2380.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2380.TorqueConverterSystemDeflection))
        return value
