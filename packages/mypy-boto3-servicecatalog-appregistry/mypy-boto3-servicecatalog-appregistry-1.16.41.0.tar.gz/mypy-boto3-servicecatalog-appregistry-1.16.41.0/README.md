...
[boto3.AppRegistry 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/servicecatalog-appregistry.html#AppRegistry) service
compatible with
