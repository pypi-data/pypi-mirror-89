        ...
        if not self._is_complete(settings):
            with Printer("Account settings...") as p:
                ...
                if self.action in ("custom", "paranoiac"):                 # si il faut tout de metre en metre un
                    raise NotImplementedError("Il faut le coder.")
                ...
                if self.action == "custom":
                    settings["account"]["give_ram_usage"] = question_binaire(
                ...
                if self.action == "custom":
                    settings["account"]["automatic_update"] = question_binaire(
            ...
            with Printer("Cluster work settings...") as p:
                ...
                if get_temperature() is None:    # si il n'est pas possible de recuperer la temperature
                    ...
                    if self.action == "altruistic":
                        ...
                        settings["cluster_work"]["limit_fan_noise"] = checks.question_binaire(
                ...
                if self.action == "altruistic":
                    ...
                    settings["cluster_work"]["limit_cpu_usage"] = question_binaire(
                ...
                if self.action == "altruistic":
                    ...
                    settings["cluster_work"]["limit_ram_usage"] = checks.question_binaire(
                ...
                if self.action == "paranoiac":
                    ...
                    settings["cluster_work"]["limit_bandwidth"] = checks.question_binaire(
                ...
                if self.action == "paranoiac":
                    ...
                    settings["cluster_work"]["restrict_access"] = checks.question_binaire(
