...
import Utils.SocketApiServe as sk
import Utils.eventThread as gloevent
class IRenderControlEvents():
	...
	def Bind(self,name,fun):
		if type(fun).__name__ == "function":
			JsonData = {"api": "RenderControl.Rc"+name[2:], "EventName": name}
			gloevent.EventProcessStart(fn,"onMouseClickSelect",self.Events["onMouseClickSelect"]["args"],{ "propertyType":"onMouseClickSelect", "_HashCode": "" },None,JsonData)
	...
	def onAsyncSearchFinished(self,fn):
		...
		sk.postMessage({ "propertyType":"onAsyncSearchFinished", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onAsyncSearchFinished",self.Events["onAsyncSearchFinished"]["args"],{ "propertyType":"onAsyncSearchFinished", "_HashCode": "" },None,JsonData)
	...
	def onBeforePresentationItemActivation(self,fn):
		...
		sk.postMessage({ "propertyType":"onBeforePresentationItemActivation", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onBeforePresentationItemActivation",self.Events["onBeforePresentationItemActivation"]["args"],{ "propertyType":"onBeforePresentationItemActivation", "_HashCode": "" },None,JsonData)
	...
	def onCameraChanged(self,fn):
		...
		sk.postMessage({ "propertyType":"onCameraChanged", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onCameraChanged",self.Events["onCameraChanged"]["args"],{ "propertyType":"onCameraChanged", "_HashCode": "" },None,JsonData)
	...
	def onCameraFlyFinished(self,fn):
		...
		sk.postMessage({ "propertyType":"onCameraFlyFinished", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onCameraFlyFinished",self.Events["onCameraFlyFinished"]["args"],{ "propertyType":"onCameraFlyFinished", "_HashCode": "" },None,JsonData)
	...
	def onCameraTourWaypointChanged(self,fn):
		...
		sk.postMessage({ "propertyType":"onCameraTourWaypointChanged", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onCameraTourWaypointChanged",self.Events["onCameraTourWaypointChanged"]["args"],{ "propertyType":"onCameraTourWaypointChanged", "_HashCode": "" },None,JsonData)
	...
	def onCameraUndoRedoStatusChanged(self,fn):
		...
		sk.postMessage({ "propertyType":"onCameraUndoRedoStatusChanged", "_HashCode": "" },None,JsonData)
		AddRenderEventCB(fn,"onCameraUndoRedoStatusChanged")
	@property
	...
	def onDataSourceDisconnected(self,fn):
		...
		sk.postMessage({ "propertyType":"onDataSourceDisconnected", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onDataSourceDisconnected",self.Events["onDataSourceDisconnected"]["args"],{ "propertyType":"onDataSourceDisconnected", "_HashCode": "" },None,JsonData)
	...
	def onFeaturesMoving(self,fn):
		...
		sk.postMessage({ "propertyType":"onFeaturesMoving", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onFeaturesMoving",self.Events["onFeaturesMoving"]["args"],{ "propertyType":"onFeaturesMoving", "_HashCode": "" },None,JsonData)
	...
	def onFrame(self,fn):
		...
		sk.postMessage({ "propertyType":"onFrame", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onFrame",self.Events["onFrame"]["args"],{ "propertyType":"onFrame", "_HashCode": "" },None,JsonData)
	...
	def onFullScreenChanged(self,fn):
		...
		sk.postMessage({ "propertyType":"onFullScreenChanged", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onFullScreenChanged",self.Events["onFullScreenChanged"]["args"],{ "propertyType":"onFullScreenChanged", "_HashCode": "" },None,JsonData)
	...
	def onInteractFocusChanged(self,fn):
		...
		sk.postMessage({ "propertyType":"onInteractFocusChanged", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onInteractFocusChanged",self.Events["onInteractFocusChanged"]["args"],{ "propertyType":"onInteractFocusChanged", "_HashCode": "" },None,JsonData)
	...
	def onKeyDown(self,fn):
		...
		sk.postMessage({ "propertyType":"onKeyDown", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onKeyDown",self.Events["onKeyDown"]["args"],{ "propertyType":"onKeyDown", "_HashCode": "" },None,JsonData)
	...
	def onKeyUp(self,fn):
		...
		sk.postMessage({ "propertyType":"onKeyUp", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onKeyUp",self.Events["onKeyUp"]["args"],{ "propertyType":"onKeyUp", "_HashCode": "" },None,JsonData)
	...
	def onLButtonDblClk(self,fn):
		...
		sk.postMessage({ "propertyType":"onLButtonDblClk", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onLButtonDblClk",self.Events["onLButtonDblClk"]["args"],{ "propertyType":"onLButtonDblClk", "_HashCode": "" },None,JsonData)
	...
	def onLButtonDown(self,fn):
		...
		sk.postMessage({ "propertyType":"onLButtonDown", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onLButtonDown",self.Events["onLButtonDown"]["args"],{ "propertyType":"onLButtonDown", "_HashCode": "" },None,JsonData)
	...
	def onLButtonUp(self,fn):
		...
		sk.postMessage({ "propertyType":"onLButtonUp", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onLButtonUp",self.Events["onLButtonUp"]["args"],{ "propertyType":"onLButtonUp", "_HashCode": "" },None,JsonData)
	...
	def onMButtonDblClk(self,fn):
		...
		sk.postMessage({ "propertyType":"onMButtonDblClk", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onMButtonDblClk",self.Events["onMButtonDblClk"]["args"],{ "propertyType":"onMButtonDblClk", "_HashCode": "" },None,JsonData)
	...
	def onMButtonDown(self,fn):
		...
		sk.postMessage({ "propertyType":"onMButtonDown", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onMButtonDown",self.Events["onMButtonDown"]["args"],{ "propertyType":"onMButtonDown", "_HashCode": "" },None,JsonData)
	...
	def onMButtonUp(self,fn):
		...
		sk.postMessage({ "propertyType":"onMButtonUp", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onMButtonUp",self.Events["onMButtonUp"]["args"],{ "propertyType":"onMButtonUp", "_HashCode": "" },None,JsonData)
	...
	def onMouseClick(self,fn):
		...
		sk.postMessage({ "propertyType":"onMouseClick", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onMouseClick",self.Events["onMouseClick"]["args"],{ "propertyType":"onMouseClick", "_HashCode": "" },None,JsonData)
	...
	def onMouseClickSelect(self,fn):
		...
		sk.postMessage({ "propertyType":"onMouseClickSelect", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onMouseClickSelect",self.Events["onMouseClickSelect"]["args"],{ "propertyType":"onMouseClickSelect", "_HashCode": "" },None,JsonData)
	...
	def onMouseDragSelect(self,fn):
		...
		sk.postMessage({ "propertyType":"onMouseDragSelect", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onMouseDragSelect",self.Events["onMouseDragSelect"]["args"],{ "propertyType":"onMouseDragSelect", "_HashCode": "" },None,JsonData)
	...
	def onMouseHover(self,fn):
		...
		sk.postMessage({ "propertyType":"onMouseHover", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onMouseHover",self.Events["onMouseHover"]["args"],{ "propertyType":"onMouseHover", "_HashCode": "" },None,JsonData)
	...
	def onMouseMove(self,fn):
		...
		sk.postMessage({ "propertyType":"onMouseMove", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onMouseMove",self.Events["onMouseMove"]["args"],{ "propertyType":"onMouseMove", "_HashCode": "" },None,JsonData)
	...
	def onMouseWheel(self,fn):
		...
		sk.postMessage({ "propertyType":"onMouseWheel", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onMouseWheel",self.Events["onMouseWheel"]["args"],{ "propertyType":"onMouseWheel", "_HashCode": "" },None,JsonData)
	...
	def onObjectEditFinish(self,fn):
		...
		sk.postMessage({ "propertyType":"onObjectEditFinish", "_HashCode": "" },None,JsonData)
		AddRenderEventCB(fn,"onObjectEditFinish")
	@property
	...
	def onObjectEditing(self,fn):
		...
		sk.postMessage({ "propertyType":"onObjectEditing", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onObjectEditing",self.Events["onObjectEditing"]["args"],{ "propertyType":"onObjectEditing", "_HashCode": "" },None,JsonData)
	...
	def onPictureExportBegin(self,fn):
		...
		sk.postMessage({ "propertyType":"onPictureExportBegin", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onPictureExportBegin",self.Events["onPictureExportBegin"]["args"],{ "propertyType":"onPictureExportBegin", "_HashCode": "" },None,JsonData)
	...
	def onPictureExportEnd(self,fn):
		...
		sk.postMessage({ "propertyType":"onPictureExportEnd", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onPictureExportEnd",self.Events["onPictureExportEnd"]["args"],{ "propertyType":"onPictureExportEnd", "_HashCode": "" },None,JsonData)
	...
	def onPictureExporting(self,fn):
		...
		sk.postMessage({ "propertyType":"onPictureExporting", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onPictureExporting",self.Events["onPictureExporting"]["args"],{ "propertyType":"onPictureExporting", "_HashCode": "" },None,JsonData)
	...
	def onPresentationFlyToReachedDestination(self,fn):
		...
		sk.postMessage({ "propertyType":"onPresentationFlyToReachedDestination", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onPresentationFlyToReachedDestination",self.Events["onPresentationFlyToReachedDestination"]["args"],{ "propertyType":"onPresentationFlyToReachedDestination", "_HashCode": "" },None,JsonData)
	...
	def onPresentationStatusChanged(self,fn):
		...
		sk.postMessage({ "propertyType":"onPresentationStatusChanged", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onPresentationStatusChanged",self.Events["onPresentationStatusChanged"]["args"],{ "propertyType":"onPresentationStatusChanged", "_HashCode": "" },None,JsonData)
	...
	def onProjectChanged(self,fn):
		...
		sk.postMessage({ "propertyType":"onProjectChanged", "_HashCode": "" },None,JsonData)
		AddRenderEventCB(fn,"onProjectChanged")
	@property
	...
	def onRButtonDblClk(self,fn):
		...
		sk.postMessage({ "propertyType":"onRButtonDblClk", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onRButtonDblClk",self.Events["onRButtonDblClk"]["args"],{ "propertyType":"onRButtonDblClk", "_HashCode": "" },None,JsonData)
	...
	def onRButtonDown(self,fn):
		...
		sk.postMessage({ "propertyType":"onRButtonDown", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onRButtonDown",self.Events["onRButtonDown"]["args"],{ "propertyType":"onRButtonDown", "_HashCode": "" },None,JsonData)
	...
	def onRButtonUp(self,fn):
		...
		sk.postMessage({ "propertyType":"onRButtonUp", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onRButtonUp",self.Events["onRButtonUp"]["args"],{ "propertyType":"onRButtonUp", "_HashCode": "" },None,JsonData)
	...
	def onResPacking(self,fn):
		...
		sk.postMessage({ "propertyType":"onResPacking", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onResPacking",self.Events["onResPacking"]["args"],{ "propertyType":"onResPacking", "_HashCode": "" },None,JsonData)
	...
	def onTransformHelperBegin(self,fn):
		...
		sk.postMessage({ "propertyType":"onTransformHelperBegin", "_HashCode": "" },None,JsonData)
		AddRenderEventCB(fn,"onTransformHelperBegin")
	@property
	...
	def onTransformHelperBoxScaling(self,fn):
		...
		sk.postMessage({ "propertyType":"onTransformHelperBoxScaling", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onTransformHelperBoxScaling",self.Events["onTransformHelperBoxScaling"]["args"],{ "propertyType":"onTransformHelperBoxScaling", "_HashCode": "" },None,JsonData)
	...
	def onTransformHelperEnd(self,fn):
		...
		sk.postMessage({ "propertyType":"onTransformHelperEnd", "_HashCode": "" },None,JsonData)
		AddRenderEventCB(fn,"onTransformHelperEnd")
	@property
	...
	def onTransformHelperMoving(self,fn):
		...
		sk.postMessage({ "propertyType":"onTransformHelperMoving", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onTransformHelperMoving",self.Events["onTransformHelperMoving"]["args"],{ "propertyType":"onTransformHelperMoving", "_HashCode": "" },None,JsonData)
	...
	def onTransformHelperRotating(self,fn):
		...
		sk.postMessage({ "propertyType":"onTransformHelperRotating", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onTransformHelperRotating",self.Events["onTransformHelperRotating"]["args"],{ "propertyType":"onTransformHelperRotating", "_HashCode": "" },None,JsonData)
	...
	def onTransformHelperScaling(self,fn):
		...
		sk.postMessage({ "propertyType":"onTransformHelperScaling", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onTransformHelperScaling",self.Events["onTransformHelperScaling"]["args"],{ "propertyType":"onTransformHelperScaling", "_HashCode": "" },None,JsonData)
	...
	def onUIWindowEvent(self,fn):
		...
		sk.postMessage({ "propertyType":"onUIWindowEvent", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onUIWindowEvent",self.Events["onUIWindowEvent"]["args"],{ "propertyType":"onUIWindowEvent", "_HashCode": "" },None,JsonData)
	...
	def onVideoExportBegin(self,fn):
		...
		sk.postMessage({ "propertyType":"onVideoExportBegin", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onVideoExportBegin",self.Events["onVideoExportBegin"]["args"],{ "propertyType":"onVideoExportBegin", "_HashCode": "" },None,JsonData)
	...
	def onVideoExportEnd(self,fn):
		...
		sk.postMessage({ "propertyType":"onVideoExportEnd", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onVideoExportEnd",self.Events["onVideoExportEnd"]["args"],{ "propertyType":"onVideoExportEnd", "_HashCode": "" },None,JsonData)
	...
	def onVideoExporting(self,fn):
		...
		sk.postMessage({ "propertyType":"onVideoExporting", "_HashCode": "" },None,JsonData)
		gloevent.EventProcessStart(fn,"onVideoExporting",self.Events["onVideoExporting"]["args"],{ "propertyType":"onVideoExporting", "_HashCode": "" },None,JsonData)
