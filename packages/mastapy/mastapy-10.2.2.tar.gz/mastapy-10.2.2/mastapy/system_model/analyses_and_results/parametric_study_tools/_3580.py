...
class KlingelnbergCycloPalloidHypoidGearParametricStudyTool(_3577.KlingelnbergCycloPalloidConicalGearParametricStudyTool):
    '''KlingelnbergCycloPalloidHypoidGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2326.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2326.KlingelnbergCycloPalloidHypoidGearSystemDeflection))
        return value
