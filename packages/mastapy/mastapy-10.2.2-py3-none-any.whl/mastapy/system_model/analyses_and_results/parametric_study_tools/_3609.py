...
class RollingRingAssemblyParametricStudyTool(_3616.SpecialisedAssemblyParametricStudyTool):
    '''RollingRingAssemblyParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2347.RollingRingAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2347.RollingRingAssemblySystemDeflection))
        return value
