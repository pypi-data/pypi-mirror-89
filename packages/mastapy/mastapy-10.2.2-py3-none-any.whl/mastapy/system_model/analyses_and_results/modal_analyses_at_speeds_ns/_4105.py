...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4051, _4014
...
class ShaftModalAnalysesAtSpeeds(_4014.AbstractShaftOrHousingModalAnalysesAtSpeeds):
    '''ShaftModalAnalysesAtSpeeds
    ...
    @property
    def critical_speeds(self) -> 'List[_4051.CriticalSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CriticalSpeeds, constructor.new(_4051.CriticalSpeed))
        return value
