...
class Time:
	...
	def get(self, stream=repcap.Stream.Default) -> GetStruct:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:STARt:GLONass<ST>:TIME \n
		Snippet: value: GetStruct = driver.source.bb.gnss.time.start.glonass.time.get(stream = repcap.Stream.Default) \n
