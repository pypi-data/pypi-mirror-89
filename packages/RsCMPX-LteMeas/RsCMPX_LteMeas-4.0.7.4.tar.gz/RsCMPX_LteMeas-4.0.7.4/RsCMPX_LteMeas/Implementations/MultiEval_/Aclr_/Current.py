...
class Current:
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			...
			- Eutraneg: float: ACLR for the first E-UTRA channel with lower frequency
			- Eutra: float: Power in the allocated E-UTRA channel
			- Eutrapos: float: ACLR for the first E-UTRA channel with higher frequency
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Eutraneg: enums.ResultStatus2: ACLR for the first E-UTRA channel with lower frequency
			- Eutra: enums.ResultStatus2: Power in the allocated E-UTRA channel
			- Eutrapos: enums.ResultStatus2: ACLR for the first E-UTRA channel with higher frequency
