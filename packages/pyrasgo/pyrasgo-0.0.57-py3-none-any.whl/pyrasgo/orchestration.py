        ...
        for fs in featuresets:
            ...
            if fs.get("tags"):
                for t in fs.get("tags"):
                    tags.append(t)
            featureset = self.rasgo.publish_feature_set(name=featureset_name, datasource_id=datasource["id"], table_name=snowflake_table, org_id=org_id, granularity=granularity, rawFilePath=gitRepo)
