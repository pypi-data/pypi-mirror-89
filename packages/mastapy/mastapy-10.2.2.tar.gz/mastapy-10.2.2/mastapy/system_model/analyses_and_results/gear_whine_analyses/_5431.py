...
class SynchroniserGearWhineAnalysis(_5415.SpecialisedAssemblyGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2374.SynchroniserSystemDeflection':
        ...
        return constructor.new(_2374.SynchroniserSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
