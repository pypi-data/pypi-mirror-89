...
class Endpoint(K8sObject):
    ...
    conditions: Union[None, OmitEnum, kdsl.discovery.v1beta1.EndpointConditions] = attr.ib(metadata={'yaml_name': 'conditions'}, converter=kdsl.discovery.v1beta1_converters.optional_converter_EndpointConditions, default=OMIT)
...
class EndpointSlice(K8sResource):
    ...
    endpoints: Sequence[kdsl.discovery.v1beta1.Endpoint] = attr.ib(metadata={'yaml_name': 'endpoints'}, converter=kdsl.discovery.v1beta1_converters.required_list_converter_Endpoint)
    ...
    ports: Union[None, OmitEnum, Sequence[kdsl.discovery.v1beta1.EndpointPort]] = attr.ib(metadata={'yaml_name': 'ports'}, converter=kdsl.discovery.v1beta1_converters.optional_list_converter_EndpointPort, default=OMIT)
