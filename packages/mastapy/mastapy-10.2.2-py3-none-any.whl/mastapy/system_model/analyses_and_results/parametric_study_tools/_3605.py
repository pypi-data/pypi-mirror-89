...
class PlanetCarrierParametricStudyTool(_3588.MountableComponentParametricStudyTool):
    '''PlanetCarrierParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2343.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2343.PlanetCarrierSystemDeflection))
        return value
