...
class Prepetition:
	...
	def set(self, prepetition: int, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.mstation.pcpch.prepetition.set(prepetition = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:MSTation<ST>:PCPCh:PREPetition \n
		Snippet: value: int = driver.source.bb.w3Gpp.mstation.pcpch.prepetition.get(stream = repcap.Stream.Default) \n
		The command defines the number of PCPCH preamble components. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Mstation')
