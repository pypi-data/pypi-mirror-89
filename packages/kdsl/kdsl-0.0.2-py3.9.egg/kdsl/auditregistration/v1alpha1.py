...
class Webhook(K8sObject):
    clientConfig: kdsl.auditregistration.v1alpha1.WebhookClientConfig = attr.ib(metadata={'yaml_name': 'clientConfig'}, converter=kdsl.auditregistration.v1alpha1_converters.required_converter_WebhookClientConfig)
    throttle: Union[None, OmitEnum, kdsl.auditregistration.v1alpha1.WebhookThrottleConfig] = attr.ib(metadata={'yaml_name': 'throttle'}, converter=kdsl.auditregistration.v1alpha1_converters.optional_converter_WebhookThrottleConfig, default=OMIT)
...
class WebhookClientConfig(K8sObject):
    ...
    service: Union[None, OmitEnum, kdsl.auditregistration.v1alpha1.ServiceReference] = attr.ib(metadata={'yaml_name': 'service'}, converter=kdsl.auditregistration.v1alpha1_converters.optional_converter_ServiceReference, default=OMIT)
...
class Policy(K8sObject):
    ...
    stages: Union[None, OmitEnum, Sequence[str]] = attr.ib(metadata={'yaml_name': 'stages'}, default=OMIT)
...
class WebhookThrottleConfig(K8sObject):
    burst: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'burst'}, default=OMIT)
    qps: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'qps'}, default=OMIT)
...
WebhookThrottleConfigUnion = Union[WebhookThrottleConfig, WebhookThrottleConfigTypedDict]
...
class AuditSink(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.auditregistration.v1alpha1.AuditSinkSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.auditregistration.v1alpha1_converters.optional_converter_AuditSinkSpec, default=OMIT)


@attr.s(kw_only=True)
class AuditSinkSpec(K8sObject):
    policy: kdsl.auditregistration.v1alpha1.Policy = attr.ib(metadata={'yaml_name': 'policy'}, converter=kdsl.auditregistration.v1alpha1_converters.required_converter_Policy)
    webhook: kdsl.auditregistration.v1alpha1.Webhook = attr.ib(metadata={'yaml_name': 'webhook'}, converter=kdsl.auditregistration.v1alpha1_converters.required_converter_Webhook)
