...
class Ioffset:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:SBAS<ST>:GAGAN:UTC:IOFFset \n
		Snippet: value: int = driver.source.bb.gnss.time.conversion.sbas.gagan.utc.ioffset.get(stream = repcap.Stream.Default) \n
