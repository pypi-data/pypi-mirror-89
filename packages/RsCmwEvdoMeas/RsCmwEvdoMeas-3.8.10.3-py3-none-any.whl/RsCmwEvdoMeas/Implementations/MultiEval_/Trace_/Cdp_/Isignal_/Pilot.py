...
class Pilot:
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Pilot_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Pilot_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Pilot_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Pilot_.Minimum import Minimum
	...
	def state(self):
		...
		if not hasattr(self, '_state'):
			from .Pilot_.State import State
	...
	def limit(self):
		...
		if not hasattr(self, '_limit'):
			from .Pilot_.Limit import Limit
