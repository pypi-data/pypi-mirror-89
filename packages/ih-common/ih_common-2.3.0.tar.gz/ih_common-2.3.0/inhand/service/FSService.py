...
try:
    with open('/Users/han/workroom/coding/python/minio/src/main/python/put_object.py', 'rb') as file_data:
        file_stat = os.stat('put_object.py')
        client.put_object('demo', 'put_object.py',
...
try:
    with open('/Users/han/workroom/coding/python/minio/src/main/python/put_object.py', 'rb') as file_data:
        file_stat = os.stat('put_object.py')
        client.put_object('demo', 'put_object',
