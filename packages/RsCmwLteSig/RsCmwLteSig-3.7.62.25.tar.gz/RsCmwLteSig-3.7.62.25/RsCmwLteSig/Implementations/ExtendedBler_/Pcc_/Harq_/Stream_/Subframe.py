...
class Subframe:
	"""Subframe commands group definition. 2 total commands, 2 Sub-groups, 0 group commands"""
	...
	def absolute(self):
		...
		if not hasattr(self, '_absolute'):
			from .Subframe_.Absolute import Absolute
	...
	def relative(self):
		...
		if not hasattr(self, '_relative'):
			from .Subframe_.Relative import Relative
