...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3109, _3016
...
class RootAssemblySteadyStateSynchronousResponse(_3016.AssemblySteadyStateSynchronousResponse):
    '''RootAssemblySteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response_inputs(self) -> '_3109.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3109.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponseInputs) if self.wrapped.SteadyStateSynchronousResponseInputs else None
