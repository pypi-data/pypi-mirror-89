...
class Nhtrans:
	...
	def set(self, num_harq_trans: int, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.user.asPy.ul.nhtrans.set(num_harq_trans = 1, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:AS:UL:NHTRans \n
		Snippet: value: int = driver.source.bb.eutra.dl.user.asPy.ul.nhtrans.get(channel = repcap.Channel.Default) \n
		Sets the number of HARQ transmissions. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
