...
class Qpsk:
	...
	class IqOffsetStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			...
			- Offset_1: float: I/Q origin offset limit for high TX power range Range: -256 dBc to 256 dBc, Unit: dB
			- Offset_2: float: I/Q origin offset limit for intermediate TX power range Range: -256 dBc to 256 dBc, Unit: dB
			- Offset_3: float: I/Q origin offset limit for low TX power range Range: -256 dBc to 256 dBc, Unit: dB"""
		__meta_args_list = [
