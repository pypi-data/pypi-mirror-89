...
class BoltParametricStudyTool(_3532.ComponentParametricStudyTool):
    '''BoltParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2270.BoltSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2270.BoltSystemDeflection))
        return value
