...
class PointLoadSystemDeflection(_2385.VirtualComponentSystemDeflection):
    '''PointLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3344.PointLoadPowerFlow':
        ...
        return constructor.new(_3344.PointLoadPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
