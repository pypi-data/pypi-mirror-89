...
class RsSmab:
	"""1092 total commands, 24 Sub-groups, 0 group commands"""
	driver_options = "SupportedInstrModels = SMA/SMAB, SupportedIdnPatterns = SMA, SimulationIdnString = 'Rohde&Schwarz,SMA100B,100001,4.70.205.0009'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '4.70.205.0009'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '4.70.205.0009'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsSmab version failed. Current version: '4.70.205.0009', minimum required version: '{min_version}'")
