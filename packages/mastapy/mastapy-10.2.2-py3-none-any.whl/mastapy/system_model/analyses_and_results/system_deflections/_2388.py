...
class WormGearSystemDeflection(_2314.GearSystemDeflection):
    '''WormGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3383.WormGearPowerFlow':
        ...
        return constructor.new(_3383.WormGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
