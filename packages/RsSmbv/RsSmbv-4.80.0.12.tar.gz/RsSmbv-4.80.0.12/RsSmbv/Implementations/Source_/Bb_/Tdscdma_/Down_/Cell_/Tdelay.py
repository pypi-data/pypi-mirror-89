...
class Tdelay:
	...
	def set(self, tdelay: int, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.down.cell.tdelay.set(tdelay = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:TDSCdma:DOWN:CELL<ST>:TDELay \n
		Snippet: value: int = driver.source.bb.tdscdma.down.cell.tdelay.get(stream = repcap.Stream.Default) \n
		Sets the time shift of the selected cell compared to cell 1; the time delay of cell 1 is 0. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cell')
