...
class PrbNumber:
	...
	def set(self, prb_number: int, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.rdata.prbNumber.set(prb_number = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:RDATa:PRBNumber \n
		Snippet: value: int = driver.source.bb.eutra.ul.ue.sl.rdata.prbNumber.get(stream = repcap.Stream.Default) \n
		Sets the number of resource blocks each of the SL bands occupies. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
