...
class Addresses:
	...
	def get_catalog(self) -> List[str]:
		...
		Snippet: value: List[str] = driver.sense.data.control.ipvFour.dhcp.addresses.get_catalog() \n
		...
		"""
		response = self._core.io.query_str('SENSe:DATA:CONTrol:IPVFour:DHCP:ADDResses:CATalog?')
