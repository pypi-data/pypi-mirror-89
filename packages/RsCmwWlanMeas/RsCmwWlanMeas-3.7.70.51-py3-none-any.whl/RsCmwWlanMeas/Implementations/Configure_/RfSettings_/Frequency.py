...
class Frequency:
	...
	def get_schannel(self) -> enums.SlopeType:
		...
		Sets the position of the secondary channel relative to the primary channel for 40 MHz IEEE 802.11n signals. \n
	...
	def get_value(self) -> float:
		...
		or 160-MHz WLAN channel. For 80+80 MHz signals, set the center frequency of the left segment.
