...
class Mode:
	...
	def set(self, pr_erors_mode: enums.PseudorangeMode, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:GPS<ST>:PRERrors:MODE \n
		Snippet: driver.source.bb.gnss.svid.gps.prErrors.mode.set(pr_erors_mode = enums.PseudorangeMode.CONStant, channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> enums.PseudorangeMode:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:GPS<ST>:PRERrors:MODE \n
		Snippet: value: enums.PseudorangeMode = driver.source.bb.gnss.svid.gps.prErrors.mode.get(channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
		Sets how the pseudorange errors are defined. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Svid')
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Gps')
