...
from mastapy.system_model.part_model.couplings import _2168, _2165
...
class PulleyCompoundSteadyStateSynchronousResponseOnAShaft(_2684.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    '''PulleyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2168.Pulley':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2607.PulleySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2607.PulleySteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_steady_state_synchronous_response_on_a_shaft_load_cases(self) -> 'List[_2607.PulleySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSteadyStateSynchronousResponseOnAShaftLoadCases, constructor.new(_2607.PulleySteadyStateSynchronousResponseOnAShaft))
        return value
