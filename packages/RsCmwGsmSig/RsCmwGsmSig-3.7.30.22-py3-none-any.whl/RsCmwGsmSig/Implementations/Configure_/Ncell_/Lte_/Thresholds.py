...
class Thresholds:
	...
	def get_high(self) -> int:
		...
		"""
		response = self._core.io.query_str('CONFigure:GSM:SIGNaling<Instance>:NCELl:LTE:THResholds:HIGH?')
	...
	def set_high(self, high: int) -> None:
		...
		self._core.io.write(f'CONFigure:GSM:SIGNaling<Instance>:NCELl:LTE:THResholds:HIGH {param}')
