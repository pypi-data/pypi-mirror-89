...
class Downlink:
	...
	class AllStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			...
			- Start_Rb: int: Position of first resource block Range: 0 to 4
	...
	def get_all(self) -> AllStruct:
		...
		Snippet: value: AllStruct = driver.configure.connection.pcc.cscheduling.a.downlink.get_all() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:CSCHeduling:A:DL:ALL?', self.__class__.AllStruct())

	def set_all(self, value: AllStruct) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:CONNection[:PCC]:CSCHeduling:A:DL:ALL \n
		Snippet: driver.configure.connection.pcc.cscheduling.a.downlink.set_all(value = AllStruct()) \n
		Configures eMTC compact scheduling, downlink, for CE mode A. The indicated input ranges list all possible values.
		The ranges have dependencies described in the background information, see Table 'eMTC compact scheduling settings'. \n
			:param value: see the help for AllStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:CSCHeduling:A:DL:ALL', value)
