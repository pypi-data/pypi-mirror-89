...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.ehich.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:WCDMa:SIGNaling<Instance>:EHICh:STATe:ALL?', self.__class__.FetchStruct())
