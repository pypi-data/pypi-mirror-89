...
class Per:
	...
	def initiate(self) -> None:
		...
		These remote commands control the packet error rate measurement - either forward or reverse, depending on the current
		test application mode (see method RsCmwEvdoSig.Configure.Application.mode) .
		...
		"""
		self._core.io.write(f'INITiate:EVDO:SIGNaling<Instance>:PER')
	...
	def initiate_with_opc(self) -> None:
		...
		"""
		self._core.io.write_with_opc(f'INITiate:EVDO:SIGNaling<Instance>:PER')
	...
	def stop(self) -> None:
		...
		Use FETCh...STATe? to query the current measurement state. \n
		"""
		self._core.io.write(f'STOP:EVDO:SIGNaling<Instance>:PER')
	...
	def stop_with_opc(self) -> None:
		...
		"""
		self._core.io.write_with_opc(f'STOP:EVDO:SIGNaling<Instance>:PER')
	...
	def abort(self) -> None:
		...
		Use FETCh...STATe? to query the current measurement state. \n
		"""
		self._core.io.write(f'ABORt:EVDO:SIGNaling<Instance>:PER')
	...
	def abort_with_opc(self) -> None:
		...
		"""
		self._core.io.write_with_opc(f'ABORt:EVDO:SIGNaling<Instance>:PER')
