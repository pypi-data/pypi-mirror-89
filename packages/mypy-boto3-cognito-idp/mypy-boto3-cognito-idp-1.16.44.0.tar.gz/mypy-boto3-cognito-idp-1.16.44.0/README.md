...
[boto3.CognitoIdentityProvider 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/cognito-idp.html#CognitoIdentityProvider) service
compatible with
