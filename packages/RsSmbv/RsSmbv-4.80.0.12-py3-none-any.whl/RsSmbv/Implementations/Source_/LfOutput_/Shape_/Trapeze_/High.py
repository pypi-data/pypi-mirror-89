...
class High:
	...
	def set(self, high: float, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.lfOutput.shape.trapeze.high.set(high = 1.0, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> float:
		"""SCPI: [SOURce<HW>]:LFOutput<CH>:SHAPe:TRAPeze:HIGH \n
		Snippet: value: float = driver.source.lfOutput.shape.trapeze.high.get(channel = repcap.Channel.Default) \n
		Sets the high time for the trapezoid signal of the LF generator. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'LfOutput')
