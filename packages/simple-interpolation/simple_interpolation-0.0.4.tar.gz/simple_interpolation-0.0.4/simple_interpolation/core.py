...
__all__ = ['interpolate_gaps', 'check_dataframe', 'plot_results', 'bb', 'get_local_std', 'add_artificial_gaps_to_data',
           'benchmark', 'methods_demo']
...
def add_artificial_gaps_to_data ( df , plot = False, n_gaps = 25, internal = False):
    ...
    dataframe_valid, params_deduced = si.check_dataframe( df )
    # Unpack parameters
    x_column = params_deduced['x_column']
    y_column = params_deduced['y_column']
    datetime_present = params_deduced['datetime_flag']
...
#     global corrected_local
    ...
    corrected_local = si.interpolate_gaps(df_emptied_1, method = 'local_scan')
    print("terminated local_scan method")

    # Interpolation weiner
#     global corrected
    corrected = si.interpolate_gaps(df_emptied_2)
