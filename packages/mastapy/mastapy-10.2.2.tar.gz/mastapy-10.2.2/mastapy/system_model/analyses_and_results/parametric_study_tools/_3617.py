...
class SpiralBevelGearMeshParametricStudyTool(_3523.BevelGearMeshParametricStudyTool):
    '''SpiralBevelGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2357.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2357.SpiralBevelGearMeshSystemDeflection))
        return value
