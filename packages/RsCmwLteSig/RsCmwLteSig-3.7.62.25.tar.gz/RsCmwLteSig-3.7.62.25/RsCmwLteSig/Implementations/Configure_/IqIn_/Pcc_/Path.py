...
class Path:
	...
	def set(self, structure: PathStruct, path=repcap.Path.Default) -> None:
		...
		Snippet: driver.configure.iqIn.pcc.path.set(value = [PROPERTY_STRUCT_NAME](), path = repcap.Path.Default) \n
		...
		self._core.io.write_struct(f'CONFigure:LTE:SIGNaling<Instance>:IQIN:PCC:PATH{path_cmd_val}', structure)
