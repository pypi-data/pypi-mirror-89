...
class MWTWrapper:
    ...
    def get_mwt_trainer(self, language, use_gpu):
        ...
        self.trainer = Trainer(args=args, vocab=vocab, use_cuda=args['cuda'])
        self.args = args
    ...
    def train(self):
        ...
        dev_preds = self.trainer.predict_dict(get_mwt_expansions(self.dev_batch.doc, evaluation=True, training_mode=True))
        doc = copy.deepcopy(self.dev_batch.doc)
        ...
        for epoch in range(1, self.args['num_epoch'] + 1):
            ...
            dev_preds = self.trainer.ensemble(get_mwt_expansions(self.dev_batch.doc, evaluation=True, training_mode=True), dev_preds)
