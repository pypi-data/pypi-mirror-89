...
class Ioffset:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:GLONass<ST>:UTCSu:IOFFset \n
		Snippet: value: int = driver.source.bb.gnss.time.conversion.glonass.utcsu.ioffset.get(stream = repcap.Stream.Default) \n
