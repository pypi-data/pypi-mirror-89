...
class Rule:
	...
	def get_catalog(self) -> str:
		...
		Returns all time zone values that can be set via method RsCmwBase.System.Time.DaylightSavingTime.Rule.value. \n
			:return: cat: Comma-separated list of all supported values. Each value is represented as a string.
		"""
	...
	def get_value(self) -> str:
		...
		DST. See also method RsCmwBase.System.Time.DaylightSavingTime.mode. Modifying the time zone modifies also the configured
		time zone offset, see method RsCmwBase.System.tzone. \n
	...
	def set_value(self, rule: str) -> None:
		...
		DST. See also method RsCmwBase.System.Time.DaylightSavingTime.mode. Modifying the time zone modifies also the configured
		time zone offset, see method RsCmwBase.System.tzone. \n
			:param rule: Time zone as string To query a list of all supported strings, use method RsCmwBase.System.Time.DaylightSavingTime.Rule.catalog.
		"""
