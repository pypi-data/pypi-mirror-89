...
class Execute:
	...
	def set(self) -> None:
		...
		Snippet: driver.configure.cell.carrier.hsupa.ergch.pattern.execute.set() \n
		Triggers the execution of a single relative grant pattern (mode SINGle) . \n
		Global Repeated Capabilities: repcap.Carrier
		"""
		self._core.io.write(f'CONFigure:WCDMa:SIGNaling<Instance>:CELL:CARRier<Carrier>:HSUPa:ERGCh:PATTern:EXECute')

	def set_with_opc(self) -> None:
		"""SCPI: CONFigure:WCDMa:SIGNaling<instance>:CELL:CARRier<carrier>:HSUPa:ERGCh:PATTern:EXECute \n
		Snippet: driver.configure.cell.carrier.hsupa.ergch.pattern.execute.set_with_opc() \n
		Triggers the execution of a single relative grant pattern (mode SINGle) . \n
		...
		Global Repeated Capabilities: repcap.Carrier
		"""
		self._core.io.write_with_opc(f'CONFigure:WCDMa:SIGNaling<Instance>:CELL:CARRier<Carrier>:HSUPa:ERGCh:PATTern:EXECute')
