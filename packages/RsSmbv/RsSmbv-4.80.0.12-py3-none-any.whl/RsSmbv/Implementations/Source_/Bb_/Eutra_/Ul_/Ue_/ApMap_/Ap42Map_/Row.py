...
class Row:
	...
	def set(self, ant_port_mapping: bool, stream=repcap.Stream.Default, channel=repcap.Channel.Default, rowIx=repcap.RowIx.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:APMap:AP42Map<CH>:ROW<BBID> \n
		Snippet: driver.source.bb.eutra.ul.ue.apMap.ap42Map.row.set(ant_port_mapping = False, stream = repcap.Stream.Default, channel = repcap.Channel.Default, rowIx = repcap.RowIx.Default) \n
	...
	def get(self, stream=repcap.Stream.Default, channel=repcap.Channel.Default, rowIx=repcap.RowIx.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:APMap:AP42Map<CH>:ROW<BBID> \n
		Snippet: value: bool = driver.source.bb.eutra.ul.ue.apMap.ap42Map.row.get(stream = repcap.Stream.Default, channel = repcap.Channel.Default, rowIx = repcap.RowIx.Default) \n
		Sets which antenna port will be generated by which baseband. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ap42Map')
			:param rowIx: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Row')
