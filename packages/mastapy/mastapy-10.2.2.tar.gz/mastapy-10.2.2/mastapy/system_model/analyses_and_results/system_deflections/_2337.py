...
class OilSealSystemDeflection(_2288.ConnectorSystemDeflection):
    '''OilSealSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3336.OilSealPowerFlow':
        ...
        return constructor.new(_3336.OilSealPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
