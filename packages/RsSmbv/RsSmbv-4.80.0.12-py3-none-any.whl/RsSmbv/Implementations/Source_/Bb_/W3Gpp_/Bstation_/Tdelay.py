...
class Tdelay:
	...
	def set(self, tdelay: int, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.bstation.tdelay.set(tdelay = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:BSTation<ST>:TDELay \n
		Snippet: value: int = driver.source.bb.w3Gpp.bstation.tdelay.get(stream = repcap.Stream.Default) \n
		Adds a time shift for the selected base station compared to base station 1. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Bstation')
