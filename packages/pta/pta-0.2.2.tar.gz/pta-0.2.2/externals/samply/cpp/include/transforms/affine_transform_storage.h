...
public:
	 ...
	 */
	const Matrix<Scalar>& get_linear() const noexcept { return T_; }
	 ...
	 */
	const Vector<Scalar>& get_shift() const noexcept { return shift_; }
	 ...
	 */
	const Vector<Scalar>& get_diagonal() const noexcept { return diagonal_; }
