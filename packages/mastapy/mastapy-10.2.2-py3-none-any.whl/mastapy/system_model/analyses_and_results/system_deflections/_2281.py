...
from mastapy.system_model.analyses_and_results.system_deflections import _2282, _2280, _2313
...
class ConceptGearSetSystemDeflection(_2313.GearSetSystemDeflection):
    '''ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3292.ConceptGearSetPowerFlow':
        ...
        return constructor.new(_3292.ConceptGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2282.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSystemDeflection, constructor.new(_2282.ConceptGearSystemDeflection))
        return value

    @property
    def concept_meshes_system_deflection(self) -> 'List[_2280.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSystemDeflection, constructor.new(_2280.ConceptGearMeshSystemDeflection))
        return value
