...
class Dconflict:
	...
	def get(self, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:TDSCdma:DOWN:CELL<ST>:SLOT<CH>:DCONflict \n
		Snippet: value: bool = driver.source.bb.tdscdma.down.cell.slot.dconflict.get(stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
