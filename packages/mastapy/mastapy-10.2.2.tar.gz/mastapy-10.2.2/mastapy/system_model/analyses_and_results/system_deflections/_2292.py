...
class CVTBeltConnectionSystemDeflection(_2259.BeltConnectionSystemDeflection):
    '''CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3301.CVTBeltConnectionPowerFlow':
        ...
        return constructor.new(_3301.CVTBeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
