...
class Measurement:
	"""Measurement commands group definition. 5 total commands, 2 Sub-groups, 0 group commands"""
	...
	@property
	def ueReport(self):
		"""ueReport commands group. 1 Sub-classes, 2 commands."""
		if not hasattr(self, '_ueReport'):
			from .Measurement_.UeReport import UeReport
	...
	def bler(self):
		...
		if not hasattr(self, '_bler'):
			from .Measurement_.Bler import Bler
