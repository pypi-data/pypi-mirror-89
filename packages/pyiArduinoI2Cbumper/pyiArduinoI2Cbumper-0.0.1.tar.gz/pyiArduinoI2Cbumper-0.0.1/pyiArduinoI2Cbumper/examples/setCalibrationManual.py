...
#  КАЛИБРУЕМ МОДУЛЬ:                                      #
    ...
    if(f){println("Модуль успешно откалиброван!") } #   Если калибровка выполнена (f==true), то выводим текст.
    else {println("Ошибка калибровки модуля!"   ) } #   Иначе, выводим сообщение об ошибке.
#  ЗАДАЁМ ТИП ЛИНИИ ТРАССЫ:                               #
    ...
    if(f){println("Тип линии трассы задан!"     ) } # * Если тип линии принят модулем (f==true), то выводим текст.
    else {println("Ошибка указания типа линии!" ) } # * Иначе, выводим сообщение об ошибке.
}                                                          #
