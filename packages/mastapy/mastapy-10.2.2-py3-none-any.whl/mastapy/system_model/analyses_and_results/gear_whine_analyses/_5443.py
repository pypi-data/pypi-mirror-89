...
class WormGearMeshGearWhineAnalysis(_5368.GearMeshGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2386.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2386.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
