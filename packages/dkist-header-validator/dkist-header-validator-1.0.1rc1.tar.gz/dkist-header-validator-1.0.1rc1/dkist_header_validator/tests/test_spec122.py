...
def test_spec122_valid_return_dictionary(valid_spec_122_header):
    """
    Validates a fits header against the SPEC-122 schema
    Given: A valid SPEC-122 fits header
    When: Validating headers
...
def valid_spec_122_header_fail_bytesio_and_file(request, valid_spec_122_headers):
    yield valid_spec_122_headers[request.param]
...
def test_spec122_valid_return_fits_header(valid_spec_122_header):
    """
    Validates a fits header against the SPEC-122 schema
    Given: A valid SPEC-122 fits header
    When: Validating headers
...
def test_validate_and_translate_spec122(valid_spec_122_header):
    """
...
def test_validate_and_translate_spec122_return_dictionary(valid_spec_122_header):
    """
    Validates and tries to translate a fits header against the SPEC-122 schema
    Given: A valid SPEC-122 fits header
    When: Validating headers
...
def test_validate_and_translate_spec122_return_fits_header(valid_spec_122_header):
    """
    Validates and tries to translate a fits header against the SPEC-122 schema
    Given: A valid SPEC-122 fits header
    When: Validating headers
