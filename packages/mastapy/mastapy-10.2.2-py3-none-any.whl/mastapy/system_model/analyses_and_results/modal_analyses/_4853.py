...
from mastapy.system_model.analyses_and_results.system_deflections import _2365, _2369, _2370
...
class StraightBevelDiffGearModalAnalysis(_4762.BevelGearModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2365.StraightBevelDiffGearSystemDeflection':
