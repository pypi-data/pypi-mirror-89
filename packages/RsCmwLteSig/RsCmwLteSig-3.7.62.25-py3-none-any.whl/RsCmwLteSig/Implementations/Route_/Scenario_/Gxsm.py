...
class Gxsm:
	...
	class FlexibleStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			...
			- Scc_4_Tx_3_Conn: enums.TxConnector: RF connector for the third SCC4 output path
			- Scc_4_Tx_3_Conv: enums.TxConverter: TX module for the third SCC4 output path
			- Scc_4_Tx_4_Conn: enums.TxConnector: RF connector for the fourth SCC4 output path
			- Scc_4_Tx_4_Conv: enums.TxConverter: TX module for the fourth SCC4 output path
			...
			- Scc_5_Tx_3_Conn: enums.TxConnector: RF connector for the third SCC5 output path
			- Scc_5_Tx_3_Conv: enums.TxConverter: TX module for the third SCC5 output path
			- Scc_5_Tx_4_Conn: enums.TxConnector: RF connector for the fourth SCC5 output path
			- Scc_5_Tx_4_Conv: enums.TxConverter: TX module for the fourth SCC5 output path
