...
class StraightBevelSunGearSystemDeflection(_2365.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3370.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_3370.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
