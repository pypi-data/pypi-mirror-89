...
class Scode:
	...
	def set(self, scode: int, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.up.cell.scode.set(scode = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:TDSCdma:UP:CELL<ST>:SCODe \n
		Snippet: value: int = driver.source.bb.tdscdma.up.cell.scode.get(stream = repcap.Stream.Default) \n
		Sets the scrambling code. The scrambling code is used for transmitter-dependent scrambling of the chip sequence. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cell')
