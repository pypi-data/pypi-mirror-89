...
class TorqueConverterConnectionModalAnalysis(_4783.CouplingConnectionModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2378.TorqueConverterConnectionSystemDeflection':
        ...
        return constructor.new(_2378.TorqueConverterConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
