...
[boto3.KinesisVideoSignalingChannels 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/kinesis-video-signaling.html#KinesisVideoSignalingChannels) service
compatible with
