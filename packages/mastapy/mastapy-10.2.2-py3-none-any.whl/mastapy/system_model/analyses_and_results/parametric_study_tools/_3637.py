...
class TorqueConverterPumpParametricStudyTool(_3545.CouplingHalfParametricStudyTool):
    '''TorqueConverterPumpParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2379.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2379.TorqueConverterPumpSystemDeflection))
        return value
