...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6406, _6407, _6342
...
class WormGearSetAdvancedSystemDeflection(_6342.GearSetAdvancedSystemDeflection):
    ...
    @property
    def worm_gears_advanced_system_deflection(self) -> 'List[_6406.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsAdvancedSystemDeflection, constructor.new(_6406.WormGearAdvancedSystemDeflection))
        return value

    @property
    def worm_meshes_advanced_system_deflection(self) -> 'List[_6407.WormGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesAdvancedSystemDeflection, constructor.new(_6407.WormGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2387.WormGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2387.WormGearSetSystemDeflection))
        return value
