...
class TestCliCertificate(unittest.TestCase):
    ...
    def test_create_certificates_from_mah1h_ecc(self):
        ...
        with patch.object(sys, 'argv', testargs):
            ...
            with open(os.path.join(ECC_CERT_OUTPUT_FOLDER, "signer_certificate.crt"), "rb") as certfile:
                signer_certificate = certfile.read()
            with open(os.path.join(ECC_CERT_OUTPUT_FOLDER, "device_certificate.crt"), "rb") as certfile:
