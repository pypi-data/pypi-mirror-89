...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3890, _3889, _3784
...
class ZerolBevelGearSetModalAnalysesAtStiffnesses(_3784.BevelGearSetModalAnalysesAtStiffnesses):
    '''ZerolBevelGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def zerol_bevel_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3890.ZerolBevelGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysesAtStiffnesses, constructor.new(_3890.ZerolBevelGearModalAnalysesAtStiffnesses))
        return value

    @property
    def zerol_bevel_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3889.ZerolBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysesAtStiffnesses, constructor.new(_3889.ZerolBevelGearMeshModalAnalysesAtStiffnesses))
        return value
