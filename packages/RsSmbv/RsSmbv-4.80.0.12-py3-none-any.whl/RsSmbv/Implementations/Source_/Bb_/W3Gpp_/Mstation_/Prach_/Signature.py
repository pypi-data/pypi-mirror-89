...
class Signature:
	...
	def set(self, signature: int, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.mstation.prach.signature.set(signature = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:MSTation<ST>:PRACh:SIGNature \n
		Snippet: value: int = driver.source.bb.w3Gpp.mstation.prach.signature.get(stream = repcap.Stream.Default) \n
		The command selects the signature of the PRACH (see Table 3 in 3GPP TS 25.213 Version 3.4.0 Release 1999) . \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Mstation')
