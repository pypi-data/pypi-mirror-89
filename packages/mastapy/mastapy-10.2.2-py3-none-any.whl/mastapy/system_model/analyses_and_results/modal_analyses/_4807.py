...
class ImportedFEComponentModalAnalysis(_4748.AbstractShaftOrHousingModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2319.ImportedFEComponentSystemDeflection':
        ...
        return constructor.new(_2319.ImportedFEComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
