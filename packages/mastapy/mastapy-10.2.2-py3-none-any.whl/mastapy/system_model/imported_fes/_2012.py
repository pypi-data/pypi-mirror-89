...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    def set_alternative_fe_mesh_file(self, file_path: 'str', format_: '_1473.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0):
    ...
    def set_fe_mesh_file_to_include(self, file_path: 'str', format_: '_1473.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0):
