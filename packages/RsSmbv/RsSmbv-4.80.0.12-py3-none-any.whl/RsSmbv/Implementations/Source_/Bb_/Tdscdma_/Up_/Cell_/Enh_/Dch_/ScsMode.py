...
class ScsMode:
	...
	def set(self, scs_mode: enums.AutoUser, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.up.cell.enh.dch.scsMode.set(scs_mode = enums.AutoUser.AUTO, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> enums.AutoUser:
		"""SCPI: [SOURce<HW>]:BB:TDSCdma:UP:CELL<ST>:ENH:DCH:SCSMode \n
		Snippet: value: enums.AutoUser = driver.source.bb.tdscdma.up.cell.enh.dch.scsMode.get(stream = repcap.Stream.Default) \n
		Sets the spreading code selection mode for the used transport channels. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cell')
