...
from mastapy.bearings.bearing_results.rolling.fitting import _1756, _1754, _1757
from mastapy.bearings.bearing_results.rolling import (
    _1625, _1622, _1709, _1682
)
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1747, _1745, _1751, _1750,
    _1746, _1752, _1748
)
...
class LoadedRollingBearingResults(_1609.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1547.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1547.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1756.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1756.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1756.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1756.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1754.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1754.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1754.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1754.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions else None
    ...
    @property
    def din732(self) -> '_1622.DIN732Results':
        ...
        return constructor.new(_1622.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def iso2812007(self) -> '_1747.ISO2812007Results':
        ...
        if _1747.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1745.BallISO2812007Results':
        ...
        if _1745.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1751.RollerISO2812007Results':
        ...
        if _1751.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1750.ISOTS162812008Results':
        ...
        if _1750.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1746.BallISOTS162812008Results':
        ...
        if _1746.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1752.RollerISOTS162812008Results':
        ...
        if _1752.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1748.ISO762006Results':
        ...
        return constructor.new(_1748.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1709.MaximumStaticContactStress':
        ...
        return constructor.new(_1709.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1742.SKFModuleResults':
        ...
        return constructor.new(_1742.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1682.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1682.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1757.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1757.RingFittingThermalResults))
        return value
