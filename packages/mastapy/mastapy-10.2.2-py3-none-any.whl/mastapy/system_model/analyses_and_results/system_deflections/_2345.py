...
from mastapy.system_model.analyses_and_results.system_deflections import _2383, _2385
...
class PowerLoadSystemDeflection(_2385.VirtualComponentSystemDeflection):
    '''PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3347.PowerLoadPowerFlow':
        ...
        return constructor.new(_3347.PowerLoadPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_2383.TransmissionErrorResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_2383.TransmissionErrorResult))
        return value
