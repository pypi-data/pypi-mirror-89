...
class Dpdch:
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Dpdch_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Dpdch_.Average import Average
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Dpdch_.Minimum import Minimum
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Dpdch_.Maximum import Maximum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .Dpdch_.StandardDev import StandardDev
