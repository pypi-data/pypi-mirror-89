...
class UdSource:
	...
	def set(self, use_diff_src_state: bool, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:IMPort:GPS<ST>:UDSource \n
		Snippet: driver.source.bb.gnss.sv.importPy.gps.udSource.set(use_diff_src_state = False, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:IMPort:GPS<ST>:UDSource \n
		Snippet: value: bool = driver.source.bb.gnss.sv.importPy.gps.udSource.get(stream = repcap.Stream.Default) \n
		Enables loading the dedicated files as source for the navigation data. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Gps')
