...
class Rx:
	...
	def set(self, name_signal_path: str, correction_table: List[str] = None) -> None:
		...
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle('name_signal_path', name_signal_path, DataType.String), ArgSingle('correction_table', correction_table, DataType.StringList, True, True, 1))
