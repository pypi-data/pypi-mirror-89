...
class Catalog:
	...
	def get(self, stream=repcap.Stream.Default) -> List[str]:
		"""SCPI: [SOURce<HW>]:IQ:DPD<ST>:SHAPing:TABLe:AMPM:FILE:CATalog \n
		Snippet: value: List[str] = driver.source.iq.dpd.shaping.table.amPm.file.catalog.get(stream = repcap.Stream.Default) \n
