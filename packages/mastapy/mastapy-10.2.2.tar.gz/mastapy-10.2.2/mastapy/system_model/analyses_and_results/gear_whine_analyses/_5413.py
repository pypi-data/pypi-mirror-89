...
from mastapy.system_model.analyses_and_results.system_deflections import _2355, _2274, _2342
...
class ShaftToMountableComponentConnectionGearWhineAnalysis(_5335.ConnectionGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2355.ShaftToMountableComponentConnectionSystemDeflection':
