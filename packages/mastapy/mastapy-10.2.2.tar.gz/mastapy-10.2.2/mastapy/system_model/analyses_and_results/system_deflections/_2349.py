...
class RollingRingSystemDeflection(_2290.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3351.RollingRingPowerFlow':
        ...
        return constructor.new(_3351.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
