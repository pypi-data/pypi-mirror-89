...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3872, _3871, _3784
...
class StraightBevelGearSetModalAnalysesAtStiffnesses(_3784.BevelGearSetModalAnalysesAtStiffnesses):
    '''StraightBevelGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def straight_bevel_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3872.StraightBevelGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysesAtStiffnesses, constructor.new(_3872.StraightBevelGearModalAnalysesAtStiffnesses))
        return value

    @property
    def straight_bevel_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3871.StraightBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysesAtStiffnesses, constructor.new(_3871.StraightBevelGearMeshModalAnalysesAtStiffnesses))
        return value
