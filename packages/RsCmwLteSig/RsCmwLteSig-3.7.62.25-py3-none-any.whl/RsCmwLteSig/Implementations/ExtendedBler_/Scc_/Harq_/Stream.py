...
class Stream:
	"""Stream commands group definition. 4 total commands, 2 Sub-groups, 0 group commands
	...
	def transmission(self):
		...
		if not hasattr(self, '_transmission'):
			from .Stream_.Transmission import Transmission
	...
	def subframe(self):
		...
		if not hasattr(self, '_subframe'):
			from .Stream_.Subframe import Subframe
