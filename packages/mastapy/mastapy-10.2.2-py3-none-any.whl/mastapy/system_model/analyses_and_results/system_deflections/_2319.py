...
from mastapy.system_model.imported_fes import _2012
...
class ImportedFEComponentSystemDeflection(_2253.AbstractShaftOrHousingSystemDeflection):
    '''ImportedFEComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3322.ImportedFEComponentPowerFlow':
        ...
        return constructor.new(_3322.ImportedFEComponentPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def export(self) -> '_2012.SystemDeflectionFEExportOptions':
        ...
        return constructor.new(_2012.SystemDeflectionFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
