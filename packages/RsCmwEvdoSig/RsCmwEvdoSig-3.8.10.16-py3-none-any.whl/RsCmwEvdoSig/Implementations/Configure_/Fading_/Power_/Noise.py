...
class Noise:
	...
	def get_total(self) -> float:
		...
		"""
		response = self._core.io.query_str('CONFigure:EVDO:SIGNaling<Instance>:FADing:POWer:NOISe:TOTal?')
	...
	def get_value(self) -> float:
		...
		"""
		response = self._core.io.query_str('CONFigure:EVDO:SIGNaling<Instance>:FADing:POWer:NOISe?')
		return Conversions.str_to_float(response)
