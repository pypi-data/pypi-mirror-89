...
class BoltedJointParametricStudyTool(_3616.SpecialisedAssemblyParametricStudyTool):
    '''BoltedJointParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2269.BoltedJointSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2269.BoltedJointSystemDeflection))
        return value
