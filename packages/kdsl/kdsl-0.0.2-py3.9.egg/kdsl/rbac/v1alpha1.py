...
class Role(K8sResource):
    ...
    rules: Union[None, OmitEnum, Sequence[kdsl.rbac.v1alpha1.PolicyRule]] = attr.ib(metadata={'yaml_name': 'rules'}, converter=kdsl.rbac.v1alpha1_converters.optional_list_converter_PolicyRule, default=OMIT)
...
class ClusterRoleBinding(K8sResource):
    ...
    roleRef: kdsl.rbac.v1alpha1.RoleRef = attr.ib(metadata={'yaml_name': 'roleRef'}, converter=kdsl.rbac.v1alpha1_converters.required_converter_RoleRef)
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    subjects: Union[None, OmitEnum, Sequence[kdsl.rbac.v1alpha1.Subject]] = attr.ib(metadata={'yaml_name': 'subjects'}, converter=kdsl.rbac.v1alpha1_converters.optional_list_converter_Subject, default=OMIT)
...
class ClusterRole(K8sResource):
    ...
    aggregationRule: Union[None, OmitEnum, kdsl.rbac.v1alpha1.AggregationRule] = attr.ib(metadata={'yaml_name': 'aggregationRule'}, converter=kdsl.rbac.v1alpha1_converters.optional_converter_AggregationRule, default=OMIT)
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    rules: Union[None, OmitEnum, Sequence[kdsl.rbac.v1alpha1.PolicyRule]] = attr.ib(metadata={'yaml_name': 'rules'}, converter=kdsl.rbac.v1alpha1_converters.optional_list_converter_PolicyRule, default=OMIT)
