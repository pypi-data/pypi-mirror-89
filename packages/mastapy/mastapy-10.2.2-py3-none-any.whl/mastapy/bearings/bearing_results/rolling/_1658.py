...
class LoadedCylindricalRollerBearingRow(_1673.LoadedNonBarrelRollerBearingRow):
    ...
    @property
    def rib_normal_contact_stress_inner_left(self) -> '_6556.SMTBitmap':
        ...
        return constructor.new(_6556.SMTBitmap)(self.wrapped.RibNormalContactStressInnerLeft) if self.wrapped.RibNormalContactStressInnerLeft else None

    @property
    def rib_normal_contact_stress_inner_right(self) -> '_6556.SMTBitmap':
        ...
        return constructor.new(_6556.SMTBitmap)(self.wrapped.RibNormalContactStressInnerRight) if self.wrapped.RibNormalContactStressInnerRight else None

    @property
    def rib_normal_contact_stress_outer_left(self) -> '_6556.SMTBitmap':
        ...
        return constructor.new(_6556.SMTBitmap)(self.wrapped.RibNormalContactStressOuterLeft) if self.wrapped.RibNormalContactStressOuterLeft else None

    @property
    def rib_normal_contact_stress_outer_right(self) -> '_6556.SMTBitmap':
        ...
        return constructor.new(_6556.SMTBitmap)(self.wrapped.RibNormalContactStressOuterRight) if self.wrapped.RibNormalContactStressOuterRight else None
