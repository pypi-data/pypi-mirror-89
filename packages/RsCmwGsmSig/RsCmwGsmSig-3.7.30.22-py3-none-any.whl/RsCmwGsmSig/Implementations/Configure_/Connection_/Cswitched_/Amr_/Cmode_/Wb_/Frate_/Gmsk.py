...
class Gmsk:
	...
	def get_downlink(self) -> int or bool:
		...
		Snippet: value: int or bool = driver.configure.connection.cswitched.amr.cmode.wb.frate.gmsk.get_downlink() \n
		...
		modes, see method RsCmwGsmSig.Configure.Connection.Cswitched.Amr.Rset.Wb.Frate.gmsk. \n
		...
		"""
		response = self._core.io.query_str('CONFigure:GSM:SIGNaling<Instance>:CONNection:CSWitched:AMR:CMODe:WB:FRATe:GMSK:DL?')
		return Conversions.str_to_int_or_bool(response)

	def set_downlink(self, codec_mode: int or bool) -> None:
		"""SCPI: CONFigure:GSM:SIGNaling<Instance>:CONNection:CSWitched:AMR:CMODe:WB:FRATe:GMSK:DL \n
		Snippet: driver.configure.connection.cswitched.amr.cmode.wb.frate.gmsk.set_downlink(codec_mode = 1) \n
		Select the codec modes to be used by the R&S CMW (downlink) and the MS (uplink) for the full-rate wideband AMR codec
		(GMSK modulation) . Only active codec modes can be selected. For configuration and activation/deactivation of the codec
		modes, see method RsCmwGsmSig.Configure.Connection.Cswitched.Amr.Rset.Wb.Frate.gmsk. \n
		...
		self._core.io.write(f'CONFigure:GSM:SIGNaling<Instance>:CONNection:CSWitched:AMR:CMODe:WB:FRATe:GMSK:DL {param}')

	def get_uplink(self) -> int or bool:
		"""SCPI: CONFigure:GSM:SIGNaling<Instance>:CONNection:CSWitched:AMR:CMODe:WB:FRATe:GMSK:UL \n
		Snippet: value: int or bool = driver.configure.connection.cswitched.amr.cmode.wb.frate.gmsk.get_uplink() \n
		Select the codec modes to be used by the R&S CMW (downlink) and the MS (uplink) for the full-rate wideband AMR codec
		(GMSK modulation) . Only active codec modes can be selected. For configuration and activation/deactivation of the codec
		modes, see method RsCmwGsmSig.Configure.Connection.Cswitched.Amr.Rset.Wb.Frate.gmsk. \n
			:return: codec_mode: integer | ON | OFF Range: 1 to 3 (if all codec modes are active, otherwise less) Additional parameters OFF (ON) disables (enables) codec mode.
		"""
		response = self._core.io.query_str('CONFigure:GSM:SIGNaling<Instance>:CONNection:CSWitched:AMR:CMODe:WB:FRATe:GMSK:UL?')
		return Conversions.str_to_int_or_bool(response)

	def set_uplink(self, codec_mode: int or bool) -> None:
		"""SCPI: CONFigure:GSM:SIGNaling<Instance>:CONNection:CSWitched:AMR:CMODe:WB:FRATe:GMSK:UL \n
		Snippet: driver.configure.connection.cswitched.amr.cmode.wb.frate.gmsk.set_uplink(codec_mode = 1) \n
		Select the codec modes to be used by the R&S CMW (downlink) and the MS (uplink) for the full-rate wideband AMR codec
		(GMSK modulation) . Only active codec modes can be selected. For configuration and activation/deactivation of the codec
		modes, see method RsCmwGsmSig.Configure.Connection.Cswitched.Amr.Rset.Wb.Frate.gmsk. \n
			:param codec_mode: integer | ON | OFF Range: 1 to 3 (if all codec modes are active, otherwise less) Additional parameters OFF (ON) disables (enables) codec mode.
		"""
		param = Conversions.decimal_or_bool_value_to_str(codec_mode)
		self._core.io.write(f'CONFigure:GSM:SIGNaling<Instance>:CONNection:CSWitched:AMR:CMODe:WB:FRATe:GMSK:UL {param}')
