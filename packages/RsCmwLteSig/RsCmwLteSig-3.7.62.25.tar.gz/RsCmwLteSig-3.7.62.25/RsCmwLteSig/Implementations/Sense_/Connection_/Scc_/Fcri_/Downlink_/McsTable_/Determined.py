...
class Determined:
	...
	def get(self, tablename: enums.Table = None, secondaryCompCarrier=repcap.SecondaryCompCarrier.Default) -> List[int]:
		...
		Snippet: value: List[int] = driver.sense.connection.scc.fcri.downlink.mcsTable.determined.get(tablename = enums.Table.ANY, secondaryCompCarrier = repcap.SecondaryCompCarrier.Default) \n
