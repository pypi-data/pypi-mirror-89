...
class Slot:
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Default, allocationPerUser=repcap.AllocationPerUser.Default) -> float:
		...
		Snippet: value: float = driver.source.bb.nr5G.scheduling.cell.subf.common.alloc.slot.get(channel = repcap.Channel.Default, stream = repcap.Stream.Default, allocationPerUser = repcap.AllocationPerUser.Default) \n
