...
from mastapy.system_model.analyses_and_results.system_deflections import _2359, _2357, _2267
...
class SpiralBevelGearSetSystemDeflection(_2267.BevelGearSetSystemDeflection):
    '''SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3359.SpiralBevelGearSetPowerFlow':
        ...
        return constructor.new(_3359.SpiralBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2359.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSystemDeflection, constructor.new(_2359.SpiralBevelGearSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_system_deflection(self) -> 'List[_2357.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesSystemDeflection, constructor.new(_2357.SpiralBevelGearMeshSystemDeflection))
        return value
