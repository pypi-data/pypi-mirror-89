...
class SpringDamperHalfModalAnalysis(_4784.CouplingHalfModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2361.SpringDamperHalfSystemDeflection':
        ...
        return constructor.new(_2361.SpringDamperHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
