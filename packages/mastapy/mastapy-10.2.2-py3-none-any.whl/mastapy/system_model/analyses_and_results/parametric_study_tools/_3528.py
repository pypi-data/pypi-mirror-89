...
class ClutchConnectionParametricStudyTool(_3544.CouplingConnectionParametricStudyTool):
    '''ClutchConnectionParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2271.ClutchConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2271.ClutchConnectionSystemDeflection))
        return value
