...
class ConceptGearGearWhineAnalysis(_5366.GearGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2282.ConceptGearSystemDeflection':
        ...
        return constructor.new(_2282.ConceptGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
