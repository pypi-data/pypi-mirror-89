...
class Active:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:SELection:GALileo<ST>:ACTive \n
		Snippet: value: int = driver.source.bb.gnss.sv.selection.galileo.active.get(stream = repcap.Stream.Default) \n
