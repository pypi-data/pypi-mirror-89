...
def authenticate(clientid, secret, tenant):
    """
    Wraps the ServicePrincipalCredentials object. Handle these values with care! Best practice is to securely set them as environment variables in CI/CD pipelines or non-source control managed configs if testing locally.
    """
