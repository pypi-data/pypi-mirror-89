...
class Antenna:
	...
	def set(self, connector_all: str, ext_att: float = None, enp: float = None, antenna=repcap.Antenna.Default) -> None:
		...
		uses antenna 1 and 2. Segment 1 uses antenna 3 and 4. \n
			...
			:param enp: numeric Expected nominal power for antenna n for true MIMO. It can be calculated as follows: Range (Expected Nominal Power) = Range (Input Power) + External Attenuation - User Margin The input power range is stated in the data sheet.
	...
	class GetStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Enp: float: numeric Expected nominal power for antenna n for true MIMO. It can be calculated as follows: Range (Expected Nominal Power) = Range (Input Power) + External Attenuation - User Margin The input power range is stated in the data sheet."""
		__meta_args_list = [
