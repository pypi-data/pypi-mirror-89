...
class Poffset:
	...
	def set(self, poffset: float, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.mstation.cmode.poffset.set(poffset = 1.0, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:MSTation<ST>:CMODe:POFFset \n
		Snippet: value: float = driver.source.bb.w3Gpp.mstation.cmode.poffset.get(stream = repcap.Stream.Default) \n
		The command sets the power offset for mode USER. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Mstation')
