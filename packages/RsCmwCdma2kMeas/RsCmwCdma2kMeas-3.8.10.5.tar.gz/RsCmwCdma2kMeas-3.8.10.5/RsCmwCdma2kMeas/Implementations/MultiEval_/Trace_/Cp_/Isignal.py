...
class Isignal:
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Isignal_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Isignal_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Isignal_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Isignal_.Minimum import Minimum
	...
	def state(self):
		...
		if not hasattr(self, '_state'):
			from .Isignal_.State import State
