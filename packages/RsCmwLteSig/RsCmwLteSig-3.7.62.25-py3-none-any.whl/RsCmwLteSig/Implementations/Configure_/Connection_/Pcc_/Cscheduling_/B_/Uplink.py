...
class Uplink:
	...
	def get_all(self) -> AllStruct:
		...
		Snippet: value: AllStruct = driver.configure.connection.pcc.cscheduling.b.uplink.get_all() \n
		No command help available \n
			:return: structure: for return value, see the help for AllStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:CSCHeduling:B:UL:ALL?', self.__class__.AllStruct())

	def set_all(self, value: AllStruct) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:CONNection[:PCC]:CSCHeduling:B:UL:ALL \n
		Snippet: driver.configure.connection.pcc.cscheduling.b.uplink.set_all(value = AllStruct()) \n
		No command help available \n
			:param value: see the help for AllStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:CSCHeduling:B:UL:ALL', value)
