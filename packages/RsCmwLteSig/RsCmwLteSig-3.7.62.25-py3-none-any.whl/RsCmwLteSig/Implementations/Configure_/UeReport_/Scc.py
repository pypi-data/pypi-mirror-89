...
class Scc:
	"""Scc commands group definition. 7 total commands, 2 Sub-groups, 0 group commands
	...
	def dmtc(self):
		...
		if not hasattr(self, '_dmtc'):
			from .Scc_.Dmtc import Dmtc
			self._dmtc = Dmtc(self._core, self._base)
		return self._dmtc
