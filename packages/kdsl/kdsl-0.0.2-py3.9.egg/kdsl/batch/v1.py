...
class JobStatus(K8sObject):
    ...
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.batch.v1.JobConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.batch.v1_converters.optional_mlist_converter_JobConditionItem, default=OMIT)
...
class Job(K8sResource):
    ...
    status: Union[None, OmitEnum, kdsl.batch.v1.JobStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.batch.v1_converters.optional_converter_JobStatus, default=OMIT)
