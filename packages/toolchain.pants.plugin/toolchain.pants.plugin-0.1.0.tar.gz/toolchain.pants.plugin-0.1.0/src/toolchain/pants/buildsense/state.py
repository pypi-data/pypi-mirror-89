...
from toolchain.pants.buildsense.converter import WorkUnitCoverter, WorkUnitsMap
...
class BuildState:
    ...
    def queue_workunits(self, call_num: int, workunits: WorkUnitsMap, timestamp: int) -> None:
        run_id = self._run_id
        if not run_id:
