...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.bler.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:GSM:SIGNaling<Instance>:BLER:STATe:ALL?', self.__class__.FetchStruct())
