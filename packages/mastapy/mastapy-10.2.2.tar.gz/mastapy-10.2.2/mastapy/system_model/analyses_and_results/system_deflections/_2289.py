...
class CouplingConnectionSystemDeflection(_2320.InterMountableComponentConnectionSystemDeflection):
    '''CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3298.CouplingConnectionPowerFlow':
