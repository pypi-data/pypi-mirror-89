...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5814
...
class StraightBevelPlanetGearCompoundGearWhineAnalysis(_5814.StraightBevelDiffGearCompoundGearWhineAnalysis):
    '''StraightBevelPlanetGearCompoundGearWhineAnalysis
