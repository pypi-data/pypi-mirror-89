/** src/common에 있는 vpSuggestInputText을 api block에 맞게 커스텀 */define([
    ...
    var MakeVpSuggestInputText_apiblock = function(id, value, loadedVariableNameList, classList,placeholder, callback = console.log) {
        ...
        // suggestInputArg1.setSelectEvent(function(selectedValue) { 
