...
class WorkspaceFetcher(object):
    def __init__(self, sdk_key=None, update_interval=None, blocking_timeout=None, logger=None, tls_v1=False,
                 timeout=None):
        self.sdk_key = sdk_key
        self.workspace_url = (tls_v1 and enums.Default.TLS_V1_WORKSPACE_URL) or enums.Default.WORKSPACE_URL
