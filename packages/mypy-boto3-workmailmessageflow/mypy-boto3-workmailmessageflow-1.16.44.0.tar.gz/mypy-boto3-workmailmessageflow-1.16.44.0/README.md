...
[boto3.WorkMailMessageFlow 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/workmailmessageflow.html#WorkMailMessageFlow) service
compatible with
