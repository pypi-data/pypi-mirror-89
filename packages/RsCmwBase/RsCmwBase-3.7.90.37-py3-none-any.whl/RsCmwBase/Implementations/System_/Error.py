...
class Error:
	...
	def get_all(self) -> AllStruct:
		...
		Queries and deletes all entries in the error queue. Each entry consists of an error number and a short error description.
		Positive error numbers are instrument-specific. Negative error numbers are reserved by the SCPI standard. \n
	...
	def get_next(self) -> NextStruct:
		...
		Queries and deletes the oldest entry in the error queue. Each entry consists of an error number and a short error
		description. Positive error numbers are instrument-specific. Negative error numbers are reserved by the SCPI standard.
		The command has the same effect as STATus. \n
