...
class RollingRingParametricStudyTool(_3545.CouplingHalfParametricStudyTool):
    '''RollingRingParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2349.RollingRingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2349.RollingRingSystemDeflection))
        return value
