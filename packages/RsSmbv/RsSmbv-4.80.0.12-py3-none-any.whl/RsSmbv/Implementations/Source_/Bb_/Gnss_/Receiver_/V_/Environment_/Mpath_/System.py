...
class System:
	...
	def set(self, system_source: enums.Hybrid, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.source.bb.gnss.receiver.v.environment.mpath.system.set(system_source = enums.Hybrid.BEIDou, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> enums.Hybrid:
		"""SCPI: [SOURce<HW>]:BB:GNSS:RECeiver:[V<ST>]:ENVironment:MPATh:SYSTem \n
		Snippet: value: enums.Hybrid = driver.source.bb.gnss.receiver.v.environment.mpath.system.get(stream = repcap.Stream.Default) \n
		Sets the GNSS system. If the copy to function is used, this setting refers to the source. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'V')
