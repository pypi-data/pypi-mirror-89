...
class Current:
	...
	def read(self) -> ResultData:
		...
		return self._core.io.query_struct(f'READ:GSM:MEASurement<Instance>:MEValuation:TRACe:IQ:CURRent?', self.__class__.ResultData())
	...
	def fetch(self) -> ResultData:
		...
		Returns the results in the I/Q constellation diagram. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:GSM:MEASurement<Instance>:MEValuation:TRACe:IQ:CURRent?', self.__class__.ResultData())
