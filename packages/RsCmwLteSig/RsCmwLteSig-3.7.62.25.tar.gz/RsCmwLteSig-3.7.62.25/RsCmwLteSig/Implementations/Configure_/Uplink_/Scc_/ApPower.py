...
class ApPower:
	"""ApPower commands group definition. 6 total commands, 6 Sub-groups, 0 group commands"""
	...
	def eaSettings(self):
		...
		if not hasattr(self, '_eaSettings'):
			from .ApPower_.EaSettings import EaSettings
			self._eaSettings = EaSettings(self._core, self._base)
