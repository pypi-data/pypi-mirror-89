...
from mastapy.system_model.analyses_and_results import _2251
...
class StaticLoadCase(_6097.LoadCase):
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2251.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2251.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None
