...
class BlAllocation:
	...
	def get(self, ch_20_index: enums.Ch20Index) -> GetStruct:
		"""SCPI: CONFigure:WLAN:SIGNaling<instance>:CONNection:DFRame:HEMU:BLALlocation \n
		Snippet: value: GetStruct = driver.configure.connection.dframe.hemu.blAllocation.get(ch_20_index = enums.Ch20Index.CHA1) \n
		...
		return self._core.io.query_struct(f'CONFigure:WLAN:SIGNaling<Instance>:CONNection:DFRame:HEMU:BLALlocation? {param}', self.__class__.GetStruct())
