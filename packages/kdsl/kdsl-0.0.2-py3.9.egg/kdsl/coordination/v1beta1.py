...
class Lease(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.coordination.v1beta1.LeaseSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.coordination.v1beta1_converters.optional_converter_LeaseSpec, default=OMIT)
