...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4041, _4040, _4068
...
class ConceptGearSetModalAnalysesAtSpeeds(_4068.GearSetModalAnalysesAtSpeeds):
    ...
    @property
    def concept_gears_modal_analyses_at_speeds(self) -> 'List[_4041.ConceptGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysesAtSpeeds, constructor.new(_4041.ConceptGearModalAnalysesAtSpeeds))
        return value

    @property
    def concept_meshes_modal_analyses_at_speeds(self) -> 'List[_4040.ConceptGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysesAtSpeeds, constructor.new(_4040.ConceptGearMeshModalAnalysesAtSpeeds))
        return value
