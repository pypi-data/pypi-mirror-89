...
class Delay:
	...
	def set(self, delay: float, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.pramp.trigger.external.delay.set(delay = 1.0, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:PRAMp:TRIGger:[EXTernal<CH>]:DELay \n
		Snippet: value: float = driver.source.bb.pramp.trigger.external.delay.get(channel = repcap.Channel.Default) \n
		No command help available \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'External')
