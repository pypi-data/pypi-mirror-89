...
class TimeSeriesLoadCase(_6097.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5093.MBDAnalysisOptions':
        ...
        return constructor.new(_5093.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
