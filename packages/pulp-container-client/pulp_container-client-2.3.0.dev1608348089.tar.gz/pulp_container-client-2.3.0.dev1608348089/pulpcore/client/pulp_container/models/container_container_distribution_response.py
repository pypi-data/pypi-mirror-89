...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, base_path=None, repository=None, content_guard=None, repository_version=None, name=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
