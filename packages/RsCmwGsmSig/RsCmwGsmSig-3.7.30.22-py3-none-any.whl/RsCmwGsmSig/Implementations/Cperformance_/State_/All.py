...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.cperformance.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:GSM:SIGNaling<Instance>:CPERformance:STATe:ALL?', self.__class__.FetchStruct())
