...
class AccAddress(str):
    """`terra-` prefixed Bech32-encoded account address, works anywhere a `str` is
...
class ValAddress(str):
    """`terravaloper-` prefixed Bech32-encoded account address, works anywhere a `str`
...
class ValConsAddress(str):
    """`terravalcons-` prefixed Bech32-encoded consensus address, works anywhere a `str`
    is accepted but will perform verification on the checksum.
