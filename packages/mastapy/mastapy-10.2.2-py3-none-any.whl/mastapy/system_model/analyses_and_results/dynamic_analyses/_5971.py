...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2269, _5883
...
class RootAssemblyDynamicAnalysis(_5883.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2269.DynamicAnalysis':
        ...
        if _2269.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysisInputs.__class__.__mro__:
