...
class TestMyReport:
    ...
    def test_get_my_reports_without_parameters(self, mocker):
        ...
        my_report.list()
        spy_method_paginate.assert_called_once_with(endpoint='report/my-report', params={})
    ...
    def test_get_incident_reports_with_parameters(self, mocker):
        ...
        spy_method_paginate.assert_called_once_with(endpoint='report/my-report', params=expected_params)
