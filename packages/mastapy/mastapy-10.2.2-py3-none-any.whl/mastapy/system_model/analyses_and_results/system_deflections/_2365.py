...
from mastapy.system_model.analyses_and_results.power_flows import _3364, _3369, _3370
...
class StraightBevelDiffGearSystemDeflection(_2268.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3364.StraightBevelDiffGearPowerFlow':
