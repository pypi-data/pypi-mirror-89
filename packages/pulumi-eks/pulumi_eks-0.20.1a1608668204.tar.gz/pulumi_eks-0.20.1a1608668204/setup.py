...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.20.1-alpha.1608668204+d1ae8e63'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.20.1-alpha.1608668204+d1ae8e63`
                """)
            else:
                raise
