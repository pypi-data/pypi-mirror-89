...
from mastapy.bearings.bearing_results.rolling import _1684, _1651
...
class LoadedSelfAligningBallBearingRow(_1651.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1684.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1684.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
