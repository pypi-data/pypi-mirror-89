...
class Prach:
	...
	def get_sc_spacing(self) -> enums.SubCarrSpacingB:
		...
		format, see Table 'Preambles in the frequency domain'. \n
			:return: subcarr_spacing: 1.25 kHz, 5 kHz, 15 kHz, 30 kHz, 60 kHz
		"""
	...
	def set_sc_spacing(self, subcarr_spacing: enums.SubCarrSpacingB) -> None:
		"""SCPI: CONFigure:NRSub:MEASurement<Instance>:PRACh:SCSPacing \n
		Snippet: driver.configure.nrSubMeas.prach.set_sc_spacing(subcarr_spacing = enums.SubCarrSpacingB.S15K) \n
		Specifies the subcarrier spacing used by the UE for the preambles. The allowed subset of values depends on the preamble
		format, see Table 'Preambles in the frequency domain'. \n
			:param subcarr_spacing: 1.25 kHz, 5 kHz, 15 kHz, 30 kHz, 60 kHz
		"""
		param = Conversions.enum_scalar_to_str(subcarr_spacing, enums.SubCarrSpacingB)
