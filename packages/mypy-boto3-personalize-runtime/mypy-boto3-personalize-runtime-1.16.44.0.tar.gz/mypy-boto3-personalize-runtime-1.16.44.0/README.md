...
[boto3.PersonalizeRuntime 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/personalize-runtime.html#PersonalizeRuntime) service
compatible with
