...
class HypoidGearMeshSystemDeflection(_2327.AGMAGleasonConicalGearMeshSystemDeflection):
    '''HypoidGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3724.HypoidGearMeshPowerFlow':
        ...
        return constructor.new(_3724.HypoidGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
