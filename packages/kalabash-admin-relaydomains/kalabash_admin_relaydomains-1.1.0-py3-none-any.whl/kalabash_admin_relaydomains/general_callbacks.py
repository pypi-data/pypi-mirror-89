...
PERMISSIONS = {
    "Resellers": [
        ("kalabash_admin_relaydomains", "relaydomain", "add_relaydomain"),
        ("kalabash_admin_relaydomains", "relaydomain", "change_relaydomain"),
        ("kalabash_admin_relaydomains", "relaydomain", "delete_relaydomain"),
        ("kalabash_admin_relaydomains", "service", "add_service"),
        ("kalabash_admin_relaydomains", "service", "change_service"),
        ("kalabash_admin_relaydomains", "service", "delete_service")
    ]
}
...
def extra_permissions(rolename):
    ...
    if not exts_pool.is_extension_installed("kalabash_admin_limits"):
        return []
...
def static_content(caller, st_type, user):
    ...
    t = Template("""<script src="{{ STATIC_URL }}kalabash_admin_relaydomains/js/relay_domains.js" type="text/javascript"></script>
...
def extra_wizard_step():
    ...
    return [RelayDomainWizardStep(
        ...
        "kalabash_admin_relaydomains/relaydomain_form.html"
    )]
...
def extra_domain_form(user, domain):
    ...
    if not user.has_perm("kalabash_admin_relaydomains.change_relaydomain"):
        return []
    ...
    return [{
        ...
        "formtpl": "kalabash_admin_relaydomains/relaydomain_form.html"
    }]
