...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.14.0-alpha.1608644336+3b11a2f1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.14.0-alpha.1608644336+3b11a2f1`
                """)
            else:
                raise
