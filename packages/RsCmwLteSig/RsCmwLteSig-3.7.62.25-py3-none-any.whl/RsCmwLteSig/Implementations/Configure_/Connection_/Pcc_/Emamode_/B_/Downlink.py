...
class Downlink:
	...
	class AllStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			- Number_Rb: float: ZERO | N4 | N6 Number of allocated resource blocks
			- Start_Rb: int: Position of first resource block Range: 0 to 0
			- Narrow_Band: int: Narrowband for the first transmission Range: 0 to 15
			- Modulation: enums.Modulation: QPSK Modulation type QPSK
			- Transp_Block_Size_Idx: int: Transport block size index Range: 0 to 9"""
		__meta_args_list = [
	...
	def get_all(self) -> AllStruct:
		...
		Snippet: value: AllStruct = driver.configure.connection.pcc.emamode.b.downlink.get_all() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:EMAMode:B:DL:ALL?', self.__class__.AllStruct())

	def set_all(self, value: AllStruct) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:CONNection[:PCC]:EMAMode:B:DL:ALL \n
		Snippet: driver.configure.connection.pcc.emamode.b.downlink.set_all(value = AllStruct()) \n
		Configures the eMTC auto mode, downlink, for CE mode B. The indicated input ranges list all possible values. The ranges
		have dependencies described in the background information, see Table 'eMTC auto mode settings'. \n
			:param value: see the help for AllStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:EMAMode:B:DL:ALL', value)
