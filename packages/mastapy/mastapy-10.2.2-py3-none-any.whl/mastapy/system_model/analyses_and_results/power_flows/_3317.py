...
from mastapy.system_model.analyses_and_results.power_flows import _3315, _3316, _3356
...
class GearSetPowerFlow(_3356.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3315.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3315.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3316.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3316.GearPowerFlow))
        return value
