...
class State:
	...
	def fetch(self) -> List[enums.ResultStateB]:
		...
		Snippet: value: List[enums.ResultStateB] = driver.multiEval.trace.cde.qsignal.rri.state.fetch() \n
		...
		response = self._core.io.query_str_suppressed(f'FETCh:EVDO:MEASurement<Instance>:MEValuation:TRACe:CDE:QSIGnal:RRI:STATe?', suppressed)
