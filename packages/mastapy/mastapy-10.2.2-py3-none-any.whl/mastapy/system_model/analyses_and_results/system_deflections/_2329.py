...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2323.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3331.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow':
        ...
        return constructor.new(_3331.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
