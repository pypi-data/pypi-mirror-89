...
class Downlink:
	...
	def set(self, structure: DownlinkStruct, stream=repcap.Stream.Default) -> None:
		...
		Snippet: driver.configure.connection.pcc.sps.downlink.set(value = [PROPERTY_STRUCT_NAME](), stream = repcap.Stream.Default) \n
		...
		self._core.io.write_struct(f'CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:SPS:DL{stream_cmd_val}', structure)
