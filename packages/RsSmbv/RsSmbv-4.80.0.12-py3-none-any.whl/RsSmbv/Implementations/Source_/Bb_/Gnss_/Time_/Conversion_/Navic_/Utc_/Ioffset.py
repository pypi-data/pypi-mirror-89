...
class Ioffset:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:NAVic<ST>:UTC:IOFFset \n
		Snippet: value: int = driver.source.bb.gnss.time.conversion.navic.utc.ioffset.get(stream = repcap.Stream.Default) \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:GNSS:TIME:CONVersion:NAVic{stream_cmd_val}:UTC:IOFFset?')
