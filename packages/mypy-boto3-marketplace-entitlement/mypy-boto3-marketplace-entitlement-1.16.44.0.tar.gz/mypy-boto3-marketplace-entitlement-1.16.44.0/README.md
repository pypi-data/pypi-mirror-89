...
[boto3.MarketplaceEntitlementService 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
compatible with
