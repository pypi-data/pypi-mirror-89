...
from mastapy.bearings.bearing_results.rolling import _1715, _1662
...
class LoadedRollerBearingElement(_1662.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1715.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1715.ResultsAtRollerOffset))
        return value
