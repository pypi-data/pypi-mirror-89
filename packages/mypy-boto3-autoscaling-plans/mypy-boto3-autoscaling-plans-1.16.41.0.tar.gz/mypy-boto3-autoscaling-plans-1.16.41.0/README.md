...
[boto3.AutoScalingPlans 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/autoscaling-plans.html#AutoScalingPlans) service
compatible with
