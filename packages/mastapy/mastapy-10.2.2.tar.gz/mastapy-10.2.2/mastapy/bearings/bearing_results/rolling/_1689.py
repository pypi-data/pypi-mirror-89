...
from mastapy.bearings.bearing_results.rolling import _1688, _1678
...
class LoadedSphericalRollerRadialBearingRow(_1678.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1688.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1688.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
