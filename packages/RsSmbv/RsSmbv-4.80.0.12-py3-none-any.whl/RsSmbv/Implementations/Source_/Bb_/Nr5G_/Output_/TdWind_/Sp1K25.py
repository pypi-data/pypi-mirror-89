...
class Sp1K25:
	...
	def get_trtsamples(self) -> int:
		"""SCPI: [SOURce<HW>]:BB:NR5G:OUTPut:TDWind:SP1K25:TRTSamples \n
		Snippet: value: int = driver.source.bb.nr5G.output.tdWind.sp1K25.get_trtsamples() \n
	...
	def get_tr_time(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:NR5G:OUTPut:TDWind:SP1K25:TRTime \n
		Snippet: value: float = driver.source.bb.nr5G.output.tdWind.sp1K25.get_tr_time() \n
		No command help available \n
	...
	def set_tr_time(self, transition_time: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:OUTPut:TDWind:SP1K25:TRTime \n
		Snippet: driver.source.bb.nr5G.output.tdWind.sp1K25.set_tr_time(transition_time = 1.0) \n
		No command help available \n
