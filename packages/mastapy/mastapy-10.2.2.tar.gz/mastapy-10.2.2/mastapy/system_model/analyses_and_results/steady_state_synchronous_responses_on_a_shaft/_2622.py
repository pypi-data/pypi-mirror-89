...
class SteadyStateSynchronousResponseOnAShaft(_6548.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3111.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3111.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
