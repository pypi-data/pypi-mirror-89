...
class PlanetaryConnectionSystemDeflection(_2355.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3341.PlanetaryConnectionPowerFlow':
        ...
        return constructor.new(_3341.PlanetaryConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
