...
class ShaftHubConnection(_2033.Connector):
    ...
    @property
    def tilt_stiffness_type(self) -> '_2170.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2170.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2170.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def twod_spline_drawing(self) -> '_6556.SMTBitmap':
        ...
        return constructor.new(_6556.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None
    ...
    @property
    def flank_lead_crowning(self) -> '_2163.CrowningSpecification':
        ...
        return constructor.new(_2163.CrowningSpecification)(self.wrapped.FlankLeadCrowning) if self.wrapped.FlankLeadCrowning else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2171.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2171.RigidConnectorToothLocation))
        return value
