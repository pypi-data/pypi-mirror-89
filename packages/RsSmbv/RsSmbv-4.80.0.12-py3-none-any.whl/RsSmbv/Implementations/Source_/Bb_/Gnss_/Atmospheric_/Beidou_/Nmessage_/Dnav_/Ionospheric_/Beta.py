...
class Beta:
	...
	def set(self, beta: int, channel=repcap.Channel.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ATMospheric:BEIDou:[NMESsage]:[DNAV]:IONospheric:BETA<CH> \n
		Snippet: driver.source.bb.gnss.atmospheric.beidou.nmessage.dnav.ionospheric.beta.set(beta = 1, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ATMospheric:BEIDou:[NMESsage]:[DNAV]:IONospheric:BETA<CH> \n
		Snippet: value: int = driver.source.bb.gnss.atmospheric.beidou.nmessage.dnav.ionospheric.beta.get(channel = repcap.Channel.Default) \n
		Sets the parameters beta_0 to beta_3 of the satellite's navigation message. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Beta')
