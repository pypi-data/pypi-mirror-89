...
class Cell:
	...
	def set(self, structure: CellStruct, cellNo=repcap.CellNo.Default) -> None:
		...
		self._core.io.write_struct(f'CONFigure:EVDO:SIGNaling<Instance>:NCELl:EVDO:CELL{cellNo_cmd_val}', structure)
	...
	def get(self, cellNo=repcap.CellNo.Default) -> CellStruct:
		...
		cellNo_cmd_val = self._base.get_repcap_cmd_value(cellNo, repcap.CellNo)
		return self._core.io.query_struct(f'CONFigure:EVDO:SIGNaling<Instance>:NCELl:EVDO:CELL{cellNo_cmd_val}?', self.__class__.CellStruct())
