...
class ConceptCouplingSystemDeflection(_2291.CouplingSystemDeflection):
    '''ConceptCouplingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3289.ConceptCouplingPowerFlow':
        ...
        return constructor.new(_3289.ConceptCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
