...
from mastapy.system_model.analyses_and_results.system_deflections import _2271, _2372
...
class SynchroniserHalfSystemDeflection(_2372.SynchroniserPartSystemDeflection):
    '''SynchroniserHalfSystemDeflection
    ...
    @property
    def clutch_connection(self) -> '_2271.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2271.ClutchConnectionSystemDeflection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
    ...
    @property
    def power_flow_results(self) -> '_3371.SynchroniserHalfPowerFlow':
        ...
        return constructor.new(_3371.SynchroniserHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
