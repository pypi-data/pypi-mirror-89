...
class Cc:
	"""Cc commands group definition. 14 total commands, 8 Sub-groups, 0 group commands
	...
	def nbwParts(self):
		...
		if not hasattr(self, '_nbwParts'):
			from .Cc_.NbwParts import NbwParts
	...
	@property
	def allocation(self):
		"""allocation commands group. 1 Sub-classes, 1 commands."""
