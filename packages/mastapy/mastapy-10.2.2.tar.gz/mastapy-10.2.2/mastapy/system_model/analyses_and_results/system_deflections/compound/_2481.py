...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2473
...
class PlanetCarrierCompoundSystemDeflection(_2473.MountableComponentCompoundSystemDeflection):
    '''PlanetCarrierCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2343.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2343.PlanetCarrierSystemDeflection))
        return value

    @property
    def component_system_deflection_load_cases(self) -> 'List[_2343.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionLoadCases, constructor.new(_2343.PlanetCarrierSystemDeflection))
        return value
