...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, name=None, pulp_created=None, repository=None, repository_version=None, pulp_href=None, base_path=None, registry_path=None, namespace=None, local_vars_configuration=None):  # noqa: E501
