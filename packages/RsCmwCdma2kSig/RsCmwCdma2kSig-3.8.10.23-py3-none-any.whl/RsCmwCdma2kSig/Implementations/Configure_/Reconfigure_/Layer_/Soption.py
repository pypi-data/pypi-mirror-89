...
class Soption:
	...
	def get_first(self) -> enums.ServiceOption:
		...
		Snippet: value: enums.ServiceOption = driver.configure.reconfigure.layer.soption.get_first() \n
		Sets the primary service option to be proposed to the MS during an active connection. Trigger the reconfiguration of the
		current connection via method RsCmwCdma2kSig.Call.Reconfigure.start. \n
		...
		"""
		response = self._core.io.query_str('CONFigure:CDMA:SIGNaling<Instance>:REConfigure:LAYer:SOPTion:FIRSt?')
	...
	def set_first(self, service_option: enums.ServiceOption) -> None:
		"""SCPI: CONFigure:CDMA:SIGNaling<Instance>:REConfigure:LAYer:SOPTion:FIRSt \n
		Snippet: driver.configure.reconfigure.layer.soption.set_first(service_option = enums.ServiceOption.SO1) \n
		Sets the primary service option to be proposed to the MS during an active connection. Trigger the reconfiguration of the
		current connection via method RsCmwCdma2kSig.Call.Reconfigure.start. \n
		...
		self._core.io.write(f'CONFigure:CDMA:SIGNaling<Instance>:REConfigure:LAYer:SOPTion:FIRSt {param}')
