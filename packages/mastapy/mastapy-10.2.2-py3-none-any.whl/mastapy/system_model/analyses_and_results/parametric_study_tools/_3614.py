...
class ShaftParametricStudyTool(_3510.AbstractShaftOrHousingParametricStudyTool):
    '''ShaftParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2354.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2354.ShaftSystemDeflection))
        return value
