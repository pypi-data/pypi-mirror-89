...
class Tot:
	...
	def set(self, tot: int, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:QZSS<ST>:UTC:TOT \n
		Snippet: driver.source.bb.gnss.time.conversion.qzss.utc.tot.set(tot = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:QZSS<ST>:UTC:TOT \n
		Snippet: value: int = driver.source.bb.gnss.time.conversion.qzss.utc.tot.get(stream = repcap.Stream.Default) \n
		Sets the UTC data reference time of week, tot. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Qzss')
