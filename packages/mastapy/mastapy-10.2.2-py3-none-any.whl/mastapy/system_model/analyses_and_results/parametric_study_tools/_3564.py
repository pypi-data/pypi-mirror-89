...
class FaceGearParametricStudyTool(_3568.GearParametricStudyTool):
    '''FaceGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2310.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2310.FaceGearSystemDeflection))
        return value
