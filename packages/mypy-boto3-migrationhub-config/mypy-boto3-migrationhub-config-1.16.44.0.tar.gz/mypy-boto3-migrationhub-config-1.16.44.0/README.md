...
[boto3.MigrationHubConfig 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/migrationhub-config.html#MigrationHubConfig) service
compatible with
