...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3806, _3773
...
class RootAssemblyModalAnalysesAtStiffnesses(_3773.AssemblyModalAnalysesAtStiffnesses):
    '''RootAssemblyModalAnalysesAtStiffnesses
    ...
    @property
    def modal_analyses_at_stiffnesses_inputs(self) -> '_3806.CriticalSpeedAnalysis':
        ...
        return constructor.new(_3806.CriticalSpeedAnalysis)(self.wrapped.ModalAnalysesAtStiffnessesInputs) if self.wrapped.ModalAnalysesAtStiffnessesInputs else None
