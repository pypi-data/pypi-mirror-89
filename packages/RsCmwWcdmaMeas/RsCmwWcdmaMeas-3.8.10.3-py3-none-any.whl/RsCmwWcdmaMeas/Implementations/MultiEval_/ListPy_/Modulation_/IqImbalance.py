...
class IqImbalance:
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .IqImbalance_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .IqImbalance_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .IqImbalance_.Maximum import Maximum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .IqImbalance_.StandardDev import StandardDev
	...
	def clone(self) -> 'IqImbalance':
		...
		new_group = IqImbalance(self._core, self._base.parent)
