...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3811, _3810, _3822
...
class CylindricalGearSetModalAnalysesAtStiffnesses(_3822.GearSetModalAnalysesAtStiffnesses):
    '''CylindricalGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def cylindrical_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3811.CylindricalGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysesAtStiffnesses, constructor.new(_3811.CylindricalGearModalAnalysesAtStiffnesses))
        return value

    @property
    def cylindrical_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3810.CylindricalGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysesAtStiffnesses, constructor.new(_3810.CylindricalGearMeshModalAnalysesAtStiffnesses))
        return value
