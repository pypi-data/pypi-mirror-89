...
class Available:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:SELection:BEIDou<ST>:AVAilable \n
		Snippet: value: int = driver.source.bb.gnss.sv.selection.beidou.available.get(stream = repcap.Stream.Default) \n
