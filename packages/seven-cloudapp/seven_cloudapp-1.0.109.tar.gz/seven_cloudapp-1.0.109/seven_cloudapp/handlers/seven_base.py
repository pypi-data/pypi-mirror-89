...
:LastEditTime: 2020-12-25 17:21:19
...
class SevenBaseHandler(BaseApiHandler):
    ...
    def get_online_url(self, act_id, app_id, page="pages/index/index"):
        """
        ...
        :last_editors: HuangJingCan
        """
        page_index = CodingHelper.url_encode(page)
        online_url = f"https://m.duanqu.com/?_ariver_appid={app_id}&page={page_index}&query=" + CodingHelper.url_encode(f"actid={act_id}")
        return online_url
