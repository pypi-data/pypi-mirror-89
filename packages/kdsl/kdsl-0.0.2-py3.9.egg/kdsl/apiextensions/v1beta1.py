...
class CustomResourceDefinitionSpec(K8sObject):
    ...
    names: kdsl.apiextensions.v1beta1.CustomResourceDefinitionNames = attr.ib(metadata={'yaml_name': 'names'}, converter=kdsl.apiextensions.v1beta1_converters.required_converter_CustomResourceDefinitionNames)
    scope: str = attr.ib(metadata={'yaml_name': 'scope'})
    additionalPrinterColumns: Union[None, OmitEnum, Sequence[kdsl.apiextensions.v1beta1.CustomResourceColumnDefinition]] = attr.ib(metadata={'yaml_name': 'additionalPrinterColumns'}, converter=kdsl.apiextensions.v1beta1_converters.optional_list_converter_CustomResourceColumnDefinition, default=OMIT)
    conversion: Union[None, OmitEnum, kdsl.apiextensions.v1beta1.CustomResourceConversion] = attr.ib(metadata={'yaml_name': 'conversion'}, converter=kdsl.apiextensions.v1beta1_converters.optional_converter_CustomResourceConversion, default=OMIT)
    preserveUnknownFields: Union[None, OmitEnum, bool] = attr.ib(metadata={'yaml_name': 'preserveUnknownFields'}, default=OMIT)
    subresources: Union[None, OmitEnum, kdsl.apiextensions.v1beta1.CustomResourceSubresources] = attr.ib(metadata={'yaml_name': 'subresources'}, converter=kdsl.apiextensions.v1beta1_converters.optional_converter_CustomResourceSubresources, default=OMIT)
    validation: Union[None, OmitEnum, kdsl.apiextensions.v1beta1.CustomResourceValidation] = attr.ib(metadata={'yaml_name': 'validation'}, converter=kdsl.apiextensions.v1beta1_converters.optional_converter_CustomResourceValidation, default=OMIT)
    version: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'version'}, default=OMIT)
    versions: Union[None, OmitEnum, Sequence[kdsl.apiextensions.v1beta1.CustomResourceDefinitionVersion]] = attr.ib(metadata={'yaml_name': 'versions'}, converter=kdsl.apiextensions.v1beta1_converters.optional_list_converter_CustomResourceDefinitionVersion, default=OMIT)


class CustomResourceDefinitionSpecOptionalTypedDict(TypedDict, total=(False)):
    additionalPrinterColumns: Sequence[kdsl.apiextensions.v1beta1.CustomResourceColumnDefinition]
...
class CustomResourceDefinitionStatus(K8sObject):
    acceptedNames: kdsl.apiextensions.v1beta1.CustomResourceDefinitionNames = attr.ib(metadata={'yaml_name': 'acceptedNames'}, converter=kdsl.apiextensions.v1beta1_converters.required_converter_CustomResourceDefinitionNames)
    storedVersions: Sequence[str] = attr.ib(metadata={'yaml_name': 'storedVersions'})
    conditions: Union[None, OmitEnum, Sequence[kdsl.apiextensions.v1beta1.CustomResourceDefinitionCondition]] = attr.ib(metadata={'yaml_name': 'conditions'}, converter=kdsl.apiextensions.v1beta1_converters.optional_list_converter_CustomResourceDefinitionCondition, default=OMIT)
...
class CustomResourceDefinitionStatusTypedDict(CustomResourceDefinitionStatusOptionalTypedDict, total=(True)):
...
class CustomResourceDefinition(K8sResource):
    ...
    spec: kdsl.apiextensions.v1beta1.CustomResourceDefinitionSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apiextensions.v1beta1_converters.required_converter_CustomResourceDefinitionSpec)
    ...
    status: Union[None, OmitEnum, kdsl.apiextensions.v1beta1.CustomResourceDefinitionStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apiextensions.v1beta1_converters.optional_converter_CustomResourceDefinitionStatus, default=OMIT)


@attr.s(kw_only=True)
class WebhookClientConfig(K8sObject):
    caBundle: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'caBundle'}, default=OMIT)
    service: Union[None, OmitEnum, kdsl.apiextensions.v1beta1.ServiceReference] = attr.ib(metadata={'yaml_name': 'service'}, converter=kdsl.apiextensions.v1beta1_converters.optional_converter_ServiceReference, default=OMIT)
...
class CustomResourceConversion(K8sObject):
    ...
    webhookClientConfig: Union[None, OmitEnum, kdsl.apiextensions.v1beta1.WebhookClientConfig] = attr.ib(metadata={'yaml_name': 'webhookClientConfig'}, converter=kdsl.apiextensions.v1beta1_converters.optional_converter_WebhookClientConfig, default=OMIT)
...
class CustomResourceSubresources(K8sObject):
    scale: Union[None, OmitEnum, kdsl.apiextensions.v1beta1.CustomResourceSubresourceScale] = attr.ib(metadata={'yaml_name': 'scale'}, converter=kdsl.apiextensions.v1beta1_converters.optional_converter_CustomResourceSubresourceScale, default=OMIT)
...
class CustomResourceDefinitionVersion(K8sObject):
    ...
    additionalPrinterColumns: Union[None, OmitEnum, Sequence[kdsl.apiextensions.v1beta1.CustomResourceColumnDefinition]] = attr.ib(metadata={'yaml_name': 'additionalPrinterColumns'}, converter=kdsl.apiextensions.v1beta1_converters.optional_list_converter_CustomResourceColumnDefinition, default=OMIT)
    schema: Union[None, OmitEnum, kdsl.apiextensions.v1beta1.CustomResourceValidation] = attr.ib(metadata={'yaml_name': 'schema'}, converter=kdsl.apiextensions.v1beta1_converters.optional_converter_CustomResourceValidation, default=OMIT)
    subresources: Union[None, OmitEnum, kdsl.apiextensions.v1beta1.CustomResourceSubresources] = attr.ib(metadata={'yaml_name': 'subresources'}, converter=kdsl.apiextensions.v1beta1_converters.optional_converter_CustomResourceSubresources, default=OMIT)
