...
[boto3.SagemakerEdgeManager 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/sagemaker-edge.html#SagemakerEdgeManager) service
compatible with
