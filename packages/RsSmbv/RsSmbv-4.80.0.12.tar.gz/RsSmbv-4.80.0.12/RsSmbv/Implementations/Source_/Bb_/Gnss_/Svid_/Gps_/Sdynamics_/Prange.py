...
class Prange:
	...
	def set(self, pr_ange: float, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:GPS<ST>:SDYNamics:PRANge \n
		Snippet: driver.source.bb.gnss.svid.gps.sdynamics.prange.set(pr_ange = 1.0, channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:GPS<ST>:SDYNamics:PRANge \n
		Snippet: value: float = driver.source.bb.gnss.svid.gps.sdynamics.prange.get(channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
		Sets the initial pseudorange. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Svid')
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Gps')
