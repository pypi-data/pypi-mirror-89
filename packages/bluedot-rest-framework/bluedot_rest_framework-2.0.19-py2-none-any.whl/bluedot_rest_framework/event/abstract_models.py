...
class AbstractEventLive(models.Model):
    ...
    live_room_id = models.CharField(max_length=16, verbose_name='直播房间id',null=True)
    live_create_room_time = models.DateTimeField(verbose_name='创建房间时间',null=True)
    live_stream_number = models.CharField(max_length=16, verbose_name='串流码',null=True)
    live_push_address = models.CharField(max_length=128, verbose_name='推流地址',null=True)
    live_vod_id = models.CharField(max_length=256, verbose_name='回放id',null=True)
    live_task_id = models.CharField(max_length=256, verbose_name='任务id',null=True)
