...
class OilSealParametricStudyTool(_3543.ConnectorParametricStudyTool):
    '''OilSealParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2337.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2337.OilSealSystemDeflection))
        return value
