...
from mastapy.utility.model_validation import _1330, _1331
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def all_status_errors(self) -> 'List[_1331.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1331.StatusItem))
        return value
