...
class Uplink:
	...
	class AllStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			- Number_Rb: enums.NumberRb2: ZERO | N1 | N2 | N3 | N4 | N5 | N6 Number of allocated resource blocks
	...
	def get_all(self) -> AllStruct:
		...
		Snippet: value: AllStruct = driver.configure.connection.pcc.emamode.a.uplink.get_all() \n
		...
		"""
		return self._core.io.query_struct('CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:EMAMode:A:UL:ALL?', self.__class__.AllStruct())

	def set_all(self, value: AllStruct) -> None:
		"""SCPI: CONFigure:LTE:SIGNaling<instance>:CONNection[:PCC]:EMAMode:A:UL:ALL \n
		Snippet: driver.configure.connection.pcc.emamode.a.uplink.set_all(value = AllStruct()) \n
		Configures the eMTC auto mode, uplink, for CE mode A. The indicated input ranges list all possible values. The ranges
		have dependencies described in the background information, see Table 'eMTC auto mode settings'. \n
			:param value: see the help for AllStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:LTE:SIGNaling<Instance>:CONNection:PCC:EMAMode:A:UL:ALL', value)
