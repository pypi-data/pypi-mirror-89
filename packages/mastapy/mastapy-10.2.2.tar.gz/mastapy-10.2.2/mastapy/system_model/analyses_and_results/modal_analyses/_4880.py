...
class ZerolBevelGearSetModalAnalysis(_4763.BevelGearSetModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2390.ZerolBevelGearSetSystemDeflection':
        ...
        return constructor.new(_2390.ZerolBevelGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
