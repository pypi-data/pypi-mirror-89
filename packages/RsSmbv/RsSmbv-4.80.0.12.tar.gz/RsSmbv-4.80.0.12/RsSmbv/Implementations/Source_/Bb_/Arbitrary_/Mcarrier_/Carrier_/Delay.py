...
class Delay:
	...
	def set(self, delay: float, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.arbitrary.mcarrier.carrier.delay.set(delay = 1.0, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:ARBitrary:MCARrier:CARRier<CH>:DELay \n
		Snippet: value: float = driver.source.bb.arbitrary.mcarrier.carrier.delay.get(channel = repcap.Channel.Default) \n
		Sets the start delay of the selected carrier. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Carrier')
