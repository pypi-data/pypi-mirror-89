...
class CurrentUserResponse(msrest.serialization.Model):
    ...
    :param application_role:  Possible values include: "Sentry", "ApplicationUser", "Invalid",
     "SaasAdmin", "AccountAdmin", "Technician", "User", "SystemProcess", "Sales",
...
class HubResponse(msrest.serialization.Model):
    ...
    :param nickname:
    :type nickname: str
    :param power_type_id:  Possible values include: "AC (120V)", "Unspecified", "DC (24V)",
     "Battery".
...
class UserCorporationChild(msrest.serialization.Model):
    ...
    :param corporation_abbreviation:
    :type corporation_abbreviation: str
    :param corporation_user_role:  Possible values include: "Sentry", "ApplicationUser", "Invalid",
     "SaasAdmin", "AccountAdmin", "Technician", "User", "SystemProcess", "Sales",
     "CorporationAdmin", "CorporationUser", "CorporationNone".
...
class UserLocationChild(msrest.serialization.Model):
    ...
    :param location_abbreviation:
    :type location_abbreviation: str
    :param location_user_role:  Possible values include: "Sentry", "ApplicationUser", "Invalid",
     "SaasAdmin", "AccountAdmin", "Technician", "User", "SystemProcess", "Sales",
     "CorporationAdmin", "CorporationUser", "CorporationNone".
