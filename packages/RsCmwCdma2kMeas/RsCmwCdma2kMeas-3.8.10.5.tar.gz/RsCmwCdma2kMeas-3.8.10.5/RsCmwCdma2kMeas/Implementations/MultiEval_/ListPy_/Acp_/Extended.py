...
class Extended:
	...
	def acpm(self):
		...
		if not hasattr(self, '_acpm'):
			from .Extended_.Acpm import Acpm
	...
	def acpp(self):
		...
		if not hasattr(self, '_acpp'):
			from .Extended_.Acpp import Acpp
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Extended_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Extended_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Extended_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Extended_.Minimum import Minimum
	...
	def standardDev(self):
		...
		if not hasattr(self, '_standardDev'):
			from .Extended_.StandardDev import StandardDev
