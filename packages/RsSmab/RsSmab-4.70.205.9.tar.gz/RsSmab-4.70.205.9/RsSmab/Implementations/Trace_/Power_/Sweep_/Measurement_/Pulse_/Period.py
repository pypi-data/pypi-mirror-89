...
class Period:
	...
	def get(self, channel=repcap.Channel.Default) -> float:
		...
		Snippet: value: float = driver.trace.power.sweep.measurement.pulse.period.get(channel = repcap.Channel.Default) \n
		...
		response = self._core.io.query_str(f'TRACe{channel_cmd_val}:POWer:SWEep:MEASurement:PULSe:PERiod?')
