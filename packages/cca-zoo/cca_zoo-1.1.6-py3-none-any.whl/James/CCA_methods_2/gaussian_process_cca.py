...
import CCA_methods_2
from CCA_methods_2.generate_data import generate_candola
...
class Wrapper:
    ...
    def fit(self, X_train, Y_train):
        ...
        # shape: 437 x 2
        warm_start_cca = CCA_methods_2.linear.DeepWrapper(outdim_size=self.outdim_size).fit(X_train, Y_train)
...
def main():
    ...
    lincca = CCA_methods_2.linear.DeepWrapper().fit(Z, Y)
