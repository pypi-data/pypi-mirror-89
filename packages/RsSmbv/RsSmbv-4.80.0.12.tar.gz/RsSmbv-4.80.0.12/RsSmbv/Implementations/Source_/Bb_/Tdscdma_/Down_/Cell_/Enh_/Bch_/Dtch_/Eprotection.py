...
class Eprotection:
	...
	def get(self, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> enums.EnhTchErr:
		...
		Snippet: value: enums.EnhTchErr = driver.source.bb.tdscdma.down.cell.enh.bch.dtch.eprotection.get(stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
