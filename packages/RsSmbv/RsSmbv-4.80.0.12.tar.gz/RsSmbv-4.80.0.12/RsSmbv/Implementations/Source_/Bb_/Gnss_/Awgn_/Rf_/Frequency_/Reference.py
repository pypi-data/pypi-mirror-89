...
class Reference:
	...
	def get(self, channel=repcap.Channel.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.gnss.awgn.rf.frequency.reference.get(channel = repcap.Channel.Default) \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:GNSS:AWGN:RF{channel_cmd_val}:FREQuency:REFerence?')
