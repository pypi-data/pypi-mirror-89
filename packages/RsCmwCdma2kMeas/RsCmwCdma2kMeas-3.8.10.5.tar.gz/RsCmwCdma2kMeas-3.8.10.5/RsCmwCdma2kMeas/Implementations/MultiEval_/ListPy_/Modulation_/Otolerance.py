...
class Otolerance:
	...
	def fetch(self) -> List[int]:
		...
		Snippet: value: List[int] = driver.multiEval.listPy.modulation.otolerance.fetch() \n
		...
		response = self._core.io.query_bin_or_ascii_int_list_suppressed(f'FETCh:CDMA:MEASurement<Instance>:MEValuation:LIST:MODulation:OTOLerance?', suppressed)
		return response
