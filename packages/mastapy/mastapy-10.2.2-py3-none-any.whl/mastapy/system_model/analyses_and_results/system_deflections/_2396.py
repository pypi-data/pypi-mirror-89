...
class HypoidGearSystemDeflection(_2329.AGMAGleasonConicalGearSystemDeflection):
    '''HypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3725.HypoidGearPowerFlow':
        ...
        return constructor.new(_3725.HypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
