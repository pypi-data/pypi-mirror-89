...
class Aone:
	...
	def set(self, aone: int, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:UTCSu<ST>:UTC:AONE \n
		Snippet: driver.source.bb.gnss.time.conversion.utcsu.utc.aone.set(aone = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:UTCSu<ST>:UTC:AONE \n
		Snippet: value: int = driver.source.bb.gnss.time.conversion.utcsu.utc.aone.get(stream = repcap.Stream.Default) \n
		Sets the first order term of polynomial, A1. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Utcsu')
