...
id = "e78f0b9b162a0142b95d2f56b5c4ffce64fe5ef1"
date = "2020-12-19 01:03:10 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "e78f0b9b162a0142b95d2f56b5c4ffce64fe5ef1":
        return
    msg = "Program id (e78f0b9b162a0142b95d2f56b5c4ffce64fe5ef1) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
