...
class OilSealCompoundPowerFlow(_3422.ConnectorCompoundPowerFlow):
    '''OilSealCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3336.OilSealPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3336.OilSealPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3336.OilSealPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3336.OilSealPowerFlow))
        return value
