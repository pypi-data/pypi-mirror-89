...
class ShaftHubConnectionParametricStudyTool(_3543.ConnectorParametricStudyTool):
    '''ShaftHubConnectionParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2351.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2351.ShaftHubConnectionSystemDeflection))
        return value
