...
class Power:
	...
	def get_signal(self) -> float:
		...
		"""
		response = self._core.io.query_str('CONFigure:EVDO:SIGNaling<Instance>:FADing:POWer:SIGNal?')
	...
	def get_sum(self) -> float:
		...
		"""
		response = self._core.io.query_str('CONFigure:EVDO:SIGNaling<Instance>:FADing:POWer:SUM?')
		return Conversions.str_to_float(response)
