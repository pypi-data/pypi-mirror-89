...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3817, _3816, _3822
...
class FaceGearSetModalAnalysesAtStiffnesses(_3822.GearSetModalAnalysesAtStiffnesses):
    '''FaceGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def face_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3817.FaceGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysesAtStiffnesses, constructor.new(_3817.FaceGearModalAnalysesAtStiffnesses))
        return value

    @property
    def face_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3816.FaceGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysesAtStiffnesses, constructor.new(_3816.FaceGearMeshModalAnalysesAtStiffnesses))
        return value
