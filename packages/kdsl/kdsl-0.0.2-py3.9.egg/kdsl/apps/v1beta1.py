...
class StatefulSetSpec(K8sObject):
    ...
    updateStrategy: Union[None, OmitEnum, kdsl.apps.v1beta1.StatefulSetUpdateStrategy] = attr.ib(metadata={'yaml_name': 'updateStrategy'}, converter=kdsl.apps.v1beta1_converters.optional_converter_StatefulSetUpdateStrategy, default=OMIT)
...
class DeploymentSpec(K8sObject):
    ...
    replicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'replicas'}, default=OMIT)
    revisionHistoryLimit: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'revisionHistoryLimit'}, default=OMIT)
    rollbackTo: Union[None, OmitEnum, kdsl.apps.v1beta1.RollbackConfig] = attr.ib(metadata={'yaml_name': 'rollbackTo'}, converter=kdsl.apps.v1beta1_converters.optional_converter_RollbackConfig, default=OMIT)
    selector: Union[None, OmitEnum, kdsl.core.v1.LabelSelector] = attr.ib(metadata={'yaml_name': 'selector'}, converter=kdsl.core.v1_converters.optional_converter_LabelSelector, default=OMIT)
    strategy: Union[None, OmitEnum, kdsl.apps.v1beta1.DeploymentStrategy] = attr.ib(metadata={'yaml_name': 'strategy'}, converter=kdsl.apps.v1beta1_converters.optional_converter_DeploymentStrategy, default=OMIT)
...
class StatefulSetStatus(K8sObject):
    ...
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apps.v1beta1.StatefulSetConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apps.v1beta1_converters.optional_mlist_converter_StatefulSetConditionItem, default=OMIT)
...
class DeploymentStrategy(K8sObject):
    rollingUpdate: Union[None, OmitEnum, kdsl.apps.v1beta1.RollingUpdateDeployment] = attr.ib(metadata={'yaml_name': 'rollingUpdate'}, converter=kdsl.apps.v1beta1_converters.optional_converter_RollingUpdateDeployment, default=OMIT)
...
class StatefulSet(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.apps.v1beta1.StatefulSetSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apps.v1beta1_converters.optional_converter_StatefulSetSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apps.v1beta1.StatefulSetStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apps.v1beta1_converters.optional_converter_StatefulSetStatus, default=OMIT)
...
class Deployment(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.apps.v1beta1.DeploymentSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apps.v1beta1_converters.optional_converter_DeploymentSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.apps.v1beta1.DeploymentStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apps.v1beta1_converters.optional_converter_DeploymentStatus, default=OMIT)
...
class DeploymentStatus(K8sObject):
    ...
    collisionCount: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'collisionCount'}, default=OMIT)
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.apps.v1beta1.DeploymentConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.apps.v1beta1_converters.optional_mlist_converter_DeploymentConditionItem, default=OMIT)
    observedGeneration: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'observedGeneration'}, default=OMIT)
    readyReplicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'readyReplicas'}, default=OMIT)
    replicas: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'replicas'}, default=OMIT)
...
class StatefulSetUpdateStrategy(K8sObject):
    rollingUpdate: Union[None, OmitEnum, kdsl.apps.v1beta1.RollingUpdateStatefulSetStrategy] = attr.ib(metadata={'yaml_name': 'rollingUpdate'}, converter=kdsl.apps.v1beta1_converters.optional_converter_RollingUpdateStatefulSetStrategy, default=OMIT)
    type: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'type'}, default=OMIT)
