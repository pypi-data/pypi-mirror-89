...
from mastapy.system_model.analyses_and_results.power_flows import _3371, _3356
...
class SynchroniserPowerFlow(_3356.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3371.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3371.SynchroniserHalfPowerFlow))
        return value
