...
class State:
	...
	def fetch(self) -> List[enums.ResultStateA]:
		...
		Snippet: value: List[enums.ResultStateA] = driver.multiEval.listPy.cp.data.state.fetch() \n
		...
		response = self._core.io.query_str_suppressed(f'FETCh:EVDO:MEASurement<Instance>:MEValuation:LIST:CP:DATA:STATe?', suppressed)
