...
class CVTBeltConnectionModalAnalysis(_4754.BeltConnectionModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2292.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2292.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
