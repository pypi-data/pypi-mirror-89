...
class HypoidGearMeshSystemDeflection(_2254.AGMAGleasonConicalGearMeshSystemDeflection):
    '''HypoidGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3319.HypoidGearMeshPowerFlow':
        ...
        return constructor.new(_3319.HypoidGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
