...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.7.0-alpha.1608570482+5f0b15be'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.7.0-alpha.1608570482+5f0b15be`
                """)
            else:
                raise
