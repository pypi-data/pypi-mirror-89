...
class Mtext:
	...
	def set(self) -> None:
		...
		Resets all parameters related to a received SMS message. The message text and the information about the message length
		are deleted. The 'message read' flag is set to true. \n
		"""
		self._core.io.write(f'CLEan:GSM:SIGNaling<Instance>:SMS:INComing:INFO:MTEXt')
	...
	def set_with_opc(self) -> None:
		...
		"""
		self._core.io.write_with_opc(f'CLEan:GSM:SIGNaling<Instance>:SMS:INComing:INFO:MTEXt')
