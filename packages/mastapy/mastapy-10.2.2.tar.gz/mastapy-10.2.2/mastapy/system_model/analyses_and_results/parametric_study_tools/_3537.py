...
class ConceptGearParametricStudyTool(_3568.GearParametricStudyTool):
    '''ConceptGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2282.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2282.ConceptGearSystemDeflection))
        return value
