...
[boto3.MigrationHubConfig 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/migrationhub-config.html#MigrationHubConfig) service
compatible with
