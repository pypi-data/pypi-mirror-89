...
class MassDiscCompoundParametricStudyTool(_3761.VirtualComponentCompoundParametricStudyTool):
    '''MassDiscCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3585.MassDiscParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3585.MassDiscParametricStudyTool))
        return value

    @property
    def component_parametric_study_tool_load_cases(self) -> 'List[_3585.MassDiscParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentParametricStudyToolLoadCases, constructor.new(_3585.MassDiscParametricStudyTool))
        return value
