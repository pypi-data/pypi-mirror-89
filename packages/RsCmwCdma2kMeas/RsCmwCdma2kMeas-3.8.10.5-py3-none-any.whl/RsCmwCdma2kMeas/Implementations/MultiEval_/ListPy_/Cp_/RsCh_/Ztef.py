...
class Ztef:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("ztef", core, parent)

	@property
	def state(self):
		"""state commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_state'):
			from .Ztef_.State import State
	...
	def current(self):
		...
		if not hasattr(self, '_current'):
			from .Ztef_.Current import Current
	...
	def average(self):
		...
		if not hasattr(self, '_average'):
			from .Ztef_.Average import Average
	...
	def maximum(self):
		...
		if not hasattr(self, '_maximum'):
			from .Ztef_.Maximum import Maximum
	...
	def minimum(self):
		...
		if not hasattr(self, '_minimum'):
			from .Ztef_.Minimum import Minimum
	...
	def clone(self) -> 'Ztef':
		...
		new_group = Ztef(self._core, self._base.parent)
