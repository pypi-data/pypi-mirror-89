...
class ScFading:
	...
	def get_external(self) -> ExternalStruct:
		...
		"""
		return self._core.io.query_struct('ROUTe:EVDO:SIGNaling<Instance>:SCENario:SCFading:EXTernal?', self.__class__.ExternalStruct())
	...
	def set_external(self, value: ExternalStruct) -> None:
		...
		"""
		self._core.io.write_struct('ROUTe:EVDO:SIGNaling<Instance>:SCENario:SCFading:EXTernal', value)
	...
	def get_internal(self) -> InternalStruct:
		...
		"""
		return self._core.io.query_struct('ROUTe:EVDO:SIGNaling<Instance>:SCENario:SCFading:INTernal?', self.__class__.InternalStruct())
	...
	def set_internal(self, value: InternalStruct) -> None:
		...
		"""
		self._core.io.write_struct('ROUTe:EVDO:SIGNaling<Instance>:SCENario:SCFading:INTernal', value)
