...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _6509, _6510, _6428
...
class StraightBevelDiffGearSetCompoundAdvancedSystemDeflection(_6428.BevelGearSetCompoundAdvancedSystemDeflection):
    '''StraightBevelDiffGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def straight_bevel_diff_gears_compound_advanced_system_deflection(self) -> 'List[_6509.StraightBevelDiffGearCompoundAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsCompoundAdvancedSystemDeflection, constructor.new(_6509.StraightBevelDiffGearCompoundAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_compound_advanced_system_deflection(self) -> 'List[_6510.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesCompoundAdvancedSystemDeflection, constructor.new(_6510.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection))
        return value
