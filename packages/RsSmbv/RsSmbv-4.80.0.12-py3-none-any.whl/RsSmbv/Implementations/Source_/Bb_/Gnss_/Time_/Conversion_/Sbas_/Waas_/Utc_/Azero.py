...
class Azero:
	...
	def set(self, azero: int, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:SBAS<ST>:WAAS:UTC:AZERo \n
		Snippet: driver.source.bb.gnss.time.conversion.sbas.waas.utc.azero.set(azero = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:SBAS<ST>:WAAS:UTC:AZERo \n
		Snippet: value: int = driver.source.bb.gnss.time.conversion.sbas.waas.utc.azero.get(stream = repcap.Stream.Default) \n
		Sets the constant term of polynomial, A0. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Sbas')
