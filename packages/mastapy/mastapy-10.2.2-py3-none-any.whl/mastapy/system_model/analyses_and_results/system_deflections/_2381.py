...
class TorqueConverterTurbineSystemDeflection(_2290.CouplingHalfSystemDeflection):
    '''TorqueConverterTurbineSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3379.TorqueConverterTurbinePowerFlow':
        ...
        return constructor.new(_3379.TorqueConverterTurbinePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
