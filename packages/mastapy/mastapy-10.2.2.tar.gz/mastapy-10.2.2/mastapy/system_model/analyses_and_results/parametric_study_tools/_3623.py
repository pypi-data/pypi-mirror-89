...
class StraightBevelDiffGearMeshParametricStudyTool(_3523.BevelGearMeshParametricStudyTool):
    '''StraightBevelDiffGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2363.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2363.StraightBevelDiffGearMeshSystemDeflection))
        return value
