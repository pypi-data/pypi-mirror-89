...
class Rise:
	...
	def set(self, rise: float, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.lfOutput.shape.trapeze.rise.set(rise = 1.0, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> float:
		"""SCPI: [SOURce<HW>]:LFOutput<CH>:SHAPe:TRAPeze:RISE \n
		Snippet: value: float = driver.source.lfOutput.shape.trapeze.rise.get(channel = repcap.Channel.Default) \n
		Selects the rise time for the trapezoid shape of the LF generator. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'LfOutput')
