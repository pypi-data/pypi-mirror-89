...
class Qpsk:
	...
	def get_user_defined(self) -> UserDefinedStruct:
		"""SCPI: CONFigure:WCDMa:SIGNaling<instance>:CELL:HSDPa:CQI:RVCSequences:QPSK:UDEFined \n
		Snippet: value: UserDefinedStruct = driver.configure.cell.hsdpa.cqi.rvcSequences.qpsk.get_user_defined() \n
		Specifies an RV coding sequence to be used for signals with QPSK modulation if UDEFined is set via method RsCmwWcdmaSig.
		Configure.Cell.Hsdpa.Cqi.RvcSequences.Qpsk.value. \n
			:return: structure: for return value, see the help for UserDefinedStruct structure arguments.
		"""
		return self._core.io.query_struct('CONFigure:WCDMa:SIGNaling<Instance>:CELL:HSDPa:CQI:RVCSequences:QPSK:UDEFined?', self.__class__.UserDefinedStruct())

	def set_user_defined(self, value: UserDefinedStruct) -> None:
		"""SCPI: CONFigure:WCDMa:SIGNaling<instance>:CELL:HSDPa:CQI:RVCSequences:QPSK:UDEFined \n
		Snippet: driver.configure.cell.hsdpa.cqi.rvcSequences.qpsk.set_user_defined(value = UserDefinedStruct()) \n
		Specifies an RV coding sequence to be used for signals with QPSK modulation if UDEFined is set via method RsCmwWcdmaSig.
		Configure.Cell.Hsdpa.Cqi.RvcSequences.Qpsk.value. \n
			:param value: see the help for UserDefinedStruct structure arguments.
		"""
		self._core.io.write_struct('CONFigure:WCDMa:SIGNaling<Instance>:CELL:HSDPa:CQI:RVCSequences:QPSK:UDEFined', value)

	# noinspection PyTypeChecker
	def get_value(self) -> enums.RvcSequence:
		"""SCPI: CONFigure:WCDMa:SIGNaling<instance>:CELL:HSDPa:CQI:RVCSequences:QPSK \n
		Snippet: value: enums.RvcSequence = driver.configure.cell.hsdpa.cqi.rvcSequences.qpsk.get_value() \n
		Specifies an RV coding sequence to be used for signals with QPSK modulation. If UDEFined is selected, the sequence is
		defined via method RsCmwWcdmaSig.Configure.Cell.Hsdpa.Cqi.RvcSequences.Qpsk.userDefined. \n
		...
		"""
		response = self._core.io.query_str('CONFigure:WCDMa:SIGNaling<Instance>:CELL:HSDPa:CQI:RVCSequences:QPSK?')
		return Conversions.str_to_scalar_enum(response, enums.RvcSequence)

	def set_value(self, sequence: enums.RvcSequence) -> None:
		"""SCPI: CONFigure:WCDMa:SIGNaling<instance>:CELL:HSDPa:CQI:RVCSequences:QPSK \n
		Snippet: driver.configure.cell.hsdpa.cqi.rvcSequences.qpsk.set_value(sequence = enums.RvcSequence.S1) \n
		Specifies an RV coding sequence to be used for signals with QPSK modulation. If UDEFined is selected, the sequence is
		defined via method RsCmwWcdmaSig.Configure.Cell.Hsdpa.Cqi.RvcSequences.Qpsk.userDefined. \n
		...
		self._core.io.write(f'CONFigure:WCDMa:SIGNaling<Instance>:CELL:HSDPa:CQI:RVCSequences:QPSK {param}')
