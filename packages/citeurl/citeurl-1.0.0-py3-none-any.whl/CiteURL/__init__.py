...
def load_schemas(filepath):
    ...
    This function is automatically called on init to load the
    default schemas, but it can be called again to add more."""
    yaml_text = Path(filepath).read_text()
