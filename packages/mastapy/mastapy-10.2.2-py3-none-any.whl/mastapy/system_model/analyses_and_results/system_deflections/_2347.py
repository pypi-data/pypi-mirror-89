...
class RollingRingAssemblySystemDeflection(_2356.SpecialisedAssemblySystemDeflection):
    '''RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3349.RollingRingAssemblyPowerFlow':
        ...
        return constructor.new(_3349.RollingRingAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
