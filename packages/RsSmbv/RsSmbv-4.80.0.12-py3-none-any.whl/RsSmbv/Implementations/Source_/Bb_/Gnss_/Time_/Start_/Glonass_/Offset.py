...
class Offset:
	...
	def get(self, stream=repcap.Stream.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:STARt:GLONass<ST>:OFFSet \n
		Snippet: value: float = driver.source.bb.gnss.time.start.glonass.offset.get(stream = repcap.Stream.Default) \n
