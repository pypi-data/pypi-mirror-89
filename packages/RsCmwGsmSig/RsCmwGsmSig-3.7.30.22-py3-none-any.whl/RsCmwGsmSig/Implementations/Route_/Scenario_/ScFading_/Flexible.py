...
class Flexible:
	...
	def get_external(self) -> ExternalStruct:
		...
		"""
		return self._core.io.query_struct('ROUTe:GSM:SIGNaling<Instance>:SCENario:SCFading:FLEXible:EXTernal?', self.__class__.ExternalStruct())
	...
	def set_external(self, value: ExternalStruct) -> None:
		...
		"""
		self._core.io.write_struct('ROUTe:GSM:SIGNaling<Instance>:SCENario:SCFading:FLEXible:EXTernal', value)
	...
	class InternalStruct(StructBase):
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_enum('Tx_Connector', enums.TxConnector),
			ArgStruct.scalar_enum('Tx_Converter', enums.TxConverter),
			ArgStruct.scalar_enum('Fading_Board', enums.FadingBoard)]
		...
		def __init__(self):
			...
			self.Tx_Connector: enums.TxConnector = None
			self.Tx_Converter: enums.TxConverter = None
			self.Fading_Board: enums.FadingBoard = None
	...
	def get_internal(self) -> InternalStruct:
		...
		Activates the 'Standard Cell Fading: Internal' scenario and selects the signal paths. The internal fader is selectable.
		...
		"""
		return self._core.io.query_struct('ROUTe:GSM:SIGNaling<Instance>:SCENario:SCFading:FLEXible:INTernal?', self.__class__.InternalStruct())
	...
	def set_internal(self, value: InternalStruct) -> None:
		...
		"""
		self._core.io.write_struct('ROUTe:GSM:SIGNaling<Instance>:SCENario:SCFading:FLEXible:INTernal', value)
