...
class Mmonitor:
	...
	def get_enable(self) -> bool:
		...
		"""
		response = self._core.io.query_str('CONFigure:GSM:SIGNaling<Instance>:MMONitor:ENABle?')
	...
	def set_enable(self, enable: bool) -> None:
		...
		self._core.io.write(f'CONFigure:GSM:SIGNaling<Instance>:MMONitor:ENABle {param}')
