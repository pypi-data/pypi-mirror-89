...
class RuntimeClass(K8sResource):
    ...
    spec: kdsl.node.v1alpha1.RuntimeClassSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.node.v1alpha1_converters.required_converter_RuntimeClassSpec)
...
class RuntimeClassSpec(K8sObject):
    ...
    overhead: Union[None, OmitEnum, kdsl.node.v1alpha1.Overhead] = attr.ib(metadata={'yaml_name': 'overhead'}, converter=kdsl.node.v1alpha1_converters.optional_converter_Overhead, default=OMIT)
    scheduling: Union[None, OmitEnum, kdsl.node.v1alpha1.Scheduling] = attr.ib(metadata={'yaml_name': 'scheduling'}, converter=kdsl.node.v1alpha1_converters.optional_converter_Scheduling, default=OMIT)
