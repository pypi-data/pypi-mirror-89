...
class Komu:
	...
	def get(self, channel=repcap.Channel.Default, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CH>:TXBW:S60K<ST>:KOMU \n
		Snippet: value: int = driver.source.bb.nr5G.node.cell.txbw.s60K.komu.get(channel = repcap.Channel.Default, stream = repcap.Stream.Default) \n
