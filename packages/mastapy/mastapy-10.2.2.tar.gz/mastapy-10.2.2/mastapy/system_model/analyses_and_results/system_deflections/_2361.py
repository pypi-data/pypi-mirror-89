...
class SpringDamperHalfSystemDeflection(_2290.CouplingHalfSystemDeflection):
    '''SpringDamperHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3361.SpringDamperHalfPowerFlow':
        ...
        return constructor.new(_3361.SpringDamperHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
