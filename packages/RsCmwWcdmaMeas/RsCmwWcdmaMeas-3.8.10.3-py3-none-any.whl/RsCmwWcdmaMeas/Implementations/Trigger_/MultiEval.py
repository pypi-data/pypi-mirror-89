...
class MultiEval:
	...
	def get_timeout(self) -> float or bool:
		...
		indicates a trigger timeout in manual operation mode. This setting has no influence on 'Free Run' measurements. \n
			:return: time_out: numeric | ON | OFF Range: 0.01 s to 10 s, Unit: s Additional OFF | ON disables/enables the timeout
		"""
	...
	def set_timeout(self, time_out: float or bool) -> None:
		"""SCPI: TRIGger:WCDMa:MEASurement<instance>:MEValuation:TOUT \n
		Snippet: driver.trigger.multiEval.set_timeout(time_out = 1.0) \n
		Selects the maximum time that the measurement waits for a trigger event before it stops in remote control mode or
		indicates a trigger timeout in manual operation mode. This setting has no influence on 'Free Run' measurements. \n
			:param time_out: numeric | ON | OFF Range: 0.01 s to 10 s, Unit: s Additional OFF | ON disables/enables the timeout
		"""
