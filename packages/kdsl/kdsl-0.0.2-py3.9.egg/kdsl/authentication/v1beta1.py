...
class TokenReviewStatus(K8sObject):
    ...
    user: Union[None, OmitEnum, kdsl.authentication.v1beta1.UserInfo] = attr.ib(metadata={'yaml_name': 'user'}, converter=kdsl.authentication.v1beta1_converters.optional_converter_UserInfo, default=OMIT)
...
class TokenReview(K8sResource):
    ...
    spec: kdsl.authentication.v1beta1.TokenReviewSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.authentication.v1beta1_converters.required_converter_TokenReviewSpec)
    ...
    status: Union[None, OmitEnum, kdsl.authentication.v1beta1.TokenReviewStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.authentication.v1beta1_converters.optional_converter_TokenReviewStatus, default=OMIT)
