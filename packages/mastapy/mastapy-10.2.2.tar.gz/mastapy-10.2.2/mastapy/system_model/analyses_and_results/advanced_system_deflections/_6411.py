...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6409, _6410, _6303
...
class ZerolBevelGearSetAdvancedSystemDeflection(_6303.BevelGearSetAdvancedSystemDeflection):
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_6409.ZerolBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsAdvancedSystemDeflection, constructor.new(_6409.ZerolBevelGearAdvancedSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_6410.ZerolBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesAdvancedSystemDeflection, constructor.new(_6410.ZerolBevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2390.ZerolBevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2390.ZerolBevelGearSetSystemDeflection))
        return value
