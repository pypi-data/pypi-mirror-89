...
class Primary:
	...
	def get_address(self) -> str:
		...
		Snippet: value: str = driver.sense.data.control.dns.current.ipvFour.primary.get_address() \n
		Queries the IPv4 address sent to the DUT as primary DNS server address. \n
			:return: cdns_prim_ip_4: IPv4 address as string
		"""
		response = self._core.io.query_str('SENSe:DATA:CONTrol:DNS:CURRent:IPVFour:PRIMary:ADDRess?')
