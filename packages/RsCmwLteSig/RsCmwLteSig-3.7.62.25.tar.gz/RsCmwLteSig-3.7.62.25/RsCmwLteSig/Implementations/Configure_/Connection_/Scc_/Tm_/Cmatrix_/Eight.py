...
class Eight:
	...
	def set(self, structure: SetStruct, secondaryCompCarrier=repcap.SecondaryCompCarrier.Default, matrixEightLine=repcap.MatrixEightLine.Default) -> None:
		...
		Snippet: driver.configure.connection.scc.tm.cmatrix.eight.set(value = [PROPERTY_STRUCT_NAME](), secondaryCompCarrier = repcap.SecondaryCompCarrier.Default, matrixEightLine = repcap.MatrixEightLine.Default) \n
