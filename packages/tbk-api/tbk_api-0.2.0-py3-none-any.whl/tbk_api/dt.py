...
class TbkBrandInfo(BaseModel):
    ...
    seller_name: Optional[str] = Field(None, title="旗舰店铺名称")
    seller_id: Optional[str] = Field(None, title="店铺ID")
    seller_score: Optional[float] = Field(None, title="店铺评分")
    seller_location: Optional[str] = Field(None, title="商家地址")
