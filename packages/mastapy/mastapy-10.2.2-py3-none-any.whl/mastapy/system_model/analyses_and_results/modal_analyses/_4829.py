...
class PartToPartShearCouplingHalfModalAnalysis(_4784.CouplingHalfModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2340.PartToPartShearCouplingHalfSystemDeflection':
        ...
        return constructor.new(_2340.PartToPartShearCouplingHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
