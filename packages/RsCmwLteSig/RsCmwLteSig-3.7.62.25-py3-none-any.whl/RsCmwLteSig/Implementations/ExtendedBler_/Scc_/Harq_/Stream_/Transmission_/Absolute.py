...
class Absolute:
	...
	def fetch(self, secondaryCompCarrier=repcap.SecondaryCompCarrier.Default, stream=repcap.Stream.Default) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.extendedBler.scc.harq.stream.transmission.absolute.fetch(secondaryCompCarrier = repcap.SecondaryCompCarrier.Default, stream = repcap.Stream.Default) \n
