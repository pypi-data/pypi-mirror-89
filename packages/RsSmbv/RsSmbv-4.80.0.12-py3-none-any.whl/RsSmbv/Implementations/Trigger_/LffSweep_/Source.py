...
class Source:
	...
	def get_advanced(self) -> enums.TrigSweepImmBusExt:
		...
		Snippet: value: enums.TrigSweepImmBusExt = driver.trigger.lffSweep.source.get_advanced() \n
	...
	def set_advanced(self, lf_trig_sour_adv: enums.TrigSweepImmBusExt) -> None:
		"""SCPI: TRIGger<HW>:LFFSweep:SOURce:ADVanced \n
		Snippet: driver.trigger.lffSweep.source.set_advanced(lf_trig_sour_adv = enums.TrigSweepImmBusExt.BUS) \n
		No command help available \n
	...
	def get_value(self) -> enums.SingExtAuto:
		...
		Snippet: value: enums.SingExtAuto = driver.trigger.lffSweep.source.get_value() \n
	...
	def set_value(self, source: enums.SingExtAuto) -> None:
		"""SCPI: TRIGger<HW>:LFFSweep:SOURce \n
		Snippet: driver.trigger.lffSweep.source.set_value(source = enums.SingExtAuto.AUTO) \n
			INTRO_CMD_HELP: Selects the trigger source for the corresponding sweeps: \n
			- FSWeep - RF frequency
			- LFFSweep - LF frequency
			- PSWeep - RF level
