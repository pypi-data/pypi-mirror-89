...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.6.0-alpha.1609256081+d1314ef1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.6.0-alpha.1609256081+d1314ef1`
                """)
            else:
                raise
