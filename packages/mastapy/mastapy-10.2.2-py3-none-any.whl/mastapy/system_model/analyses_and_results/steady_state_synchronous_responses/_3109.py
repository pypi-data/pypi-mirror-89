...
class SteadyStateSynchronousResponse(_6535.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3111.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3111.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
