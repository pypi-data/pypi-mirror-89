...
class Current:
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Msp_Ower_1_M_23: List[enums.ResultStatus2]: No parameter help available
		...
		__meta_args_list = [
			...
			ArgStruct('Msp_Ower_1_M_23', DataType.EnumList, enums.ResultStatus2, False, True, 1),
		...
		def __init__(self):
			...
			self.Msp_Ower_1_M_23: List[enums.ResultStatus2] = None
