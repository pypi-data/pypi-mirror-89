...
class PirPower:
	...
	def get_basic(self) -> float:
		...
		Snippet: value: float = driver.sense.uplink.setc.apPower.pirPower.get_basic() \n
		...
		"""
		response = self._core.io.query_str('SENSe:LTE:SIGNaling<Instance>:UL:SETC:APPower:PIRPower:BASic?')
