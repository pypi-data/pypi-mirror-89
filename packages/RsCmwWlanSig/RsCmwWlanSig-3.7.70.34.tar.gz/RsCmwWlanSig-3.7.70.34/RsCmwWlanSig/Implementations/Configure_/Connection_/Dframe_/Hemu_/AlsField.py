...
class AlsField:
	...
	def set(self, ch_20_index: enums.Ch20Index, subfield: enums.Subfield) -> None:
		"""SCPI: CONFigure:WLAN:SIGNaling<instance>:CONNection:DFRame:HEMU:ALSField \n
		Snippet: driver.configure.connection.dframe.hemu.alsField.set(ch_20_index = enums.Ch20Index.CHA1, subfield = enums.Subfield.A000) \n
		Sets 8-bit indices for resource unit (RU) allocation for the selected channel. The <Subfield> parameter specifies the
		number of RUs, their position and size. Refer to IEEE P802.11ax/D4.3, table 27-26, RU allocation signaling. \n
		...
		self._core.io.write(f'CONFigure:WLAN:SIGNaling<Instance>:CONNection:DFRame:HEMU:ALSField {param}'.rstrip())

	# noinspection PyTypeChecker
	def get(self, ch_20_index: enums.Ch20Index) -> enums.Subfield:
		"""SCPI: CONFigure:WLAN:SIGNaling<instance>:CONNection:DFRame:HEMU:ALSField \n
		Snippet: value: enums.Subfield = driver.configure.connection.dframe.hemu.alsField.get(ch_20_index = enums.Ch20Index.CHA1) \n
		Sets 8-bit indices for resource unit (RU) allocation for the selected channel. The <Subfield> parameter specifies the
		number of RUs, their position and size. Refer to IEEE P802.11ax/D4.3, table 27-26, RU allocation signaling. \n
			:param ch_20_index: CHA1 | CHA2 | CHA3 | CHA4
		...
		response = self._core.io.query_str(f'CONFigure:WLAN:SIGNaling<Instance>:CONNection:DFRame:HEMU:ALSField? {param}')
