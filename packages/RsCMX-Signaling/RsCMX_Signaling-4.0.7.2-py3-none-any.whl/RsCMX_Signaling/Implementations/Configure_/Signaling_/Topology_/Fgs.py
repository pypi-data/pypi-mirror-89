...
class Fgs:
	"""Fgs commands group definition. 3 total commands, 3 Sub-groups, 0 group commands"""
	...
	def default(self):
		...
		if not hasattr(self, '_default'):
			from .Fgs_.Default import Default
	...
	def taCode(self):
		...
		if not hasattr(self, '_taCode'):
			from .Fgs_.TaCode import TaCode
