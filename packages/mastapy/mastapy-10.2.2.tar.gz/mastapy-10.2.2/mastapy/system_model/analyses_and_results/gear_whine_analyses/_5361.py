...
class FaceGearGearWhineAnalysis(_5366.GearGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2310.FaceGearSystemDeflection':
        ...
        return constructor.new(_2310.FaceGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
