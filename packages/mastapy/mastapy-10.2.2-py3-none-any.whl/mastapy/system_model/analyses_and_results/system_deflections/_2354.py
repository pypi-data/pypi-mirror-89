...
from mastapy.system_model.analyses_and_results.system_deflections import _2352, _2353, _2253
...
class ShaftSystemDeflection(_2253.AbstractShaftOrHousingSystemDeflection):
    '''ShaftSystemDeflection
    ...
    @property
    def twod_drawing_showing_axial_forces_with_mounted_components(self) -> '_6556.SMTBitmap':
        ...
        return constructor.new(_6556.SMTBitmap)(self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents) if self.wrapped.TwoDDrawingShowingAxialForcesWithMountedComponents else None
    ...
    @property
    def power_flow_results(self) -> '_3354.ShaftPowerFlow':
        ...
        return constructor.new(_3354.ShaftPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2352.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2352.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2352.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2352.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2352.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2352.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife else None
    ...
    @property
    def shaft_section_results(self) -> 'List[_2353.ShaftSectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionResults, constructor.new(_2353.ShaftSectionSystemDeflection))
        return value

    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2352.ShaftSectionEndResultsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_2352.ShaftSectionEndResultsSystemDeflection))
        return value
