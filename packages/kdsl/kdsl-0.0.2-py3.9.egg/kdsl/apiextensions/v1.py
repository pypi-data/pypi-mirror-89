...
class CustomResourceSubresources(K8sObject):
    scale: Union[None, OmitEnum, kdsl.apiextensions.v1.CustomResourceSubresourceScale] = attr.ib(metadata={'yaml_name': 'scale'}, converter=kdsl.apiextensions.v1_converters.optional_converter_CustomResourceSubresourceScale, default=OMIT)
...
class CustomResourceDefinition(K8sResource):
    ...
    spec: kdsl.apiextensions.v1.CustomResourceDefinitionSpec = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.apiextensions.v1_converters.required_converter_CustomResourceDefinitionSpec)
    ...
    status: Union[None, OmitEnum, kdsl.apiextensions.v1.CustomResourceDefinitionStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.apiextensions.v1_converters.optional_converter_CustomResourceDefinitionStatus, default=OMIT)
...
class CustomResourceDefinitionVersion(K8sObject):
    ...
    additionalPrinterColumns: Union[None, OmitEnum, Sequence[kdsl.apiextensions.v1.CustomResourceColumnDefinition]] = attr.ib(metadata={'yaml_name': 'additionalPrinterColumns'}, converter=kdsl.apiextensions.v1_converters.optional_list_converter_CustomResourceColumnDefinition, default=OMIT)
    schema: Union[None, OmitEnum, kdsl.apiextensions.v1.CustomResourceValidation] = attr.ib(metadata={'yaml_name': 'schema'}, converter=kdsl.apiextensions.v1_converters.optional_converter_CustomResourceValidation, default=OMIT)
    subresources: Union[None, OmitEnum, kdsl.apiextensions.v1.CustomResourceSubresources] = attr.ib(metadata={'yaml_name': 'subresources'}, converter=kdsl.apiextensions.v1_converters.optional_converter_CustomResourceSubresources, default=OMIT)


class CustomResourceDefinitionVersionOptionalTypedDict(TypedDict, total=(False)):
    additionalPrinterColumns: Sequence[kdsl.apiextensions.v1.CustomResourceColumnDefinition]
...
class CustomResourceDefinitionSpec(K8sObject):
    ...
    names: kdsl.apiextensions.v1.CustomResourceDefinitionNames = attr.ib(metadata={'yaml_name': 'names'}, converter=kdsl.apiextensions.v1_converters.required_converter_CustomResourceDefinitionNames)
    scope: str = attr.ib(metadata={'yaml_name': 'scope'})
    versions: Sequence[kdsl.apiextensions.v1.CustomResourceDefinitionVersion] = attr.ib(metadata={'yaml_name': 'versions'}, converter=kdsl.apiextensions.v1_converters.required_list_converter_CustomResourceDefinitionVersion)
    conversion: Union[None, OmitEnum, kdsl.apiextensions.v1.CustomResourceConversion] = attr.ib(metadata={'yaml_name': 'conversion'}, converter=kdsl.apiextensions.v1_converters.optional_converter_CustomResourceConversion, default=OMIT)
...
class CustomResourceDefinitionStatus(K8sObject):
    acceptedNames: kdsl.apiextensions.v1.CustomResourceDefinitionNames = attr.ib(metadata={'yaml_name': 'acceptedNames'}, converter=kdsl.apiextensions.v1_converters.required_converter_CustomResourceDefinitionNames)
    storedVersions: Sequence[str] = attr.ib(metadata={'yaml_name': 'storedVersions'})
    conditions: Union[None, OmitEnum, Sequence[kdsl.apiextensions.v1.CustomResourceDefinitionCondition]] = attr.ib(metadata={'yaml_name': 'conditions'}, converter=kdsl.apiextensions.v1_converters.optional_list_converter_CustomResourceDefinitionCondition, default=OMIT)
...
class WebhookConversion(K8sObject):
    ...
    clientConfig: Union[None, OmitEnum, kdsl.apiextensions.v1.WebhookClientConfig] = attr.ib(metadata={'yaml_name': 'clientConfig'}, converter=kdsl.apiextensions.v1_converters.optional_converter_WebhookClientConfig, default=OMIT)
...
class CustomResourceConversion(K8sObject):
    ...
    webhook: Union[None, OmitEnum, kdsl.apiextensions.v1.WebhookConversion] = attr.ib(metadata={'yaml_name': 'webhook'}, converter=kdsl.apiextensions.v1_converters.optional_converter_WebhookConversion, default=OMIT)
...
class WebhookClientConfig(K8sObject):
    ...
    service: Union[None, OmitEnum, kdsl.apiextensions.v1.ServiceReference] = attr.ib(metadata={'yaml_name': 'service'}, converter=kdsl.apiextensions.v1_converters.optional_converter_ServiceReference, default=OMIT)
