...
class DciFormat:
	...
	def set(self, cell_name: str, subframe: float, dci_format: enums.DciFormat) -> None:
		...
		Snippet: driver.configure.signaling.lte.cell.ueScheduling.userDefined.sassignment.downlink.dciFormat.set(cell_name = '1', subframe = 1.0, dci_format = enums.DciFormat.D0) \n
		Defines the DCI format for the DL subframe with the index <Subframe>, for user-defined scheduling. \n
	...
	def get(self, cell_name: str, subframe: float) -> enums.DciFormat:
		"""SCPI: [CONFigure]:SIGNaling:LTE:CELL:UESCheduling:UDEFined:SASSignment:DL:DCIFormat \n
		Snippet: value: enums.DciFormat = driver.configure.signaling.lte.cell.ueScheduling.userDefined.sassignment.downlink.dciFormat.get(cell_name = '1', subframe = 1.0) \n
		Defines the DCI format for the DL subframe with the index <Subframe>, for user-defined scheduling. \n
			:param cell_name: No help available
			:param subframe: No help available
