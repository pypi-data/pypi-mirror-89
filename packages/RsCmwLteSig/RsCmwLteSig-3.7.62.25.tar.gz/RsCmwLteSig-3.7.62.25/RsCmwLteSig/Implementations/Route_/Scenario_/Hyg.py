...
class Hyg:
	...
	class FlexibleStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			...
			- Scc_3_Tx_3_Conn: enums.TxConnector: No parameter help available
			- Scc_3_Tx_3_Conv: enums.TxConverter: No parameter help available
			- Scc_3_Tx_4_Conn: enums.TxConnector: No parameter help available
			- Scc_3_Tx_4_Conv: enums.TxConverter: No parameter help available
			...
			- Scc_4_Tx_3_Conn: enums.TxConnector: No parameter help available
			- Scc_4_Tx_3_Conv: enums.TxConverter: No parameter help available
			- Scc_4_Tx_4_Conn: enums.TxConnector: No parameter help available
			- Scc_4_Tx_4_Conv: enums.TxConverter: No parameter help available
			...
			- Scc_5_Tx_3_Conn: enums.TxConnector: No parameter help available
			- Scc_5_Tx_3_Conv: enums.TxConverter: No parameter help available
			- Scc_5_Tx_4_Conn: enums.TxConnector: No parameter help available
			- Scc_5_Tx_4_Conv: enums.TxConverter: No parameter help available
			...
			- Scc_6_Tx_3_Conn: enums.TxConnector: No parameter help available
			- Scc_6_Tx_3_Conv: enums.TxConverter: No parameter help available
			- Scc_6_Tx_4_Conn: enums.TxConnector: No parameter help available
			- Scc_6_Tx_4_Conv: enums.TxConverter: No parameter help available
			...
			- Scc_7_Tx_3_Conn: enums.TxConnector: No parameter help available
			- Scc_7_Tx_3_Conv: enums.TxConverter: No parameter help available
			- Scc_7_Tx_4_Conn: enums.TxConnector: No parameter help available
			- Scc_7_Tx_4_Conv: enums.TxConverter: No parameter help available
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_enum('Scc_4_Tx_3_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_4_Tx_3_Conv', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_4_Tx_4_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_4_Tx_4_Conv', enums.TxConverter),
			...
			ArgStruct.scalar_enum('Scc_5_Tx_3_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_5_Tx_3_Conv', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_5_Tx_4_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_5_Tx_4_Conv', enums.TxConverter),
			...
			ArgStruct.scalar_enum('Scc_6_Tx_3_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_6_Tx_3_Conv', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_6_Tx_4_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_6_Tx_4_Conv', enums.TxConverter),
			...
			ArgStruct.scalar_enum('Scc_7_Tx_3_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_7_Tx_3_Conv', enums.TxConverter),
			ArgStruct.scalar_enum('Scc_7_Tx_4_Conn', enums.TxConnector),
			ArgStruct.scalar_enum('Scc_7_Tx_4_Conv', enums.TxConverter),
		...
		def __init__(self):
			...
			self.Scc_4_Tx_3_Conn: enums.TxConnector = None
			self.Scc_4_Tx_3_Conv: enums.TxConverter = None
			self.Scc_4_Tx_4_Conn: enums.TxConnector = None
			self.Scc_4_Tx_4_Conv: enums.TxConverter = None
			...
			self.Scc_5_Tx_3_Conn: enums.TxConnector = None
			self.Scc_5_Tx_3_Conv: enums.TxConverter = None
			self.Scc_5_Tx_4_Conn: enums.TxConnector = None
			self.Scc_5_Tx_4_Conv: enums.TxConverter = None
			...
			self.Scc_6_Tx_3_Conn: enums.TxConnector = None
			self.Scc_6_Tx_3_Conv: enums.TxConverter = None
			self.Scc_6_Tx_4_Conn: enums.TxConnector = None
			self.Scc_6_Tx_4_Conv: enums.TxConverter = None
			...
			self.Scc_7_Tx_3_Conn: enums.TxConnector = None
			self.Scc_7_Tx_3_Conv: enums.TxConverter = None
			self.Scc_7_Tx_4_Conn: enums.TxConnector = None
			self.Scc_7_Tx_4_Conv: enums.TxConverter = None
