...
class PartToPartShearCouplingConnectionModalAnalysis(_4783.CouplingConnectionModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2339.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2339.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
