...
class Mmonitor:
	...
	def get_enable(self) -> bool:
		...
		"""
		response = self._core.io.query_str('CONFigure:EVDO:SIGNaling<Instance>:MMONitor:ENABle?')
	...
	def set_enable(self, enable: bool) -> None:
		...
		self._core.io.write(f'CONFigure:EVDO:SIGNaling<Instance>:MMONitor:ENABle {param}')
