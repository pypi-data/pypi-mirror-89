...
from mastapy.system_model.analyses_and_results.power_flows import _3348, _3303
...
class PulleySystemDeflection(_2290.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3348.PulleyPowerFlow':
