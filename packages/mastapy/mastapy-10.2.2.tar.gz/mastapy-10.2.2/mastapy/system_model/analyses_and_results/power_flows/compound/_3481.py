...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3479, _3480, _3404
...
class SpiralBevelGearSetCompoundPowerFlow(_3404.BevelGearSetCompoundPowerFlow):
    '''SpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def spiral_bevel_gears_compound_power_flow(self) -> 'List[_3479.SpiralBevelGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCompoundPowerFlow, constructor.new(_3479.SpiralBevelGearCompoundPowerFlow))
        return value

    @property
    def spiral_bevel_meshes_compound_power_flow(self) -> 'List[_3480.SpiralBevelGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCompoundPowerFlow, constructor.new(_3480.SpiralBevelGearMeshCompoundPowerFlow))
        return value

    @property
    def load_case_analyses_ready(self) -> 'List[_3359.SpiralBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3359.SpiralBevelGearSetPowerFlow))
        return value

    @property
    def assembly_power_flow_load_cases(self) -> 'List[_3359.SpiralBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyPowerFlowLoadCases, constructor.new(_3359.SpiralBevelGearSetPowerFlow))
        return value
