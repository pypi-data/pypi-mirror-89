...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3796, _3795, _3822
...
class ConceptGearSetModalAnalysesAtStiffnesses(_3822.GearSetModalAnalysesAtStiffnesses):
    '''ConceptGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def concept_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3796.ConceptGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysesAtStiffnesses, constructor.new(_3796.ConceptGearModalAnalysesAtStiffnesses))
        return value

    @property
    def concept_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3795.ConceptGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysesAtStiffnesses, constructor.new(_3795.ConceptGearMeshModalAnalysesAtStiffnesses))
        return value
