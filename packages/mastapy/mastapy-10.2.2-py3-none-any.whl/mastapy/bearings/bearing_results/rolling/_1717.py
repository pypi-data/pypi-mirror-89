...
class RollingBearingFrictionCoefficients(_1151.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    '''RollingBearingFrictionCoefficients
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1601.EquivalentLoadFactors':
        ...
        return constructor.new(_1601.EquivalentLoadFactors)(self.wrapped.ISO14179StaticEquivalentLoadFactors) if self.wrapped.ISO14179StaticEquivalentLoadFactors else None

    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1601.EquivalentLoadFactors':
        ...
        return constructor.new(_1601.EquivalentLoadFactors)(self.wrapped.ISO14179DynamicEquivalentLoadFactors) if self.wrapped.ISO14179DynamicEquivalentLoadFactors else None
