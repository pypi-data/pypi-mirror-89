...
class Layer:
	...
	def set(self, layer: enums.EnhBitErr, channel=repcap.Channel.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:BSTation:ENHanced:CHANnel<CH>:DPCH:DERRor:BIT:LAYer \n
		Snippet: driver.source.bb.w3Gpp.bstation.enhanced.channel.dpch.derror.bit.layer.set(layer = enums.EnhBitErr.PHYSical, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> enums.EnhBitErr:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:BSTation:ENHanced:CHANnel<CH>:DPCH:DERRor:BIT:LAYer \n
		Snippet: value: enums.EnhBitErr = driver.source.bb.w3Gpp.bstation.enhanced.channel.dpch.derror.bit.layer.get(channel = repcap.Channel.Default) \n
		The command selects the layer in the coding process in which bit errors are inserted. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Channel')
