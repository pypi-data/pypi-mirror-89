...
class mysql2postgresql:
    ...
    def connect_mysql_database(self):
        ...
        self.db = mysql.connector.connect(**connect_mysql_kwargs)
        self.dbx = self.db.cursor()
        self.database = connect_mysql_kwargs['db']
    ...
    def connect_postgresql_database(self, **connect_postgresql_kwargs):
        print('connecting postgresql server ...')
        self.DB = psycopg2.connect(**connect_postgresql_kwargs)
