...
class All:
	...
	def fetch(self) -> FetchStruct:
		...
		Snippet: value: FetchStruct = driver.hack.state.all.fetch() \n
		...
		return self._core.io.query_struct(f'FETCh:WCDMa:SIGNaling<Instance>:HACK:STATe:ALL?', self.__class__.FetchStruct())
