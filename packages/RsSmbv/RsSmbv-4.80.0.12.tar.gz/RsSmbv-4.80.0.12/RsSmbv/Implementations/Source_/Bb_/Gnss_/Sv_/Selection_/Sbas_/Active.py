...
class Active:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:SELection:SBAS<ST>:ACTive \n
		Snippet: value: int = driver.source.bb.gnss.sv.selection.sbas.active.get(stream = repcap.Stream.Default) \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:GNSS:SV:SELection:SBAS{stream_cmd_val}:ACTive?')
