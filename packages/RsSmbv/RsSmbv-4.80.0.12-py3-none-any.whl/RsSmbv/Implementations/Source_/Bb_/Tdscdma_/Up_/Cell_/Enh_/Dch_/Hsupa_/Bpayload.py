...
class Bpayload:
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.tdscdma.up.cell.enh.dch.hsupa.bpayload.get(stream = repcap.Stream.Default) \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:TDSCdma:UP:CELL{stream_cmd_val}:ENH:DCH:HSUPA:BPAYload?')
