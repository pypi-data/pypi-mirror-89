...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2401.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3732.KlingelnbergCycloPalloidHypoidGearPowerFlow':
        ...
        return constructor.new(_3732.KlingelnbergCycloPalloidHypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
