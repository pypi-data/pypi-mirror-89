...
class KlingelnbergCycloPalloidConicalGearSetSystemDeflection(_2285.ConicalGearSetSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3326.KlingelnbergCycloPalloidConicalGearSetPowerFlow':
