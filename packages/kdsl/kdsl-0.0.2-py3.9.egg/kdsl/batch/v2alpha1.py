...
class CronJob(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.batch.v2alpha1.CronJobSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.batch.v2alpha1_converters.optional_converter_CronJobSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.batch.v2alpha1.CronJobStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.batch.v2alpha1_converters.optional_converter_CronJobStatus, default=OMIT)


@attr.s(kw_only=True)
class CronJobStatus(K8sObject):
    active: Union[None, OmitEnum, Sequence[kdsl.core.v1.ObjectReference]] = attr.ib(metadata={'yaml_name': 'active'}, converter=kdsl.core.v1_converters.optional_list_converter_ObjectReference, default=OMIT)
...
class JobTemplateSpec(K8sObject):
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.batch.v1.JobSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.batch.v1_converters.optional_converter_JobSpec, default=OMIT)
...
class CronJobSpec(K8sObject):
    jobTemplate: kdsl.batch.v2alpha1.JobTemplateSpec = attr.ib(metadata={'yaml_name': 'jobTemplate'}, converter=kdsl.batch.v2alpha1_converters.required_converter_JobTemplateSpec)
