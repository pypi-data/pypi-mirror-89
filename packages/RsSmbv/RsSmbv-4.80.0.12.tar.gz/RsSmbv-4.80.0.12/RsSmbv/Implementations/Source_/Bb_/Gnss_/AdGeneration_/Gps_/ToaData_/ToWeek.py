...
class ToWeek:
	...
	def set(self, tow: int, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:GPS<ST>:TOAData:TOWeek \n
		Snippet: driver.source.bb.gnss.adGeneration.gps.toaData.toWeek.set(tow = 1, stream = repcap.Stream.Default) \n
	...
	def get(self, stream=repcap.Stream.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:GPS<ST>:TOAData:TOWeek \n
		Snippet: value: int = driver.source.bb.gnss.adGeneration.gps.toaData.toWeek.get(stream = repcap.Stream.Default) \n
		Enabled for GPS timebase (method RsSmbv.Source.Bb.Gnss.AdGeneration.Gps.ToaData.Tbasis.set) . Determines the Time of Week
		(TOW) the assistance data is generated for. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Gps')
