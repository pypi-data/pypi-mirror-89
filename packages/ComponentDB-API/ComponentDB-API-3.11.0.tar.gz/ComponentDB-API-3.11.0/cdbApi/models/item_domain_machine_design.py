...
class ItemDomainMachineDesign(object):
    ...
    openapi_types = {
        ...
        'full_relationship_list': 'list[ItemElementRelationship]',
    ...
    attribute_map = {
        ...
        'full_relationship_list': 'fullRelationshipList',
    ...
    def __init__(self, id=None, name=None, item_identifier1=None, item_identifier2=None, qr_id=None, domain=None, derived_from_item=None, item_source_list=None, is_cloned=None, is_item_deleted=None, is_item_inventory=None, full_relationship_list=None, primary_image_for_item=None, max_sort_order=None, description=None, entity_type_list=None, item_category_list=None, item_type_list=None, item_project_list=None, move_to_trash_error_msg=None, move_to_trash_warning_msg=None, current_hierarchy_item_element=None, status_property_type_name=None, alternate_name=None, assigned_item=None, move_to_trash_row_style=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._full_relationship_list = None
        ...
        if full_relationship_list is not None:
            self.full_relationship_list = full_relationship_list
    ...
    @property
    def full_relationship_list(self):
        """Gets the full_relationship_list of this ItemDomainMachineDesign.  # noqa: E501


        :return: The full_relationship_list of this ItemDomainMachineDesign.  # noqa: E501
        :rtype: list[ItemElementRelationship]
        """
        return self._full_relationship_list

    @full_relationship_list.setter
    def full_relationship_list(self, full_relationship_list):
        """Sets the full_relationship_list of this ItemDomainMachineDesign.


        :param full_relationship_list: The full_relationship_list of this ItemDomainMachineDesign.  # noqa: E501
        :type: list[ItemElementRelationship]
        """

        self._full_relationship_list = full_relationship_list
