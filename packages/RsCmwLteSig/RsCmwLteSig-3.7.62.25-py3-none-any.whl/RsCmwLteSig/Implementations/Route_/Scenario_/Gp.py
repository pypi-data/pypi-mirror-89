...
class Gp:
	...
	class FlexibleStruct(StructBase):
		"""Structure for reading output parameters. Fields: \n
			...
			- Pcc_Tx_3_Conn: enums.TxConnector: RF connector for the third PCC output path
			- Pcc_Tx_3_Conv: enums.TxConverter: TX module for the third PCC output path
			- Pcc_Tx_4_Conn: enums.TxConnector: RF connector for the fourth PCC output path
			- Pcc_Tx_4_Conv: enums.TxConverter: TX module for the fourth PCC output path
