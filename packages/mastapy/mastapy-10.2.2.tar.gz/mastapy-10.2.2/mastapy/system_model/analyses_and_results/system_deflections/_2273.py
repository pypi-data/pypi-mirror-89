...
from mastapy.system_model.analyses_and_results.system_deflections import _2271, _2291
...
class ClutchSystemDeflection(_2291.CouplingSystemDeflection):
    '''ClutchSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3284.ClutchPowerFlow':
        ...
        return constructor.new(_3284.ClutchPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
