...
class JointModel(BertPreTrainedModel):
    def __init__(self, args, vocab, config, tokenizer):  # , vocab_phobert, bpe, max_seq_length
    ...
    def annotate(self, text=None, input_file=None, output_file=None, batch_size=1, output_type=''):
        ...
        for i in tqdm(range(len(data_tagger))):
            ...
            if torch.cuda.is_available():
                ...
                tokens_phobert1, first_subword1, words_mask1 = tokens_phobert.cuda(), first_subword.cuda(), words_mask.cuda()
