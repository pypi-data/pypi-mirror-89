...
class MedRxNorm:
	def __init__(self):
		...
		self.hyphen_rule = self._hyphen_rule()
	...
	def _hyphen_rule(self):
		return self._full_word_rule(["-"], " to ", self.unions["all_numbers_plus_decimals"], self.unions["all_numbers_plus_decimals"])
