...
id = "ff2ae0b8090fcbb4aa890353497c1bfabde4a33c"
date = "2020-12-18 20:25:06 +0000"
branch = "None"
tag = "lalsuite-v6.80"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "ff2ae0b8090fcbb4aa890353497c1bfabde4a33c":
        return
    msg = "Program id (ff2ae0b8090fcbb4aa890353497c1bfabde4a33c) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
