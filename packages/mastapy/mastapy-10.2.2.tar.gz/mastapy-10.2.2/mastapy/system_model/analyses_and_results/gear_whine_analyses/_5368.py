...
class GearMeshGearWhineAnalysis(_5382.InterMountableComponentConnectionGearWhineAnalysis):
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3375.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3375.ToothPassingHarmonic))
        return value

    @property
    def system_deflection_results(self) -> '_2312.GearMeshSystemDeflection':
