...
class EvmAll:
	...
	def get_tb_high(self) -> TbHighStruct:
		...
		line with standard IEEE 802.11ax, table 28-45 Allowed relative constellation error versus constellation size and coding
		rate. \n
	...
	def get_tb_low(self) -> TbLowStruct:
		...
		values are in line with standard IEEE P802.11ax/D4.3, table 27-49 Allowed relative constellation error versus
