...
class Endpoint(object):
    ...
    def _formatreturn(self, resp, subattribute=None):
        if subattribute:
          try:
              r = resp.json()[subattribute]
          except ValueError:
    ...
    def get(self, the_id=None, level=None, user_params={}, user_headers={}, subattribute=None):
        ...
        if resp.status_code != 200:
            ...
            return self._formatreturn(resp, subattribute)
