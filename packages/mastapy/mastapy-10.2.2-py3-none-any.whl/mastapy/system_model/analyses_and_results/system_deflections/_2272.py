...
class ClutchHalfSystemDeflection(_2290.CouplingHalfSystemDeflection):
    '''ClutchHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3283.ClutchHalfPowerFlow':
        ...
        return constructor.new(_3283.ClutchHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
