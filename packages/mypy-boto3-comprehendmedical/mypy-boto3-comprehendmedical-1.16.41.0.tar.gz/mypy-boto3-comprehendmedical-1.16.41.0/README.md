...
[boto3.ComprehendMedical 1.16.41](https://boto3.amazonaws.com/v1/documentation/api/1.16.41/reference/services/comprehendmedical.html#ComprehendMedical) service
compatible with
