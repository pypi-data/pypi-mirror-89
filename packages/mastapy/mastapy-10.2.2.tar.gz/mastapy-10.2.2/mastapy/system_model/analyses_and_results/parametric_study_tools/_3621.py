...
class SpringDamperHalfParametricStudyTool(_3545.CouplingHalfParametricStudyTool):
    '''SpringDamperHalfParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2361.SpringDamperHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2361.SpringDamperHalfSystemDeflection))
        return value
