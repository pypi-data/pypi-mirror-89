...
class EventDispatcher(object):
    event_url = enums.Default.EVENT_URL

    @classmethod
    def dispatch_event(cls, sdk_key, event):
        ...
        try:
            requests.post(cls.event_url, data=json.dumps(event, cls=EventEncoder), headers=request_headers,
