...
class HypoidGearSetGearWhineAnalysis(_5305.AGMAGleasonConicalGearSetGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2317.HypoidGearSetSystemDeflection':
        ...
        return constructor.new(_2317.HypoidGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
