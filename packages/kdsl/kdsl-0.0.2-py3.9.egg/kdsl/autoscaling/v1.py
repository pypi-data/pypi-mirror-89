...
class HorizontalPodAutoscaler(K8sResource):
    ...
    spec: Union[None, OmitEnum, kdsl.autoscaling.v1.HorizontalPodAutoscalerSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.autoscaling.v1_converters.optional_converter_HorizontalPodAutoscalerSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.autoscaling.v1.HorizontalPodAutoscalerStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.autoscaling.v1_converters.optional_converter_HorizontalPodAutoscalerStatus, default=OMIT)
...
class HorizontalPodAutoscalerSpec(K8sObject):
    ...
    scaleTargetRef: kdsl.autoscaling.v1.CrossVersionObjectReference = attr.ib(metadata={'yaml_name': 'scaleTargetRef'}, converter=kdsl.autoscaling.v1_converters.required_converter_CrossVersionObjectReference)
