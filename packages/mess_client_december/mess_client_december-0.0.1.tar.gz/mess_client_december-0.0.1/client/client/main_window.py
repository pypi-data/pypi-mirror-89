...
from client.client.client_ui_conv import Ui_MainClientWindow
...
class ClientMainWindow(QMainWindow):
    ...
    конвертированого файла client_ui_conv.py
    """
    ...
    def __init__(self, database, transport, keys):
        ...
        # Даблклик по списку контактов отправляется в обработчик
    ...
    def send_message(self):
        ...
        if not message_text:
            return
        # Шифрование сообщения ключом получателя и упаковываем в base64.
    ...
    def message(self, message):
        ...
        if sender == self.current_chat:
            ...
            if self.database.check_contact(sender):
                ...
                print('NO')
                # если нету,спрашиваем хотим ли добавить юзера в контакты.
                if self.messages.question(self, 'Новое сообщение', f'Получено новое сообщение от {sender}.\n'
