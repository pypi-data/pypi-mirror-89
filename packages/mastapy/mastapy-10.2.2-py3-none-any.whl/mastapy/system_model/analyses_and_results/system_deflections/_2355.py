...
from mastapy.system_model.analyses_and_results.power_flows import _3355, _3285, _3341
...
class ShaftToMountableComponentConnectionSystemDeflection(_2287.ConnectionSystemDeflection):
    '''ShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3355.ShaftToMountableComponentConnectionPowerFlow':
