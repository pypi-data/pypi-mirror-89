...
class Store:
	...
	def set(self, filename: str, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:IQ:DOHerty<ST>:SHAPing:NORMalized:DATA:STORe \n
		Snippet: driver.source.iq.doherty.shaping.normalized.data.store.set(filename = '1', stream = repcap.Stream.Default) \n
