...
REQUIREMENTS = ['cloudscraper', 'cssselect>=1.1', 'lxml~=4.6', 'packaging>=20.3', 'Pillow~=8.0', 'progressbar2>=3.50', 'pycryptodome>=3.9', 'PyExecJS>=1.5', 'requests>=2.23', 'better_exceptions>=0.2', '# aiocfscrape  # cf', ]
