...
[boto3.CodeStarNotifications 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/codestar-notifications.html#CodeStarNotifications) service
compatible with
