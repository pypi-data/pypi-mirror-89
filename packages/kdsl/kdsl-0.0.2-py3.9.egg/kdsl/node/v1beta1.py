...
class RuntimeClass(K8sResource):
    ...
    overhead: Union[None, OmitEnum, kdsl.node.v1beta1.Overhead] = attr.ib(metadata={'yaml_name': 'overhead'}, converter=kdsl.node.v1beta1_converters.optional_converter_Overhead, default=OMIT)
    scheduling: Union[None, OmitEnum, kdsl.node.v1beta1.Scheduling] = attr.ib(metadata={'yaml_name': 'scheduling'}, converter=kdsl.node.v1beta1_converters.optional_converter_Scheduling, default=OMIT)
