...
from mastapy.system_model.analyses_and_results.system_deflections import _2330, _2377
...
class SystemDeflection(_6542.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2330.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2330.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2377.SystemDeflectionOptions':
        ...
        return constructor.new(_2377.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
