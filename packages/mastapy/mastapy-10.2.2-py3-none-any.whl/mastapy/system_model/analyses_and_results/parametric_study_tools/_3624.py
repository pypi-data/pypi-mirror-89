...
class StraightBevelDiffGearParametricStudyTool(_3524.BevelGearParametricStudyTool):
    '''StraightBevelDiffGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2365.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2365.StraightBevelDiffGearSystemDeflection))
        return value
