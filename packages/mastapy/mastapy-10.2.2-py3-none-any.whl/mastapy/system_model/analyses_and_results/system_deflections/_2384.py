...
class UnbalancedMassSystemDeflection(_2385.VirtualComponentSystemDeflection):
    '''UnbalancedMassSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3380.UnbalancedMassPowerFlow':
        ...
        return constructor.new(_3380.UnbalancedMassPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
