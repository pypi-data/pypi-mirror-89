...
class WormGearSetGearWhineAnalysis(_5371.GearSetGearWhineAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2387.WormGearSetSystemDeflection':
        ...
        return constructor.new(_2387.WormGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
