...
class Store:
	...
	def set(self, filename: str, stream=repcap.Stream.Default) -> None:
		"""SCPI: [SOURce<HW>]:IQ:DPD<ST>:SHAPing:POLYnomial:COEFficients:STORe \n
		Snippet: driver.source.iq.dpd.shaping.polynomial.coefficients.store.set(filename = '1', stream = repcap.Stream.Default) \n
