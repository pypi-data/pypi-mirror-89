...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2401.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3735.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow':
        ...
        return constructor.new(_3735.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
