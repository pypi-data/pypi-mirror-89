...
[boto3.ComputeOptimizer 1.16.44](https://boto3.amazonaws.com/v1/documentation/api/1.16.44/reference/services/compute-optimizer.html#ComputeOptimizer) service
compatible with
