...
class PointLoadAdvancedSystemDeflection(_6405.VirtualComponentAdvancedSystemDeflection):
    '''PointLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2344.PointLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2344.PointLoadSystemDeflection))
        return value
