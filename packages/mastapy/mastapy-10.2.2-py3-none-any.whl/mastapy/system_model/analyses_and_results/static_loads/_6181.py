...
from mastapy.system_model.analyses_and_results.static_loads import _6184, _6180, _6161
...
class HarmonicLoadDataImportFromMotorPackages(_6180.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
