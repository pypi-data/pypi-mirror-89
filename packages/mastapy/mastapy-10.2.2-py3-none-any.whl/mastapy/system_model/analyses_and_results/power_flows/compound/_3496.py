...
class SynchroniserSleeveCompoundPowerFlow(_3495.SynchroniserPartCompoundPowerFlow):
    '''SynchroniserSleeveCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3374.SynchroniserSleevePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3374.SynchroniserSleevePowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3374.SynchroniserSleevePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3374.SynchroniserSleevePowerFlow))
        return value
