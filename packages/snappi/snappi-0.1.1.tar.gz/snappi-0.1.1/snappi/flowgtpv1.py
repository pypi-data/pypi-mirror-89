...
class FlowGtpv1(SnappiObject):
    ...
    def message_length(self):
        ...
        A container for packet header field patterns.A 16-bit field that indicates the length of the payload in bytes (rest of the packet following the mandatory 8-byte GTP header)  
    ...
    def squence_number(self):
        ...
        A container for packet header field patterns.An (optional) 16-bit field  
    ...
    def n_pdu_number(self):
        ...
        A container for packet header field patterns.An (optional) 8-bit field  
        This field exists if any of the e_flag, s_flag, or pn_flag bits are on  
