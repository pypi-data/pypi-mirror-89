...
class CompositeGates:
    pass


class PauliRotation(CompositeGates):
    ...
    def __call__(self, *qubits):
        ...
        operations += PauliRotation.change_basis(*qubits, self.paulis)
        ...
        operations += PauliRotation.change_basis(*qubits, self.paulis, inverse=True)
