...
class KlingelnbergCycloPalloidHypoidGearModalAnalysis(_4810.KlingelnbergCycloPalloidConicalGearModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2326.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
        ...
        return constructor.new(_2326.KlingelnbergCycloPalloidHypoidGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
