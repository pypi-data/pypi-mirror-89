...
class Per:
	...
	class ResultData(StructBase):
		"""Response structure. Fields: \n
			...
			- Per: float: float Range: 0 % to 100 % , Unit: %
	...
	def read(self) -> ResultData:
		...
		Snippet: value: ResultData = driver.per.read() \n
		Returns all results of the PER measurement. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'READ:WLAN:SIGNaling<Instance>:PER?', self.__class__.ResultData())

	def fetch(self) -> ResultData:
		"""SCPI: FETCh:WLAN:SIGNaling<instance>:PER \n
		Snippet: value: ResultData = driver.per.fetch() \n
		Returns all results of the PER measurement. \n
			:return: structure: for return value, see the help for ResultData structure arguments."""
		return self._core.io.query_struct(f'FETCh:WLAN:SIGNaling<Instance>:PER?', self.__class__.ResultData())
