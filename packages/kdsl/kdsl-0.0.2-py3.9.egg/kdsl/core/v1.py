...
from typing import Mapping, Union, ClassVar, Optional, TypedDict, Any, Sequence
...
class Namespace(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.core.v1.NamespaceSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.core.v1_converters.optional_converter_NamespaceSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.core.v1.NamespaceStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.core.v1_converters.optional_converter_NamespaceStatus, default=OMIT)


@attr.s(kw_only=True)
class LoadBalancerStatus(K8sObject):
    ingress: Union[None, OmitEnum, Sequence[kdsl.core.v1.LoadBalancerIngress]] = attr.ib(metadata={'yaml_name': 'ingress'}, converter=kdsl.core.v1_converters.optional_list_converter_LoadBalancerIngress, default=OMIT)
...
class EnvVar(K8sObject):
    ...
    valueFrom: Union[None, OmitEnum, kdsl.core.v1.EnvVarSource] = attr.ib(metadata={'yaml_name': 'valueFrom'}, converter=kdsl.core.v1_converters.optional_converter_EnvVarSource, default=OMIT)
...
class EphemeralContainerItem(K8sObject):
    ...
    env: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.EnvVarItem]] = attr.ib(metadata={'yaml_name': 'env', 'mlist_key': 'name'}, converter=kdsl.core.v1_converters.optional_mlist_converter_EnvVarItem, default=OMIT)
    envFrom: Union[None, OmitEnum, Sequence[kdsl.core.v1.EnvFromSource]] = attr.ib(metadata={'yaml_name': 'envFrom'}, converter=kdsl.core.v1_converters.optional_list_converter_EnvFromSource, default=OMIT)
    ...
    lifecycle: Union[None, OmitEnum, kdsl.core.v1.Lifecycle] = attr.ib(metadata={'yaml_name': 'lifecycle'}, converter=kdsl.core.v1_converters.optional_converter_Lifecycle, default=OMIT)
    livenessProbe: Union[None, OmitEnum, kdsl.core.v1.Probe] = attr.ib(metadata={'yaml_name': 'livenessProbe'}, converter=kdsl.core.v1_converters.optional_converter_Probe, default=OMIT)
    ports: Union[None, OmitEnum, Sequence[kdsl.core.v1.ContainerPort]] = attr.ib(metadata={'yaml_name': 'ports'}, converter=kdsl.core.v1_converters.optional_list_converter_ContainerPort, default=OMIT)
    readinessProbe: Union[None, OmitEnum, kdsl.core.v1.Probe] = attr.ib(metadata={'yaml_name': 'readinessProbe'}, converter=kdsl.core.v1_converters.optional_converter_Probe, default=OMIT)
    resources: Union[None, OmitEnum, kdsl.core.v1.ResourceRequirements] = attr.ib(metadata={'yaml_name': 'resources'}, converter=kdsl.core.v1_converters.optional_converter_ResourceRequirements, default=OMIT)
    securityContext: Union[None, OmitEnum, kdsl.core.v1.SecurityContext] = attr.ib(metadata={'yaml_name': 'securityContext'}, converter=kdsl.core.v1_converters.optional_converter_SecurityContext, default=OMIT)
    startupProbe: Union[None, OmitEnum, kdsl.core.v1.Probe] = attr.ib(metadata={'yaml_name': 'startupProbe'}, converter=kdsl.core.v1_converters.optional_converter_Probe, default=OMIT)
    ...
    volumeDevices: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.VolumeDeviceItem]] = attr.ib(metadata={'yaml_name': 'volumeDevices', 'mlist_key': 'devicePath'}, converter=kdsl.core.v1_converters.optional_mlist_converter_VolumeDeviceItem, default=OMIT)
    volumeMounts: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.VolumeMountItem]] = attr.ib(metadata={'yaml_name': 'volumeMounts', 'mlist_key': 'mountPath'}, converter=kdsl.core.v1_converters.optional_mlist_converter_VolumeMountItem, default=OMIT)
...
class SecretProjection(K8sObject):
    items: Union[None, OmitEnum, Sequence[kdsl.core.v1.KeyToPath]] = attr.ib(metadata={'yaml_name': 'items'}, converter=kdsl.core.v1_converters.optional_list_converter_KeyToPath, default=OMIT)
...
class Affinity(K8sObject):
    nodeAffinity: Union[None, OmitEnum, kdsl.core.v1.NodeAffinity] = attr.ib(metadata={'yaml_name': 'nodeAffinity'}, converter=kdsl.core.v1_converters.optional_converter_NodeAffinity, default=OMIT)
    podAffinity: Union[None, OmitEnum, kdsl.core.v1.PodAffinity] = attr.ib(metadata={'yaml_name': 'podAffinity'}, converter=kdsl.core.v1_converters.optional_converter_PodAffinity, default=OMIT)
    podAntiAffinity: Union[None, OmitEnum, kdsl.core.v1.PodAntiAffinity] = attr.ib(metadata={'yaml_name': 'podAntiAffinity'}, converter=kdsl.core.v1_converters.optional_converter_PodAntiAffinity, default=OMIT)
...
class CinderPersistentVolumeSource(K8sObject):
    ...
    secretRef: Union[None, OmitEnum, kdsl.core.v1.SecretReference] = attr.ib(metadata={'yaml_name': 'secretRef'}, converter=kdsl.core.v1_converters.optional_converter_SecretReference, default=OMIT)
...
class CSIPersistentVolumeSource(K8sObject):
    ...
    controllerExpandSecretRef: Union[None, OmitEnum, kdsl.core.v1.SecretReference] = attr.ib(metadata={'yaml_name': 'controllerExpandSecretRef'}, converter=kdsl.core.v1_converters.optional_converter_SecretReference, default=OMIT)
    controllerPublishSecretRef: Union[None, OmitEnum, kdsl.core.v1.SecretReference] = attr.ib(metadata={'yaml_name': 'controllerPublishSecretRef'}, converter=kdsl.core.v1_converters.optional_converter_SecretReference, default=OMIT)
    fsType: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'fsType'}, default=OMIT)
    nodePublishSecretRef: Union[None, OmitEnum, kdsl.core.v1.SecretReference] = attr.ib(metadata={'yaml_name': 'nodePublishSecretRef'}, converter=kdsl.core.v1_converters.optional_converter_SecretReference, default=OMIT)
    nodeStageSecretRef: Union[None, OmitEnum, kdsl.core.v1.SecretReference] = attr.ib(metadata={'yaml_name': 'nodeStageSecretRef'}, converter=kdsl.core.v1_converters.optional_converter_SecretReference, default=OMIT)
    readOnly: Union[None, OmitEnum, bool] = attr.ib(metadata={'yaml_name': 'readOnly'}, default=OMIT)
...
class PodStatus(K8sObject):
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.PodConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.core.v1_converters.optional_mlist_converter_PodConditionItem, default=OMIT)
    containerStatuses: Union[None, OmitEnum, Sequence[kdsl.core.v1.ContainerStatus]] = attr.ib(metadata={'yaml_name': 'containerStatuses'}, converter=kdsl.core.v1_converters.optional_list_converter_ContainerStatus, default=OMIT)
    ephemeralContainerStatuses: Union[None, OmitEnum, Sequence[kdsl.core.v1.ContainerStatus]] = attr.ib(metadata={'yaml_name': 'ephemeralContainerStatuses'}, converter=kdsl.core.v1_converters.optional_list_converter_ContainerStatus, default=OMIT)
    hostIP: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'hostIP'}, default=OMIT)
    initContainerStatuses: Union[None, OmitEnum, Sequence[kdsl.core.v1.ContainerStatus]] = attr.ib(metadata={'yaml_name': 'initContainerStatuses'}, converter=kdsl.core.v1_converters.optional_list_converter_ContainerStatus, default=OMIT)
    ...
    podIPs: Union[None, OmitEnum, Sequence[kdsl.core.v1.PodIP]] = attr.ib(metadata={'yaml_name': 'podIPs'}, converter=kdsl.core.v1_converters.optional_list_converter_PodIP, default=OMIT)
...
class EnvVarSource(K8sObject):
    configMapKeyRef: Union[None, OmitEnum, kdsl.core.v1.ConfigMapKeySelector] = attr.ib(metadata={'yaml_name': 'configMapKeyRef'}, converter=kdsl.core.v1_converters.optional_converter_ConfigMapKeySelector, default=OMIT)
    fieldRef: Union[None, OmitEnum, kdsl.core.v1.ObjectFieldSelector] = attr.ib(metadata={'yaml_name': 'fieldRef'}, converter=kdsl.core.v1_converters.optional_converter_ObjectFieldSelector, default=OMIT)
    resourceFieldRef: Union[None, OmitEnum, kdsl.core.v1.ResourceFieldSelector] = attr.ib(metadata={'yaml_name': 'resourceFieldRef'}, converter=kdsl.core.v1_converters.optional_converter_ResourceFieldSelector, default=OMIT)
    secretKeyRef: Union[None, OmitEnum, kdsl.core.v1.SecretKeySelector] = attr.ib(metadata={'yaml_name': 'secretKeyRef'}, converter=kdsl.core.v1_converters.optional_converter_SecretKeySelector, default=OMIT)
...
class PodSecurityContext(K8sObject):
    ...
    seLinuxOptions: Union[None, OmitEnum, kdsl.core.v1.SELinuxOptions] = attr.ib(metadata={'yaml_name': 'seLinuxOptions'}, converter=kdsl.core.v1_converters.optional_converter_SELinuxOptions, default=OMIT)
    supplementalGroups: Union[None, OmitEnum, Sequence[int]] = attr.ib(metadata={'yaml_name': 'supplementalGroups'}, default=OMIT)
    sysctls: Union[None, OmitEnum, Sequence[kdsl.core.v1.Sysctl]] = attr.ib(metadata={'yaml_name': 'sysctls'}, converter=kdsl.core.v1_converters.optional_list_converter_Sysctl, default=OMIT)
    windowsOptions: Union[None, OmitEnum, kdsl.core.v1.WindowsSecurityContextOptions] = attr.ib(metadata={'yaml_name': 'windowsOptions'}, converter=kdsl.core.v1_converters.optional_converter_WindowsSecurityContextOptions, default=OMIT)
...
class FlexVolumeSource(K8sObject):
    ...
    readOnly: Union[None, OmitEnum, bool] = attr.ib(metadata={'yaml_name': 'readOnly'}, default=OMIT)
    secretRef: Union[None, OmitEnum, kdsl.core.v1.LocalObjectReference] = attr.ib(metadata={'yaml_name': 'secretRef'}, converter=kdsl.core.v1_converters.optional_converter_LocalObjectReference, default=OMIT)
...
class NodeSelectorTerm(K8sObject):
    matchExpressions: Union[None, OmitEnum, Sequence[kdsl.core.v1.NodeSelectorRequirement]] = attr.ib(metadata={'yaml_name': 'matchExpressions'}, converter=kdsl.core.v1_converters.optional_list_converter_NodeSelectorRequirement, default=OMIT)
    matchFields: Union[None, OmitEnum, Sequence[kdsl.core.v1.NodeSelectorRequirement]] = attr.ib(metadata={'yaml_name': 'matchFields'}, converter=kdsl.core.v1_converters.optional_list_converter_NodeSelectorRequirement, default=OMIT)
...
class Toleration(K8sObject):
    ...
    operator: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'operator'}, default=OMIT)
...
class ServiceStatus(K8sObject):
    loadBalancer: Union[None, OmitEnum, kdsl.core.v1.LoadBalancerStatus] = attr.ib(metadata={'yaml_name': 'loadBalancer'}, converter=kdsl.core.v1_converters.optional_converter_LoadBalancerStatus, default=OMIT)
...
class Endpoints(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    subsets: Union[None, OmitEnum, Sequence[kdsl.core.v1.EndpointSubset]] = attr.ib(metadata={'yaml_name': 'subsets'}, converter=kdsl.core.v1_converters.optional_list_converter_EndpointSubset, default=OMIT)


@attr.s(kw_only=True)
class EnvFromSource(K8sObject):
    configMapRef: Union[None, OmitEnum, kdsl.core.v1.ConfigMapEnvSource] = attr.ib(metadata={'yaml_name': 'configMapRef'}, converter=kdsl.core.v1_converters.optional_converter_ConfigMapEnvSource, default=OMIT)
    prefix: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'prefix'}, default=OMIT)
    secretRef: Union[None, OmitEnum, kdsl.core.v1.SecretEnvSource] = attr.ib(metadata={'yaml_name': 'secretRef'}, converter=kdsl.core.v1_converters.optional_converter_SecretEnvSource, default=OMIT)
...
class PersistentVolume(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.core.v1.PersistentVolumeSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.core.v1_converters.optional_converter_PersistentVolumeSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.core.v1.PersistentVolumeStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.core.v1_converters.optional_converter_PersistentVolumeStatus, default=OMIT)
...
class HTTPGetAction(K8sObject):
    ...
    httpHeaders: Union[None, OmitEnum, Sequence[kdsl.core.v1.HTTPHeader]] = attr.ib(metadata={'yaml_name': 'httpHeaders'}, converter=kdsl.core.v1_converters.optional_list_converter_HTTPHeader, default=OMIT)
    path: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'path'}, default=OMIT)
...
class ResourceQuotaSpec(K8sObject):
    ...
    scopeSelector: Union[None, OmitEnum, kdsl.core.v1.ScopeSelector] = attr.ib(metadata={'yaml_name': 'scopeSelector'}, converter=kdsl.core.v1_converters.optional_converter_ScopeSelector, default=OMIT)
...
class PodTemplateSpec(K8sObject):
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.core.v1.PodSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.core.v1_converters.optional_converter_PodSpec, default=OMIT)
...
class EndpointAddress(K8sObject):
    ...
    targetRef: Union[None, OmitEnum, kdsl.core.v1.ObjectReference] = attr.ib(metadata={'yaml_name': 'targetRef'}, converter=kdsl.core.v1_converters.optional_converter_ObjectReference, default=OMIT)
...
class Handler(K8sObject):
    exec: Union[None, OmitEnum, kdsl.core.v1.ExecAction] = attr.ib(metadata={'yaml_name': 'exec'}, converter=kdsl.core.v1_converters.optional_converter_ExecAction, default=OMIT)
    httpGet: Union[None, OmitEnum, kdsl.core.v1.HTTPGetAction] = attr.ib(metadata={'yaml_name': 'httpGet'}, converter=kdsl.core.v1_converters.optional_converter_HTTPGetAction, default=OMIT)
    tcpSocket: Union[None, OmitEnum, kdsl.core.v1.TCPSocketAction] = attr.ib(metadata={'yaml_name': 'tcpSocket'}, converter=kdsl.core.v1_converters.optional_converter_TCPSocketAction, default=OMIT)
...
class VolumeItem(K8sObject):
    awsElasticBlockStore: Union[None, OmitEnum, kdsl.core.v1.AWSElasticBlockStoreVolumeSource] = attr.ib(metadata={'yaml_name': 'awsElasticBlockStore'}, converter=kdsl.core.v1_converters.optional_converter_AWSElasticBlockStoreVolumeSource, default=OMIT)
    azureDisk: Union[None, OmitEnum, kdsl.core.v1.AzureDiskVolumeSource] = attr.ib(metadata={'yaml_name': 'azureDisk'}, converter=kdsl.core.v1_converters.optional_converter_AzureDiskVolumeSource, default=OMIT)
    azureFile: Union[None, OmitEnum, kdsl.core.v1.AzureFileVolumeSource] = attr.ib(metadata={'yaml_name': 'azureFile'}, converter=kdsl.core.v1_converters.optional_converter_AzureFileVolumeSource, default=OMIT)
    cephfs: Union[None, OmitEnum, kdsl.core.v1.CephFSVolumeSource] = attr.ib(metadata={'yaml_name': 'cephfs'}, converter=kdsl.core.v1_converters.optional_converter_CephFSVolumeSource, default=OMIT)
    cinder: Union[None, OmitEnum, kdsl.core.v1.CinderVolumeSource] = attr.ib(metadata={'yaml_name': 'cinder'}, converter=kdsl.core.v1_converters.optional_converter_CinderVolumeSource, default=OMIT)
    configMap: Union[None, OmitEnum, kdsl.core.v1.ConfigMapVolumeSource] = attr.ib(metadata={'yaml_name': 'configMap'}, converter=kdsl.core.v1_converters.optional_converter_ConfigMapVolumeSource, default=OMIT)
    csi: Union[None, OmitEnum, kdsl.core.v1.CSIVolumeSource] = attr.ib(metadata={'yaml_name': 'csi'}, converter=kdsl.core.v1_converters.optional_converter_CSIVolumeSource, default=OMIT)
    downwardAPI: Union[None, OmitEnum, kdsl.core.v1.DownwardAPIVolumeSource] = attr.ib(metadata={'yaml_name': 'downwardAPI'}, converter=kdsl.core.v1_converters.optional_converter_DownwardAPIVolumeSource, default=OMIT)
    emptyDir: Union[None, OmitEnum, kdsl.core.v1.EmptyDirVolumeSource] = attr.ib(metadata={'yaml_name': 'emptyDir'}, converter=kdsl.core.v1_converters.optional_converter_EmptyDirVolumeSource, default=OMIT)
    fc: Union[None, OmitEnum, kdsl.core.v1.FCVolumeSource] = attr.ib(metadata={'yaml_name': 'fc'}, converter=kdsl.core.v1_converters.optional_converter_FCVolumeSource, default=OMIT)
    flexVolume: Union[None, OmitEnum, kdsl.core.v1.FlexVolumeSource] = attr.ib(metadata={'yaml_name': 'flexVolume'}, converter=kdsl.core.v1_converters.optional_converter_FlexVolumeSource, default=OMIT)
    flocker: Union[None, OmitEnum, kdsl.core.v1.FlockerVolumeSource] = attr.ib(metadata={'yaml_name': 'flocker'}, converter=kdsl.core.v1_converters.optional_converter_FlockerVolumeSource, default=OMIT)
    gcePersistentDisk: Union[None, OmitEnum, kdsl.core.v1.GCEPersistentDiskVolumeSource] = attr.ib(metadata={'yaml_name': 'gcePersistentDisk'}, converter=kdsl.core.v1_converters.optional_converter_GCEPersistentDiskVolumeSource, default=OMIT)
    gitRepo: Union[None, OmitEnum, kdsl.core.v1.GitRepoVolumeSource] = attr.ib(metadata={'yaml_name': 'gitRepo'}, converter=kdsl.core.v1_converters.optional_converter_GitRepoVolumeSource, default=OMIT)
    glusterfs: Union[None, OmitEnum, kdsl.core.v1.GlusterfsVolumeSource] = attr.ib(metadata={'yaml_name': 'glusterfs'}, converter=kdsl.core.v1_converters.optional_converter_GlusterfsVolumeSource, default=OMIT)
    hostPath: Union[None, OmitEnum, kdsl.core.v1.HostPathVolumeSource] = attr.ib(metadata={'yaml_name': 'hostPath'}, converter=kdsl.core.v1_converters.optional_converter_HostPathVolumeSource, default=OMIT)
    iscsi: Union[None, OmitEnum, kdsl.core.v1.ISCSIVolumeSource] = attr.ib(metadata={'yaml_name': 'iscsi'}, converter=kdsl.core.v1_converters.optional_converter_ISCSIVolumeSource, default=OMIT)
    nfs: Union[None, OmitEnum, kdsl.core.v1.NFSVolumeSource] = attr.ib(metadata={'yaml_name': 'nfs'}, converter=kdsl.core.v1_converters.optional_converter_NFSVolumeSource, default=OMIT)
    persistentVolumeClaim: Union[None, OmitEnum, kdsl.core.v1.PersistentVolumeClaimVolumeSource] = attr.ib(metadata={'yaml_name': 'persistentVolumeClaim'}, converter=kdsl.core.v1_converters.optional_converter_PersistentVolumeClaimVolumeSource, default=OMIT)
    photonPersistentDisk: Union[None, OmitEnum, kdsl.core.v1.PhotonPersistentDiskVolumeSource] = attr.ib(metadata={'yaml_name': 'photonPersistentDisk'}, converter=kdsl.core.v1_converters.optional_converter_PhotonPersistentDiskVolumeSource, default=OMIT)
    portworxVolume: Union[None, OmitEnum, kdsl.core.v1.PortworxVolumeSource] = attr.ib(metadata={'yaml_name': 'portworxVolume'}, converter=kdsl.core.v1_converters.optional_converter_PortworxVolumeSource, default=OMIT)
    projected: Union[None, OmitEnum, kdsl.core.v1.ProjectedVolumeSource] = attr.ib(metadata={'yaml_name': 'projected'}, converter=kdsl.core.v1_converters.optional_converter_ProjectedVolumeSource, default=OMIT)
    quobyte: Union[None, OmitEnum, kdsl.core.v1.QuobyteVolumeSource] = attr.ib(metadata={'yaml_name': 'quobyte'}, converter=kdsl.core.v1_converters.optional_converter_QuobyteVolumeSource, default=OMIT)
    rbd: Union[None, OmitEnum, kdsl.core.v1.RBDVolumeSource] = attr.ib(metadata={'yaml_name': 'rbd'}, converter=kdsl.core.v1_converters.optional_converter_RBDVolumeSource, default=OMIT)
    scaleIO: Union[None, OmitEnum, kdsl.core.v1.ScaleIOVolumeSource] = attr.ib(metadata={'yaml_name': 'scaleIO'}, converter=kdsl.core.v1_converters.optional_converter_ScaleIOVolumeSource, default=OMIT)
    secret: Union[None, OmitEnum, kdsl.core.v1.SecretVolumeSource] = attr.ib(metadata={'yaml_name': 'secret'}, converter=kdsl.core.v1_converters.optional_converter_SecretVolumeSource, default=OMIT)
    storageos: Union[None, OmitEnum, kdsl.core.v1.StorageOSVolumeSource] = attr.ib(metadata={'yaml_name': 'storageos'}, converter=kdsl.core.v1_converters.optional_converter_StorageOSVolumeSource, default=OMIT)
    vsphereVolume: Union[None, OmitEnum, kdsl.core.v1.VsphereVirtualDiskVolumeSource] = attr.ib(metadata={'yaml_name': 'vsphereVolume'}, converter=kdsl.core.v1_converters.optional_converter_VsphereVirtualDiskVolumeSource, default=OMIT)
...
class PodAntiAffinity(K8sObject):
    preferredDuringSchedulingIgnoredDuringExecution: Union[None, OmitEnum, Sequence[kdsl.core.v1.WeightedPodAffinityTerm]] = attr.ib(metadata={'yaml_name': 'preferredDuringSchedulingIgnoredDuringExecution'}, converter=kdsl.core.v1_converters.optional_list_converter_WeightedPodAffinityTerm, default=OMIT)
    requiredDuringSchedulingIgnoredDuringExecution: Union[None, OmitEnum, Sequence[kdsl.core.v1.PodAffinityTerm]] = attr.ib(metadata={'yaml_name': 'requiredDuringSchedulingIgnoredDuringExecution'}, converter=kdsl.core.v1_converters.optional_list_converter_PodAffinityTerm, default=OMIT)


class PodAntiAffinityTypedDict(TypedDict, total=(False)):
    preferredDuringSchedulingIgnoredDuringExecution: Sequence[kdsl.core.v1.WeightedPodAffinityTerm]
    requiredDuringSchedulingIgnoredDuringExecution: Sequence[kdsl.core.v1.PodAffinityTerm]
...
class PodDNSConfig(K8sObject):
    ...
    options: Union[None, OmitEnum, Sequence[kdsl.core.v1.PodDNSConfigOption]] = attr.ib(metadata={'yaml_name': 'options'}, converter=kdsl.core.v1_converters.optional_list_converter_PodDNSConfigOption, default=OMIT)
...
class NodeDaemonEndpoints(K8sObject):
    kubeletEndpoint: Union[None, OmitEnum, kdsl.core.v1.DaemonEndpoint] = attr.ib(metadata={'yaml_name': 'kubeletEndpoint'}, converter=kdsl.core.v1_converters.optional_converter_DaemonEndpoint, default=OMIT)
...
class NodeConfigStatus(K8sObject):
    active: Union[None, OmitEnum, kdsl.core.v1.NodeConfigSource] = attr.ib(metadata={'yaml_name': 'active'}, converter=kdsl.core.v1_converters.optional_converter_NodeConfigSource, default=OMIT)
    assigned: Union[None, OmitEnum, kdsl.core.v1.NodeConfigSource] = attr.ib(metadata={'yaml_name': 'assigned'}, converter=kdsl.core.v1_converters.optional_converter_NodeConfigSource, default=OMIT)
    error: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'error'}, default=OMIT)
    lastKnownGood: Union[None, OmitEnum, kdsl.core.v1.NodeConfigSource] = attr.ib(metadata={'yaml_name': 'lastKnownGood'}, converter=kdsl.core.v1_converters.optional_converter_NodeConfigSource, default=OMIT)
...
class Lifecycle(K8sObject):
    postStart: Union[None, OmitEnum, kdsl.core.v1.Handler] = attr.ib(metadata={'yaml_name': 'postStart'}, converter=kdsl.core.v1_converters.optional_converter_Handler, default=OMIT)
    preStop: Union[None, OmitEnum, kdsl.core.v1.Handler] = attr.ib(metadata={'yaml_name': 'preStop'}, converter=kdsl.core.v1_converters.optional_converter_Handler, default=OMIT)
...
class ReplicationController(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.core.v1.ReplicationControllerSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.core.v1_converters.optional_converter_ReplicationControllerSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.core.v1.ReplicationControllerStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.core.v1_converters.optional_converter_ReplicationControllerStatus, default=OMIT)


@attr.s(kw_only=True)
class NodeAffinity(K8sObject):
    preferredDuringSchedulingIgnoredDuringExecution: Union[None, OmitEnum, Sequence[kdsl.core.v1.PreferredSchedulingTerm]] = attr.ib(metadata={'yaml_name': 'preferredDuringSchedulingIgnoredDuringExecution'}, converter=kdsl.core.v1_converters.optional_list_converter_PreferredSchedulingTerm, default=OMIT)
    requiredDuringSchedulingIgnoredDuringExecution: Union[None, OmitEnum, kdsl.core.v1.NodeSelector] = attr.ib(metadata={'yaml_name': 'requiredDuringSchedulingIgnoredDuringExecution'}, converter=kdsl.core.v1_converters.optional_converter_NodeSelector, default=OMIT)


class NodeAffinityTypedDict(TypedDict, total=(False)):
    preferredDuringSchedulingIgnoredDuringExecution: Sequence[kdsl.core.v1.PreferredSchedulingTerm]
...
class LimitRangeSpec(K8sObject):
    limits: Sequence[kdsl.core.v1.LimitRangeItem] = attr.ib(metadata={'yaml_name': 'limits'}, converter=kdsl.core.v1_converters.required_list_converter_LimitRangeItem)
...
class NodeSpec(K8sObject):
    configSource: Union[None, OmitEnum, kdsl.core.v1.NodeConfigSource] = attr.ib(metadata={'yaml_name': 'configSource'}, converter=kdsl.core.v1_converters.optional_converter_NodeConfigSource, default=OMIT)
    ...
    taints: Union[None, OmitEnum, Sequence[kdsl.core.v1.Taint]] = attr.ib(metadata={'yaml_name': 'taints'}, converter=kdsl.core.v1_converters.optional_list_converter_Taint, default=OMIT)
...
class EndpointSubset(K8sObject):
    addresses: Union[None, OmitEnum, Sequence[kdsl.core.v1.EndpointAddress]] = attr.ib(metadata={'yaml_name': 'addresses'}, converter=kdsl.core.v1_converters.optional_list_converter_EndpointAddress, default=OMIT)
    notReadyAddresses: Union[None, OmitEnum, Sequence[kdsl.core.v1.EndpointAddress]] = attr.ib(metadata={'yaml_name': 'notReadyAddresses'}, converter=kdsl.core.v1_converters.optional_list_converter_EndpointAddress, default=OMIT)
    ports: Union[None, OmitEnum, Sequence[kdsl.core.v1.EndpointPort]] = attr.ib(metadata={'yaml_name': 'ports'}, converter=kdsl.core.v1_converters.optional_list_converter_EndpointPort, default=OMIT)
...
class PersistentVolumeClaimSpec(K8sObject):
    ...
    dataSource: Union[None, OmitEnum, kdsl.core.v1.TypedLocalObjectReference] = attr.ib(metadata={'yaml_name': 'dataSource'}, converter=kdsl.core.v1_converters.optional_converter_TypedLocalObjectReference, default=OMIT)
    resources: Union[None, OmitEnum, kdsl.core.v1.ResourceRequirements] = attr.ib(metadata={'yaml_name': 'resources'}, converter=kdsl.core.v1_converters.optional_converter_ResourceRequirements, default=OMIT)
    selector: Union[None, OmitEnum, kdsl.core.v1.LabelSelector] = attr.ib(metadata={'yaml_name': 'selector'}, converter=kdsl.core.v1_converters.optional_converter_LabelSelector, default=OMIT)
...
class ContainerStatus(K8sObject):
    ...
    containerID: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'containerID'}, default=OMIT)
    lastState: Union[None, OmitEnum, kdsl.core.v1.ContainerState] = attr.ib(metadata={'yaml_name': 'lastState'}, converter=kdsl.core.v1_converters.optional_converter_ContainerState, default=OMIT)
    started: Union[None, OmitEnum, bool] = attr.ib(metadata={'yaml_name': 'started'}, default=OMIT)
    state: Union[None, OmitEnum, kdsl.core.v1.ContainerState] = attr.ib(metadata={'yaml_name': 'state'}, converter=kdsl.core.v1_converters.optional_converter_ContainerState, default=OMIT)
...
class EventSeries(K8sObject):
    ...
    state: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'state'}, default=OMIT)
...
class ObjectMeta(K8sObject):
    ...
    managedFields: Union[None, OmitEnum, Sequence[kdsl.core.v1.ManagedFieldsEntry]] = attr.ib(metadata={'yaml_name': 'managedFields'}, converter=kdsl.core.v1_converters.optional_list_converter_ManagedFieldsEntry, default=OMIT)
    name: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'name'}, default=OMIT)
    namespace: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'namespace'}, default=OMIT)
    ownerReferences: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.OwnerReferenceItem]] = attr.ib(metadata={'yaml_name': 'ownerReferences', 'mlist_key': 'uid'}, converter=kdsl.core.v1_converters.optional_mlist_converter_OwnerReferenceItem, default=OMIT)
...
class ReplicationControllerSpec(K8sObject):
    ...
    template: Union[None, OmitEnum, kdsl.core.v1.PodTemplateSpec] = attr.ib(metadata={'yaml_name': 'template'}, converter=kdsl.core.v1_converters.optional_converter_PodTemplateSpec, default=OMIT)
...
class Pod(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.core.v1.PodSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.core.v1_converters.optional_converter_PodSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.core.v1.PodStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.core.v1_converters.optional_converter_PodStatus, default=OMIT)
...
class ScaleIOPersistentVolumeSource(K8sObject):
    ...
    secretRef: kdsl.core.v1.SecretReference = attr.ib(metadata={'yaml_name': 'secretRef'}, converter=kdsl.core.v1_converters.required_converter_SecretReference)
...
class PersistentVolumeSpec(K8sObject):
    ...
    awsElasticBlockStore: Union[None, OmitEnum, kdsl.core.v1.AWSElasticBlockStoreVolumeSource] = attr.ib(metadata={'yaml_name': 'awsElasticBlockStore'}, converter=kdsl.core.v1_converters.optional_converter_AWSElasticBlockStoreVolumeSource, default=OMIT)
    azureDisk: Union[None, OmitEnum, kdsl.core.v1.AzureDiskVolumeSource] = attr.ib(metadata={'yaml_name': 'azureDisk'}, converter=kdsl.core.v1_converters.optional_converter_AzureDiskVolumeSource, default=OMIT)
    azureFile: Union[None, OmitEnum, kdsl.core.v1.AzureFilePersistentVolumeSource] = attr.ib(metadata={'yaml_name': 'azureFile'}, converter=kdsl.core.v1_converters.optional_converter_AzureFilePersistentVolumeSource, default=OMIT)
    capacity: Union[None, OmitEnum, Mapping[str, str]] = attr.ib(metadata={'yaml_name': 'capacity'}, default=OMIT)
    cephfs: Union[None, OmitEnum, kdsl.core.v1.CephFSPersistentVolumeSource] = attr.ib(metadata={'yaml_name': 'cephfs'}, converter=kdsl.core.v1_converters.optional_converter_CephFSPersistentVolumeSource, default=OMIT)
    cinder: Union[None, OmitEnum, kdsl.core.v1.CinderPersistentVolumeSource] = attr.ib(metadata={'yaml_name': 'cinder'}, converter=kdsl.core.v1_converters.optional_converter_CinderPersistentVolumeSource, default=OMIT)
    claimRef: Union[None, OmitEnum, kdsl.core.v1.ObjectReference] = attr.ib(metadata={'yaml_name': 'claimRef'}, converter=kdsl.core.v1_converters.optional_converter_ObjectReference, default=OMIT)
    csi: Union[None, OmitEnum, kdsl.core.v1.CSIPersistentVolumeSource] = attr.ib(metadata={'yaml_name': 'csi'}, converter=kdsl.core.v1_converters.optional_converter_CSIPersistentVolumeSource, default=OMIT)
    fc: Union[None, OmitEnum, kdsl.core.v1.FCVolumeSource] = attr.ib(metadata={'yaml_name': 'fc'}, converter=kdsl.core.v1_converters.optional_converter_FCVolumeSource, default=OMIT)
    flexVolume: Union[None, OmitEnum, kdsl.core.v1.FlexPersistentVolumeSource] = attr.ib(metadata={'yaml_name': 'flexVolume'}, converter=kdsl.core.v1_converters.optional_converter_FlexPersistentVolumeSource, default=OMIT)
    flocker: Union[None, OmitEnum, kdsl.core.v1.FlockerVolumeSource] = attr.ib(metadata={'yaml_name': 'flocker'}, converter=kdsl.core.v1_converters.optional_converter_FlockerVolumeSource, default=OMIT)
    gcePersistentDisk: Union[None, OmitEnum, kdsl.core.v1.GCEPersistentDiskVolumeSource] = attr.ib(metadata={'yaml_name': 'gcePersistentDisk'}, converter=kdsl.core.v1_converters.optional_converter_GCEPersistentDiskVolumeSource, default=OMIT)
    glusterfs: Union[None, OmitEnum, kdsl.core.v1.GlusterfsPersistentVolumeSource] = attr.ib(metadata={'yaml_name': 'glusterfs'}, converter=kdsl.core.v1_converters.optional_converter_GlusterfsPersistentVolumeSource, default=OMIT)
    hostPath: Union[None, OmitEnum, kdsl.core.v1.HostPathVolumeSource] = attr.ib(metadata={'yaml_name': 'hostPath'}, converter=kdsl.core.v1_converters.optional_converter_HostPathVolumeSource, default=OMIT)
    iscsi: Union[None, OmitEnum, kdsl.core.v1.ISCSIPersistentVolumeSource] = attr.ib(metadata={'yaml_name': 'iscsi'}, converter=kdsl.core.v1_converters.optional_converter_ISCSIPersistentVolumeSource, default=OMIT)
    local: Union[None, OmitEnum, kdsl.core.v1.LocalVolumeSource] = attr.ib(metadata={'yaml_name': 'local'}, converter=kdsl.core.v1_converters.optional_converter_LocalVolumeSource, default=OMIT)
    mountOptions: Union[None, OmitEnum, Sequence[str]] = attr.ib(metadata={'yaml_name': 'mountOptions'}, default=OMIT)
    nfs: Union[None, OmitEnum, kdsl.core.v1.NFSVolumeSource] = attr.ib(metadata={'yaml_name': 'nfs'}, converter=kdsl.core.v1_converters.optional_converter_NFSVolumeSource, default=OMIT)
    nodeAffinity: Union[None, OmitEnum, kdsl.core.v1.VolumeNodeAffinity] = attr.ib(metadata={'yaml_name': 'nodeAffinity'}, converter=kdsl.core.v1_converters.optional_converter_VolumeNodeAffinity, default=OMIT)
    ...
    portworxVolume: Union[None, OmitEnum, kdsl.core.v1.PortworxVolumeSource] = attr.ib(metadata={'yaml_name': 'portworxVolume'}, converter=kdsl.core.v1_converters.optional_converter_PortworxVolumeSource, default=OMIT)
    quobyte: Union[None, OmitEnum, kdsl.core.v1.QuobyteVolumeSource] = attr.ib(metadata={'yaml_name': 'quobyte'}, converter=kdsl.core.v1_converters.optional_converter_QuobyteVolumeSource, default=OMIT)
    rbd: Union[None, OmitEnum, kdsl.core.v1.RBDPersistentVolumeSource] = attr.ib(metadata={'yaml_name': 'rbd'}, converter=kdsl.core.v1_converters.optional_converter_RBDPersistentVolumeSource, default=OMIT)
    scaleIO: Union[None, OmitEnum, kdsl.core.v1.ScaleIOPersistentVolumeSource] = attr.ib(metadata={'yaml_name': 'scaleIO'}, converter=kdsl.core.v1_converters.optional_converter_ScaleIOPersistentVolumeSource, default=OMIT)
    storageClassName: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'storageClassName'}, default=OMIT)
    storageos: Union[None, OmitEnum, kdsl.core.v1.StorageOSPersistentVolumeSource] = attr.ib(metadata={'yaml_name': 'storageos'}, converter=kdsl.core.v1_converters.optional_converter_StorageOSPersistentVolumeSource, default=OMIT)
    volumeMode: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'volumeMode'}, default=OMIT)
    vsphereVolume: Union[None, OmitEnum, kdsl.core.v1.VsphereVirtualDiskVolumeSource] = attr.ib(metadata={'yaml_name': 'vsphereVolume'}, converter=kdsl.core.v1_converters.optional_converter_VsphereVirtualDiskVolumeSource, default=OMIT)
...
class CSIVolumeSource(K8sObject):
    driver: str = attr.ib(metadata={'yaml_name': 'driver'})
    fsType: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'fsType'}, default=OMIT)
    nodePublishSecretRef: Union[None, OmitEnum, kdsl.core.v1.LocalObjectReference] = attr.ib(metadata={'yaml_name': 'nodePublishSecretRef'}, converter=kdsl.core.v1_converters.optional_converter_LocalObjectReference, default=OMIT)
    readOnly: Union[None, OmitEnum, bool] = attr.ib(metadata={'yaml_name': 'readOnly'}, default=OMIT)
    volumeAttributes: Union[None, OmitEnum, Mapping[str, str]] = attr.ib(metadata={'yaml_name': 'volumeAttributes'}, default=OMIT)
...
class Node(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.core.v1.NodeSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.core.v1_converters.optional_converter_NodeSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.core.v1.NodeStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.core.v1_converters.optional_converter_NodeStatus, default=OMIT)


@attr.s(kw_only=True)
class PodAffinityTerm(K8sObject):
    topologyKey: str = attr.ib(metadata={'yaml_name': 'topologyKey'})
    labelSelector: Union[None, OmitEnum, kdsl.core.v1.LabelSelector] = attr.ib(metadata={'yaml_name': 'labelSelector'}, converter=kdsl.core.v1_converters.optional_converter_LabelSelector, default=OMIT)
...
class PodSpec(K8sObject):
    containers: Mapping[str, kdsl.core.v1.ContainerItem] = attr.ib(metadata={'yaml_name': 'containers', 'mlist_key': 'name'}, converter=kdsl.core.v1_converters.required_mlist_converter_ContainerItem)
    activeDeadlineSeconds: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'activeDeadlineSeconds'}, default=OMIT)
    affinity: Union[None, OmitEnum, kdsl.core.v1.Affinity] = attr.ib(metadata={'yaml_name': 'affinity'}, converter=kdsl.core.v1_converters.optional_converter_Affinity, default=OMIT)
    ...
    dnsConfig: Union[None, OmitEnum, kdsl.core.v1.PodDNSConfig] = attr.ib(metadata={'yaml_name': 'dnsConfig'}, converter=kdsl.core.v1_converters.optional_converter_PodDNSConfig, default=OMIT)
    ...
    ephemeralContainers: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.EphemeralContainerItem]] = attr.ib(metadata={'yaml_name': 'ephemeralContainers', 'mlist_key': 'name'}, converter=kdsl.core.v1_converters.optional_mlist_converter_EphemeralContainerItem, default=OMIT)
    hostAliases: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.HostAliasItem]] = attr.ib(metadata={'yaml_name': 'hostAliases', 'mlist_key': 'ip'}, converter=kdsl.core.v1_converters.optional_mlist_converter_HostAliasItem, default=OMIT)
    ...
    hostname: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'hostname'}, default=OMIT)
    imagePullSecrets: Union[None, OmitEnum, Sequence[kdsl.core.v1.LocalObjectReference]] = attr.ib(metadata={'yaml_name': 'imagePullSecrets'}, converter=kdsl.core.v1_converters.optional_list_converter_LocalObjectReference, default=OMIT)
    initContainers: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.ContainerItem]] = attr.ib(metadata={'yaml_name': 'initContainers', 'mlist_key': 'name'}, converter=kdsl.core.v1_converters.optional_mlist_converter_ContainerItem, default=OMIT)
    nodeName: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'nodeName'}, default=OMIT)
    ...
    readinessGates: Union[None, OmitEnum, Sequence[kdsl.core.v1.PodReadinessGate]] = attr.ib(metadata={'yaml_name': 'readinessGates'}, converter=kdsl.core.v1_converters.optional_list_converter_PodReadinessGate, default=OMIT)
    ...
    securityContext: Union[None, OmitEnum, kdsl.core.v1.PodSecurityContext] = attr.ib(metadata={'yaml_name': 'securityContext'}, converter=kdsl.core.v1_converters.optional_converter_PodSecurityContext, default=OMIT)
    ...
    tolerations: Union[None, OmitEnum, Sequence[kdsl.core.v1.Toleration]] = attr.ib(metadata={'yaml_name': 'tolerations'}, converter=kdsl.core.v1_converters.optional_list_converter_Toleration, default=OMIT)
    topologySpreadConstraints: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.TopologySpreadConstraintItem]] = attr.ib(metadata={'yaml_name': 'topologySpreadConstraints', 'mlist_key': 'topologyKey'}, converter=kdsl.core.v1_converters.optional_mlist_converter_TopologySpreadConstraintItem, default=OMIT)
    volumes: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.VolumeItem]] = attr.ib(metadata={'yaml_name': 'volumes', 'mlist_key': 'name'}, converter=kdsl.core.v1_converters.optional_mlist_converter_VolumeItem, default=OMIT)
...
class ReplicationControllerStatus(K8sObject):
    ...
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.ReplicationControllerConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.core.v1_converters.optional_mlist_converter_ReplicationControllerConditionItem, default=OMIT)
...
class PreferredSchedulingTerm(K8sObject):
    preference: kdsl.core.v1.NodeSelectorTerm = attr.ib(metadata={'yaml_name': 'preference'}, converter=kdsl.core.v1_converters.required_converter_NodeSelectorTerm)
...
class DeleteOptions(K8sObject):
    ...
    preconditions: Union[None, OmitEnum, kdsl.core.v1.Preconditions] = attr.ib(metadata={'yaml_name': 'preconditions'}, converter=kdsl.core.v1_converters.optional_converter_Preconditions, default=OMIT)
...
class ScopeSelector(K8sObject):
    matchExpressions: Union[None, OmitEnum, Sequence[kdsl.core.v1.ScopedResourceSelectorRequirement]] = attr.ib(metadata={'yaml_name': 'matchExpressions'}, converter=kdsl.core.v1_converters.optional_list_converter_ScopedResourceSelectorRequirement, default=OMIT)
...
class LabelSelector(K8sObject):
    matchExpressions: Union[None, OmitEnum, Sequence[kdsl.core.v1.LabelSelectorRequirement]] = attr.ib(metadata={'yaml_name': 'matchExpressions'}, converter=kdsl.core.v1_converters.optional_list_converter_LabelSelectorRequirement, default=OMIT)
...
class ResourceQuota(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.core.v1.ResourceQuotaSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.core.v1_converters.optional_converter_ResourceQuotaSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.core.v1.ResourceQuotaStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.core.v1_converters.optional_converter_ResourceQuotaStatus, default=OMIT)
...
class NodeStatus(K8sObject):
    addresses: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.NodeAddressItem]] = attr.ib(metadata={'yaml_name': 'addresses', 'mlist_key': 'type'}, converter=kdsl.core.v1_converters.optional_mlist_converter_NodeAddressItem, default=OMIT)
    allocatable: Union[None, OmitEnum, Mapping[str, str]] = attr.ib(metadata={'yaml_name': 'allocatable'}, default=OMIT)
    capacity: Union[None, OmitEnum, Mapping[str, str]] = attr.ib(metadata={'yaml_name': 'capacity'}, default=OMIT)
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.NodeConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.core.v1_converters.optional_mlist_converter_NodeConditionItem, default=OMIT)
    config: Union[None, OmitEnum, kdsl.core.v1.NodeConfigStatus] = attr.ib(metadata={'yaml_name': 'config'}, converter=kdsl.core.v1_converters.optional_converter_NodeConfigStatus, default=OMIT)
    daemonEndpoints: Union[None, OmitEnum, kdsl.core.v1.NodeDaemonEndpoints] = attr.ib(metadata={'yaml_name': 'daemonEndpoints'}, converter=kdsl.core.v1_converters.optional_converter_NodeDaemonEndpoints, default=OMIT)
    images: Union[None, OmitEnum, Sequence[kdsl.core.v1.ContainerImage]] = attr.ib(metadata={'yaml_name': 'images'}, converter=kdsl.core.v1_converters.optional_list_converter_ContainerImage, default=OMIT)
    nodeInfo: Union[None, OmitEnum, kdsl.core.v1.NodeSystemInfo] = attr.ib(metadata={'yaml_name': 'nodeInfo'}, converter=kdsl.core.v1_converters.optional_converter_NodeSystemInfo, default=OMIT)
    phase: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'phase'}, default=OMIT)
    volumesAttached: Union[None, OmitEnum, Sequence[kdsl.core.v1.AttachedVolume]] = attr.ib(metadata={'yaml_name': 'volumesAttached'}, converter=kdsl.core.v1_converters.optional_list_converter_AttachedVolume, default=OMIT)
...
class PersistentVolumeClaim(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.core.v1.PersistentVolumeClaimSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.core.v1_converters.optional_converter_PersistentVolumeClaimSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.core.v1.PersistentVolumeClaimStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.core.v1_converters.optional_converter_PersistentVolumeClaimStatus, default=OMIT)


@attr.s(kw_only=True)
class NamespaceStatus(K8sObject):
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.NamespaceConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.core.v1_converters.optional_mlist_converter_NamespaceConditionItem, default=OMIT)
    phase: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'phase'}, default=OMIT)
...
class Binding(K8sResource):
    ...
    target: kdsl.core.v1.ObjectReference = attr.ib(metadata={'yaml_name': 'target'}, converter=kdsl.core.v1_converters.required_converter_ObjectReference)
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
...
class StorageOSPersistentVolumeSource(K8sObject):
    fsType: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'fsType'}, default=OMIT)
    readOnly: Union[None, OmitEnum, bool] = attr.ib(metadata={'yaml_name': 'readOnly'}, default=OMIT)
    secretRef: Union[None, OmitEnum, kdsl.core.v1.ObjectReference] = attr.ib(metadata={'yaml_name': 'secretRef'}, converter=kdsl.core.v1_converters.optional_converter_ObjectReference, default=OMIT)
    volumeName: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'volumeName'}, default=OMIT)
...
class ScaleIOVolumeSource(K8sObject):
    gateway: str = attr.ib(metadata={'yaml_name': 'gateway'})
    secretRef: kdsl.core.v1.LocalObjectReference = attr.ib(metadata={'yaml_name': 'secretRef'}, converter=kdsl.core.v1_converters.required_converter_LocalObjectReference)
    system: str = attr.ib(metadata={'yaml_name': 'system'})
    fsType: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'fsType'}, default=OMIT)
    protectionDomain: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'protectionDomain'}, default=OMIT)
    readOnly: Union[None, OmitEnum, bool] = attr.ib(metadata={'yaml_name': 'readOnly'}, default=OMIT)
...
class Service(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.core.v1.ServiceSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.core.v1_converters.optional_converter_ServiceSpec, default=OMIT)
    status: Union[None, OmitEnum, kdsl.core.v1.ServiceStatus] = attr.ib(metadata={'yaml_name': 'status'}, converter=kdsl.core.v1_converters.optional_converter_ServiceStatus, default=OMIT)
...
class ContainerState(K8sObject):
    running: Union[None, OmitEnum, kdsl.core.v1.ContainerStateRunning] = attr.ib(metadata={'yaml_name': 'running'}, converter=kdsl.core.v1_converters.optional_converter_ContainerStateRunning, default=OMIT)
    terminated: Union[None, OmitEnum, kdsl.core.v1.ContainerStateTerminated] = attr.ib(metadata={'yaml_name': 'terminated'}, converter=kdsl.core.v1_converters.optional_converter_ContainerStateTerminated, default=OMIT)
    waiting: Union[None, OmitEnum, kdsl.core.v1.ContainerStateWaiting] = attr.ib(metadata={'yaml_name': 'waiting'}, converter=kdsl.core.v1_converters.optional_converter_ContainerStateWaiting, default=OMIT)
...
class PersistentVolumeClaimStatus(K8sObject):
    accessModes: Union[None, OmitEnum, Sequence[str]] = attr.ib(metadata={'yaml_name': 'accessModes'}, default=OMIT)
    capacity: Union[None, OmitEnum, Mapping[str, str]] = attr.ib(metadata={'yaml_name': 'capacity'}, default=OMIT)
    conditions: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.PersistentVolumeClaimConditionItem]] = attr.ib(metadata={'yaml_name': 'conditions', 'mlist_key': 'type'}, converter=kdsl.core.v1_converters.optional_mlist_converter_PersistentVolumeClaimConditionItem, default=OMIT)
    phase: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'phase'}, default=OMIT)
...
class NodeConfigSource(K8sObject):
    configMap: Union[None, OmitEnum, kdsl.core.v1.ConfigMapNodeConfigSource] = attr.ib(metadata={'yaml_name': 'configMap'}, converter=kdsl.core.v1_converters.optional_converter_ConfigMapNodeConfigSource, default=OMIT)
...
class SecurityContext(K8sObject):
    ...
    capabilities: Union[None, OmitEnum, kdsl.core.v1.Capabilities] = attr.ib(metadata={'yaml_name': 'capabilities'}, converter=kdsl.core.v1_converters.optional_converter_Capabilities, default=OMIT)
...
class ServiceAccount(K8sResource):
    ...
    imagePullSecrets: Union[None, OmitEnum, Sequence[kdsl.core.v1.LocalObjectReference]] = attr.ib(metadata={'yaml_name': 'imagePullSecrets'}, converter=kdsl.core.v1_converters.optional_list_converter_LocalObjectReference, default=OMIT)
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    secrets: Union[None, OmitEnum, Mapping[str, kdsl.core.v1.ObjectReferenceItem]] = attr.ib(metadata={'yaml_name': 'secrets', 'mlist_key': 'name'}, converter=kdsl.core.v1_converters.optional_mlist_converter_ObjectReferenceItem, default=OMIT)


@attr.s(kw_only=True)
class DownwardAPIProjection(K8sObject):
    items: Union[None, OmitEnum, Sequence[kdsl.core.v1.DownwardAPIVolumeFile]] = attr.ib(metadata={'yaml_name': 'items'}, converter=kdsl.core.v1_converters.optional_list_converter_DownwardAPIVolumeFile, default=OMIT)
...
class SessionAffinityConfig(K8sObject):
    clientIP: Union[None, OmitEnum, kdsl.core.v1.ClientIPConfig] = attr.ib(metadata={'yaml_name': 'clientIP'}, converter=kdsl.core.v1_converters.optional_converter_ClientIPConfig, default=OMIT)
...
class ContainerItem(K8sObject):
    ...
    lifecycle: Union[None, OmitEnum, kdsl.core.v1.Lifecycle] = attr.ib(metadata={'yaml_name': 'lifecycle'}, converter=kdsl.core.v1_converters.optional_converter_Lifecycle, default=OMIT)
    livenessProbe: Union[None, OmitEnum, kdsl.core.v1.Probe] = attr.ib(metadata={'yaml_name': 'livenessProbe'}, converter=kdsl.core.v1_converters.optional_converter_Probe, default=OMIT)
    ports: Union[None, OmitEnum, Mapping[int, kdsl.core.v1.ContainerPortItem]] = attr.ib(metadata={'yaml_name': 'ports', 'mlist_key': 'containerPort'}, converter=kdsl.core.v1_converters.optional_mlist_converter_ContainerPortItem, default=OMIT)
    readinessProbe: Union[None, OmitEnum, kdsl.core.v1.Probe] = attr.ib(metadata={'yaml_name': 'readinessProbe'}, converter=kdsl.core.v1_converters.optional_converter_Probe, default=OMIT)
    resources: Union[None, OmitEnum, kdsl.core.v1.ResourceRequirements] = attr.ib(metadata={'yaml_name': 'resources'}, converter=kdsl.core.v1_converters.optional_converter_ResourceRequirements, default=OMIT)
    securityContext: Union[None, OmitEnum, kdsl.core.v1.SecurityContext] = attr.ib(metadata={'yaml_name': 'securityContext'}, converter=kdsl.core.v1_converters.optional_converter_SecurityContext, default=OMIT)
    startupProbe: Union[None, OmitEnum, kdsl.core.v1.Probe] = attr.ib(metadata={'yaml_name': 'startupProbe'}, converter=kdsl.core.v1_converters.optional_converter_Probe, default=OMIT)
...
class NodeSelector(K8sObject):
    nodeSelectorTerms: Sequence[kdsl.core.v1.NodeSelectorTerm] = attr.ib(metadata={'yaml_name': 'nodeSelectorTerms'}, converter=kdsl.core.v1_converters.required_list_converter_NodeSelectorTerm)
...
class WeightedPodAffinityTerm(K8sObject):
    podAffinityTerm: kdsl.core.v1.PodAffinityTerm = attr.ib(metadata={'yaml_name': 'podAffinityTerm'}, converter=kdsl.core.v1_converters.required_converter_PodAffinityTerm)
    weight: int = attr.ib(metadata={'yaml_name': 'weight'})
...
class LimitRange(K8sResource):
    ...
    metadata: Union[None, OmitEnum, kdsl.core.v1.ObjectMeta] = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.optional_converter_ObjectMeta, default=OMIT)
    spec: Union[None, OmitEnum, kdsl.core.v1.LimitRangeSpec] = attr.ib(metadata={'yaml_name': 'spec'}, converter=kdsl.core.v1_converters.optional_converter_LimitRangeSpec, default=OMIT)


@attr.s(kw_only=True)
class VolumeNodeAffinity(K8sObject):
    required: Union[None, OmitEnum, kdsl.core.v1.NodeSelector] = attr.ib(metadata={'yaml_name': 'required'}, converter=kdsl.core.v1_converters.optional_converter_NodeSelector, default=OMIT)
...
class VolumeProjection(K8sObject):
    configMap: Union[None, OmitEnum, kdsl.core.v1.ConfigMapProjection] = attr.ib(metadata={'yaml_name': 'configMap'}, converter=kdsl.core.v1_converters.optional_converter_ConfigMapProjection, default=OMIT)
    downwardAPI: Union[None, OmitEnum, kdsl.core.v1.DownwardAPIProjection] = attr.ib(metadata={'yaml_name': 'downwardAPI'}, converter=kdsl.core.v1_converters.optional_converter_DownwardAPIProjection, default=OMIT)
    secret: Union[None, OmitEnum, kdsl.core.v1.SecretProjection] = attr.ib(metadata={'yaml_name': 'secret'}, converter=kdsl.core.v1_converters.optional_converter_SecretProjection, default=OMIT)
    serviceAccountToken: Union[None, OmitEnum, kdsl.core.v1.ServiceAccountTokenProjection] = attr.ib(metadata={'yaml_name': 'serviceAccountToken'}, converter=kdsl.core.v1_converters.optional_converter_ServiceAccountTokenProjection, default=OMIT)
...
class TopologySelectorTerm(K8sObject):
    matchLabelExpressions: Union[None, OmitEnum, Sequence[kdsl.core.v1.TopologySelectorLabelRequirement]] = attr.ib(metadata={'yaml_name': 'matchLabelExpressions'}, converter=kdsl.core.v1_converters.optional_list_converter_TopologySelectorLabelRequirement, default=OMIT)
...
class ServiceSpec(K8sObject):
    ...
    ipFamily: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'ipFamily'}, default=OMIT)
    ...
    ports: Union[None, OmitEnum, Mapping[int, kdsl.core.v1.ServicePortItem]] = attr.ib(metadata={'yaml_name': 'ports', 'mlist_key': 'port'}, converter=kdsl.core.v1_converters.optional_mlist_converter_ServicePortItem, default=OMIT)
    ...
    sessionAffinityConfig: Union[None, OmitEnum, kdsl.core.v1.SessionAffinityConfig] = attr.ib(metadata={'yaml_name': 'sessionAffinityConfig'}, converter=kdsl.core.v1_converters.optional_converter_SessionAffinityConfig, default=OMIT)
...
class Event(K8sResource):
    ...
    involvedObject: kdsl.core.v1.ObjectReference = attr.ib(metadata={'yaml_name': 'involvedObject'}, converter=kdsl.core.v1_converters.required_converter_ObjectReference)
    metadata: kdsl.core.v1.ObjectMeta = attr.ib(metadata={'yaml_name': 'metadata'}, converter=kdsl.core.v1_converters.required_converter_ObjectMeta)
    ...
    message: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'message'}, default=OMIT)
    reason: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'reason'}, default=OMIT)
    related: Union[None, OmitEnum, kdsl.core.v1.ObjectReference] = attr.ib(metadata={'yaml_name': 'related'}, converter=kdsl.core.v1_converters.optional_converter_ObjectReference, default=OMIT)
    ...
    series: Union[None, OmitEnum, kdsl.core.v1.EventSeries] = attr.ib(metadata={'yaml_name': 'series'}, converter=kdsl.core.v1_converters.optional_converter_EventSeries, default=OMIT)
    source: Union[None, OmitEnum, kdsl.core.v1.EventSource] = attr.ib(metadata={'yaml_name': 'source'}, converter=kdsl.core.v1_converters.optional_converter_EventSource, default=OMIT)
    type: Union[None, OmitEnum, str] = attr.ib(metadata={'yaml_name': 'type'}, default=OMIT)
...
class ProjectedVolumeSource(K8sObject):
    sources: Sequence[kdsl.core.v1.VolumeProjection] = attr.ib(metadata={'yaml_name': 'sources'}, converter=kdsl.core.v1_converters.required_list_converter_VolumeProjection)
    defaultMode: Union[None, OmitEnum, int] = attr.ib(metadata={'yaml_name': 'defaultMode'}, default=OMIT)
...
class ProjectedVolumeSourceTypedDict(ProjectedVolumeSourceOptionalTypedDict, total=(True)):
