...
class PlanetaryConnectionParametricStudyTool(_3615.ShaftToMountableComponentConnectionParametricStudyTool):
    '''PlanetaryConnectionParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2342.PlanetaryConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2342.PlanetaryConnectionSystemDeflection))
        return value
