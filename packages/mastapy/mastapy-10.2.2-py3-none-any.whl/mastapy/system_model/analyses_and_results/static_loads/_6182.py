...
from mastapy.system_model.analyses_and_results.static_loads import _6150, _6181, _6162
...
class HarmonicLoadDataJMAGImport(_6181.HarmonicLoadDataImportFromMotorPackages['_6162.ElectricMachineHarmonicLoadJMAGImportOptions']):
    '''HarmonicLoadDataJMAGImport
    ...
    @property
    def electric_machine_data_per_speed(self) -> 'List[_6150.DataFromJMAGPerSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataPerSpeed, constructor.new(_6150.DataFromJMAGPerSpeed))
        return value
