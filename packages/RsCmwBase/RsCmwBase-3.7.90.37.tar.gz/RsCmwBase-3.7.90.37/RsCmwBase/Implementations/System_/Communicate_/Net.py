...
class Net:
	...
	def set_adapter(self, networkadapter: str) -> None:
		...
		Selects a LAN network adapter for configuration via other SYSTem:COMMunicate:NET... commands. \n
			:param networkadapter: String parameter identifying the network adapter
		"""
	...
	def set_ip_address(self, ipaddresses: List[str]) -> None:
		...
		Assigns one or more IPv4 addresses to the network adapter. This command is only relevant if DHCP is disabled. A query
		returns the currently assigned addresses, irrespective of whether they have been assigned manually or via DHCP. \n
			:param ipaddresses: String parameter, IPv4 address consisting of four blocks (octets) separated by dots Several strings separated by commas can be entered or several addresses separated by commas can be included in one string.
		"""
