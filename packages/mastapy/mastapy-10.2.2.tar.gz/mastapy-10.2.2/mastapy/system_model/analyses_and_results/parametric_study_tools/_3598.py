...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3590, _3587
...
class ParametricStudyVariable(_2222.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_3590.ParametricStudyDimension':
        ...
        return constructor.new(_3590.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_3590.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_3587.MonteCarloDistribution':
        ...
        return constructor.new(_3587.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_3587.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
