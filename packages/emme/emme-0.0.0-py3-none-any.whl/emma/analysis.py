...
operate on `emma.Model` objects, or arrays represention various
structural matrices.
"""


from emma.matrices import *
# from emma.utilities.fedeas.syntax import *
import numpy as np  
...
def kStaticCondensation(K, dofs=None, idxs=None):
    ...
    K_matrix: np.ndarray or emma.Structural_Matrix
...
def StaticCondensation(K_matrix, M_matrix=None, dofs=None, idxs=None):
    ...
    if (dofs is None and idxs is None) and (Mass_matrix is not None):
        # This method may require emma.Stiffness_matrix and emma.Mass_matrix objects as 
