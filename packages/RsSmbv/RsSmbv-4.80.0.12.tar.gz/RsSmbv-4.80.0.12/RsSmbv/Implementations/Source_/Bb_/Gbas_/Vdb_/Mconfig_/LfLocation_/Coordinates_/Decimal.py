...
class Decimal:
	...
	def set(self, structure: DecimalStruct, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.gbas.vdb.mconfig.lfLocation.coordinates.decimal.set(value = [PROPERTY_STRUCT_NAME](), channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> DecimalStruct:
		"""SCPI: [SOURce<HW>]:BB:GBAS:VDB<CH>:MCONfig:LFLocation:COORdinates:DECimal \n
		Snippet: value: DecimalStruct = driver.source.bb.gbas.vdb.mconfig.lfLocation.coordinates.decimal.get(channel = repcap.Channel.Default) \n
		Defines the coordinates of the LTP/FTP in decimal format. \n
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Vdb')
