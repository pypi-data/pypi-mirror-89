...
class Tgd:
	...
	def set(self, tgd: int, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.bstation.cmode.pattern.tgd.set(tgd = 1, stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
	...
	def get(self, stream=repcap.Stream.Default, channel=repcap.Channel.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:BSTation<ST>:CMODe:PATTern<CH>:TGD \n
		Snippet: value: int = driver.source.bb.w3Gpp.bstation.cmode.pattern.tgd.get(stream = repcap.Stream.Default, channel = repcap.Channel.Default) \n
		Sets the transmission gap distances. \n
			:param stream: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Bstation')
			:param channel: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Pattern')
