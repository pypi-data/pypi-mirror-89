...
class ShaftDutyCycleSystemDeflection(_0.APIBase):
    ...
    @property
    def shaft_static_analyses(self) -> 'List[_2354.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftStaticAnalyses, constructor.new(_2354.ShaftSystemDeflection))
        return value
