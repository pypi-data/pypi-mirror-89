...
class Dtime:
	...
	def set(self, index: int, dwell_time: float) -> None:
		...
		Snippet: driver.source.sequencer.listPy.dtime.set(index = 1, dwell_time = 1.0) \n
		Defines or queries the dwell time for the sequencer list entry with the selected <Index>. \n
			:param index: No help available
			:param dwell_time: Range: 200E-6 s to 20 s, Unit: s
		"""
	...
	def get(self, index: int) -> float:
		"""SCPI: SOURce:GPRF:GENerator<Instance>:SEQuencer:LIST:DTIMe \n
		Snippet: value: float = driver.source.sequencer.listPy.dtime.get(index = 1) \n
		Defines or queries the dwell time for the sequencer list entry with the selected <Index>. \n
			:param index: No help available
			:return: dwell_time: Range: 200E-6 s to 20 s, Unit: s"""
	...
	def get_all(self) -> List[float]:
		...
		Snippet: value: List[float] = driver.source.sequencer.listPy.dtime.get_all() \n
		Defines the dwell times for all sequencer list entries. \n
			:return: dwell_time: Comma-separated list of values, one value per list entry Range: 200E-6 s to 20 s, Unit: s
		"""
	...
	def set_all(self, dwell_time: List[float]) -> None:
		"""SCPI: SOURce:GPRF:GENerator<Instance>:SEQuencer:LIST:DTIMe:ALL \n
		Snippet: driver.source.sequencer.listPy.dtime.set_all(dwell_time = [1.1, 2.2, 3.3]) \n
		Defines the dwell times for all sequencer list entries. \n
			:param dwell_time: Comma-separated list of values, one value per list entry Range: 200E-6 s to 20 s, Unit: s
		"""
